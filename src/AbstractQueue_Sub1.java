...
public class AbstractQueue_Sub1 extends AbstractQueue {
	...
	void method6383(int i, int i_0_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ajy.b(").append(')').toString());
		}
	}
	...
	void method6384(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ajy.a(").append(')').toString());
		}
	}
	...
	public int size() {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ajy.size(").append(')').toString());
		}
	}
	...
	public boolean contains(Object object) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ajy.contains(").append(')').toString());
		}
	}
	...
	public Object poll() {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ajy.poll(").append(')').toString());
		}
	}
	...
	void method6385(int i, int i_8_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ajy.f(").append(')').toString());
		}
	}
	...
	public Object[] toArray() {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ajy.toArray(").append(')').toString());
		}
	}
	...
	public Iterator iterator() {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ajy.iterator(").append(')').toString());
		}
	}
	...
	public Object peek() {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ajy.peek(").append(')').toString());
		}
	}
	...
	public boolean offer(Object object) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ajy.offer(").append(')').toString());
		}
	}
	...
	public boolean remove(Object object) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ajy.remove(").append(')').toString());
		}
	}
