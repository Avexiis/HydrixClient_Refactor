/* AntialiasPreference - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

public class AntialiasPreference extends IntegerPreferenceField {
	public static int anInt8396 = 0;
	static int anInt8397 = 2;

	public AntialiasPreference(int i, GamePreferences gamePreferences) {
		super(i, gamePreferences);
	}

	public void method5673(byte i) {
		try {
			if (aGamePreferences_5346.graphicsPreference.method5679(16711680) && !Class261.method2465(aGamePreferences_5346.graphicsPreference.getValue(-1298559578), 1142209695))
				anInt5350 = 0;
			if (anInt5350 * -1598873795 < 0 || anInt5350 * -1598873795 > 2)
				anInt5350 = method5611(-1016152227) * 1886334997;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ado.s(").append(')').toString());
		}
	}

	public AntialiasPreference(GamePreferences gamePreferences) {
		super(gamePreferences);
	}

	public boolean method5674(int i) {
		try {
			if (!Class261.method2465(aGamePreferences_5346.graphicsPreference.getValue(-541516290), 718607573))
				return false;
			return true;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ado.z(").append(')').toString());
		}
	}
	...
	int method5611(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ado.a(").append(')').toString());
		}
	}
	...
	void method5614(int i, int i_0_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ado.p(").append(')').toString());
		}
	}
	...
	public int getValue(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ado.y(").append(')').toString());
		}
	}
	...
	public int method5616(int i) {
		if (!Class261.method2465(aGamePreferences_5346.graphicsPreference.getValue(-2048845946), -31427967))
			return 3;
		return 1;
	}
	...
	public int method5612(int i, int i_1_) {
		try {
			if (!Class261.method2465(aGamePreferences_5346.graphicsPreference.getValue(-1771476690), -1583872086))
				return 3;
			return 1;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ado.f(").append(')').toString());
		}
	}
	...
	static void method5676(int i, int i_2_, int i_3_, int i_4_, int i_5_, int i_6_, int i_7_, int i_8_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ado.av(").append(')').toString());
		}
	}
}
