...
public final class Canvas_Sub1 extends Canvas {
	...
	public final void update(Graphics graphics) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ajk.update(").append(')').toString());
		}
	}
	...
	public final void paint(Graphics graphics) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ajk.paint(").append(')').toString());
		}
	}
