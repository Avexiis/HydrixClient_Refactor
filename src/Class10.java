...
public class Class10 {
	...
	static Packet[] aClass298_Sub53Array133 = new Packet[2048];
	...
	public static void method322(Packet buffer, byte i) {
		try {
			byte[] is = new byte[24];
			try {
				GameShell.aClass484_6499.method6140(0L);
				GameShell.aClass484_6499.method6136(is, 430767444);
				int i_0_;
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ak.r(").append(')').toString());
		}
	}
	...
	static final void method323(ClientScript2 class403, int i) {
		try {
			...
			Class194.method1870(class105, RSInterface, class403, (byte) -123);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ak.jn(").append(')').toString());
		}
	}
	...
	static final void method324(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ak.aef(").append(')').toString());
		}
	}
