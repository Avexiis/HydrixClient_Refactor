...
public class Class100 {
	...
	static final void method1073(ClientScript2 class403, byte i) {
		try {
			...
			LocalizedString.markComponentForRedraw(class105, -1793194156);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("eb.bj(").append(')').toString());
		}
	}

	static final void method1074(ClientScript2 class403, int i) {
		try {
			MapDetails.method3455((((ClientScript2) class403).anIntArray5244[(((ClientScript2) class403).anInt5239 -= -391880689) * 681479919]), -1482618001);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("eb.xy(").append(')').toString());
		}
	}
	...
	static final void method1075(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("eb.acu(").append(')').toString());
		}
	}
	...
	static final void method1077(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("eb.aec(").append(')').toString());
		}
	}
	...
	static final void method1078(ClientScript2 class403, short i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("eb.adw(").append(')').toString());
		}
	}
}
