...
public class Class101 {
	...
	String method1079(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ec.f(").append(')').toString());
		}
	}
	...
	int method1080(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ec.a(").append(')').toString());
		}
	}
	...
	static final void method1081(ClientScript2 class403, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ec.afe(").append(')').toString());
		}
	}
}
