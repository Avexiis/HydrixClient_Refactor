...
public class Class102 {
	...
	void method1082(int i, int i_0_, String string, String string_1_, String string_2_, String string_3_, int i_4_, String string_5_, short i_6_) {
		try {
			...
			anInt1085 = -1698852737 * GameClient.anInt8884;
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ed.a(").append(')').toString());
		}
	}

	Class102(int i, int i_7_, String string, String string_8_, String string_9_, String string_10_, int i_11_, String string_12_) {
		anInt1085 = GameClient.anInt8884 * -1698852737;
		anInt1087 = i * 392659741;
	...
	static final void method1085(IComponentDefinition class105, RSInterface RSInterface, ClientScript2 class403, int i) {
		try {
			class105.anInt1173 = (((ClientScript2) class403).anIntArray5244[(((ClientScript2) class403).anInt5239 -= -391880689) * 681479919]) * -1041514725;
			LocalizedString.markComponentForRedraw(class105, -1371264268);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ed.db(").append(')').toString());
		}
	}
}
