...
public class Class104 {
	...
	static final void method1101(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ef.zk(").append(')').toString());
		}
	}
	...
	static final void method1102(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ef.zv(").append(')').toString());
		}
	}

	static final void method1103(Entity class365_sub1_sub1_sub2, int i) {
		try {
			Animator animator = class365_sub1_sub1_sub2.projectileAnimator;
			if ((GameClient.anInt8884 * 443738891 == class365_sub1_sub1_sub2.anInt10103 * 1450943713) || !animator.method5819((byte) -78) || animator.method5836(1, 2027501470)) {
				int i_3_ = (class365_sub1_sub1_sub2.anInt10103 * 1450943713 - class365_sub1_sub1_sub2.anInt10095 * -412225079);
				int i_4_ = (443738891 * GameClient.anInt8884 - -412225079 * class365_sub1_sub1_sub2.anInt10095);
				...
				class365_sub1_sub1_sub2.method4341((float) ((i_5_ * (i_3_ - i_4_) + i_4_ * i_7_) / i_3_), (float) (int) sceneObjectPosition.y, (float) ((i_4_ * i_8_ + (i_3_ - i_4_) * i_6_) / i_3_));
			}
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ef.hp(").append(')').toString());
		}
	}
	...
	static final void method1104(int i) {
		try {
			...
			Class448.method5912(GameClient.WINDOW_PANE_ID * -257444687, 0, 0, Class462.canvasWidth * -2110394505, Class298_Sub40_Sub9.anInt9716 * -1111710645, 0, 0, -1, 421170136);
			if (null != Class83.aClass105Array764) {
				Class422_Sub24.method5714(Class83.aClass105Array764, -1412584499, 0, 0, Class462.canvasWidth * -2110394505, -1111710645 * Class298_Sub40_Sub9.anInt9716, Class216.anInt6660 * -391533651, HashTable.anInt5518 * -514549911, (Class82_Sub3.aClass105_6825 == GameClient.aClass105_8712 ? -1 : GameClient.aClass105_8712.anInt1303 * 91937559), true, (byte) 0);
				Class83.aClass105Array764 = null;
			}
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ef.kl(").append(')').toString());
		}
	}
	...
	static final void method1105(ClientScript2 class403, int i) {
		try {
			...
			Class75.method835(class105, RSInterface, class403, (byte) -113);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ef.jj(").append(')').toString());
		}
	}
	...
	static final void method1106(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ef.az(").append(')').toString());
		}
	}

	public static String method1107(Class298_Sub37_Sub15 class298_sub37_sub15, byte i) {
		try {
			if (ContextMenu.menuOpen || null == class298_sub37_sub15)
				return "";
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ef.as(").append(')').toString());
		}
	}
	...
	public static void method1108(int i, int i_10_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ef.q(").append(')').toString());
		}
	}
}
