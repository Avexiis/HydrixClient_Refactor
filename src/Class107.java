...
public class Class107 {
	...
	static final void method1138(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ej.sc(").append(')').toString());
		}
	}
	...
	static final void method1139(ClientScript2 class403, int i) {
		try {
			...
			Class298_Sub36 class298_sub36 = Class18.method359(OutgoingPacket.aClass198_2085, class25.aClass449_330, (byte) 119);
			class298_sub36.buffer.writeByte((Class58.method693(string, 824741758) + 2 + Class58.method693(string_2_, 1825350693)));
			class298_sub36.buffer.writeString(string, 2106957480);
			class298_sub36.buffer.writeByte(i_3_ - 1);
			class298_sub36.buffer.writeByte(i_4_);
			class298_sub36.buffer.writeString(string_2_, 2102628417);
			class25.writeOutboundPacket(class298_sub36, (byte) -56);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ej.abn(").append(')').toString());
		}
	}

	static final void method1140(ClientScript2 class403, int i) {
		try {
			GraphicsAutoSetup.clientPreferences.method3540(GraphicsAutoSetup.clientPreferences.aGraphicsAutoSetup_7569, (((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 -= -391880689) * 681479919)]), -2044130238);
			Class3.writePreferences();
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ej.aiu(").append(')').toString());
		}
	}
	...
	static final void method1141(ClientScript2 class403, short i) {
		try {
			...
			Class284.method2696(class105, RSInterface, class403, (short) 909);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ej.gn(").append(')').toString());
		}
	}
	...
	static final void method1142(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ej.pq(").append(')').toString());
		}
	}
	...
	static final void method1143(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ej.xa(").append(')').toString());
		}
	}

	public static void method1144(boolean bool, short i) {
		try {
			if (1596783995 * GameClient.cutsceneStage != 2 && 1596783995 * GameClient.cutsceneStage != 3) {
				if (!bool) {
				...
				GameClient.cutsceneStage = 1973597030;
				...
				Class298_Sub36 class298_sub36 = Class18.method359(OutgoingPacket.aClass198_2011, GameClient.gameConnection.aClass449_330, (byte) 30);
				class298_sub36.buffer.writeByte(bool ? 1 : 0);
				GameClient.gameConnection.writeOutboundPacket(class298_sub36, (byte) -61);
			}
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ej.i(").append(')').toString());
		}
	}
}
