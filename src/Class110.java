...
public abstract class Class110 implements Interface8 {
	...
	String method1160(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("em.a(").append(')').toString());
		}
	}
	...
	public static void method1223(int i) {
		try {
			...
			MovementType.aClass270_6546 = new Class270(22050, 1164070869 * Class284.anInt3059);
	...
	static final void method1224(ClientScript2 class403, int i) {
		try {
			...
			Class318.method3875(class105, RSInterface, class403, -1300595818);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("em.ch(").append(')').toString());
		}
	}
	...
	static final void method1225(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("em.acl(").append(')').toString());
		}
	}
		...
		try {
			if (HashTable.aClass371_5520.aBoolean4038 || (ContextMenu.actionCount * -278777595 != 1 && (!Class396.aBoolean5196 || 2 != -278777595 * ContextMenu.actionCount || !(((Class298_Sub37_Sub15) ContextMenu.aClass298_Sub37_Sub15_5477).aString9667.equals(LocalizedString.ACTION_FACE_HERE.getText(Class321.ACTIVE_LANGUAGE, -875414210)))))) {
				...
				if (!ContextMenu.aBoolean5471) {
					...
					i_63_ += 8;
					i_64_ = (-411680299 * ContextMenu.anInt5467 * (ContextMenu.actionCount * -278777595)) + 21;
					Class448.anInt5619 = ((ContextMenu.anInt5467 * -411680299 * (ContextMenu.actionCount * -278777595)) + (ContextMenu.aBoolean5496 ? 26 : 22)) * -893561885;
				} else {
					...
					i_63_ += 8;
					i_64_ = (ContextMenu.anInt5479 * 1592446965 * (ContextMenu.anInt5467 * -411680299)) + 21;
					Class448.anInt5619 = -893561885 * ((ContextMenu.aBoolean5496 ? 26 : 22) + (ContextMenu.anInt5467 * -411680299 * (ContextMenu.anInt5479 * 1592446965)));
				}
				i_63_ += 10;
				int i_67_ = i - i_63_ / 2;
				if (i_63_ + i_67_ > Class462.canvasWidth * -2110394505)
					i_67_ = -2110394505 * Class462.canvasWidth - i_63_;
				if (i_67_ < 0)
					i_67_ = 0;
				int i_68_ = i_61_;
				...
				TileText.anInt7658 = 1083843311 * i_68_;
				Class134.anInt6343 = i_63_ * 1077909003;
				ContextMenu.anInt5498 = (int) (Math.random() * 24.0) * 704172827;
				ContextMenu.menuOpen = true;
			}
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("em.r(").append(')').toString());
		}
	}
	...
	static final void method1227(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("em.os(").append(')').toString());
		}
	}
}
