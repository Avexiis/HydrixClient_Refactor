...
public class Class110_Sub2 extends Class110 {
	...
	Class110_Sub2(Class_ra_Sub3_Sub1 class_ra_sub3_sub1, Class108 class108) {
		...
		if (class108.aString1316 != null) {
			...
			if (class108.aTimeUtilsArray1319 != null) {
				TimeUtils[] timeUtilsArray1 = class108.aTimeUtilsArray1319;
				for (int i = 0; i < timeUtilsArray1.length; i++) {
					TimeUtils tu = timeUtilsArray1[i];
					stringbuilder.append("#define " + tu.aString1465 +
							" " + tu.aString1464 +
							'\n');
				}
			}
		...
		if (class108.aString1318 != null) {
			...
			if (class108.aTimeUtilsArray1320 != null) {
				TimeUtils[] timeUtilsArray2 = class108.aTimeUtilsArray1320;
				for (int i = 0; i < timeUtilsArray2.length; i++) {
					TimeUtils tu = timeUtilsArray2[i];
					stringbuilder.append("#define " + tu.aString1465 +
							" " + tu.aString1464 +
							'\n');
				}
		...
		Class425.method5740(
				((Class110_Sub2) this).anIntArray8612,
				0,
				((Class110_Sub2) this).anIntArray8612.length,
				-1
		);
	}
