...
public class Class112 {
	...
	public int method1239(int i, int i_0_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("eo.a(").append(')').toString());
		}
	}
	...
	static int method1240(int i, byte i_7_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("eo.p(").append(')').toString());
		}
	}
	...
	static final void method1241(ClientScript2 class403, int i) {
		try {
			...
			Class127.method1419(class105, RSInterface, class403, 970111404);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("eo.gf(").append(')').toString());
		}
	}
	...
	static final void method1242(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("eo.agn(").append(')').toString());
		}
	}
	...
	static void method1244(int i, int i_9_, byte i_10_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("eo.ay(").append(')').toString());
		}
	}
}
