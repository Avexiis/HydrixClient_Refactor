...
public class Class114 {
	...
	void method1256(Class101 class101, byte i) {
		try {
			...
			((Class114) this).aClass100_1375 = ObjectTypeList.method5799(-1585817819)[i_0_];
			if (((Class114) this).aClass100_1375 == Class100.aClass100_1076) {
				int i_1_ = class101.method1080(656081273);
				((Class114) this).aClass100_1376 = ObjectTypeList.method5799(-12226797)[i_1_];
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("eq.a(").append(')').toString());
		}
	}
	...
	public static void method1257(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("eq.z(").append(')').toString());
		}
	}
	...
	static final void method1258(ClientScript2 class403, byte i) {
		try {
			...
			Class261.method2463(class105, RSInterface, class403, (byte) -113);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("eq.lj(").append(')').toString());
		}
	}
