...
public class Class115 {
	...
	static final void method1260(ClientScript2 class403, int i) {
		try {
			...
			MapSizePreference.method5668(class105, RSInterface, class403, 2137737023);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("er.mu(").append(')').toString());
		}
	}
	...
	static final void method1261(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("er.apo(").append(')').toString());
		}
	}
	...
	static final void method1262(ClientScript2 class403, short i) {
		try {
			...
			Class472.method6065(class105, RSInterface, class403, 788007280);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("er.nd(").append(')').toString());
		}
	}
}
