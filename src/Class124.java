...
public class Class124 implements Runnable {
	...
	void method1381(String string, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("f.a(").append(')').toString());
		}
	}
	...
	void method1382(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("f.b(").append(')').toString());
		}
	}
	...
	public void run() {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("f.run(").append(')').toString());
		}
	}
	...
	void method1383(byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("f.p(").append(')').toString());
		}
	}
	...
	long method1384(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("f.f(").append(')').toString());
		}
	}
	...
	public static void method1385(int i, byte i_0_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("f.x(").append(')').toString());
		}
	}
	...
	static final void method1388(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("f.alw(").append(')').toString());
		}
	}

	static final void method1389(Entity class365_sub1_sub1_sub2, int i) {
		try {
			int i_5_ = (class365_sub1_sub1_sub2.anInt10095 * -412225079 - GameClient.anInt8884 * 443738891);
			...
			class365_sub1_sub1_sub2.method4341((float) ((i_6_ - (int) sceneObjectPosition.x) / i_5_ + (int) sceneObjectPosition.x), (float) (int) sceneObjectPosition.y, (float) ((int) sceneObjectPosition.z + (i_7_ - (int) sceneObjectPosition.z) / i_5_));
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("f.he(").append(')').toString());
		}
	}
}
