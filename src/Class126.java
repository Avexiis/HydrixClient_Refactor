...
public class Class126 implements Interface6 {
	...
	public boolean method52(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("fc.b(").append(')').toString());
		}
	}
	...
	public void method58(boolean bool, byte i) {
		try {
			if (bool) {
				int i_0_ = ((((Class126) this).aClass151_6368.aClass139_6352.method1545((1296783199 * ((Class126) this).aClass151_6368.anInt6346), GameClient.anInt8794 * 775068819, -2104401433)) + (((Class126) this).aClass151_6368.anInt6348 * -591189315));
				int i_1_ = ((((Class126) this).aClass151_6368.aClass133_6351.method1482((-1025867285 * ((Class126) this).aClass151_6368.anInt6347), GameClient.anInt8803 * -791746413, -1504826584)) + (-842094713 * ((Class126) this).aClass151_6368.anInt6349));
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("fc.f(").append(')').toString());
		}
	}
	...
	public void method56(boolean bool) {
		if (bool) {
			int i = ((((Class126) this).aClass151_6368.aClass139_6352.method1545(1296783199 * ((Class126) this).aClass151_6368.anInt6346, GameClient.anInt8794 * 775068819, -1797975072)) + ((Class126) this).aClass151_6368.anInt6348 * -591189315);
			int i_2_ = ((((Class126) this).aClass151_6368.aClass133_6351.method1482(-1025867285 * ((Class126) this).aClass151_6368.anInt6347, GameClient.anInt8803 * -791746413, -792749412)) + -842094713 * ((Class126) this).aClass151_6368.anInt6349);
	...
	static final void method1404(ClientScript2 class403, byte i) {
		try {
			...
			Class499.method6218(class105, RSInterface, class403, (byte) 46);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("fc.lf(").append(')').toString());
		}
	}
	...
	public static void method1405(Class502 class502, int i, int i_5_, int i_6_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("fc.r(").append(')').toString());
		}
	}
	...
	static char method1406(char c, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("fc.k(").append(')').toString());
		}
	}
	...
	static final void method1407(byte i) {
		try {
			...
			if (GameClient.gameConnection.aBoolean347) {
				GameClient.gameConnection.aBoolean347 = false;
				...
				for (int i_7_ = 0; i_7_ < 100; i_7_++) {
					if (!Class247.method2370(GameClient.gameConnection, 2136824168)) {
						if (i <= 4)
				...
				if (GameClient.anInt8752 * -1233866115 == 0) {
					while (ClanSettings.method4577((byte) 35)) {
						Class298_Sub36 class298_sub36 = Class18.method359(OutgoingPacket.aClass198_2005, (GameClient.gameConnection.aClass449_330), (byte) 105);
						class298_sub36.buffer.writeByte(0);
						int i_8_ = ((class298_sub36.buffer.pos) * 385051775);
						Class234.method2181((class298_sub36.buffer), -1720754748);
						class298_sub36.buffer.method3649((class298_sub36.buffer.pos) * 385051775 - i_8_, (byte) -105);
						GameClient.gameConnection.writeOutboundPacket(class298_sub36, (byte) -102);
					}
					if (null != Ground.aClass396_6291) {
						if (Ground.aClass396_6291.anInt5195 * -747638219 != -1) {
							Class298_Sub36 class298_sub36 = Class18.method359(OutgoingPacket.aClass198_2009, (GameClient.gameConnection.aClass449_330), (byte) 64);
							class298_sub36.buffer.writeShort((-747638219 * Ground.aClass396_6291.anInt5195), 16711935);
							GameClient.gameConnection.writeOutboundPacket(class298_sub36, (byte) -33);
					...
					if (GameClient.map.method2675(-1611682495) != null) {
						if (3 == ObjectDeque.anInt7164 * -863531439)
							Class298_Sub39.method3506(78506535);
						else if (1 == -863531439 * ObjectDeque.anInt7164)
					...
					if (0 == -1233866115 * GameClient.anInt8752) {
						GameClient.map.method2640((byte) 2).updateAtmosphereScene(GameClient.map, -2061035316);
						Class271.method2546(-2124691803);
						SpotAnimation.method609((short) -26190);
						if (596487115 * GameClient.anInt8723 > 10)
							((Class25) GameClient.gameConnection).anInt338 += 157945923;
						if ((((Class25) GameClient.gameConnection).anInt338 * 1237236843) > 2250)
							SubIncommingPacket.method1923(1705248535);
						else {
							if (GameClient.cutsceneStage * 1596783995 == 3) {
								...
								if (GameClient.cutsceneStage * 1596783995 == 1 && (Class298_Sub24_Sub3.method3090(577335585 * GameClient.anInt8870, -275734557))) {
									GameClient.map.sendMapScene(new Class267(Class266.aClass266_2846, null), -1991819579);
									GameClient.cutsceneStage = -347773236;
								}
								if (4 == 1596783995 * GameClient.cutsceneStage && 17 != GameClient.anInt8752 * -1233866115) {
									Class87.aClass437_793.method5811((byte) -51);
									GameClient.cutsceneStage = 0;
									GameClient.anInt8726 = -96767293 * GameClient.anInt8884;
									GameClient.anInt8930 = 0;
									Interface.method3575((byte) -114);
								}
								if (0 == 1596783995 * GameClient.cutsceneStage) {
									int i_9_ = (443738891 * GameClient.anInt8884 - GameClient.anInt8726 * -1846472167);
									while_61_: do {
							...
							FogPreference.method5635(-1841664621);
							if (!GameClient.aBoolean8917) {
								CustomCursorPreference.method5732(1446435433);
								GameClient.aBoolean8917 = true;
							}
							WaterDetailPreference.method5644(-1345932063);
							...
							if (null != Class236.aClass105_2606) {
								...
								if (GameClient.anInt8788 * -2018194505 >= 15) {
									LocalizedString.markComponentForRedraw((Class236.aClass105_2606), -1829287170);
							...
							for (;;) {
								ScriptContext scriptContext = ((ScriptContext) GameClient.aLinkedNodeList_8660.method5936(2107909159));
								...
								if (-1309843523 * class105.component >= 0) {
									IComponentDefinition class105_11_ = Class50.getIComponentDefinitions((class105.parentId * 1573706803), (byte) 54);
									if (class105_11_ == null || (class105_11_.aClass105Array1292 == null) || (class105.component * -1309843523 >= (class105_11_.aClass105Array1292).length))
										continue;
									if ((class105_11_.aClass105Array1292[class105.component * -1309843523]) != class105) {
										if (i <= 4) {
											/* empty */
										}
										continue;
								...
								ClientBuild.execute(scriptContext, (byte) 9);
							}
							for (;;) {
								ScriptContext scriptContext = ((ScriptContext) GameClient.aLinkedNodeList_8895.method5936(2126788731));
								if (scriptContext == null) {
									if (i <= 4) {
										/* empty */
									}
								...
								IComponentDefinition class105 = scriptContext.source;
								if (-1309843523 * class105.component >= 0) {
									IComponentDefinition class105_12_ = Class50.getIComponentDefinitions((class105.parentId * 1573706803), (byte) 80);
									if (null == class105_12_ || (class105_12_.aClass105Array1292 == null) || (class105.component * -1309843523 >= (class105_12_.aClass105Array1292).length))
										continue;
									if ((class105_12_.aClass105Array1292[class105.component * -1309843523]) != class105) {
										if (i <= 4) {
											/* empty */
										}
										continue;
								...
								ClientBuild.execute(scriptContext, (byte) 64);
							}
							for (;;) {
								ScriptContext scriptContext = ((ScriptContext) GameClient.aLinkedNodeList_8893.method5936(2113415758));
								...
								if (class105.component * -1309843523 >= 0) {
									IComponentDefinition class105_13_ = Class50.getIComponentDefinitions((class105.parentId * 1573706803), (byte) 36);
									if (null == class105_13_ || (null == class105_13_.aClass105Array1292) || (-1309843523 * class105.component >= (class105_13_.aClass105Array1292).length))
										continue;
									if ((class105_13_.aClass105Array1292[class105.component * -1309843523]) != class105) {
										if (i <= 4)
											throw new IllegalStateException();
										continue;
									}
							...
							if (null != GameClient.aClass105_8850)
								MaterialRaw.method602(-1193693208);
							...
							if (GameClient.aBoolean8736 && (GameClient.aLong8892 * -4876927317316500383L < TimeUtils.getTime((byte) 1) - 60000L))
								Class52_Sub2.writeVarcs(1315881016);
							...
							if (GameClient.anInt8749 * 356727603 > 10)
								GameClient.anInt8972 = -999313729;
							GameClient.gameConnection.anInt339 += 1797987493;
							if (2033675053 * GameClient.gameConnection.anInt339 > 50) {
								Class298_Sub36 class298_sub36 = Class18.method359((OutgoingPacket.PING_PACKET), (GameClient.gameConnection.aClass449_330), (byte) 120);
								GameClient.gameConnection.writeOutboundPacket(class298_sub36, (byte) -57);
							}
							...
							try {
								GameClient.gameConnection.method386(-1146717706);
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("fc.gu(").append(')').toString());
		}
	}
	...
	static final void method1408(ClientScript2 class403, byte i) {
		try {
			...
			VarClanSettings varClanSettings = Class299.aClanSettings_3199.method4576(i_18_, -1368678783);
			if (varClanSettings == null)
				throw new RuntimeException();
			Integer integer = (((ClientScript2) class403).aClass162_5252.method1753(GameClient.aGameContext_8944.gameType * -937307905 << 16 | i_18_, (byte) -31));
			int i_19_;
			if (integer == null) {
				if (varClanSettings.aChar4085 == 'i' || varClanSettings.aChar4085 == '1')
					i_19_ = 0;
				else
					i_19_ = -1;
			} else
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("fc.bv(").append(')').toString());
		}
	}
}
