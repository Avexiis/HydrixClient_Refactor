...
public abstract class Class127 implements Interface6 {
	...
	public boolean method52(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("fd.b(").append(')').toString());
		}
	}
	...
	public void method58(boolean bool, byte i) {
		try {
			int i_4_ = ((((Class127) this).aClass128_6375.aClass139_6322.method1545(-944287579 * ((Class127) this).aClass128_6375.anInt6326, GameClient.anInt8794 * 775068819, -2137791831)) + ((Class127) this).aClass128_6375.anInt6327 * -39975161);
			int i_5_ = ((((Class127) this).aClass128_6375.aClass133_6323.method1482(-1387457793 * ((Class127) this).aClass128_6375.anInt6330, -791746413 * GameClient.anInt8803, -1715218341)) + ((Class127) this).aClass128_6375.anInt6325 * 1886882435);
			...
			if ((TimeUtils.getTime((byte) 1) - ((Class127) this).aLong6376 * 109366757865047727L) > 10000L)
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("fd.f(").append(')').toString());
		}
	}
	...
	public void method56(boolean bool) {
		int i = ((((Class127) this).aClass128_6375.aClass139_6322.method1545(-944287579 * ((Class127) this).aClass128_6375.anInt6326, GameClient.anInt8794 * 775068819, -1925244247)) + ((Class127) this).aClass128_6375.anInt6327 * -39975161);
		int i_8_ = ((((Class127) this).aClass128_6375.aClass133_6323.method1482(-1387457793 * ((Class127) this).aClass128_6375.anInt6330, -791746413 * GameClient.anInt8803, -1769429058)) + ((Class127) this).aClass128_6375.anInt6325 * 1886882435);
			...
			if (-1729871315 * ((Class127) this).anInt6371 == i_15_ && i_15_ != 0) {
				...
				if (i_17_ > i_15_) {
					...
					if (l > 0L) {
						...
						long l_19_ = ((TimeUtils.getTime((byte) 1) - (((Class127) this).aLong6376 * 109366757865047727L)) * 10000L);
						if (l_19_ < l_18_)
				...
				((Class127) this).aLong6376 = TimeUtils.getTime((byte) 1) * -1063467934392987569L;
			}
			return i_16_;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("fd.q(").append(')').toString());
		}
	}

	static final void method1419(IComponentDefinition class105, RSInterface RSInterface, ClientScript2 class403, int i) {
		try {
			if (5 == -1215239439 * class105.type)
				Class165.method1781(class105, RSInterface, class403, (short) -9019);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("fd.gi(").append(')').toString());
		}
	}
	...
	static final void method1421(ClientScript2 class403, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("fd.ali(").append(')').toString());
		}
	}
	...
	static final void method1422(ClientScript2 class403, short i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("fd.acc(").append(')').toString());
		}
	}
	...
	static final void method1423(IComponentDefinition class105, int i, int i_24_, int i_25_, ClientScript2 class403, int i_26_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("fd.kd(").append(')').toString());
		}
	}
}
