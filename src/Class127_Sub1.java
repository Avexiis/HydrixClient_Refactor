...
public class Class127_Sub1 extends Class127 {
	...
	void method1409(boolean bool, int i, int i_0_) {
		if (bool) {
			...
			OverlayType.activeToolkit.r(i, i_0_, (((Class127_Sub1) this).aClass128_6375.anInt6326) * -944287579 + i, (((Class127_Sub1) this).aClass128_6375.anInt6330) * -1387457793 + i_0_);
			...
			OverlayType.activeToolkit.r(i, i_0_, (-944287579 * (((Class127_Sub1) this).aClass128_6375.anInt6326) + i), i_0_ + ((Class127_Sub1) this).aClass57_8573.method626());
			...
			OverlayType.activeToolkit.r(i, (((Class127_Sub1) this).aClass128_6375.anInt6330) * -1387457793 + i_0_ - i_5_, i + -944287579 * (((Class127_Sub1) this).aClass128_6375.anInt6326), i_0_ + ((((Class127_Sub1) this).aClass128_6375.anInt6330) * -1387457793));
	...
	void method1412(boolean bool, int i, int i_6_, int i_7_) {
		try {
			if (bool) {
				int[] is = new int[4];
				OverlayType.activeToolkit.qa(is);
				OverlayType.activeToolkit.r(i, i_6_, (((Class127_Sub1) this).aClass128_6375.anInt6326) * -944287579 + i, (((Class127_Sub1) this).aClass128_6375.anInt6330) * -1387457793 + i_6_);
				...
				OverlayType.activeToolkit.r(i, i_6_, -944287579 * (((Class127_Sub1) this).aClass128_6375.anInt6326) + i, i_6_ + ((Class127_Sub1) this).aClass57_8573.method626());
				...
				OverlayType.activeToolkit.r(i, (((Class127_Sub1) this).aClass128_6375.anInt6330 * -1387457793) + i_6_ - i_12_, i + (-944287579 * ((Class127_Sub1) this).aClass128_6375.anInt6326), i_6_ + (((Class127_Sub1) this).aClass128_6375.anInt6330 * -1387457793));
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("zb.x(").append(')').toString());
		}
	}
	...
	void method1424(int i, int i_21_, int i_22_, int i_23_, int i_24_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("zb.c(").append(')').toString());
		}
	}
	...
	public boolean method52(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("zb.b(").append(')').toString());
		}
	}
	...
	public void method55() {
		...
		Class128_Sub3 class128_sub3 = (Class128_Sub3) ((Class127_Sub1) this).aClass128_6375;
		((Class127_Sub1) this).aClass57_8572 = GroundDecorPreference.method5663(((Class127_Sub1) this).aClass243_6372, class128_sub3.anInt8563 * -876812375, (byte) -20);
		((Class127_Sub1) this).aClass57_8569 = GroundDecorPreference.method5663(((Class127_Sub1) this).aClass243_6372, class128_sub3.anInt8562 * 1551490597, (byte) -36);
		((Class127_Sub1) this).aClass57_8571 = GroundDecorPreference.method5663(((Class127_Sub1) this).aClass243_6372, 578265259 * class128_sub3.anInt8566, (byte) -107);
		((Class127_Sub1) this).aClass57_8570 = GroundDecorPreference.method5663(((Class127_Sub1) this).aClass243_6372, 861652881 * class128_sub3.anInt8564, (byte) -11);
		((Class127_Sub1) this).aClass57_8573 = GroundDecorPreference.method5663(((Class127_Sub1) this).aClass243_6372, -1259370861 * class128_sub3.anInt8565, (byte) -42);
		((Class127_Sub1) this).aClass57_8574 = GroundDecorPreference.method5663(((Class127_Sub1) this).aClass243_6372, 356687159 * class128_sub3.anInt8561, (byte) -75);
	}
	...
	void method1417(boolean bool, int i, int i_25_) {
		if (bool) {
			int[] is = new int[4];
			OverlayType.activeToolkit.qa(is);
			OverlayType.activeToolkit.r(i, i_25_, (((Class127_Sub1) this).aClass128_6375.anInt6326) * -944287579 + i, (((Class127_Sub1) this).aClass128_6375.anInt6330) * -1387457793 + i_25_);
			...
			OverlayType.activeToolkit.r(i, i_25_, (-944287579 * (((Class127_Sub1) this).aClass128_6375.anInt6326) + i), i_25_ + ((Class127_Sub1) this).aClass57_8573.method626());
			...
			OverlayType.activeToolkit.r(i, (((Class127_Sub1) this).aClass128_6375.anInt6330 * -1387457793 + i_25_ - i_30_), i + (-944287579 * ((Class127_Sub1) this).aClass128_6375.anInt6326), i_25_ + (((Class127_Sub1) this).aClass128_6375.anInt6330 * -1387457793));
	...
	void method1411(boolean bool, int i, int i_31_, int i_32_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("zb.r(").append(')').toString());
		}
	}
	...
	void method1410(boolean bool, int i, int i_64_) {
		if (bool) {
			int[] is = new int[4];
			OverlayType.activeToolkit.qa(is);
			OverlayType.activeToolkit.r(i, i_64_, (((Class127_Sub1) this).aClass128_6375.anInt6326) * -944287579 + i, (((Class127_Sub1) this).aClass128_6375.anInt6330) * -1387457793 + i_64_);
			...
			OverlayType.activeToolkit.r(i, i_64_, (-944287579 * (((Class127_Sub1) this).aClass128_6375.anInt6326) + i), i_64_ + ((Class127_Sub1) this).aClass57_8573.method626());
			...
			OverlayType.activeToolkit.r(i, (((Class127_Sub1) this).aClass128_6375.anInt6330 * -1387457793 + i_64_ - i_69_), i + (-944287579 * ((Class127_Sub1) this).aClass128_6375.anInt6326), i_64_ + (((Class127_Sub1) this).aClass128_6375.anInt6330 * -1387457793));
	...
	public void method53(int i) {
		try {
			...
			Class128_Sub3 class128_sub3 = (Class128_Sub3) ((Class127_Sub1) this).aClass128_6375;
			((Class127_Sub1) this).aClass57_8572 = GroundDecorPreference.method5663((((Class127_Sub1) this).aClass243_6372), (class128_sub3.anInt8563 * -876812375), (byte) 53);
			((Class127_Sub1) this).aClass57_8569 = GroundDecorPreference.method5663((((Class127_Sub1) this).aClass243_6372), (class128_sub3.anInt8562 * 1551490597), (byte) -54);
			((Class127_Sub1) this).aClass57_8571 = GroundDecorPreference.method5663((((Class127_Sub1) this).aClass243_6372), (578265259 * class128_sub3.anInt8566), (byte) -41);
			((Class127_Sub1) this).aClass57_8570 = GroundDecorPreference.method5663((((Class127_Sub1) this).aClass243_6372), (861652881 * class128_sub3.anInt8564), (byte) -125);
			((Class127_Sub1) this).aClass57_8573 = GroundDecorPreference.method5663((((Class127_Sub1) this).aClass243_6372), (-1259370861 * class128_sub3.anInt8565), (byte) 95);
			((Class127_Sub1) this).aClass57_8574 = GroundDecorPreference.method5663((((Class127_Sub1) this).aClass243_6372), (356687159 * class128_sub3.anInt8561), (byte) -11);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("zb.a(").append(')').toString());
		}
	}
	...
	static int method1425(Class298_Sub37_Sub15 class298_sub37_sub15, GameFont gameFont, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("zb.bm(").append(')').toString());
		}
	}

	public static String huffManDecryption(Packet class298_sub53, int i) {
		try {
			return ContextMenu.method5808(class298_sub53, 32767, 116620582);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("zb.b(").append(')').toString());
		}
	}
	...
	static void method1427(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("zb.bp(").append(')').toString());
		}
	}
	...
	static final void method1428(ClientScript2 class403, byte i) {
		try {
			...
			Huffman.method1254(i_72_, new Interface(i_73_, 3), null, true, -1040917955);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("zb.sp(").append(')').toString());
		}
	}
}
