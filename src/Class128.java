...
public class Class128 implements Interface5 {
	...
	public Class146 method49(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("fe.f(").append(')').toString());
		}
	}
	...
	static final void method1435(boolean bool, ClientScript2 class403, int i) {
		try {
			...
			if (bool)
				Class131.method1470(RSInterface, class105, -1270501871);
			else
				MaterialRaw.method599(RSInterface, class105, (byte) -21);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("fe.cm(").append(')').toString());
		}
	}

	static final void method1436(IComponentDefinition class105, RSInterface RSInterface, ClientScript2 class403, int i) {
		try {
			class105.clickMask = (((ClientScript2) class403).anIntArray5244[(((ClientScript2) class403).anInt5239 -= -391880689) * 681479919]) == 1;
			LocalizedString.markComponentForRedraw(class105, 100999784);
			if (-1 == class105.component * -1309843523 && !RSInterface.aBoolean1403)
				WorldMapArea.method3582(class105.interfacehash * -440872681, -285766228);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("fe.hi(").append(')').toString());
		}
	}
	...
	public static boolean method1437(int i, int i_7_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("fe.k(").append(')').toString());
		}
	}
	...
	static final void method1438(ClientScript2 class403, int i) {
		try {
			...
			int i_9_ = GameClient.aClass251Array8920[i_8_].method2400(-574288948);
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = i_9_ == 2 ? 1 : 0;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("fe.yy(").append(')').toString());
		}
	}
}
