...
public class Class128_Sub2 extends Class128 {
	...
	public Class146 method49(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("zw.f(").append(')').toString());
		}
	}
	...
	static final Object[] method1441(String string, ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("zw.kt(").append(')').toString());
		}
	}
}
