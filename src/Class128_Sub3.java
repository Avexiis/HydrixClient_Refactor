...
public class Class128_Sub3 extends Class128 {
	...
	public Class146 method49(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("zx.f(").append(')').toString());
		}
	}
	...
	static final void method1442(ClientScript2 class403, int i) {
		try {
			...
			if (null == integer) {
				VarClanType varClanType = Class99.aVarClanTypeList_951.method6307(i_12_, 65536);
				if (varClanType.aChar6277 == 'i' || varClanType.aChar6277 == '1')
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("zx.bq(").append(')').toString());
		}
	}
}
