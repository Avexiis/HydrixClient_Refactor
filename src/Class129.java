...
public class Class129 implements Interface6 {
	...
	public boolean method52(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ff.b(").append(')').toString());
		}
	}
	...
	public void method58(boolean bool, byte i) {
		try {
			...
			if (class142 != null) {
				int i_0_ = ((((Class129) this).aClass134_6378.aClass139_6336.method1545((-1635817177 * ((Class129) this).aClass134_6378.anInt6339), GameClient.anInt8794 * 775068819, -2108328767)) + (-740662509 * ((Class129) this).aClass134_6378.anInt6333));
				int i_1_ = ((((Class129) this).aClass134_6378.aClass133_6337.method1482((-1725730589 * ((Class129) this).aClass134_6378.anInt6340), GameClient.anInt8803 * -791746413, -1943367798)) + (((Class129) this).aClass134_6378.anInt6335 * -1129431703));
				if (((Class129) this).aClass134_6378.aBoolean6342)
					OverlayType.activeToolkit.method5019(i_0_, i_1_, (-1635817177 * ((Class129) this).aClass134_6378.anInt6339), (((Class129) this).aClass134_6378.anInt6340 * -1725730589), 80994107 * ((Class129) this).aClass134_6378.anInt6338, 0);
				i_1_ += method1443(Class101.aClass264_1084, ((Class142) class142).aString1553, i_0_, i_1_, 5, 1663137711) * 12;
				i_1_ += 8;
				if (((Class129) this).aClass134_6378.aBoolean6342)
					OverlayType.activeToolkit.method5091(i_0_, i_1_, (((Class129) this).aClass134_6378.anInt6339 * -1635817177) + i_0_ - 1, i_1_, 80994107 * ((Class129) this).aClass134_6378.anInt6338, 0);
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ff.f(").append(')').toString());
		}
	}
	...
	int method1443(Class264 class264, String string, int i, int i_2_, int i_3_, int i_4_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ff.x(").append(')').toString());
		}
	}
	...
	public void method56(boolean bool) {
		...
		if (class142 != null) {
			int i = ((((Class129) this).aClass134_6378.aClass139_6336.method1545(-1635817177 * ((Class129) this).aClass134_6378.anInt6339, GameClient.anInt8794 * 775068819, -1777840883)) + -740662509 * ((Class129) this).aClass134_6378.anInt6333);
			int i_5_ = ((((Class129) this).aClass134_6378.aClass133_6337.method1482(-1725730589 * ((Class129) this).aClass134_6378.anInt6340, GameClient.anInt8803 * -791746413, -1715547706)) + ((Class129) this).aClass134_6378.anInt6335 * -1129431703);
			if (((Class129) this).aClass134_6378.aBoolean6342)
				OverlayType.activeToolkit.method5019(i, i_5_, -1635817177 * ((Class129) this).aClass134_6378.anInt6339, ((Class129) this).aClass134_6378.anInt6340 * -1725730589, 80994107 * ((Class129) this).aClass134_6378.anInt6338, 0);
			i_5_ += method1443(Class101.aClass264_1084, ((Class142) class142).aString1553, i, i_5_, 5, 1663137711) * 12;
			i_5_ += 8;
			if (((Class129) this).aClass134_6378.aBoolean6342)
				OverlayType.activeToolkit.method5091(i, i_5_, (((Class129) this).aClass134_6378.anInt6339 * -1635817177 + i - 1), i_5_, 80994107 * ((Class129) this).aClass134_6378.anInt6338, 0);
	...
	public void method53(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ff.a(").append(')').toString());
		}
	}
	...
	static final void method1444(ClientScript2 class403, byte i) {
		try {
			...
			FluType.method5887(class105, RSInterface, class403, -352941486);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ff.kr(").append(')').toString());
		}
	}

	static final void method1445(ClientScript2 class403, int i) {
		try {
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = GameClient.isMemberWorld ? 1 : 0;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ff.th(").append(')').toString());
		}
	}
	...
	static void method1446(int i, int i_6_, int i_7_, int i_8_, boolean bool, byte i_9_) {
		try {
			if (Class452.aBoolean5642 && Class231.aFrame2589 != null && (3 != i_6_ || -1012194159 * Class431.anInt6502 != i_7_ || 1953279233 * Class249.anInt6465 != i_8_)) {
				Class93.method1010(SpotAnimTypeList.aClass457_4164, Class231.aFrame2589, 1593156326);
				Class231.aFrame2589 = null;
			}
			if (Class452.aBoolean5642 && 3 == i_6_ && null == Class231.aFrame2589) {
				Class231.aFrame2589 = Class409.method4976(SpotAnimTypeList.aClass457_4164, i_7_, i_8_, 0, 0, -1107425870);
			...
			if (i_6_ == 3 && (!Class452.aBoolean5642 || Class231.aFrame2589 == null))
				...
				if (Class242.aReferenceTable_2708 != ReferenceTable.aReferenceTable_6557 && -2110394505 * Class462.canvasWidth < 1024 && Class298_Sub40_Sub9.anInt9716 * -1111710645 >= 768) {
					/* empty */
				}
				if (!bool) {
					Class52_Sub2_Sub1.aCanvas9079.setSize(Class462.canvasWidth * -2110394505, -1111710645 * Class298_Sub40_Sub9.anInt9716);
					OverlayType.activeToolkit.method5173(Class52_Sub2_Sub1.aCanvas9079, -2110394505 * Class462.canvasWidth, Class298_Sub40_Sub9.anInt9716 * -1111710645, (byte) 20);
					if (Class298_Sub36.aFrame7403 == container) {
						Insets insets = Class298_Sub36.aFrame7403.getInsets();
						Class52_Sub2_Sub1.aCanvas9079.setLocation(1898544019 * GameClient.anInt6473 + insets.left, insets.top + GameClient.anInt6474 * 540368727);
					} else
						Class52_Sub2_Sub1.aCanvas9079.setLocation(1898544019 * GameClient.anInt6473, GameClient.anInt6474 * 540368727);
				} else
				...
				if (GameClient.gameConnection.method387(537308016) != null && Class435.method5804(GameClient.anInt8752 * -1233866115, (byte) 76))
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ff.gq(").append(')').toString());
		}
	}
	...
	static final int method1447(int i, int i_11_, int i_12_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ff.l(").append(')').toString());
		}
	}
}
