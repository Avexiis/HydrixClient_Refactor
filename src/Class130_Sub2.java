...
public class Class130_Sub2 extends Class130 {
	...
	boolean method1464(int i) throws Exception_Sub2 {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("yx.t(").append(')').toString());
		}
	}
	...
	public void method1452(Class233 class233) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("yx.a(").append(')').toString());
		}
	}
	...
	public void method1451() {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("yx.b(").append(')').toString());
		}
	}
	...
	void method1465(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("yx.h(").append(')').toString());
		}
	}
	...
	public void method1450(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("yx.f(").append(')').toString());
		}
	}
