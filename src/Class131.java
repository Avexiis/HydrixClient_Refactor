...
public class Class131 {
	...
	public void method1466(short i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("fh.f(").append(')').toString());
		}
	}
	...
	public Class125 method1467(int i, int i_0_) {
		try {
			...
			synchronized (((Class131) this).aClass243_1497) {
				is = (((Class131) this).aClass243_1497.getFileFromArchive(Js5ConfigGroup.aClass120_1417.anInt1460 * -1006924897, i, (byte) -82));
			}
			class125 = new Class125();
			if (is != null)
				class125.method1390(new Packet(is), (byte) -59);
			synchronized (((Class131) this).aClass348_1496) {
				((Class131) this).aClass348_1496.put(class125, (long) i);
			}
			return class125;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("fh.a(").append(')').toString());
		}
	}
	...
	public void method1468(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("fh.p(").append(')').toString());
		}
	}

	public Class131(GameContext gameContext, Language language, Js5 class243) {
		((Class131) this).aClass243_1497 = class243;
		((Class131) this).aClass243_1497.method2316((Js5ConfigGroup.aClass120_1417.anInt1460) * -1006924897, -1961959383);
	}
	...
	public void method1469(int i, short i_1_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("fh.b(").append(')').toString());
		}
	}

	static void method1470(RSInterface RSInterface, IComponentDefinition class105, int i) {
		try {
			if (class105 != null) {
				if (class105.component * -1309843523 != -1) {
					IComponentDefinition class105_2_ = RSInterface.method1297(1573706803 * class105.parentId, (short) 26063);
					if (class105_2_ != null) {
						if (class105_2_.aClass105Array1293 == class105_2_.aClass105Array1292) {
							...
							Class425.method5737(class105_2_.aClass105Array1292, 0, class105_2_.aClass105Array1293, 0, (-1309843523 * class105.component));
							Class425.method5737(class105_2_.aClass105Array1292, 1 + class105.component * -1309843523, class105_2_.aClass105Array1293, -1309843523 * class105.component, (class105_2_.aClass105Array1292.length - class105.component * -1309843523 - 1));
						} else {
							int i_3_ = 0;
					...
					IComponentDefinition[] class105s = RSInterface.method1296((byte) 61);
					int i_4_;
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("fh.y(").append(')').toString());
		}
	}
	...
	static final void method1471(ClientScript2 class403, int i) {
		try {
			...
			Class173.method1822(((i_5_ >> 14 & 0x3fff) - worldTile.x * -1760580017), ((i_5_ & 0x3fff) - 283514611 * worldTile.y), i_6_ << 2, i_7_, i_8_, (byte) 72);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("fh.agc(").append(')').toString());
		}
	}
}
