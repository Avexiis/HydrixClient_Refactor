...
public class Class132 {
	...
	IdentityKitTypeList aIdentityKitTypeList_1500;
	...
	void method1472(Packet class298_sub53, int i) {
		try {
			for (;;) {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("fi.a(").append(')').toString());
		}
	}

	void method1473(Packet class298_sub53, int i, byte i_1_) {
		try {
			if (i == 1)
	...
	public Model method1474(byte i) {
		try {
			...
			synchronized (((IdentityKitTypeList) ((Class132) this).aIdentityKitTypeList_1500).aClass243_1560) {
				for (int i_8_ = 0; i_8_ < ((Class132) this).anIntArray1507.length; i_8_++)
					class64s[i_8_] = Model.method751((((IdentityKitTypeList) ((Class132) this).aIdentityKitTypeList_1500).aClass243_1560), (((Class132) this).anIntArray1507[i_8_]), 0);
			}
			for (int i_9_ = 0; i_9_ < ((Class132) this).anIntArray1507.length; i_9_++) {
				if (class64s[i_9_].version < 13)
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("fi.p(").append(')').toString());
		}
	}
		...
		try {
			...
			synchronized (((IdentityKitTypeList) ((Class132) this).aIdentityKitTypeList_1500).aClass243_1560) {
				for (int i_12_ = 0; i_12_ < 5; i_12_++) {
					if (-1 != ((Class132) this).anIntArray1505[i_12_] && !(((IdentityKitTypeList) ((Class132) this).aIdentityKitTypeList_1500).aClass243_1560.method2290(((Class132) this).anIntArray1505[i_12_], 0, -1795823627)))
						bool = false;
				}
			}
			return bool;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("fi.i(").append(')').toString());
		}
	}
	...
	public Model method1476(int i) {
		try {
			...
			synchronized (((IdentityKitTypeList) ((Class132) this).aIdentityKitTypeList_1500).aClass243_1560) {
				for (int i_14_ = 0; i_14_ < 5; i_14_++) {
					if (((Class132) this).anIntArray1505[i_14_] != -1)
						class64s[i_13_++] = Model.method751((((IdentityKitTypeList) (((Class132) this).aIdentityKitTypeList_1500)).aClass243_1560), (((Class132) this).anIntArray1505[i_14_]), 0);
				}
			}
			for (int i_15_ = 0; i_15_ < 5; i_15_++) {
				if (null != class64s[i_15_] && class64s[i_15_].version < 13)
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("fi.k(").append(')').toString());
		}
	}
		...
		try {
			...
			synchronized (((IdentityKitTypeList) ((Class132) this).aIdentityKitTypeList_1500).aClass243_1560) {
				for (int i_18_ = 0; i_18_ < ((Class132) this).anIntArray1507.length; i_18_++) {
					if (!((IdentityKitTypeList) ((Class132) this).aIdentityKitTypeList_1500).aClass243_1560.method2290(((Class132) this).anIntArray1507[i_18_], 0, -1755601406))
						bool = false;
				}
			}
			return bool;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("fi.b(").append(')').toString());
		}
	}
	...
	static final void method1478(ClientScript2 class403, int i) {
		try {
			...
			Class359.method4292(class105, RSInterface, class403, (byte) -37);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("fi.nc(").append(')').toString());
		}
	}
	...
	static final void method1479(ClientScript2 class403, byte i) {
		try {
			...
			if (SpotAnimTypeList.aRSInterfaceArray4165[i_20_] == null)
				((ClientScript2) class403).anObjectArray5240[((((ClientScript2) class403).anInt5241 += 969361751) * -203050393) - 1] = "";
			else {
				String string = (SpotAnimTypeList.aRSInterfaceArray4165[i_20_].aClass105Array1405[0].aString1259);
				if (null == string)
					((ClientScript2) class403).anObjectArray5240[((((ClientScript2) class403).anInt5241 += 969361751) * -203050393) - 1] = "";
				else
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("fi.aly(").append(')').toString());
		}
	}
