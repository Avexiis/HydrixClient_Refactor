...
public class Class134 implements Interface5 {
	...
	public Class146 method49(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("fk.f(").append(')').toString());
		}
	}
	...
	static final void method1487(ClientScript2 class403, int i) {
		try {
			...
			Class21.method365(class105, RSInterface, true, 2, class403, -445613711);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("fk.hv(").append(')').toString());
		}
	}
	...
	static final void method1488(ClientScript2 class403, int i) {
		try {
			Class390 class390 = (((ClientScript2) class403).aBoolean5261 ? ((ClientScript2) class403).aClass390_5247 : ((ClientScript2) class403).aClass390_5246);
			IComponentDefinition class105 = ((Class390) class390).aClass105_4168;
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = GameClient.method2801(class105).method3497((byte) -44);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("fk.ph(").append(')').toString());
		}
	}
	...
	public static void method1489(byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("fk.x(").append(')').toString());
		}
	}
}
