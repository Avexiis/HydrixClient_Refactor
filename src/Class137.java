...
public abstract class Class137 {
	...
	public SceneObjectPosition aSceneObjectPosition_1515;
	...
	public SceneObjectPosition aSceneObjectPosition_1522;
	public Class232 aClass232_1523;
	public SceneObjectPosition aSceneObjectPosition_1524;
	public Class232 aClass232_1525;
	public float[] aFloatArray1526 = new float[16];
	public SceneObjectPosition aSceneObjectPosition_1527;
	public SceneObjectPosition aSceneObjectPosition_1528;
	public SceneObjectPosition aSceneObjectPosition_1529;
	public SceneObjectPosition aSceneObjectPosition_1530;
	...
	public void method1509(MaterialRaw materialRaw) {
		switch (materialRaw.aByte536) {
		case 1:
			aFloat1521 = 32.0F;
			aFloat1513 = 0.5F;
			break;
	...
	Class137(Class_ra_Sub3 class_ra_sub3) {
		...
		aSceneObjectPosition_1530 = new SceneObjectPosition();
		aClass232_1523 = new Class232();
		aSceneObjectPosition_1524 = new SceneObjectPosition();
		aClass232_1525 = new Class232();
		aSceneObjectPosition_1522 = new SceneObjectPosition();
		aSceneObjectPosition_1527 = new SceneObjectPosition();
		aSceneObjectPosition_1528 = new SceneObjectPosition();
		aSceneObjectPosition_1529 = new SceneObjectPosition();
		aSceneObjectPosition_1515 = new SceneObjectPosition();
