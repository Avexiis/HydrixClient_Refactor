...
public final class Class138_Sub1 extends Class138 {
	...
	boolean method1539(int i) throws Exception_Sub2 {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("yi.y(").append(')').toString());
		}
	}
	...
	void method1540(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("yi.t(").append(')').toString());
		}
	}
	...
	public void method1528() {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("yi.b(").append(')').toString());
		}
	}
	...
	public void method1527() {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("yi.f(").append(')').toString());
		}
	}
	...
	public void method1526(int i, int i_10_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("yi.a(").append(')').toString());
		}
	}
	...
	static final void method1542(ClientScript2 class403, int i) {
		try {
			...
			VarBitType.method3978(class105, RSInterface, class403, 1912101040);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("yi.lb(").append(')').toString());
		}
	}
	...
	static final void method1543(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("yi.tn(").append(')').toString());
		}
	}
}
