...
public class Class139 {
	...
	public int method1545(int i, int i_0_, int i_1_) {
		try {
			int i_2_ = (Class462.canvasWidth * -2110394505 > i_0_ ? -2110394505 * Class462.canvasWidth : i_0_);
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("fq.f(").append(')').toString());
		}
	}
	...
	static final void method1546(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("fq.acs(").append(')').toString());
		}
	}
	...
	static final void method1547(ClientScript2 class403, byte i) {
		try {
			...
			MapDetails mapDetails = WorldMap.method3708(i_4_ >> 14 & 0x3fff, i_4_ & 0x3fff);
			if (mapDetails == null)
				((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919) - 1] = -1;
			else
				((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919) - 1] = mapDetails.anInt9643 * -947282109;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("fq.adh(").append(')').toString());
		}
	}
		...
		try {
			...
			if (bool_5_) {
				if (Class372_Sub3.aBoolean7730 && bool_5_) {
					...
					class_ra.method5125(Atmosphere.scriptCache, false).method662(i_10_ + Class98_Sub2.aClass89_6932.anInt812, Class98_Sub2.aClass89_6932.anInt816 + i_11_, i_6_ - Class98_Sub2.aClass89_6932.anInt812 * 2, i_7_ - 2 * Class98_Sub2.aClass89_6932.anInt816, 1, 0, 0);
					...
					Class98_Sub2.aClass89_6932.method980();
					class_ra.method5125(CustomCursorPreference.aClass89_8437, true).method636(i_10_, i_11_ + Class98_Sub2.aClass89_6932.anInt816, i_8_, i_7_ - 2 * Class98_Sub2.aClass89_6932.anInt816);
					CustomCursorPreference.aClass89_8437.method989();
					class_ra.method5125(CustomCursorPreference.aClass89_8437, true).method636(Class98_Sub2.aClass89_6932.anInt812 + i_10_, i_11_, i_6_ - 2 * Class98_Sub2.aClass89_6932.anInt812, i_8_);
					CustomCursorPreference.aClass89_8437.method989();
					class_ra.method5125(CustomCursorPreference.aClass89_8437, true).method636(i_10_ + i_6_ - i_8_, i_11_ + Class98_Sub2.aClass89_6932.anInt816, i_8_, i_7_ - 2 * Class98_Sub2.aClass89_6932.anInt816);
					CustomCursorPreference.aClass89_8437.method989();
					class_ra.method5125(CustomCursorPreference.aClass89_8437, true).method636(i_10_ + Class98_Sub2.aClass89_6932.anInt812, i_11_ + i_7_ - i_8_, i_6_ - 2 * Class98_Sub2.aClass89_6932.anInt812, i_8_);
					CustomCursorPreference.aClass89_8437.method989();
					...
					int i_15_ = 6 + i_14_;
					int i_16_ = 6 + i_14_;
					class_ra.drawFilledBox(i_15_ - i_14_, i_16_ - i_14_, i_14_ + (i_12_ + i_14_), i_13_ + i_14_ + i_14_, -16777216, 0);
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("fq.b(").append(')').toString());
		}
	}
	...
	static final void method1549(int i, int i_17_, int i_18_, int i_19_, int i_20_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("fq.jb(").append(')').toString());
		}
	}
	...
	static final void method1550(ClientScript2 class403, byte i) {
		try {
			...
			RSInterface RSInterface = SpotAnimTypeList.aRSInterfaceArray4165[i_21_ >> 16];
			Class247.method2363(class105, RSInterface, class403, 2008837273);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("fq.ff(").append(')').toString());
		}
	}
	...
	static final void method1551(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("fq.ahw(").append(')').toString());
		}
	}
}
