...
public class Class143 {
	...
	public Interface6 method1572(Interface5 interface5, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("fu.a(").append(')').toString());
		}
	}
	...
	Class140 method1573(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("fu.f(").append(')').toString());
		}
	}
	...
	static final void method1574(ClientScript2 class403, int i) {
		try {
			...
			OutgoingPacket.method1890(class105, RSInterface, class403, 2041063660);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("fu.kj(").append(')').toString());
		}
	}
	...
	static final void method1575(ClientScript2 class403, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("fu.xs(").append(')').toString());
		}
	}
	...
	static final boolean method1577(Class326[][][] class326s, int i, int i_2_, int i_3_, boolean bool, int i_4_) {
		try {
			byte[][][] is = GameClient.map.method2642(1330177323);
			byte i_5_ = (bool ? (byte) 1 : (byte) (-1953789277 * GameClient.anInt8777 & 0xff));
			if (i_5_ == is[1855729883 * Class99.anInt952][i_2_][i_3_])
				return false;
			TileFlags tileFlags = GameClient.map.method2654(-334353018);
			if (((tileFlags.flags[Class99.anInt952 * 1855729883][i_2_][i_3_]) & 0x4) == 0)
				return false;
			int i_6_ = 0;
			int i_7_ = 0;
			...
			while (i_7_ != i_6_) {
				...
				if (((tileFlags.flags[1855729883 * Class99.anInt952][i_8_][i_11_]) & 0x4) == 0)
					bool_13_ = true;
				...
				if (null != class326s) {
					...
					while_63_: for (/**/; i_15_ <= 3; i_15_++) {
						...
						} else if (((tileFlags.flags[i_15_][i_8_][i_11_]) & 0x8) == 0) {
				...
				if (bool_14_) {
					int i_24_ = GameClient.map.method2675(-1611682495).aGroundArray3517[1855729883 * Class99.anInt952 + 1].method6341(i_8_, i_11_, (byte) -36);
				...
				if (bool_13_) {
					...
					if (++i_11_ < GameClient.map.upperY(-1603394405)) {
						if (i_8_ - 1 >= 0 && i_5_ != (is[Class99.anInt952 * 1855729883][i_8_ - 1][i_11_]) && 0 == ((tileFlags.flags[1855729883 * Class99.anInt952][i_8_][i_11_]) & 0x4) && 0 == ((tileFlags.flags[Class99.anInt952 * 1855729883][i_8_ - 1][i_11_ - 1]) & 0x4)) {
						...
						if ((1 + i_8_ < GameClient.map.upperX(-1968040539)) && i_5_ != (is[Class99.anInt952 * 1855729883][1 + i_8_][i_11_]) && ((tileFlags.flags[1855729883 * Class99.anInt952][i_8_][i_11_]) & 0x4) == 0 && ((tileFlags.flags[1855729883 * Class99.anInt952][1 + i_8_][i_11_ - 1]) & 0x4) == 0) {
					...
					i_11_--;
					if ((1 + i_8_ < GameClient.map.upperX(-1881854697)) && i_5_ != (is[1855729883 * Class99.anInt952][i_8_ + 1][i_11_])) {
					...
					if (--i_11_ >= 0) {
						if (i_8_ - 1 >= 0 && i_5_ != (is[1855729883 * Class99.anInt952][i_8_ - 1][i_11_]) && ((tileFlags.flags[1855729883 * Class99.anInt952][i_8_][i_11_]) & 0x4) == 0 && ((tileFlags.flags[1855729883 * Class99.anInt952][i_8_ - 1][1 + i_11_]) & 0x4) == 0) {
						...
						if ((1 + i_8_ < GameClient.map.upperX(-1909288528)) && (is[1855729883 * Class99.anInt952][i_8_ + 1][i_11_]) != i_5_ && ((tileFlags.flags[Class99.anInt952 * 1855729883][i_8_][i_11_]) & 0x4) == 0 && ((tileFlags.flags[Class99.anInt952 * 1855729883][i_8_ + 1][i_11_ + 1]) & 0x4) == 0) {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("fu.iz(").append(')').toString());
		}
	}

	public static void method1578(byte i) {
		try {
			MagnetDefinitions.aClass348_1929.method4187();
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("fu.k(").append(')').toString());
		}
	}
}
