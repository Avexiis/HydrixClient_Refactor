...
public class Class146 {
	...
	public static String method1598(byte[] is, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("fx.d(").append(')').toString());
		}
	}
	...
	static final boolean method1599(int[][] is, int[][] is_0_, int i, int i_1_, int i_2_, int i_3_, int i_4_, int i_5_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("fx.ip(").append(')').toString());
		}
	}
}
