...
public class Class148 implements Interface23 {
	...
	int[] anIntArray6652 = new int[-1085917127 * Class440.aVarPlayerTypeList_5582.varpSize];
	static long aLong6653 = 1L;
	public int[] configs = new int[-1085917127 * Class440.aVarPlayerTypeList_5582.varpSize];

	public int method252(int i, byte i_0_) {
		try {
			return configs[i];
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("g.d(").append(')').toString());
		}
	}

	void setConfigByFileValue(int configId, int i_1_, int i_2_) {
		try {
			VarBitType class327 = Class472.configLoader.getConfigDefinitions(configId, -781710328);
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("g.k(").append(')').toString());
		}
	}

	void method1603(int i) {
		try {
			for (int i_7_ = 0; i_7_ < Class440.aVarPlayerTypeList_5582.varpSize * -1085917127; i_7_++) {
				((Class148) this).anIntArray6652[i_7_] = 0;
				configs[i_7_] = 0;
			}
			((Class148) this).aClass437_6647 = new HashTable(128);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("g.f(").append(')').toString());
		}
	}
	...
	public void method1604(int i, int i_8_, int i_9_) {
		try {
			...
			if (null != class298_sub33)
				class298_sub33.aLong7385 = (TimeUtils.getTime((byte) 1) + 500L) * 2132790236050020951L;
			else {
				class298_sub33 = new Class298_Sub33(TimeUtils.getTime((byte) 1) + 500L);
				((Class148) this).aClass437_6647.method5817(class298_sub33, (long) i);
			}
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("g.b(").append(')').toString());
		}
	}

	void method1605(int i, int i_10_, byte i_11_) {
		try {
			if (this instanceof Class148) {
				Class148 c148 = (Class148) this;
				if (i < 0 || c148.anIntArray6652 == null || i > c148.anIntArray6652.length - 1)
					return;
			}
			...
			if (null != class298_sub33) {
				if (4611686018427387905L != class298_sub33.aLong7385 * -959724544626478745L)
					class298_sub33.aLong7385 = (TimeUtils.getTime((byte) 1) + 500L | 0x4000000000000000L) * 2132790236050020951L;
			} else {
				class298_sub33 = new Class298_Sub33(4611686018427387905L);
				((Class148) this).aClass437_6647.method5817(class298_sub33, (long) i);
			}
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("g.p(").append(')').toString());
		}
	}

	public void setBitconfigValue(int i, int i_12_, int i_13_) {
		try {
			VarBitType config = Class472.configLoader.getConfigDefinitions(i, -781710328);
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("g.i(").append(')').toString());
		}
	}

	public int method250(int i, byte i_18_) {
		try {
			VarBitType class327 = Class472.configLoader.getConfigDefinitions(i, -781710328);
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("g.u(").append(')').toString());
		}
	}
	...
	int method1607(boolean bool, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("g.a(").append(')').toString());
		}
	}

	public int getBitconfigState(int bitfileid) {
		VarBitType def = Class472.configLoader.getConfigDefinitions(bitfileid, -781710328);
	...
	static final void method1609(ClientScript2 class403, byte i) {
		try {
			...
			RSInterface RSInterface = SpotAnimTypeList.aRSInterfaceArray4165[i_30_ >> 16];
			Class308_Sub1.method3786(class105, RSInterface, class403, 805534141);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("g.ko(").append(')').toString());
		}
	}

	static final void method1610(ClientScript2 class403, byte i) {
		try {
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = GameClient.anInt8665 * -1154804873;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("g.uy(").append(')').toString());
		}
	}

	static final void method1611(ClientScript2 class403, short i) {
		try {
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = GameClient.aBoolean8680 ? 1 : 0;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("g.ahy(").append(')').toString());
		}
	}
	...
	public static void method1612(int i, int i_31_) {
		try {
			...
			Class344.aClickableGeometryArray3679 = new ClickableGeometry[1 + (Class65.anIntArray658[Class344.anInt3675 * 1197525581])];
	...
	static final void method1613(ClientScript2 class403, int i) {
		try {
			...
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = ObjectDeque.method2845(i_32_, i_33_, false, false, 1482071907);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("g.ul(").append(')').toString());
		}
	}
	...
	public static void method1614(byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("g.go(").append(')').toString());
		}
	}
	...
	static final void method1615(ClientScript2 class403, byte i) {
		try {
			...
			RSInterface RSInterface = SpotAnimTypeList.aRSInterfaceArray4165[i_40_ >> 16];
			Class234.method2184(class105, RSInterface, class403, (byte) 84);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("g.cc(").append(')').toString());
		}
	}

	static final void method1616(IComponentDefinition class105, RSInterface RSInterface, ClientScript2 class403, int i) {
		try {
			class105.tempZoomDistance = (((ClientScript2) class403).anIntArray5244[(((ClientScript2) class403).anInt5239 -= -391880689) * 681479919]) * -1066050969;
			LocalizedString.markComponentForRedraw(class105, 2100669842);
			if (-1 == class105.component * -1309843523 && !RSInterface.aBoolean1403)
				Class509.method6286(class105.interfacehash * -440872681, -1977969421);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("g.fc(").append(')').toString());
		}
	}
}
