...
public class Class15 {
	...
	int anInt185;
	boolean aBoolean186;
	ModelPart_Sub1[] aClass387_Sub1Array187;
	...
	int anInt215;
	boolean aBoolean216;
	ModelPart_Sub1[] aClass387_Sub1Array217;
	...
	Class15(Class_ra_Sub1 class_ra_sub1) {
		...
		((Class15) this).aClass222_219 = new Matrix43f();
		((Class15) this).aClass222_189 = new Matrix43f();
		((Class15) this).aClass233_194 = new Class233();
		((Class15) this).aClass233_195 = new Class233();
		((Class15) this).anIntArray213 = new int[ModelPart_Sub1.anInt7810];
		((Class15) this).aFloatArray197 = new float[ModelPart_Sub1.anInt7810];
		((Class15) this).aFloatArray188 = new float[ModelPart_Sub1.anInt7810];
		((Class15) this).aFloatArray199 = new float[ModelPart_Sub1.anInt7810];
		((Class15) this).aFloatArray200 = new float[ModelPart_Sub1.anInt7810];
		...
		((Class15) this).aClass387_Sub1Array187 = new ModelPart_Sub1[7];
		((Class15) this).aClass387_Sub1Array217 = new ModelPart_Sub1[7];
		...
		for (int i = 0; i < 7; i++) {
			((Class15) this).aClass387_Sub1Array187[i] = new ModelPart_Sub1(((Class15) this).aClass_ra_Sub1_182);
			((Class15) this).aClass387_Sub1Array217[i] = new ModelPart_Sub1(((Class15) this).aClass_ra_Sub1_182);
		}
		((Class15) this).anIntArray206 = new int[ModelPart_Sub1.anInt7787];
		for (int i = 0; i < ModelPart_Sub1.anInt7787; i++)
	...
	void method347(Runnable runnable, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ap.f(").append(')').toString());
		}
	}
	...
	void method348(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ap.a(").append(')').toString());
		}
	}
	...
	static final void method349(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ap.aal(").append(')').toString());
		}
	}
	...
	static final void method350(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ap.zl(").append(')').toString());
		}
	}
	...
	static final void method351(ClientScript2 class403, int i) {
		try {
			...
			Class21.method365(class105, RSInterface, false, 1, class403, 1620962996);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ap.hp(").append(')').toString());
		}
	}
}
