...
public class Class151 implements Interface5 {
	...
	public static UnderlayTypeList aClass451_6358;

	public Class146 method49(int i) {
		try {
			return Class146.aClass146_1564;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("gc.f(").append(')').toString());
		}
	}
	...
	public static Class182 method1643(int i, int i_9_) {
		try {
			...
			if (null != is)
				class182.method1843(new Packet(is), (byte) 20);
			class182.method1845(-721593745);
			Class182.aClass348_1815.put(class182, (long) i);
			return class182;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("gc.f(").append(')').toString());
		}
	...
	static boolean method1644(int i) {
		try {
			return Class492.method6184(IdentityKitTypeList.aClass381_1563.aClass355_4114, -1572506836);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("gc.a(").append(')').toString());
		}
	}
	...
	static final void method1645(ClientScript2 class403, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("gc.bf(").append(')').toString());
		}
	}
	...
	static boolean method1646(int i, int i_10_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("gc.fg(").append(')').toString());
		}
	}
	...
	static final void method1647(ClientScript2 class403, int i) {
		try {
			...
			TileFlags.method2323(class105, RSInterface, class403, 2046664396);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("gc.gt(").append(')').toString());
		}
	}
	...
	public static final void method1648(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("gc.hq(").append(')').toString());
		}
	}
	...
	static final void method1649(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("gc.aet(").append(')').toString());
		}
	}
}
