...
public class Class152 {
	LinkedNodeList aLinkedNodeList_1587;
	...
	void method1650(Packet class298_sub53, byte i) {
		try {
			...
			for (int i_0_ = class298_sub53.readUnsignedByte(); i_0_ != 0; i_0_ = class298_sub53.readUnsignedByte()) {
				...
				((Class152) this).aLinkedNodeList_1587.addlast(class298_sub17, 120722253);
			}
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ge.a(").append(')').toString());
		}
	}
	...
	public void method1651(Class298_Sub25 class298_sub25, byte i) {
		try {
			if ((-6615773310558494831L * ((Class152) this).aLong1592 != class298_sub25.aLong3188 * 7051297995265073167L) || (-3106107963843196613L * ((Class152) this).aLong1588 != (((Class298_Sub25) class298_sub25).aLong7361 * -3244420319926665157L)))
				throw new RuntimeException("");
			for (Class298_Sub17 class298_sub17 = (Class298_Sub17) ((Class152) this).aLinkedNodeList_1587.method5939(1766612795); class298_sub17 != null; class298_sub17 = ((Class298_Sub17) ((Class152) this).aLinkedNodeList_1587.method5944(49146)))
				class298_sub17.method2918(class298_sub25, -2022437727);
			((Class298_Sub25) class298_sub25).aLong7361 += 8816161044679006451L;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ge.f(").append(')').toString());
		}
	}

	public Class152(Packet class298_sub53) {
		((Class152) this).aLinkedNodeList_1587 = new LinkedNodeList();
	...
	public static void method1652(GraphicsToolkit class_ra, long l) {
		try {
			...
			while (iterator.hasNext()) {
				...
				boolean bool = clickableGeometry.method4222(class_ra, l);
				if (!bool) {
					iterator.remove();
					Class344.aClickableGeometryArray3679[(Class344.anInt3681 * -1264407527)] = clickableGeometry;
	...
	static final void method1653(ClientScript2 class403, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ge.amo(").append(')').toString());
		}
	}
	...
	public static byte[] method1654(byte[] is, int i, int i_1_, byte i_2_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ge.i(").append(')').toString());
		}
	}
	...
	static void method1655(Class302_Sub5 class302_sub5, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ge.p(").append(')').toString());
		}
	}

	static final void method1656(ClientScript2 class403, byte i) {
		try {
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = GraphicsAutoSetup.clientPreferences.aVolumePreference_7583.method5726(-2143087996);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ge.akl(").append(')').toString());
		}
	}
}
