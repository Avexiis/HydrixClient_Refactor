...
public class Class157 {
	...
	Interface9_Impl2 method1695(int i, int i_0_) {
		...
		if (!((Class157) this).anInterface_ma1614.method170(i, (short) 28916))
			return null;
		MaterialRaw materialRaw = ((Class157) this).anInterface_ma1614.method174(i, 828461869);
		if (i_0_ == -1)
			i_0_ = (materialRaw.aBoolean518 ? 64 : (((Class_ra_Sub3) ((Class157) this).aClass_ra_Sub3_1615).anInt8271));
		Interface9_Impl2 interface9_impl2;
		if (!materialRaw.aBoolean543 || !((Class157) this).aClass_ra_Sub3_1615.method5054()) {
			int[] is;
			if (materialRaw.anInt528 * -2138060883 == 2 || !Class298_Sub32_Sub31.method3339(materialRaw.aByte529, -2037069646))
		...
		interface9_impl2.method80(materialRaw.aBoolean540, materialRaw.aBoolean541);
		((Class157) this).aClass348_1616.put(interface9_impl2, l);
