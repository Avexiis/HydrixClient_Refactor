...
public class Class158 implements Interface5 {
	...
	public Class146 method49(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("gl.f(").append(')').toString());
		}
	}
	...
	static final void method1699(IComponentDefinition class105, RSInterface RSInterface, ClientScript2 class403, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("gl.ln(").append(')').toString());
		}
	}
	...
	static final void method1700(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("gl.rv(").append(')').toString());
		}
	}
	...
	static final void method1701(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("gl.tk(").append(')').toString());
		}
	}
	...
	public static Object method1702(byte[] is, boolean bool, short i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("gl.a(").append(')').toString());
		}
	}
}
