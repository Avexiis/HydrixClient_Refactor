...
public class Class158_Sub1 extends Class158 {
	...
	public static SpotAnimTypeList aSpotAnimTypeList_8568;

	public Class146 method49(int i) {
		try {
			return Class146.aClass146_1573;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("zk.f(").append(')').toString());
		}
	}
	...
	static boolean method1703(int i, int i_3_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("zk.fi(").append(')').toString());
		}
	}
}
