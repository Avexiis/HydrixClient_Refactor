...
public class Class16 {
				...
				if (Class137_Sub1.anInt6991 * -1983068885 > 0) {
					...
					for (WorldMapArea worldMapArea = (WorldMapArea) Class301_Sub1.aLinkedNodeList_3236.method5939(1766612795); null != worldMapArea; worldMapArea = (WorldMapArea) Class301_Sub1.aLinkedNodeList_3236.method5944(49146)) {
						...
						if (!VolumePreference.method5728(worldMapLabel, 1502593597)) {
							...
							int i_21_ = ((i_13_ * (2122110429 * worldMapArea.x) / Class301_Sub1.anInt3239) + i);
							int i_22_ = (i_9_ + ((Class301_Sub1.anInt3240 - worldMapArea.y * -372920341) * i_14_ / Class301_Sub1.anInt3240));
							...
							int i_23_ = i + (2122110429 * worldMapArea.x * i_13_ / Class301_Sub1.anInt3239);
							int i_24_ = ((i_14_ * (Class301_Sub1.anInt3240 - worldMapArea.y * -372920341) / Class301_Sub1.anInt3240) + i_9_);
	...
	public static Region method354(int i, int i_25_, int i_26_) {
		try {
			...
			region.regionBaseX = -1780317135;
			region.regionBaseY = 599015853;
			((Region) region).regionX = (1 + i + 5) * -2121339651;
			((Region) region).regionY = (5 + (i_25_ + 1)) * -1973125931;
			region.masks = (new int[843157589 * ((Region) region).regionX][((Region) region).regionY * -16196483]);
			region.reset(-1639552658);
			return region;
		} catch (RuntimeException runtimeexception) {
