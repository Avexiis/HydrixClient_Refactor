...
public class Class160 {
	...
	LinkedNodeList aLinkedNodeList_1632 = new LinkedNodeList();
	...
	public void method1707(Class162 class162, byte i) {
		try {
			...
			for (Class298_Sub40 class298_sub40 = (Class298_Sub40) ((Class160) this).aLinkedNodeList_1632.method5939(1766612795); null != class298_sub40; class298_sub40 = ((Class298_Sub40) ((Class160) this).aLinkedNodeList_1632.method5944(49146)))
				class298_sub40.method3510(class162, (byte) 1);
			((Class162) class162).anInt1653 += 1441392111;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("gn.f(").append(')').toString());
		}
	}

	public Class160(Packet class298_sub53) {
		method1708(class298_sub53, (short) 594);
	}

	void method1708(Packet stream, short i) {
		try {
			((Class160) this).aLong1643 = (stream.readLong((short) 21326) * 8254773464748362975L); // has
																									...
																									// else
																									// crash
			((Class160) this).anInt1631 = stream.readUnsignedInt() * 247396807;
			for (int i_0_ = stream.readUnsignedByte(); 0 != i_0_; i_0_ = stream.readUnsignedByte()) {
				...
				((Class160) this).aLinkedNodeList_1632.addlast(class298_sub40, 843424958);
			}
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("gn.a(").append(')').toString());
		}
	}
	...
	static final void method1709(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("gn.aar(").append(')').toString());
		}
	}
	...
	static final void method1711(ClientScript2 class403, byte i) {
		try {
			...
			Class147.method1600(class105, class298Sub38.method3497((byte) -10), -1133219011 * class298Sub38.anInt7410, 1387537939);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("gn.amf(").append(')').toString());
		}
	}
}
