...
public class Class161_Sub1_Sub1 extends Class161_Sub1 {
	...
	public void method1738(int i, int i_0_, byte i_1_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("afj.ac(").append(')').toString());
		}
	}
	...
	public void method1739(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("afj.am(").append(')').toString());
		}
	}
	...
	boolean method1726() throws Exception_Sub2 {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("afj.e(").append(')').toString());
		}
	}
	...
	static Class82 method1740(Packet class298_sub53, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("afj.a(").append(')').toString());
		}
	}
}
