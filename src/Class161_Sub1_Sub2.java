...
public class Class161_Sub1_Sub2 extends Class161_Sub1 {
	...
	public SceneObjectPosition aSceneObjectPosition_9139;
	...
	public SceneObjectPosition aSceneObjectPosition_9144 = new SceneObjectPosition();
	...
	public SceneObjectPosition aSceneObjectPosition_9149;
	...
	void method1729(boolean bool) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("afv.l(").append(')').toString());
		}
	}
	...
	void method1727(Class233 class233) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("afv.m(").append(')').toString());
		}
	}
	...
	void method1743(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("afv.am(").append(')').toString());
		}
	}
	...
	public Class161_Sub1_Sub2(Class_ra_Sub3 class_ra_sub3, Class159 class159, boolean bool) throws Exception_Sub2 {
		...
		aSceneObjectPosition_9149 = new SceneObjectPosition();
		aClass232_9157 = new Class232();
		aSceneObjectPosition_9139 = new SceneObjectPosition();
	...
	public void method1748(int i) {
		try {
			...
			aClass123_7033.method1366((((Class161_Sub1_Sub2) this).aClass298_Sub31_Sub1_9143), aSceneObjectPosition_9144.x, aSceneObjectPosition_9144.y, aSceneObjectPosition_9144.z, (float) (i_12_ * aClass_ra_Sub3_1648.anInt8342 % 40000) / 40000.0F, 2032048310);
			...
			aClass123_7033.method1338((((Class161_Sub1_Sub2) this).aClass298_Sub31_Sub1_9159), aSceneObjectPosition_9149, -386546877);
			aClass123_7033.method1339((((Class161_Sub1_Sub2) this).aClass298_Sub31_Sub1_9156), aClass232_9157, 221024078);
			aClass123_7033.method1338((((Class161_Sub1_Sub2) this).aClass298_Sub31_Sub1_9152), aSceneObjectPosition_9139, -386546877);
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("afv.ac(").append(')').toString());
		}
	}
	...
	boolean method1726() throws Exception_Sub2 {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("afv.e(").append(')').toString());
		}
	}
}
