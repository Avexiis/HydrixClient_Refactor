...
public class Class165 implements Interface5 {
	...
	public Class146 method49(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("gt.f(").append(')').toString());
		}
	}
	...
	static final void method1781(IComponentDefinition class105, RSInterface RSInterface, ClientScript2 class403, short i) {
		try {
			int i_0_ = (((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 -= -391880689) * 681479919)]);
			if (class105.anInt1289 * -324971993 != i_0_) {
				class105.anInt1289 = 1025047959 * i_0_;
				LocalizedString.markComponentForRedraw(class105, -1283605613);
			}
			if (-1 == class105.component * -1309843523 && !RSInterface.aBoolean1403)
				Class302_Sub2.method3720(-440872681 * class105.interfacehash, (byte) 12);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("gt.gs(").append(')').toString());
		}
	}
	...
	static void method1782(long[] ls, Object[] objects, int i, int i_1_, int i_2_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("gt.q(").append(')').toString());
		}
	}
	...
	static void method1783(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("gt.n(").append(')').toString());
		}
	}
	...
	static final void method1784(ClientScript2 class403, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("gt.rm(").append(')').toString());
		}
	}
}
