...
public final class Class170 {
	...
	static void method1808(int i) {
		try {
			if (ContextMenu.aClass298_Sub37_Sub5_5472 != null) {
				ContextMenu.aClass298_Sub37_Sub5_5472 = null;
				Class227.method2112(805710735 * Class461.anInt5681, Class501.anInt6119 * -1370784315, Class420.anInt5345 * 2054409059, SpotAnimTypeList.anInt4166 * -1855216229, (byte) 2);
			}
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ha.z(").append(')').toString());
		}
	}
	...
	static final void method1809(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ha.pb(").append(')').toString());
		}
	}
	...
	static final void method1810(ClientScript2 class403, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ha.adx(").append(')').toString());
		}
	}
	...
	public static void method1811(int i, Js5 class243, int i_2_, int i_3_, int i_4_, boolean bool, Class97 class97, byte i_5_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ha.n(").append(')').toString());
		}
	}
			...
			for (int i_7_ = 0; i_7_ < class105s.length; i_7_++) {
				...
				if (null == class105) {
					...
					if (i == 0 && null != class105.anObjectArray1275) {
						...
						scriptContext.arguments = class105.anObjectArray1275;
						ClientBuild.execute(scriptContext, (byte) -11);
					}
					if (1 == i && class105.anObjectArray1250 != null) {
						if (class105.component * -1309843523 >= 0) {
							IComponentDefinition class105_8_ = Class50.getIComponentDefinitions((class105.interfacehash * -440872681), (byte) -12);
							if (class105_8_ == null || class105_8_.aClass105Array1292 == null || (-1309843523 * class105.component >= class105_8_.aClass105Array1292.length))
								continue;
							if ((class105_8_.aClass105Array1292[-1309843523 * class105.component]) != class105) {
								if (i_6_ <= 1) {
									/* empty */
								}
								continue;
						...
						ScriptContext scriptContext = new ScriptContext();
						scriptContext.source = class105;
						scriptContext.arguments = class105.anObjectArray1250;
						ClientBuild.execute(scriptContext, (byte) 34);
					}
				}
			}
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ha.lj(").append(')').toString());
		}
	}
	...
	static final void method1813(ClientScript2 class403, byte i) {
		try {
			...
			if (-1 != i_9_)
				RSInterface.method1300(i_9_, 2038530463);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ha.anj(").append(')').toString());
		}
	}
	...
	static boolean method1814(Interface19 interface19, Class298_Sub50 class298_sub50, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ha.i(").append(')').toString());
		}
	}
	...
	static final void method1815(ClientScript2 class403, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ha.ui(").append(')').toString());
		}
	}
}
