...
public class Class173 {
	...
	void method1816(Packet class298_sub53, int i, int i_0_, int i_1_) {
		try {
			if (1 == i) {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("he.p(").append(')').toString());
		}
	}

	void method1817(Packet class298_sub53, int i, byte i_2_) {
		try {
			for (;;) {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("he.b(").append(')').toString());
		}
	}
	...
	public static Class298_Sub19_Sub1 method1819(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("he.g(").append(')').toString());
		}
	}
	...
	public static void method1820(int i, int i_5_, int i_6_, int i_7_) {
		try {
			...
			int i_8_ = i_5_ + -1760580017 * worldTile.x;
			int i_9_ = i_6_ + 283514611 * worldTile.y;
			if (GameClient.map.method2675(-1611682495) != null && (GameClient.map.method2674(-257896295) != Class266.aClass266_2846) && i_5_ >= 0 && i_6_ >= 0 && i_5_ < GameClient.map.upperX(-1890552944) && i_6_ < GameClient.map.upperY(-1685955624)) {
				long l = (long) (i << 28 | i_9_ << 14 | i_8_);
				Class298_Sub2 class298_sub2 = (Class298_Sub2) GameClient.groundTiles.get(l);
				if (class298_sub2 == null)
					GameClient.map.method2675(-1611682495).method4059(i, i_5_, i_6_, (byte) 86);
				else {
					Class298_Sub12 class298_sub12 = (Class298_Sub12) class298_sub2.aLinkedNodeList_7166.method5939(1766612795);
					if (class298_sub12 == null)
						GameClient.map.method2675(-1611682495).method4059(i, i_5_, i_6_, (byte) 28);
					else {
						Class365_Sub1_Sub4_Sub1 class365_sub1_sub4_sub1 = ((Class365_Sub1_Sub4_Sub1) GameClient.map.method2675(-1611682495).method4059(i, i_5_, i_6_, (byte) 119));
						if (class365_sub1_sub4_sub1 == null)
							class365_sub1_sub4_sub1 = (new Class365_Sub1_Sub4_Sub1(GameClient.map.method2675(-1611682495), i_5_ << 265, GameClient.map.method2675(-1611682495).aGroundArray3517[i].method6341(i_5_, i_6_, (byte) -15), i_6_ << 265, i, i));
						else {
							...
							class365_sub1_sub4_sub1.aSceneGraph_7722 = GameClient.map.method2675(-1611682495);
						}
						...
						while_66_: do {
							...
							while_65_: do {
								do {
									class298_sub12_11_ = ((Class298_Sub12) class298_sub2.aLinkedNodeList_7166.method5944(49146));
							...
							for (;;) {
								Class298_Sub12 class298_sub12_12_ = ((Class298_Sub12) class298_sub2.aLinkedNodeList_7166.method5944(49146));
						...
						if (GameClient.map.method2654(361928521).method2320(i_5_, i_6_, -1635198415))
							class365_sub1_sub4_sub1.aByte7724++;
						GameClient.map.method2675(-1611682495).method4053(i, i_5_, i_6_, i_13_, class365_sub1_sub4_sub1, 1648403764);
					}
				}
			}
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("he.jy(").append(')').toString());
		}
	}
	...
	public static final void method1821(Interface class298_sub51, boolean bool, boolean bool_14_, int i) {
		try {
			...
			ChecksumTableEntry.method2280(i_15_, (byte) -97);
			IComponentDefinition class105 = Class50.getIComponentDefinitions(i_16_, (byte) 18);
			if (null != class105)
				LocalizedString.markComponentForRedraw(class105, 999173);
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("he.lw(").append(')').toString());
		}
	}

	public static final void method1822(int viewLocalX, int viewLocalY, int viewZ, int speed1, int speed2, byte i_23_) {
		try {
			Ground.anInt6292 = 446226445 * viewLocalX;
			...
			if (Class427.anInt5362 * 1179258959 >= 100) {
				int i_24_ = -589460992 * Ground.anInt6292 + 256;
				...
				GameClient.anInt8756 = ((int) (Math.atan2((double) i_28_, (double) i_30_) * 2607.5945876176133) & 0x3fff) * -648269561;
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("he.hs(").append(')').toString());
		}
	}
	...
	public static short method1823(int i, byte i_31_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("he.i(").append(')').toString());
		}
	}
	...
	static final void method1825(ClientScript2 class403, int i) {
		try {
			...
			Class52_Sub1_Sub1.method568(class105, RSInterface, class403, (byte) -37);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("he.dj(").append(')').toString());
		}
	}
	...
	static void method1826(int i) {
		try {
			...
			if (1265667685 * Class301_Sub1.anInt7626 >= 0 && 1265667685 * Class301_Sub1.anInt7626 != 0) {
				ClanSettings.method4578(1265667685 * Class301_Sub1.anInt7626, false, 622850291);
				Class301_Sub1.anInt7626 = -485258093;
			}
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("he.cs(").append(')').toString());
		}
	}
}
