			...
			for (/**/; class302_sub3_9_ != class302_sub3; class302_sub3_9_ = class302_sub3_9_.aClass302_Sub3_7650) {
				...
				if (i_14_ < 1600) {
					if (((Class176) this).anIntArray1781[i_14_] < 64)
						...
						int overflowRow = this.anIntArray1781[i_14_] - 64 - 1;
						int overflowCol = this.anIntArray1782[overflowRow];

						if (overflowRow < 0
						 || overflowRow >= this.aClass302_Sub3_Sub1ArrayArray1784.length
						 || overflowCol >= this.aClass302_Sub3_Sub1ArrayArray1784[overflowRow].length)
							continue; 
						this.aClass302_Sub3_Sub1ArrayArray1784[overflowRow][overflowCol] = class302_sub3_sub1;
						this.anIntArray1782[overflowRow]++; 
					}
				}
			}
