...
public class Class18 {
	...
	Class18 method355(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("as.a(").append(')').toString());
		}
	}
	...
	void method356(Class18 class18_4_, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("as.f(").append(')').toString());
		}
	}
	...
	static final void method357(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("as.ai(").append(')').toString());
		}
	}
	...
	static String method358(int i, int i_5_, byte i_6_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("as.bg(").append(')').toString());
		}
	}

	public static Class298_Sub36 method359(OutgoingPacket class198, IsaacCipher isaacCipher, byte i) {
		try {
			Class298_Sub36 class298_sub36 = Class500.method6220((byte) 56);
			((Class298_Sub36) class298_sub36).aClass198_7401 = class198;
			((Class298_Sub36) class298_sub36).anInt7397 = ((OutgoingPacket) class198).length * -1035235683;
			if (-1 == ((Class298_Sub36) class298_sub36).anInt7397 * 157188735)
				class298_sub36.buffer = new RsBitsBuffer(260);
			else if (((Class298_Sub36) class298_sub36).anInt7397 * 157188735 == -2)
				class298_sub36.buffer = new RsBitsBuffer(10000);
			else if (157188735 * ((Class298_Sub36) class298_sub36).anInt7397 <= 18)
				class298_sub36.buffer = new RsBitsBuffer(20);
			else if (((Class298_Sub36) class298_sub36).anInt7397 * 157188735 <= 98)
				class298_sub36.buffer = new RsBitsBuffer(100);
			else
				class298_sub36.buffer = new RsBitsBuffer(260);
			class298_sub36.buffer.method3665(isaacCipher, (byte) 74);
			class298_sub36.buffer.method3668((((OutgoingPacket) ((Class298_Sub36) class298_sub36).aClass198_7401).id) * -1687656101, (byte) -23);
	...
	static final void method360(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("as.em(").append(')').toString());
		}
	}
	...
	static final void method361(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("as.sy(").append(')').toString());
		}
	}
	...
	public static void method362(String string, String string_10_, int i, boolean bool, int i_11_) {
		try {
			if (GameClient.anInt8752 * -1233866115 == 8) {
				Class298_Sub36 class298_sub36 = method359(OutgoingPacket.aClass198_2072, GameClient.aClass25_8693.aClass449_330, (byte) 19);
				class298_sub36.buffer.writeShort(0, 16711935);
				int i_12_ = (385051775 * class298_sub36.buffer.pos);
				class298_sub36.buffer.writeString(string, 2138689470);
				class298_sub36.buffer.writeString(string_10_, 2115793947);
				class298_sub36.buffer.writeByte(i);
				class298_sub36.buffer.writeByte(bool ? 1 : 0);
				class298_sub36.buffer.pos += 814893177;
				class298_sub36.buffer.method3611(Class361.anIntArray3913, i_12_, (class298_sub36.buffer.pos * 385051775), -1325657598);
				class298_sub36.buffer.method3593(385051775 * (class298_sub36.buffer.pos) - i_12_, 1585504133);
				GameClient.aClass25_8693.writeOutboundPacket(class298_sub36, (byte) -20);
				if (i < 13) {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("as.i(").append(')').toString());
		}
	}
}
