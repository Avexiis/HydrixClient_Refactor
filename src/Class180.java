...
public class Class180 implements Interface20 {
	...
	public String method241(Class367 class367, int[] is, long l) {
		try {
			if (class367 == Class367.aClass367_3987) {
				EnumType class483 = Class51.aClass475_506.getClientScriptMap(is[0], 1528209569);
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("hn.a(").append(')').toString());
		}
	}
	...
	static final void method1836(ClientScript2 class403, int i) {
		try {
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = GameClient.aBoolean8647 ? 1 : 0;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("hn.akv(").append(')').toString());
		}
	}
	...
	static final void method1837(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("hn.un(").append(')').toString());
		}
	}

	static final void method1838(ClientScript2 class403, int i) {
		try {
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = WorldMapLabel.method4245(TimeUtils.getTime((byte) 1));
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("hn.akx(").append(')').toString());
		}
	}
}
