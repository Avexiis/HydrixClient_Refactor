...
public class Class182 {
	...
	void method1843(Packet class298_sub53, byte i) {
		try {
			for (;;) {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("hp.b(").append(')').toString());
		}
	}
	...
	void method1844(Packet class298_sub53, int i, short i_1_) {
		try {
			if (1 == i) {
				...
				anInt1824 = class298_sub53.readUnsignedInt() * -387057077;
				anInt1858 = class298_sub53.readUnsignedInt() * -1853520269;
			} else if (i == 4) {
				...
				((Class182) this).anInt1834 = class298_sub53.readUnsignedInt() * -1365954181;
				((Class182) this).anInt1835 = class298_sub53.readUnsignedInt() * 902519911;
			} else if (7 == i) {
				...
				anInt1837 = class298_sub53.readUnsignedInt() * 661695111;
			else if (i == 19)
				...
				anInt1828 = class298_sub53.readUnsignedInt() * 460402411;
			else if (23 == i)
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("hp.p(").append(')').toString());
		}
	}
	...
	void method1845(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("hp.i(").append(')').toString());
		}
	}
		...
		try {
			if (GameClient.cutsceneStage * 1596783995 == 3) {
				...
				for (int i_22_ = 0; i_22_ < -1230451913 * GameClient.npcCount; i_22_++) {
					...
					LinkableObject linkableObject = ((LinkableObject) GameClient.npcs.get((long) i_23_));
					if (linkableObject != null)
						((Entity) linkableObject.anObject7366).method4441(i, i_13_, i_14_, i_15_, i_16_, i_17_, i_18_, (byte) 12);
				}
			}
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("hp.js(").append(')').toString());
		}
	}
	...
	static void method1847(byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("hp.f(").append(')').toString());
		}
	}
}
