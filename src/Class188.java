...
public class Class188 implements Iterator {
	...
	public void remove() {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("hw.remove(").append(')').toString());
		}
	}
	...
	public boolean hasNext() {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("hw.hasNext(").append(')').toString());
		}
	}
	...
	public Object next() {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("hw.next(").append(')').toString());
		}
	}
	...
	static final void method1850(ClientScript2 class403, int i) {
		try {
			...
			Class214.method1989(class105, RSInterface, class403, (byte) 74);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("hw.kq(").append(')').toString());
		}
	}
	...
	static final void method1851(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("hw.td(").append(')').toString());
		}
	}
	...
	static final void method1852(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("hw.ald(").append(')').toString());
		}
	}
}
