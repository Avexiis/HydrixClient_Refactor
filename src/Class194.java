...
public class Class194 {
	...
	static final void method1863(ClientScript2 class403, byte i) {
		try {
			...
			Class125.method1397(class105, RSInterface, class403, 1051610527);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("if.np(").append(')').toString());
		}
	}
	...
	static final void method1864(ClientScript2 class403, int i) {
		try {
			...
			Class324.method3958(class105, RSInterface, class403, -389689371);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("if.oa(").append(')').toString());
		}
	}

	static final void method1865(ClientScript2 class403, int i) {
		try {
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = ObjectDeque.anInt7164 * -863531439 == 4 ? 1 : 0;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("if.agy(").append(')').toString());
		}
	}
	...
	static final void method1866(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("if.aih(").append(')').toString());
		}
	}
	...
	public static Class336 method1867(int i, int i_2_, int i_3_, int i_4_, Class424 class424, int i_5_, byte i_6_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("if.k(").append(')').toString());
		}
	}
	...
	public static void method1868(int i) {
		try {
			...
			Class227.method2112(Class88.anInt806 * -1347746885, TileText.anInt7658 * 1089948687, 608683427 * Class134.anInt6343, 1396607435 * Class448.anInt5619, (byte) 2);
			Class298_Sub45.aClass298_Sub37_Sub15_7522 = null;
			Class318.aClass298_Sub37_Sub15_3322 = null;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("if.s(").append(')').toString());
		}
	}
	...
	static final void method1869(ClientScript2 class403, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("if.pd(").append(')').toString());
		}
	}

	static final void method1870(IComponentDefinition class105, RSInterface RSInterface, ClientScript2 class403, byte i) {
		try {
			class105.anInt1232 = (((ClientScript2) class403).anIntArray5244[(((ClientScript2) class403).anInt5239 -= -391880689) * 681479919]) * -7527659;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("if.jq(").append(')').toString());
		}
	}
}
