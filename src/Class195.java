...
public class Class195 {
	...
	static final void method1871(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ig.o(").append(')').toString());
		}
	}
	...
	static final void method1872(ClientScript2 class403, byte i) {
		try {
			...
			Class249.method2393(class105, RSInterface, class403, -159729779);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ig.ix(").append(')').toString());
		}
	}
	...
	public static int method1873(int i, int i_0_, int i_1_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ig.k(").append(')').toString());
		}
	}
}
