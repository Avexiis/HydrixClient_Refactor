...
public class Class197 {
	...
	public int method1875(boolean bool, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ii.p(").append(')').toString());
		}
	}
	...
	public void method1876(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ii.f(").append(')').toString());
		}
	}
	...
	public int method1877(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ii.b(").append(')').toString());
		}
	}
	...
	public int method1878(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ii.i(").append(')').toString());
		}
	}
	...
	public void method1880(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ii.x(").append(')').toString());
		}
	}
	...
	public void method1881(int i, int i_4_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ii.r(").append(')').toString());
		}
	}
	...
	public Object method1883(Interface10 interface10, int i, boolean bool, boolean bool_7_, int i_8_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ii.k(").append(')').toString());
		}
	}
	...
	public void method1884(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ii.q(").append(')').toString());
		}
	}
	...
	Class454 method1885(Interface10 interface10, int i, boolean bool, boolean bool_9_, int i_10_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ii.u(").append(')').toString());
		}
	}
	...
	static final void method1886(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ii.px(").append(')').toString());
		}
	}
	...
	static final void method1887(ClientScript2 class403, int i) {
		try {
			...
			RSInterface RSInterface = SpotAnimTypeList.aRSInterfaceArray4165[i_13_ >> 16];
			Class7.method310(class105, RSInterface, class403, (byte) 102);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ii.od(").append(')').toString());
		}
	}
