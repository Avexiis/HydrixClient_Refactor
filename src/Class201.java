...
public class Class201 {
	...
	public static synchronized void method1900(byte[] is, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("im.f(").append(')').toString());
		}
	}
	...
	static final void method1901(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("im.te(").append(')').toString());
		}
	}
	...
	public static int method1902(byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("im.k(").append(')').toString());
		}
	}
}
