...
public class Class21 {
	...
	public static void method364(Js5 class243, int i, int i_0_, int i_1_, boolean bool, Class298_Sub19_Sub1 class298_sub19_sub1, int i_2_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("av.b(").append(')').toString());
		}
	}

	static final void method365(IComponentDefinition class105, RSInterface RSInterface, boolean bool, int i, ClientScript2 class403, int i_3_) {
		try {
			...
			if (-1 == class105.component * -1309843523 && !RSInterface.aBoolean1403) {
				Class298_Sub50.method3567(-440872681 * class105.interfacehash, 1388671560);
				Class509.method6286(-440872681 * class105.interfacehash, 106150101);
				Class70.method808(class105.interfacehash * -440872681, 2057190103);
			}
			if (-1 == i_4_) {
				class105.anInt1184 = -1530138943;
				class105.anInt1151 = 1825442367;
				class105.zds3 = -643064669;
			} else {
				class105.zds3 = i_4_ * 643064669;
				...
				class105.tempZoomDistance = class468.anInt5713 * -1056736627;
				class105.anInt1201 = i * -625792095;
				if (-692202853 * class105.anInt1221 > 0)
					class105.tempZoomDistance = (class105.tempZoomDistance * 237251296 / (class105.anInt1221 * -692202853) * -1066050969);
				else if (1769572195 * class105.anInt1253 > 0)
					class105.tempZoomDistance = (237251296 * class105.tempZoomDistance / (class105.anInt1253 * 1769572195) * -1066050969);
			}
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("av.hh(").append(')').toString());
		}
	}
	...
	static final void method366(ClientScript2 class403, int i) {
		try {
			...
			Class317.method3850(class105, RSInterface, class403, -1611318497);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("av.iu(").append(')').toString());
		}
	}
	...
	static final void method367(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("av.acy(").append(')').toString());
		}
	}
	...
	static final void method368(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("av.anf(").append(')').toString());
		}
	}
	...
	static void method369(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("av.a(").append(')').toString());
		}
	}
}
