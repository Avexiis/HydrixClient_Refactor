...
public class Class212 {
	...
	int anInt2432;
	public static IdentityKitTypeList aIdentityKitTypeList_2433;

	public String method1951(int i) {
		try {
			return new StringBuilder().append("_").append(368445667 * ((Class212) this).anInt2432).toString();
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("iy.a(").append(')').toString());
		}
	}
	...
	public void method1952(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("iy.i(").append(')').toString());
		}
	}
	...
	public void method1955(Object[] objects, short i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("iy.p(").append(')').toString());
		}
	}
	...
	static final void method1956(ClientScript2 class403, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("iy.ry(").append(')').toString());
		}
	}
	...
	static final void method1957(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("iy.ano(").append(')').toString());
		}
	}
}
