...
public class Class216 implements Interface24 {
	...
	public int method256(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("jc.a(").append(')').toString());
		}
	}
	...
	public Class463 method260(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("jc.f(").append(')').toString());
		}
	}
	...
	static final void method1997(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("jc.acz(").append(')').toString());
		}
	}

	public static int method1998(CharSequence charsequence, short i) {
		try {
			return IntegerPreferenceField.method5619(charsequence, 10, true, -1228221916);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("jc.i(").append(')').toString());
		}
	}
		...
		try {
			...
			for (int i_3_ = 0; i_3_ < is.length; i_3_++) {
				...
				if (class369.anInt4028 * 347977109 == -1) {
					...
					Class57 class57 = ((Class57) (ContextMenu.aClass348_5500.get((long) (347977109 * class369.anInt4028))));
					if (class57 == null) {
						Class89 class89 = Class89.method987(Class158.aClass243_6364, class369.anInt4028 * 347977109, 0);
						if (class89 != null) {
							class57 = OverlayType.activeToolkit.method5125(class89, true);
							ContextMenu.aClass348_5500.put(class57, (long) (class369.anInt4028 * 347977109));
						}
					}
					if (null != class57) {
						ContextMenu.aClass57Array5501[i_2_] = class57;
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("jc.bc(").append(')').toString());
		}
	}
	...
	public static final void method2001(boolean bool, byte i) {
		try {
			...
			GameClient.map.method2666(-2101576654);
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("jc.gi(").append(')').toString());
		}
	}
	...
	static void method2002(int i, int i_6_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("jc.s(").append(')').toString());
		}
	}

	static final void method2003(ClientScript2 class403, int i) {
		try {
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class287.myPlayer.primaryAnim.method4719((byte) 0) >> 3;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("jc.uc(").append(')').toString());
		}
	}
}
