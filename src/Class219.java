...
public class Class219 implements Runnable {
	...
	int method2033(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("jf.a(").append(')').toString());
		}
	}
	...
	public Class227 method2034(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("jf.r(").append(')').toString());
		}
	}
	...
	synchronized boolean method2035(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("jf.b(").append(')').toString());
		}
	}
	...
	synchronized void method2036(Interface12 interface12, int i) {
		try {
			...
			((Class219) this).aLong2468 = TimeUtils.getTime((byte) 1) * -5051392830202741391L;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("jf.p(").append(')').toString());
		}
	}
	...
	synchronized void method2037(byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("jf.f(").append(')').toString());
		}
	}
	...
	public int method2038(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("jf.d(").append(')').toString());
		}
	}
	...
	public String method2039(short i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("jf.u(").append(')').toString());
		}
	}
	...
	public long method2040(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("jf.x(").append(')').toString());
		}
	}
	...
	public int method2041(byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("jf.k(").append(')').toString());
		}
	}
	...
	void method2042(byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("jf.s(").append(')').toString());
		}
	}
				...
				synchronized (this) {
					try {
						...
						if (((Class219) this).anInterface12_2466 instanceof Class224)
							...
							long l_1_ = TimeUtils.getTime((byte) 1);
							if (OverlayType.activeToolkit != null && null != ((Class219) this).anInterface12_2467 && ((Class219) this).anInterface12_2467.method151(73548607) != 0 && ((6015775630087136145L * ((Class219) this).aLong2468) >= l_1_ - (long) (((Class219) this).anInterface12_2467.method151(-462627527)))) {
								...
								Class57 class57 = (OverlayType.activeToolkit.method5046(-2110394505 * Class462.canvasWidth, (-1111710645 * Class298_Sub40_Sub9.anInt9716), true, -34894995));
								...
								((Class219) this).anInterface12_2466.method160((((Class219) this).aBoolean2473 || (OverlayType.activeToolkit != null && OverlayType.activeToolkit.method5074())), 2145176958);
							}
							try {
								if (null != OverlayType.activeToolkit && !(((Class219) this).anInterface12_2466 instanceof Class224))
									OverlayType.activeToolkit.method4988((byte) 101);
							} catch (Exception_Sub1 exception_sub1) {
								IPAddress.method6062(new StringBuilder().append(exception_sub1.getMessage()).append(Atmosphere.gameClientInstance.method2761((byte) 1)).toString(), exception_sub1, (short) 3171);
								ClanSettings.method4578(0, true, 622850291);
							}
						}
						((Class219) this).aBoolean2473 = false;
						if (null != OverlayType.activeToolkit && !(((Class219) this).anInterface12_2466 instanceof Class224) && ((((Class219) this).aClass227_2465.anInt2548 * -861845079) < (-861845079 * Class227.aClass227_2545.anInt2548)))
							Class229.method2124((byte) -100);
					} catch (Exception exception) {
						continue;
					}
				}
				long l_3_ = TimeUtils.getTime((byte) 1);
				int i = (int) (20L - (l_3_ - l));
				if (i > 0)
					IPAddress.method6060((long) i);
			}
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("jf.run(").append(')').toString());
		}
	}
	...
	synchronized void method2043(long l, String string, int i, Class227 class227, int i_4_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("jf.i(").append(')').toString());
		}
	}

	public static ModelPart method2044(GraphicsToolkit class_ra, int i, int i_5_, int i_6_, int i_7_, int i_8_, int i_9_) {
		try {
			long l = (long) i_8_;
			ModelPart modelPart = (ModelPart) HintIcon.aClass348_264.get(l);
			int i_10_ = 2055;
			if (null == modelPart) {
				Model class64 = Model.method751(WorldTile.js5_models, i_8_, 0);
				if (class64 == null)
					return null;
				if (class64.version < 13)
					class64.method755(2);
				modelPart = class_ra.method5037(class64, i_10_, -203714349 * Class481.anInt6035, 64, 768);
				HintIcon.aClass348_264.put(modelPart, l);
			}
			modelPart = modelPart.method4755((byte) 6, i_10_, true);
			if (i != 0)
				modelPart.f(i);
			if (0 != i_5_)
				modelPart.t(i_5_);
	...
	static final void method2046(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("jf.pe(").append(')').toString());
		}
	}
	...
	public static final void method2047(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("jf.at(").append(')').toString());
		}
	}
	...
	static final void method2048(ClientScript2 class403, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("jf.rk(").append(')').toString());
		}
	}
}
