...
public class Class22 {
	...
	static Class115[] method370(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aw.a(").append(')').toString());
		}
	}

	public static File method371(int i) {
		try {
			return GameShell.aFile6500;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aw.d(").append(')').toString());
		}
	}

	static void method372(Packet buffer, int i) {
		try {
			...
			SeqTypeList.anInt5190 = buffer.readUnsignedSmart() * 457295123;
			Class338.anInt3630 = buffer.readUnsignedSmart() * -924756647;
			...
			for (int i_2_ = 0; i_2_ < 1017276543 * Class24.anInt9950; i_2_++) {
				...
				class343_sub1.anInt3670 = buffer.readUnsignedInt() * -743493231;
			...
			Class117.anInt1399 = buffer.readUnsignedInt() * -1232164675;
			Class338.aBoolean3631 = true;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aw.b(").append(')').toString());
		}
	}

	static final void method373(IComponentDefinition class105, RSInterface RSInterface, ClientScript2 class403, int i) {
		try {
			class105.aStringArray1195 = null;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aw.jx(").append(')').toString());
		}
	}

	static final void method374(ClientScript2 class403, int i) {
		try {
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = GraphicsAutoSetup.clientPreferences.fogPreference.method5633(-863865720) == 1 ? 1 : 0;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aw.ajp(").append(')').toString());
		}
	}
}
