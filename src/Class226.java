...
public class Class226 {
	...
	void method2104(byte[] is, int i) {
		try {
			Packet class298_sub53 = new Packet(Class236.method2188(is, -1012105553));
			int i_0_ = class298_sub53.readUnsignedByte();
			if (i_0_ < 5 || i_0_ > 7)
				throw new RuntimeException();
			if (i_0_ >= 6)
				((Class226) this).anInt2529 = class298_sub53.readUnsignedInt() * 967231547;
			else
			...
			if (bool) {
				...
				for (int i_8_ = 0; i_8_ < ((Class226) this).anInt2527 * -2145352941; i_8_++)
					((Class226) this).anIntArray2519[(((Class226) this).anIntArray2518[i_8_])] = class298_sub53.readUnsignedInt();
			...
			for (int i_9_ = 0; i_9_ < ((Class226) this).anInt2527 * -2145352941; i_9_++)
				((Class226) this).anIntArray2522[(((Class226) this).anIntArray2518[i_9_])] = class298_sub53.readUnsignedInt();
			if (bool_2_) {
			...
			for (int i_12_ = 0; i_12_ < -2145352941 * ((Class226) this).anInt2527; i_12_++)
				((Class226) this).anIntArray2514[(((Class226) this).anIntArray2518[i_12_])] = class298_sub53.readUnsignedInt();
			if (i_0_ >= 7) {
				...
				for (int i_27_ = 0; i_27_ < -2145352941 * ((Class226) this).anInt2527; i_27_++) {
					...
					for (int i_31_ = 0; i_31_ < i_29_; i_31_++) {
						...
						if (((Class226) this).anIntArrayArray2526[i_28_] != null)
							...
							i_32_ = i_31_;
						((Class226) this).anIntArrayArray2523[i_28_][i_32_] = class298_sub53.readUnsignedInt();
					}
					((Class226) this).aClass112Array2528[i_28_] = new Class112(((Class226) this).anIntArrayArray2523[i_28_]);
				}
			}
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("jo.a(").append(')').toString());
		}
	}
	...
	static final void method2106(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("jo.rs(").append(')').toString());
		}
	}
	...
	static final void method2107(ClientScript2 class403, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("jo.sa(").append(')').toString());
		}
	}

	static final void method2108(ClientScript2 class403, short i) {
		try {
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = (null == GameClient.aClass105_8819 ? -1 : -440872681 * GameClient.aClass105_8819.interfacehash);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("jo.api(").append(')').toString());
		}
	}
}
