...
public class Class227 {
	...
	LocalizedString aClass470_2543;
	...
	LocalizedString aClass470_2549;
	...
	Class227(int i, LocalizedString class470, int i_0_) {
	...
	Class227(int i, LocalizedString class470, LocalizedString class470_1_, int i_2_, int i_3_) {
		this(i, class470, class470_1_, i_2_, i_3_, true, false);
	}

	Class227(int i, LocalizedString class470, LocalizedString class470_4_, int i_5_, int i_6_, boolean bool, boolean bool_7_) {
	...
	static final void method2113(ClientScript2 class403, int i) {
		try {
			...
			if (GameClient.anInt8942 * 1131012101 == 2 && i_15_ < -1054937867 * GameClient.anInt8941)
				((ClientScript2) class403).anObjectArray5240[((((ClientScript2) class403).anInt5241 += 969361751) * -203050393) - 1] = GameClient.aStringArray8947[i_15_];
			else
