...
public class Class228 {
	...
	static final void method2115(ClientScript2 class403, int i) {
		try {
			...
			Class145.method1595(class105, RSInterface, class403, -762908635);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("jq.ma(").append(')').toString());
		}
	}
	...
	static final void method2116(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("jq.aaf(").append(')').toString());
		}
	}
	...
	public static void method2117(int i) {
		try {
			...
			Class87.aLinkedNodeList_799.method5943((byte) 1);
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("jq.b(").append(')').toString());
		}
	}
	...
	static final void method2118(ClientScript2 class403, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("jq.gk(").append(')').toString());
		}
	}

	public static void method2119(SeqType class391, int i, int i_2_) {
		try {
			if (Class300.anInt3213 * -991384187 < 50 && (null != class391 && class391.sounds != null && i < class391.sounds.length && null != class391.sounds[i])) {
				int i_3_ = class391.sounds[i][0];
				int i_4_ = i_3_ >> 8;
				int i_5_ = i_3_ >> 5 & 0x7;
				if (class391.sounds[i].length > 1) {
					int i_6_ = (int) (Math.random() * (double) (class391.sounds[i]).length);
					if (i_6_ > 0)
						i_4_ = class391.sounds[i][i_6_];
				}
				int i_7_ = 256;
				if (null != class391.anIntArray4183 && class391.anIntArray4190 != null)
					i_7_ = SeqType.method4888(class391.anIntArray4183[i], class391.anIntArray4190[i], 1444813491);
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("jq.q(").append(')').toString());
		}
	}

	static final boolean method2120(int i, int i_8_, Class336 class336, Region region, int i_9_) {
		try {
			int i_10_ = i;
			int i_11_ = i_8_;
			int i_12_ = 64;
			...
			while (i_17_ != i_16_) {
				...
				i_12_ = i_10_ - i_14_;
				i_13_ = i_11_ - i_15_;
				int i_18_ = i_10_ - region.regionBaseX * 1487776559;
				int i_19_ = i_11_ - 1415525851 * region.regionBaseY;
				if (class336.method4090(2, i_10_, i_11_, region, -16711936)) {
	...
	static int method2121(String string, byte[] is, int i, byte i_21_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("jq.f(").append(')').toString());
		}
	}
}
