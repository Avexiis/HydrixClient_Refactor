...
public class Class229 implements Interface12 {
	...
	public void method150(int i) {
		try {
			if (((Class229) this).aClass_ra6456 != OverlayType.activeToolkit) {
				((Class229) this).aClass_ra6456 = OverlayType.activeToolkit;
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("jr.d(").append(')').toString());
		}
	}
	...
	public void method160(boolean bool, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("jr.b(").append(')').toString());
		}
	}
	...
	public int method159(byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("jr.u(").append(')').toString());
		}
	}
	...
	public void method149(short i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("jr.k(").append(')').toString());
		}
	}

	public boolean method153(long l) {
		try {
			return (TimeUtils.getTime((byte) 1) >= l + (long) (((Class229) this).anInt6454 * -568263897));
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("jr.x(").append(')').toString());
		}
	}
	...
	public int method151(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("jr.r(").append(')').toString());
		}
	}
	...
	public static int method2123(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("jr.cy(").append(')').toString());
		}
	}

	public static void method2124(byte i) {
		try {
			synchronized (Atmosphere.gameClientInstance) {
				if (null != Class231.aFrame2589) {
					...
					if (container == null) {
						...
						Class52_Sub2_Sub1.aCanvas9079.setSize(-2110394505 * Class462.canvasWidth, -1111710645 * Class298_Sub40_Sub9.anInt9716);
						if (null != OverlayType.activeToolkit)
							OverlayType.activeToolkit.method5173(Class52_Sub2_Sub1.aCanvas9079, Class462.canvasWidth * -2110394505, -1111710645 * Class298_Sub40_Sub9.anInt9716, (byte) 20);
						if (container == Class298_Sub36.aFrame7403) {
							Insets insets = Class298_Sub36.aFrame7403.getInsets();
							Class52_Sub2_Sub1.aCanvas9079.setLocation(insets.left + GameClient.anInt6473 * 1898544019, GameClient.anInt6474 * 540368727 + insets.top);
						} else
							Class52_Sub2_Sub1.aCanvas9079.setLocation(GameClient.anInt6473 * 1898544019, GameClient.anInt6474 * 540368727);
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("jr.gn(").append(')').toString());
		}
	}
}
