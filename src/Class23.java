...
public class Class23 {
	...
	static final void method375(ClientScript2 class403, int i) {
		try {
			...
			WorldMapLabel worldMapLabel = Class363.aWorldMapLabelList_3931.method4116(i_0_, -2093323393);
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = worldMapLabel.anInt3817 * -804513353;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ax.ama(").append(')').toString());
		}
	}
	...
	public static Class57 method376(GraphicsToolkit class_ra, int i, byte i_1_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ax.k(").append(')').toString());
		}
	}
	...
	static void method377(String string, String string_2_, String string_3_, boolean bool, boolean bool_4_, byte i) {
		try {
			...
			if (class25.method387(537308016) != null) {
				Class298_Sub36 class298_sub36 = Class18.method359(OutgoingPacket.aClass198_2084, class25.aClass449_330, (byte) 52);
				class298_sub36.buffer.writeShort((Class58.method693(string, -142100047) + Class58.method693(string_2_, -435846723) + Class58.method693(string_3_, 733332406) + 1), 16711935);
				class298_sub36.buffer.writeString(string, 2114181594);
				class298_sub36.buffer.writeString(string_2_, 2128054697);
				class298_sub36.buffer.writeString(string_3_, 2103261593);
				int i_5_ = 0;
				if (bool)
					i_5_ |= 0x1;
				if (bool_4_)
					i_5_ |= 0x2;
				class298_sub36.buffer.writeByte(i_5_);
				class25.writeOutboundPacket(class298_sub36, (byte) -114);
			}
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ax.h(").append(')').toString());
		}
	}

	static final void method378(ClientScript2 class403, int i) {
		try {
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = -278777595 * ContextMenu.actionCount;
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = 1592446965 * ContextMenu.anInt5479;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ax.ua(").append(')').toString());
		}
	}
	...
	public static int method379(Packet class298_sub53, String string, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ax.f(").append(')').toString());
		}
	}
}
