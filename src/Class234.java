...
public class Class234 {
	...
	static void method2174(String string, String string_0_, int i, int i_1_, int i_2_, long l, int i_3_, int i_4_, boolean bool, boolean bool_5_, long l_6_, boolean bool_7_, int i_8_) {
		try {
			if (!ContextMenu.menuOpen && -278777595 * ContextMenu.actionCount < 521) {
				...
				MovementType.method2618(class298_sub37_sub15, 1640099092);
			}
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("jw.y(").append(')').toString());
		}
	}
	...
	public static void method2175(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("jw.i(").append(')').toString());
		}
	}
	...
	static final void method2176(ClientScript2 class403, int i) {
		try {
			...
			MagnetConfig.method782(class105, RSInterface, class403, -1168214437);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("jw.nm(").append(')').toString());
		}
	}
	...
	static final void method2177(ClientScript2 class403, int i) {
		try {
			...
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = GameClient.aClass251Array8920[i_11_].anInt2768 * 535421071;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("jw.ya(").append(')').toString());
		}
	}
	...
	static final void method2178(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("jw.zu(").append(')').toString());
		}
	}
	...
	static final void method2179(ClientScript2 class403, short i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("jw.adl(").append(')').toString());
		}
	}

	static final void method2180(ClientScript2 class403, int i) {
		try {
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = GraphicsAutoSetup.clientPreferences.aVolumePreference_7553.method5726(-2145285486);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("jw.ajz(").append(')').toString());
		}
	}
	...
	public static void method2181(RsBitsBuffer class298_sub53_sub2, int i) {
		try {
			...
			if (null != class298_sub47) {
				int i_14_ = 385051775 * class298_sub53_sub2.pos;
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("jw.b(").append(')').toString());
		}
	}

	static TextureOperation method2182(int i, byte i_21_) {
		try {
			switch (i) {
			case 0:
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("jw.d(").append(')').toString());
		}
	}
	...
	public static void method2183(int i) {
		try {
			if (!Class21.aBoolean274) {
				Class336.method4093((GameClient.map.method2675(-1611682495).aClass326ArrayArrayArray3518), 234916861);
				if ((GameClient.map.method2675(-1611682495).aClass326ArrayArrayArray3520) != null)
					Class336.method4093((GameClient.map.method2675(-1611682495).aClass326ArrayArrayArray3520), -1747837187);
				Class21.aBoolean274 = true;
			}
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("jw.a(").append(')').toString());
		}
	}

	static final void method2184(IComponentDefinition class105, RSInterface RSInterface, ClientScript2 class403, byte i) {
		try {
			...
			if (class105.hidden != bool) {
				...
				LocalizedString.markComponentForRedraw(class105, -1214371857);
			}
			if (-1 == -1309843523 * class105.component && !RSInterface.aBoolean1403)
				Class413.method5583(-440872681 * class105.interfacehash, (short) 945);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("jw.ct(").append(')').toString());
		}
	}
}
