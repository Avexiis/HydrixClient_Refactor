...
final class Class238 implements Interface10 {
	...
	public static void method2200(Class139 class139, Class133 class133, int i, int i_0_, int i_1_, int i_2_, int i_3_, int i_4_, int i_5_, int i_6_, int i_7_, int i_8_) {
		try {
			...
			CustomCursorPreference.aClass89_8437 = null;
			Atmosphere.scriptCache = null;
	...
	static Class345 method2201(Packet class298_sub53, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("k.p(").append(')').toString());
		}
	}
	...
	static final void method2202(ClientScript2 class403, int i) {
		try {
			...
			Class359.method4291(SpotAnimTypeList.aRSInterfaceArray4165[i_13_ >>> 16], i_13_ & 0xffff, i_14_, i_15_, ((ClientScript2) class403).aBoolean5261, class403, -782842809);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("k.ba(").append(')').toString());
		}
	}
}
