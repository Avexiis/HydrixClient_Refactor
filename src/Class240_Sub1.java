...
public class Class240_Sub1 extends MapDecoder {
	ObjectTypeList aClass433_7072;
	...
	void method2234(GraphicsToolkit class_ra, int i, int i_0_, int i_1_, int i_2_, Region region, int i_3_) {
		try {
			...
			if (null != interface3) {
				...
				if (i_0_ == 0) {
					...
					if (-1508517619 * class432.anInt5376 == 1) {
						if (0 == i_5_) {
							aSceneGraph_2619.aClass333_3512.method4068(1, i, i_1_, i_2_);
						} else if (1 == i_5_) {
							aSceneGraph_2619.aClass333_3512.method4068(2, i, i_1_, 1 + i_2_);
						} else if (2 == i_5_) {
							aSceneGraph_2619.aClass333_3512.method4068(1, i, i_1_ + 1, i_2_);
						} else if (i_5_ == 3) {
							aSceneGraph_2619.aClass333_3512.method4068(2, i, i_1_, i_2_);
						}
					}
				} else if (1 == i_0_) {
					aSceneGraph_2619.method4054(i, i_1_, i_2_, (byte) 59);
					aSceneGraph_2619.method4027(i, i_1_, i_2_, -391880689);
				} else if (2 == i_0_) {
					...
					if (Class424.aClass424_6595.anInt6613 * -1976050083 == i_4_) {
						if ((i_5_ & 0x1) == 0) {
							aSceneGraph_2619.aClass333_3512.method4068(8, i, i_1_, i_2_);
						} else {
							aSceneGraph_2619.aClass333_3512.method4068(16, i, i_1_, i_2_);
						}
					}
				} else if (3 == i_0_) {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aaa.cr(").append(')').toString());
		}
	}
	...
	public final void method2235(GraphicsToolkit class_ra, Packet class298_sub53, int i, int i_6_, byte i_7_) {
		try {
			if (!aBoolean2629) {
				...
				while_0_: do {
					for (;;) {
						if (class298_sub53.pos * 385051775 >= class298_sub53.payload.length) {
							break while_0_;
						}
						int i_8_ = class298_sub53.readUnsignedByte();
						if (i_8_ == 0) {
							if (atmosphere == null) {
								atmosphere = new Atmosphere(class298_sub53, aAtmosphereManager_7080);
							} else {
								atmosphere.readFromPacket(class298_sub53, aAtmosphereManager_7080, (short) 1342);
							}
						} else if (1 == i_8_) {
							...
							atmosphere.copyFrom(class298_sub53, -1319879858);
						} else if (128 == i_8_) {
							if (atmosphere == null) {
								atmosphere = new Atmosphere();
							}
							atmosphere.setSkybox(class298_sub53, aAtmosphereManager_7080, (byte) 11);
						} else {
							if (129 != i_8_) {
								break;
							}
					...
					for (int i_30_ = 0; i_30_ < 8; i_30_++) {
						for (int i_31_ = 0; i_31_ < 8; i_31_++) {
							...
							if (i_32_ >= 0 && i_32_ < anInt2627 * -954368823 >> 3 && i_33_ >= 0 && i_33_ < anInt2628 * 181474463 >> 3) {
								aAtmosphereManager_7080.setRegionAtmosphere(i_32_, i_33_, atmosphere, (byte) -2);
							}
						}
					}
				}
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aaa.ck(").append(')').toString());
		}
	}
	...
	public final void method2236(GraphicsToolkit class_ra, Packet class298_sub53, int i, int i_39_, int i_40_, int i_41_, int i_42_, int i_43_, int i_44_, int i_45_) {
		try {
			if (!aBoolean2629) {
				...
				while_1_: do {
					for (;;) {
						if (385051775 * class298_sub53.pos >= class298_sub53.payload.length) {
							break while_1_;
						}
						...
						if (0 == i_48_) {
							if (null == atmosphere) {
								...
								atmosphere.readFromPacket(class298_sub53, aAtmosphereManager_7080, (short) 1534);
							}
						} else if (1 == i_48_) {
							...
							atmosphere.setSkybox(class298_sub53, aAtmosphereManager_7080, (byte) 53);
						} else {
							if (i_48_ != 129) {
								break;
							}
				...
				if (atmosphere != null) {
					aAtmosphereManager_7080.setRegionAtmosphere(i_39_ >> 3, i_40_ >> 3, atmosphere, (byte) -31);
				}
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aaa.cn(").append(')').toString());
		}
	}
	...
	public final void method2237(GraphicsToolkit class_ra, byte[] data, int i, int i_72_, Region[] Regions, int i_73_) {
		...
		int locid = -1;
		for (;;) {
			int locincr = osrs ? buffer.readUnsignedSmart() : buffer.readSmart();
			if (locincr == 0) {
				break;
			}
			locid += locincr;
			int position = 0;
			for (;;) {
				int posincr = buffer.readUnsignedSmart();
				if (posincr == 0) {
					break;
				}
				position += posincr - 1;
				...
				if (i_84_ > 0 && i_85_ > 0 && i_84_ < -954368823 * anInt2627 - 1 && i_85_ < anInt2628 * 181474463 - 1) {
					...
					add_loc(class_ra, i_80_, i_80_, i_84_, i_85_, locid + (osrs ? OSRSData.LOCS_OFFSET : 0), i_83_, i_82_, region, -1);
				}
			}
		}
	}
	...
	public final void method2238(GraphicsToolkit class_ra, byte[] data, int i, int i_87_, int i_88_, int i_89_, int i_90_, int i_91_, int i_92_, Region[] Regions, int i_93_) {
		...
		int locid = -1;
		for (;;) {
			int i_95_ = osrs ? buffer.readUnsignedSmart() : buffer.readSmart();
			if (i_95_ == 0) {
				break;
			}
			locid += i_95_;
			int i_96_ = 0;
			for (;;) {
				int i_97_ = buffer.readUnsignedSmart();
				if (i_97_ == 0) {
					break;
				}
				i_96_ += i_97_ - 1;
				...
				if (i_89_ == i_100_ && i_99_ >= i_90_ && i_99_ < 8 + i_90_ && i_98_ >= i_91_ && i_98_ < 8 + i_91_) {
					LocType class432 = aClass433_7072.list(locid + (osrs ? OSRSData.LOCS_OFFSET : 0));
	...
	boolean method2239(GraphicsToolkit class_ra, int i, int i_107_, boolean bool, LocType class432, int i_108_, int i_109_, int i_110_, int i_111_, int i_112_, int i_113_, int i_114_, int i_115_, boolean bool_116_, Ground ground, Region region, int i_117_, int i_118_, byte i_119_) {
		try {
			...
			if (i == -1976050083 * Class424.aClass424_6592.anInt6613) {
				...
				if (class432.aBoolean5405 && aBoolean2632) {
					if (i_107_ == 0) {
						...
						ground.LA(1 + i_114_, i_115_ + 1, 50);
					} else if (2 == i_107_) {
						ground.LA(i_114_ + 1, i_115_, 50);
					} else if (3 == i_107_) {
						ground.LA(i_114_, i_115_, 50);
			...
			if (i == -1976050083 * Class424.aClass424_6593.anInt6613) {
				...
				if ((class432.anInt5376 * -1508517619 == 1 || aBoolean7073 && -1 == -1508517619 * class432.anInt5376) && !aBoolean2629) {
					if (0 == i_107_) {
						...
						aSceneGraph_2619.aClass333_3512.method4067(1, i_109_, i_114_ + 1, i_115_, class432.anInt5387 * 201968507, class432.anInt5388 * -1994960695);
						aSceneGraph_2619.aClass333_3512.method4067(2, i_109_, i_114_, 1 + i_115_, class432.anInt5387 * 201968507, class432.anInt5388 * -1994960695);
					} else if (i_107_ == 2) {
						aSceneGraph_2619.aClass333_3512.method4067(1, i_109_, 1 + i_114_, i_115_, 201968507 * class432.anInt5387, -1994960695 * class432.anInt5388);
						aSceneGraph_2619.aClass333_3512.method4067(2, i_109_, i_114_, i_115_, 201968507 * class432.anInt5387, class432.anInt5388 * -1994960695);
					} else if (3 == i_107_) {
						aSceneGraph_2619.aClass333_3512.method4067(1, i_109_, i_114_, i_115_, class432.anInt5387 * 201968507, class432.anInt5388 * -1994960695);
						aSceneGraph_2619.aClass333_3512.method4067(2, i_109_, i_114_, i_115_, class432.anInt5387 * 201968507, -1994960695 * class432.anInt5388);
					}
				}
				if (0 != -2144543407 * class432.anInt5380 && region != null) {
					region.addWall(i_114_, i_115_, i, i_107_, class432.aBoolean5424, !class432.aBoolean5416);
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aaa.ce(").append(')').toString());
		}
	}

	boolean method2240(GraphicsToolkit class_ra, int i, int i_125_, boolean bool, LocType class432, int i_126_, int i_127_, int i_128_, int i_129_, int i_130_, int i_131_, int i_132_, int i_133_, int i_134_) {
		try {
			...
			if (i == Class424.aClass424_6601.anInt6613 * -1976050083) {
				int i_135_ = 65;
				Interface3 interface3 = (Interface3) aSceneGraph_2619.method4031(i_127_, i_132_, i_133_, 644917110);
				if (null != interface3) {
					i_135_ = aClass433_7072.list(interface3.method32((byte) 27)).anInt5391 * -448694871 + 1;
				}
				Class365_Sub1_Sub3 class365_sub1_sub3;
				if (bool) {
			...
			if (-1976050083 * Class424.aClass424_6598.anInt6613 == i) {
				int i_136_ = 33;
				Interface3 interface3 = (Interface3) aSceneGraph_2619.method4031(i_127_, i_132_, i_133_, 552550945);
				if (interface3 != null) {
					i_136_ = aClass433_7072.list(interface3.method32((byte) 14)).anInt5391 * -448694871 / 2 + 1;
				}
				Class365_Sub1_Sub3 class365_sub1_sub3;
				if (bool) {
			...
			if (Class424.aClass424_6600.anInt6613 * -1976050083 == i) {
				...
				int i_139_ = 33;
				Interface3 interface3 = (Interface3) aSceneGraph_2619.method4031(i_127_, i_132_, i_133_, 2110046759);
				if (null != interface3) {
					i_139_ = aClass433_7072.list(interface3.method32((byte) 14)).anInt5391 * -448694871 / 2 + 1;
				}
				Class365_Sub1_Sub3 class365_sub1_sub3;
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aaa.cb(").append(')').toString());
		}
	}
	...
	Interface3 method2241(int i, int i_143_, int i_144_, int i_145_, int i_146_) {
		try {
			...
			if (i_143_ == 0) {
				interface3 = (Interface3) aSceneGraph_2619.method4031(i, i_144_, i_145_, 212388673);
			}
			if (1 == i_143_) {
				interface3 = (Interface3) aSceneGraph_2619.method4033(i, i_144_, i_145_, 1080081135);
			}
			if (i_143_ == 2) {
				interface3 = (Interface3) aSceneGraph_2619.method4035(i, i_144_, i_145_, GameClient.anInterface17_8960, -1336288750);
			}
			if (i_143_ == 3) {
				interface3 = (Interface3) aSceneGraph_2619.method4058(i, i_144_, i_145_, (byte) 50);
			}
			return interface3;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aaa.cu(").append(')').toString());
		}
	}
	...
	public final void method2242(GraphicsToolkit class_ra, boolean bool, int i) {
		try {
			...
			if (!bool) {
						...
						for (int i_151_ = 0; i_151_ <= anInt2627 * -954368823; i_151_++) {
							if ((aByteArrayArrayArray2637[i_149_][i_151_][i_150_] & 0x4) != 0) {
								...
								if ((1 + i_155_ - i_154_) * (i_153_ - i_152_ + 1) >= 4) {
									int i_158_ = heights[i_149_][i_152_][i_154_];
									aSceneGraph_2619.aClass333_3512.method4070(4, i_149_, i_152_ << 9, (i_153_ << 9) + 512, i_154_ << 9, 512 + (i_155_ << 9), i_158_, i_158_);
				...
				aSceneGraph_2619.aClass333_3512.method4080();
			}
			aByteArrayArrayArray2637 = null;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, "aaa.cp(" + ')');
		}
	}
	...
	final void add_loc(GraphicsToolkit class_ra, int i, int i_161_, int i_162_, int i_163_, int i_164_, int i_165_, int i_166_, Region region, int i_167_) {
		try {
			if (i < 0 || i >= aSceneGraph_2619.aGroundArray3517.length)
				return; 
			
			if (i_161_ < -1281303921 * anInt7082) {
			...
			if (GraphicsSetup.clientPreferences.texturePreference.getValue(1871358652) != 0 || !class432.aBoolean5432) {
				...
				Ground ground = aSceneGraph_2619.aGroundArray3517[i];
							...
							if (class432.aBoolean5405 && aBoolean2632) {
								...
								for (int i_181_ = 0; i_181_ <= i_169_; i_181_++) {
									for (int i_182_ = 0; i_182_ <= i_170_; i_182_++) {
										ground.LA(i_162_ + i_181_, i_182_ + i_163_, i_179_);
									}
								}
							}
						}
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aaa.ci(").append(')').toString());
		}
	}

	public Class240_Sub1(SceneGraph sceneGraph, ObjectTypeList class433, int i, int i_183_, int i_184_, boolean bool, TileFlags tileFlags, AtmosphereManager atmosphereManager) {
		super(sceneGraph, i, i_183_, i_184_, bool, Class504.aClass375_6196, Class151.aClass451_6358, tileFlags);
		aClass433_7072 = class433;
		aAtmosphereManager_7080 = atmosphereManager;
	}

	static final void method2244(IComponentDefinition class105, RSInterface RSInterface, ClientScript2 class403, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aaa.oy(").append(')').toString());
		}
	}
	...
	static final void method2245(ClientScript2 class403, int i) {
		try {
			...
			EnumType class483 = Class51.aClass475_506.getClientScriptMap(i_187_, 1528209569);
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aaa.vv(").append(')').toString());
		}
	}
	...
	static final void method2246(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aaa.pn(").append(')').toString());
		}
	}
}
