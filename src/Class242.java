...
public abstract class Class242 {
	public static ReferenceTable aReferenceTable_2708;
	...
	static final void method2266(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("kd.yr(").append(')').toString());
		}
	}
	...
	static final void method2267(ClientScript2 class403, byte i) {
		try {
			...
			Class102.method1085(class105, RSInterface, class403, 1901866056);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("kd.dn(").append(')').toString());
		}
	}
	...
	static final void method2268(ClientScript2 class403, int i) {
		try {
			...
			Class133[] class133s = Huffman.method1255(1297575712);
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("kd.se(").append(')').toString());
		}
	}
	...
	static void method2269(int i, int i_6_, int i_7_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("kd.aq(").append(')').toString());
		}
	}
}
