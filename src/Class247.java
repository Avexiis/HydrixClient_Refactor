...
public abstract class Class247 {
	...
	Class298_Sub37_Sub16_Sub1 method2338(int i, int i_0_, byte i_1_, boolean bool, int i_2_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ki.a(").append(')').toString());
		}
	}
	...
	boolean method2340(byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ki.b(").append(')').toString());
		}
	}
	...
	int method2341(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ki.p(").append(')').toString());
		}
	}
	...
	Class247() {
		...
		((Class247) this).aClass298_Sub53_2744 = new Packet(6);
		((Class247) this).aByte2743 = (byte) 0;
		anInt2735 = 0;
		anInt2745 = 0;
		((Class247) this).aClass298_Sub53_2737 = new Packet(10);
	}
	...
	boolean method2347(byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ki.f(").append(')').toString());
		}
	}
	...
	public int method2348(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ki.i(").append(')').toString());
		}
	}
	...
	static final void decodePlayerUpdate(RsBitsBuffer stream, int i, int i_3_) {
		try {
			Class10.anInt139 = 0;
			Wall.method4536(stream, (byte) -53);
			Class82_Sub7.decodePlayersMasks(stream, -2052480320);
			if (stream.pos * 385051775 != i)
				throw new RuntimeException(new StringBuilder().append(385051775 * (stream.pos)).append(" ").append(i).toString());
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ki.f(").append(')').toString());
		}
	}

	static final void method2363(IComponentDefinition class105, RSInterface RSInterface, ClientScript2 class403, int i) {
		try {
			class105.aBoolean1181 = (((ClientScript2) class403).anIntArray5244[(((ClientScript2) class403).anInt5239 -= -391880689) * 681479919]) == 1;
			LocalizedString.markComponentForRedraw(class105, -270865215);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ki.fm(").append(')').toString());
		}
	}
	...
	static final void method2364(ClientScript2 class403, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ki.gz(").append(')').toString());
		}
	}
	...
	public static void method2365(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ki.d(").append(')').toString());
		}
	}
	...
	public static int method2366(Class298_Sub37_Sub15 class298_sub37_sub15, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ki.ap(").append(')').toString());
		}
	}

	static final void method2367(ClientScript2 class403, int i) {
		try {
			WorldMapArea worldMapArea = Class236.method2190(1470671507);
			if (null == worldMapArea) {
				((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919) - 1] = -1;
				((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919) - 1] = -1;
			} else {
				((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919) - 1] = -530122905 * worldMapArea.mapAreaId;
				int i_6_ = (-1740053407 * worldMapArea.anInt7605 << 28 | (2122110429 * worldMapArea.x + WorldMap.mapX) << 14 | (WorldMap.mapY + -372920341 * worldMapArea.y));
				((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919) - 1] = i_6_;
			}
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ki.adz(").append(')').toString());
		}
	}
	...
	static final void method2369(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ki.uh(").append(')').toString());
		}
	}
	...
	static final boolean method2370(Class25 class25, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ki.jc(").append(')').toString());
		}
	}
	...
	public static void method2371(byte i) {
		try {
			...
			if (-1625219821 * GameClient.anInt8687 > 0) {
				Class298_Sub36 class298_sub36 = Class18.method359(OutgoingPacket.aClass198_1994, GameClient.gameConnection.aClass449_330, (byte) 79);
				class298_sub36.buffer.writeShort(2089055308 * GameClient.anInt8687, 16711935);
				for (int i_9_ = 0; i_9_ < GameClient.anInt8687 * -1625219821; i_9_++) {
					...
					class298_sub36.buffer.writeByte(interface16.method218((byte) -114));
					class298_sub36.buffer.putTriByte((int) l, (byte) 52);
				}
				GameClient.gameConnection.writeOutboundPacket(class298_sub36, (byte) -79);
			}
			...
			if (GameClient.aBoolean8763 && ClientScriptsExecutor.anInt4120 * -2116412357 <= 0) {
				...
				Class298_Sub36 class298_sub36 = Class18.method359(OutgoingPacket.MOVE_CAMERA_PACKET, GameClient.gameConnection.aClass449_330, (byte) 50);
				class298_sub36.buffer.writeShort128((int) GameClient.aFloat8757 >> 3);
				class298_sub36.buffer.writeShortLE((int) GameClient.aFloat8949 >> 3, 1908840395);
				GameClient.gameConnection.writeOutboundPacket(class298_sub36, (byte) -20);
			}
			if (ClientScriptsExecutor.aBoolean4122 != SceneryShadowPreference.aBoolean8385) {
				ClientScriptsExecutor.aBoolean4122 = SceneryShadowPreference.aBoolean8385;
				Class298_Sub36 class298_sub36 = Class18.method359(OutgoingPacket.aClass198_2063, GameClient.gameConnection.aClass449_330, (byte) 90);
				class298_sub36.buffer.writeByte(SceneryShadowPreference.aBoolean8385 ? 1 : 0);
				GameClient.gameConnection.writeOutboundPacket(class298_sub36, (byte) -44);
			}
	...
	static void method2372(GraphicsToolkit class_ra, int i, int i_11_, int i_12_, int i_13_, int i_14_, int i_15_) {
		try {
			if ((null == Class486.aClass57_6062 || null == Class501.aClass57_6123 || Class367.aClass57_4001 == null) && Class158.aClass243_6364.method2310(Class162.anInt1680 * 1049272911, -457216440) && Class158.aClass243_6364.method2310(Class361.anInt3914 * -745532315, -457216440) && Class158.aClass243_6364.method2310((-684155443 * Class260.anInt2820), -457216440)) {
				...
				OverlayType.aClass57_4070 = class_ra.method5125(class89_16_, true);
			}
			if (null != Class486.aClass57_6062 && Class501.aClass57_6123 != null && Class367.aClass57_4001 != null) {
				...
				OverlayType.aClass57_4070.method645(i_12_ + i - Class367.aClass57_4001.method623(), i_11_ + i_13_ - Class367.aClass57_4001.method625());
			}
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ki.am(").append(')').toString());
		}
	}
	...
	static final void method2373(ClientScript2 class403, byte i) {
		try {
			...
			boolean bool = false;
			for (MapDetails mapDetails = (MapDetails) class461.method5984(1544902477); mapDetails != null; mapDetails = ((MapDetails) class461.method5985(1578702645))) {
				if (-947282109 * mapDetails.anInt9643 == i_22_) {
					bool = true;
					break;
				}
			}
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ki.ael(").append(')').toString());
		}
	}
	...
	static final void method2374(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ki.ajq(").append(')').toString());
		}
	}
	...
	public static boolean method2375(char c, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ki.v(").append(')').toString());
		}
	}
	...
	static void method2376(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ki.w(").append(')').toString());
		}
	}
}
