...
public class Class250 {
	...
	public static byte[] method2395(int i, byte i_0_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("kl.b(").append(')').toString());
		}
	}
	...
	public static void method2396(byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("kl.a(").append(')').toString());
		}
	}
	...
	public static void method2397(int i, int i_7_, byte i_8_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("kl.f(").append(')').toString());
		}
	}
	...
	static final void method2398(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("kl.ef(").append(')').toString());
		}
	}
	...
	static final void method2399(ClientScript2 class403, byte i) {
		try {
			...
			if (null != (Class287.myPlayer.appearance) && (Class287.myPlayer.appearance.aBoolean3977))
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("kl.zm(").append(')').toString());
		}
	}
}
