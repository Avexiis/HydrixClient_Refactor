...
public class Class252 {
	...
	static void method2409(GraphicsToolkit class_ra, byte[][][] is, int i, int i_0_, int i_1_, int i_2_, int i_3_, int i_4_, int i_5_, int i_6_, int i_7_, int i_8_, byte i_9_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("kn.a(").append(')').toString());
		}
	}

	static void method2410(Class233 class233, int i) {
		try {
			ContextMenu.aClass233_5494.method2142(class233);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("kn.ab(").append(')').toString());
		}
	}
}
