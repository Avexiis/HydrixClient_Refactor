...
public final class Class253 {
	...
	public Object method2411(Object object, Object object_0_, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("kp.b(").append(')').toString());
		}
	}
	...
	boolean method2412(byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("kp.a(").append(')').toString());
		}
	}
	...
	public Object method2413(Object object, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("kp.f(").append(')').toString());
		}
	}
	...
	void method2414(Class261 class261, boolean bool, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("kp.i(").append(')').toString());
		}
	}
	...
	void method2415(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("kp.k(").append(')').toString());
		}
	}
	...
	public void method2416(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("kp.d(").append(')').toString());
		}
	}
	...
	public Object method2417(Object object, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("kp.p(").append(')').toString());
		}
	}
	...
	static final void method2418(ClientScript2 class403, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("kp.ab(").append(')').toString());
		}
	}
	...
	static final void method2419(ClientScript2 class403, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("kp.wi(").append(')').toString());
		}
	}
	...
	static final void method2420(ClientScript2 class403, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("kp.alt(").append(')').toString());
		}
	}
	...
	static final void method2421(ClientScript2 class403, byte i) {
		try {
			...
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = ((Player) ((ClientScript2) class403).aClass365_Sub1_Sub1_Sub2_5242).hitSplatQueue.method799(i_10_, -1034906382);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("kp.ae(").append(')').toString());
		}
	}
