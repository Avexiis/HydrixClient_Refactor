...
public class Class256 {
	...
	public Class298_Sub37_Sub8 method2441(int i, int i_0_) {
		try {
			...
			if (is != null)
				class298_sub37_sub8.method3430(new Packet(is), 754160666);
			if (i >= 32768)
				class298_sub37_sub8.method3432(-1787095576);
			((Class256) this).aClass348_2798.put(class298_sub37_sub8, (long) i);
			return class298_sub37_sub8;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ks.a(").append(')').toString());
		}
	}

	public Class256(Language language, Js5 class243, Js5 class243_1_) {
	...
	static final void method2442(ClientScript2 class403, int i) {
		try {
			...
			Class393.method4891(class105, RSInterface, class403, (byte) -101);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ks.hf(").append(')').toString());
		}
	}
	...
	static final void method2444(ClientScript2 class403, int i) {
		try {
			...
			Class158.method1699(class105, RSInterface, class403, (byte) -112);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ks.lo(").append(')').toString());
		}
	}
	...
	static int[] method2446(Class298_Sub36 class298_sub36, int i) {
		try {
			...
			class298_sub36.buffer.writeBytes(class298_sub53.payload, 0, 385051775 * class298_sub53.pos, (short) -19107);
			return is;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ks.s(").append(')').toString());
		}
	}
}
