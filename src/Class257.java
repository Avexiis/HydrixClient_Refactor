...
public class Class257 {
	...
	final void method2447(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("kt.a(").append(')').toString());
		}
	}
	...
	public final int[] method2448(int i, int i_1_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("kt.f(").append(')').toString());
		}
	}
	...
	public final int[][] method2449(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("kt.b(").append(')').toString());
		}
	}
	...
	static void method2450(ClientScript2 class403, short i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("kt.e(").append(')').toString());
		}
	}

	static final void method2451(IComponentDefinition class105, RSInterface RSInterface, ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("kt.ob(").append(')').toString());
		}
	}
	...
	static final void method2452(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("kt.aag(").append(')').toString());
		}
	}

	static final void method2453(boolean bool, byte i) {
		try {
			Class95.method1033(GameClient.WINDOW_PANE_ID * -257444687, -2110394505 * Class462.canvasWidth, Class298_Sub40_Sub9.anInt9716 * -1111710645, bool, 1828905535);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("kt.kg(").append(')').toString());
		}
	}
	...
	static final void method2454(ClientScript2 class403, int i) {
		try {
			...
			MapDetails mapDetails = Class298_Sub7.method2864(-1164141102);
			if (null != mapDetails) {
				boolean bool = mapDetails.method3453(i_7_ >> 28 & 0x3, i_7_ >> 14 & 0x3fff, i_7_ & 0x3fff, Class388.anIntArray4156, 1911692873);
				if (bool) {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("kt.aep(").append(')').toString());
		}
	}
}
