...
public class Class26 {
	...
	public static int method397(CharSequence charsequence, CharSequence charsequence_0_, Language language, int i) {
		try {
			...
			while_59_: do {
				...
				for (;;) {
					...
					c_6_ = EnvironmentMap.method767(c_6_, language, (byte) 93);
					c_7_ = EnvironmentMap.method767(c_7_, language, (byte) 61);
				...
				return (Class367.method4550(c_6_, language, 82862076) - Class367.method4550(c_7_, language, -2040847947));
			} while (false);
			int i_8_ = Math.min(i_1_, i_2_);
			for (int i_9_ = 0; i_9_ < i_8_; i_9_++) {
				if (Language.aLanguage_6626 == language) {
					i_3_ = i_1_ - 1 - i_9_;
					i_4_ = i_2_ - 1 - i_9_;
				} else
					i_3_ = i_4_ = i_9_;
				...
				if (c_10_ != c_11_ && (Character.toUpperCase(c_10_) != Character.toUpperCase(c_11_))) {
					...
					if (c_11_ != c_10_)
						return (Class367.method4550(c_10_, language, -1920723606) - Class367.method4550(c_11_, language, -495715201));
				}
			}
			int i_12_ = i_1_ - i_2_;
			if (0 != i_12_)
			...
			for (int i_13_ = 0; i_13_ < i_8_; i_13_++) {
				...
				if (c_15_ != c_14_)
					return (Class367.method4550(c_14_, language, -129620717) - Class367.method4550(c_15_, language, -153765629));
			}
			return 0;
		} catch (RuntimeException runtimeexception) {
