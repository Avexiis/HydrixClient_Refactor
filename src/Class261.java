...
public final class Class261 implements Comparable {
	...
	int method2462(Class261 class261_0_, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("kx.a(").append(')').toString());
		}
	}
	...
	public int compareTo(Object object) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("kx.compareTo(").append(')').toString());
		}
	}
	...
	public boolean equals(Object object) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("kx.equals(").append(')').toString());
		}
	}

	static final void method2463(IComponentDefinition class105, RSInterface RSInterface, ClientScript2 class403, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("kx.lv(").append(')').toString());
		}
	}
	...
	static final void method2464(ClientScript2 class403, int i) {
		try {
			...
			Class118.method1288(class105, RSInterface, class403, -1603621953);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("kx.km(").append(')').toString());
		}
	}
	...
	public static boolean method2465(int i, int i_3_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("kx.b(").append(')').toString());
		}
	}
}
