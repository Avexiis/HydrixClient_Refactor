...
public abstract class Class264 {
	...
	public int method2475(String string, int i, int i_4_, int i_5_, int i_6_, int i_7_, int i_8_, int i_9_, int i_10_, int i_11_, Class57[] class57s, int[] is, Class_ta class_ta, int i_12_, int i_13_, int i_14_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("l.p(").append(')').toString());
		}
	}
	...
	public int method2476(String string, int i, int i_15_, int i_16_, int i_17_, int i_18_, int i_19_, int i_20_, int i_21_, int i_22_, int i_23_, Class57[] class57s, int[] is, Class_ta class_ta, int i_24_, int i_25_, int i_26_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("l.i(").append(')').toString());
		}
	}
	...
	public int method2480(String string, int i, int i_55_, int i_56_, int i_57_, Random random, int i_58_, Class57[] class57s, int[] is, int i_59_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("l.x(").append(')').toString());
		}
	}
	...
	void method2481(int i, int i_65_, byte i_66_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("l.q(").append(')').toString());
		}
	}
	...
	void method2482(String string, short i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("l.s(").append(')').toString());
		}
	}
	...
	void method2484(String string, int i, int i_70_, Class57[] class57s, int[] is, Class_ta class_ta, int i_71_, int i_72_, int i_73_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, "l.t(" + ')');
		}
	}
	...
	public int method2485(String string, int i, int i_82_, int i_83_, int i_84_, int i_85_, int i_86_, int i_87_, int i_88_, Random random, int i_89_, int[] is, Class57[] class57s, int[] is_90_, int i_91_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("l.r(").append(')').toString());
		}
	}
	...
	void method2487(String string, int i, int i_108_, Class57[] class57s, int[] is, int[] is_109_, int[] is_110_, int i_111_) {
		try {
				...
				if (c == 60)
					...
					if (c == 62 && -1 != i_112_) {
						...
						if (string_117_.startsWith("img=")) {
							try {
								int i_118_ = (is_109_ != null ? is_109_[i_114_] : 0);
								int i_119_ = (is_110_ != null ? is_110_[i_114_] : 0);
								i_114_++;
			...
			throw ErrorContext.info(runtimeexception, "l.h(" + ')');
		}
	}
	...
	public void method2488(String string, int i, int i_125_, int i_126_, int i_127_, int i_128_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("l.a(").append(')').toString());
		}
	}
	...
	public static void method2492(int i, String string, byte i_140_) {
		try {
			ChecksumTableEntry.method2282(i, 0, "", "", "", string, -781451735);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("l.b(").append(')').toString());
		}
	}
	...
	static final void method2493(ClientScript2 class403, int i) {
		try {
			...
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = class390.method4866((((ClientScript2) class403).aClass365_Sub1_Sub1_Sub2_5242.overheadText), i_141_, i_142_, 867608709) ? 1 : 0;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("l.aop(").append(')').toString());
		}
	}
	...
	static final void method2494(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("l.ym(").append(')').toString());
		}
	}
	...
	static final void method2495(ClientScript2 class403, byte i) {
		try {
			...
			Class21.method365(class105, RSInterface, false, 2, class403, 2093890134);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("l.hu(").append(')').toString());
		}
	}
	...
	static void method2497(int i, int i_145_, int i_146_, int i_147_, int i_148_, int i_149_, int i_150_, byte i_151_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("l.n(").append(')').toString());
		}
	}
	...
	static final void method2498(ClientScript2 class403, int i) {
		try {
			...
			IComponentDefinition class105 = ((Class390) class390).aClass105_4168;
			RSInterface RSInterface = ((Class390) class390).aRSInterface_4167;
			Class22.method373(class105, RSInterface, class403, -884844467);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("l.je(").append(')').toString());
		}
	}
}
