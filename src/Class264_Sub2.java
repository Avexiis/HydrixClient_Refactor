...
public class Class264_Sub2 extends Class264 {
	...
	static final void method2506(int i) {
		try {
			RSInterface.method1304(1674101672);
			GameClient.map.method2666(-2068923271);
			for (int i_108_ = 0; i_108_ < GameClient.hintIcons.length; i_108_++)
				GameClient.hintIcons[i_108_] = null;
			...
			for (int i_110_ = 0; i_110_ < 2048; i_110_++)
				GameClient.players[i_110_] = null;
			GameClient.npcCount = 0;
			GameClient.npcs.method5811((byte) -66);
			GameClient.anInt8772 = 0;
			GameClient.groundTiles.method5811((byte) -127);
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("xk.gs(").append(')').toString());
		}
	}

	static void method2507(Class334 class334, int i, int i_111_, int i_112_, ModelPart modelPart, byte i_113_) {
		try {
			if (null != modelPart)
				class334.method4083(i, i_111_, i_112_, modelPart.N(), modelPart.RA(), modelPart.ya(), modelPart.YA(), modelPart.o(), modelPart.AA(), modelPart.ha());
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("xk.dd(").append(')').toString());
		}
	}
	...
	static final int method2508(int i, int i_114_, short i_115_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("xk.o(").append(')').toString());
		}
	}
}
