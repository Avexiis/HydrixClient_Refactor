...
public class Class264_Sub4 extends Class264 {
	...
	public static void method2513(boolean bool, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("xw.a(").append(')').toString());
		}
	}
	...
	public static int method2514(int i, int i_142_, int i_143_, short i_144_) {
		try {
			...
			for (WorldMapArea worldMapArea = ((WorldMapArea) Class301_Sub1.aLinkedNodeList_3236.method5939(1766612795)); worldMapArea != null; worldMapArea = (WorldMapArea) Class301_Sub1.aLinkedNodeList_3236.method5944(49146)) {
				if (worldMapArea.mapAreaId * -530122905 != i) {
					if (i_144_ >= 128)
						throw new IllegalStateException();
				} else {
					int i_149_ = worldMapArea.x * 2122110429;
					int i_150_ = worldMapArea.y * -372920341;
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("xw.ck(").append(')').toString());
		}
	}
	...
	static final void method2516(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("xw.ajd(").append(')').toString());
		}
	}
}
