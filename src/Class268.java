...
public class Class268 {
	...
	final void method2530(Packet class298_sub53) {
		...
		for (int i_2_ = 0; i_2_ < 10; i_2_++) {
			...
			((Class268) this).anIntArray2868[i_2_] = class298_sub53.readUnsignedSmart();
		}
		((Class268) this).anInt2869 = class298_sub53.readUnsignedSmart();
		((Class268) this).anInt2864 = class298_sub53.readUnsignedSmart();
