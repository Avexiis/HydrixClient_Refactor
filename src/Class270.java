...
public class Class270 {
	...
	byte[] method2532(byte[] is, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("lf.a(").append(')').toString());
		}
	}
	...
	public short[] method2533(short[] is, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("lf.f(").append(')').toString());
		}
	}
	...
	int method2534(int i, int i_22_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("lf.b(").append(')').toString());
		}
	}
	...
	int method2535(int i, int i_23_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("lf.p(").append(')').toString());
		}
	}
	...
	static final void method2536(IComponentDefinition class105, RSInterface RSInterface, ClientScript2 class403, int i) {
		try {
			((ClientScript2) class403).anInt5239 -= -783761378;
			class105.anInt1166 = -970389233 * (((ClientScript2) class403).anIntArray5244[681479919 * ((ClientScript2) class403).anInt5239]);
			if (class105.anInt1166 * 684246511 > (1867913305 * class105.anInt1168 - class105.width * -2093041337))
			...
			if (-1424956747 * class105.anInt1167 > (class105.anInt1169 * 2053897963 - 457937409 * class105.height))
				class105.anInt1167 = (2097037087 * class105.anInt1169 - -900266595 * class105.height);
			if (class105.anInt1167 * -1424956747 < 0)
				class105.anInt1167 = 0;
			LocalizedString.markComponentForRedraw(class105, -830371764);
			if (-1 == class105.component * -1309843523 && !RSInterface.aBoolean1403)
				ToolkitPreference.method5682(class105.interfacehash * -440872681, -754597349);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("lf.cq(").append(')').toString());
		}
	}
	...
	static final void method2537(ClientScript2 class403, int i) {
		try {
			if (GameClient.anInt8932 * -1333485389 >= 5 && -1333485389 * GameClient.anInt8932 <= 9)
				((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919) - 1] = -1333485389 * GameClient.anInt8932;
			else
				((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919) - 1] = 0;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("lf.uo(").append(')').toString());
		}
	}
	...
	static final void method2538(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("lf.aev(").append(')').toString());
		}
	}
	...
	public static final void method2539(int i, int i_37_, int i_38_, int i_39_, int i_40_, int i_41_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("lf.x(").append(')').toString());
		}
	}
