...
public class Class271 {
	...
	static final void method2542(ClientScript2 class403, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("lg.ade(").append(')').toString());
		}
	}
	...
	static boolean method2543(int i, int i_0_, int i_1_, int i_2_) {
		try {
			...
			boolean bool = true;
			Interface3 interface3 = (Interface3) sceneGraph.method4031(i, i_0_, i_1_, 693483522);
			if (null != interface3)
				bool &= Animator_Sub2.method5849(interface3, (byte) -60);
			interface3 = (Interface3) sceneGraph.method4035(i, i_0_, i_1_, GameClient.anInterface17_8960, 664102063);
			if (interface3 != null)
				bool &= Animator_Sub2.method5849(interface3, (byte) -4);
			interface3 = (Interface3) sceneGraph.method4058(i, i_0_, i_1_, (byte) 95);
			if (interface3 != null)
				bool &= Animator_Sub2.method5849(interface3, (byte) -3);
			return bool;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("lg.k(").append(')').toString());
		}
	}

	static final void method2544(ClientScript2 class403, int i) {
		try {
			ContextMenu.anInt5499 = (((ClientScript2) class403).anIntArray5244[(((ClientScript2) class403).anInt5239 -= -391880689) * 681479919]) * 985311877;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("lg.afn(").append(')').toString());
		}
	}
	...
	public static Class456[] method2545(byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("lg.hm(").append(')').toString());
		}
	}
	...
	static final void method2546(int i) {
		try {
			for (ObjectDeque objectDeque = ((ObjectDeque) ObjectDeque.aLinkedNodeList_7152.method5939(1766612795)); null != objectDeque; objectDeque = (ObjectDeque) ObjectDeque.aLinkedNodeList_7152.method5944(49146))
				Class225.method2099(objectDeque, false, (byte) 8);
			for (ObjectDeque objectDeque = ((ObjectDeque) ObjectDeque.aLinkedNodeList_7162.method5939(1766612795)); objectDeque != null; objectDeque = (ObjectDeque) ObjectDeque.aLinkedNodeList_7162.method5944(49146))
				Class225.method2099(objectDeque, true, (byte) 8);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("lg.i(").append(')').toString());
		}
	}
	...
	static void method2547(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("lg.f(").append(')').toString());
		}
	}
