...
public class Class272 {
	...
	Class298_Sub26_Sub1 method2549(int i, int i_0_, int[] is, int i_1_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("lh.a(").append(')').toString());
		}
	}
	...
	Class298_Sub26_Sub1 method2550(int i, int i_3_, int[] is, int i_4_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("lh.f(").append(')').toString());
		}
	}
	...
	public Class298_Sub26_Sub1 method2551(int i, int[] is, int i_6_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("lh.b(").append(')').toString());
		}
	}
	...
	public Class298_Sub26_Sub1 method2552(int i, int[] is, byte i_7_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("lh.p(").append(')').toString());
		}
	}
	...
	static final void method2553(ClientScript2 class403, int i) {
		try {
			...
			Class298_Sub43.method3527(class105, RSInterface, class403, (byte) -127);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("lh.el(").append(')').toString());
		}
	}
	...
	static final void method2554(ClientScript2 class403, int i) {
		try {
			...
			Class298_Sub36 class298_sub36 = Class18.method359(OutgoingPacket.aClass198_2027, GameClient.gameConnection.aClass449_330, (byte) 34);
			class298_sub36.buffer.writeByte(string.length() + 1);
			class298_sub36.buffer.writeString(string, 2114518021);
			GameClient.gameConnection.writeOutboundPacket(class298_sub36, (byte) -1);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("lh.sb(").append(')').toString());
		}
	}
	...
	static final void method2555(ClientScript2 class403, int i) {
		try {
			...
			if (i_10_ == -1) {
				...
				i_11_ -= worldTile.x * -1760580017;
				if (i_11_ < 0)
					i_11_ = 0;
				else if (i_11_ >= GameClient.map.upperX(-1866822819))
					i_11_ = GameClient.map.upperX(-1973847066);
				i_12_ -= 283514611 * worldTile.y;
				if (i_12_ < 0)
					i_12_ = 0;
				else if (i_12_ >= GameClient.map.upperY(922370140))
					i_12_ = GameClient.map.upperY(271939870);
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("lh.agw(").append(')').toString());
		}
	}
	...
	static final void method2556(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("lh.ahq(").append(')').toString());
		}
	}
	...
	public static Class298_Sub37_Sub15 method2557(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("lh.ai(").append(')').toString());
		}
	}
	...
	public static void method2558(int i, int i_13_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("lh.i(").append(')').toString());
		}
	}
}
