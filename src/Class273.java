...
public class Class273 {
	...
	public static void method2559(String string, boolean bool, boolean bool_0_, String string_1_, boolean bool_2_, boolean bool_3_, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("li.f(").append(')').toString());
		}
	}
	...
	static final void method2561(ClientScript2 class403, int i) {
		try {
			...
			if (GameClient.aBoolean8638) {
				try {
					Object object = (Class212.aClass212_2426.method1953((new Object[] { Integer.valueOf(Class298_Sub41.anInt7456 * 1914527151), (Boolean.valueOf(1 == (Class287.myPlayer.appearanceFlag))), Integer.valueOf(((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 -= -391880689) * 681479919)]) }), -1838433046));
					if (null != object)
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("li.ant(").append(')').toString());
		}
	}
	...
	static void method2562(int i, int i_4_, int i_5_, boolean bool, int i_6_, boolean bool_7_, byte i_8_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("li.x(").append(')').toString());
		}
	}
	...
	public static GraphicsToolkit method2563(Canvas canvas, Interface_ma interface_ma, int i, int i_13_, byte i_14_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("li.a(").append(')').toString());
		}
	}
	...
	static final void method2564(ClientScript2 class403, short i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("li.alx(").append(')').toString());
		}
	}
	...
	public static int method2565(short i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("li.k(").append(')').toString());
		}
	}

	public static void method2566(Packet class298_sub53, int i, byte i_18_) {
		try {
			...
			((Class298_Sub47) class298_sub47).anInt7542 = class298_sub53.readUnsignedInt() * -530104791;
					...
					if (i_20_ == 0 || i_20_ == 1 || 2 == i_20_) {
						...
						if (i_20_ == 3) {
							for (int i_27_ = 0; i_27_ < i_24_; i_27_++) {
								int i_28_ = class298_sub53.readUnsignedInt();
			...
			Class478.aLinkedNodeList_6002.addlast(class298_sub47, 512081003);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("li.p(").append(')').toString());
		}
	}
}
