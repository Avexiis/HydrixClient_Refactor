...
public class Class274 implements Interface21 {
	...
	public Class274 method2567(byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("lj.b(").append(')').toString());
		}
	}
	...
	public int method242(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("lj.f(").append(')').toString());
		}
	}
	...
	static final void method2568(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("lj.fg(").append(')').toString());
		}
	}
	...
	static final void method2569(ClientScript2 class403, int i) {
		try {
			...
			Class298_Sub32_Sub5.method3174(class105, RSInterface, class403, -1683091614);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("lj.nk(").append(')').toString());
		}
	}
}
