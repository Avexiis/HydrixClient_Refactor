...
public class Class275 {
	...
	static final void method2570(ClientScript2 class403, int i) {
		try {
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = (int) (GameClient.aLong8645 * -5648129435911399733L >> 32);
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = (int) (GameClient.aLong8645 * -5648129435911399733L & 0xffffffffffffffffL);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("lk.ahf(").append(')').toString());
		}
	}
	...
	public static Class459 method2571(int i, int i_0_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("lk.f(").append(')').toString());
		}
	}
	...
	static final void method2572(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("lk.adi(").append(')').toString());
		}
	}
	...
	public static void method2573(int i) {
		try {
			if (null == Class230.aClass227Array2561) {
				...
				Class230.aLong2560 = TimeUtils.getTime((byte) 1) * 3538585047679075717L;
			}
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("lk.a(").append(')').toString());
		}
	}
}
