...
public class Class276 {
	...
	static void method2576(GraphicsToolkit class_ra) {
		if (aModelPart_2936 == null) {
			...
			for (int i = 0; i <= 24; i++) {
				int i_1_ = i * 8192 / 24;
				int i_2_ = Class220.SINE[i_1_];
				int i_3_ = Class220.COSINE[i_1_];
				for (int i_4_ = 1; i_4_ < 24; i_4_++) {
					int i_5_ = i_4_ * 8192 / 24;
					int i_6_ = Class220.COSINE[i_5_] >> 7;
					int i_7_ = Class220.SINE[i_5_] * i_2_ >> 21;
					int i_8_ = Class220.SINE[i_5_] * i_3_ >> 21;
			...
			class64.highestFaceIndex = class64.numVertices;
			class64.facesSkin = null;
			class64.verticesSkin = null;
			class64.facesPriority = null;
			aModelPart_2936 = class_ra.method5037(class64, 51200, 33, 64, 768);
		}
	}
	...
	boolean method2578(GraphicsToolkit class_ra, Class276 class276_28_) {
		if (((Class276) this).aClass57_2925 == null) {
			if (((Class276) this).anInt2928 == 0) {
				if (Skybox.anInterface_ma2955.method170((((Class276) this).anInt2918), (short) 14716)) {
					int[] is = (Skybox.anInterface_ma2955.method172(((Class276) this).anInt2918, 0.7F, ((Class276) this).anInt2923, ((Class276) this).anInt2923, false, (byte) 2));
	...
	boolean method2579(int i, int i_29_, int i_30_, int i_31_) {
		...
		if (i_36_ > i_31_)
			i_36_ = ParticlePreference.method5639(i_31_, 2050702522);
		if (i_36_ > 512)
			i_36_ = 512;
	...
	void method2580(GraphicsToolkit class_ra, Class276 class276_37_) {
		...
		class_ra.ba(2, 0);
		class_ra.drawFilledBox(0, 0, ((Class276) this).anInt2923, ((Class276) this).anInt2923, ~0xffffff | ((Class276) this).anInt2935, 0);
		int i = 0;
		int i_38_ = 0;
		int i_39_ = 256;
		...
		if (((Class276) this).anInt2927 != 0) {
			int i_40_ = Class220.SINE[((Class276) this).anInt2927];
			int i_41_ = Class220.COSINE[((Class276) this).anInt2927];
			int i_42_ = i_38_ * i_41_ - i_39_ * i_40_ >> 14;
			i_39_ = i_38_ * i_40_ + i_39_ * i_41_ >> 14;
			i_38_ = i_42_;
		}
		if (((Class276) this).anInt2921 != 0) {
			int i_43_ = Class220.SINE[((Class276) this).anInt2921];
			int i_44_ = Class220.COSINE[((Class276) this).anInt2921];
			int i_45_ = i_39_ * i_43_ + i * i_44_ >> 14;
			i_39_ = i_39_ * i_44_ - i * i_43_ >> 14;
			i = i_45_;
		}
		ModelPart modelPart = aModelPart_2936.method4755((byte) 0, 51200, true);
		modelPart.W((short) 0, (short) ((Class276) this).anInt2918);
		class_ra.IA(1.0F);
		class_ra.m(16777215, 1.0F, 1.0F, (float) i, (float) i_38_, (float) i_39_);
		int i_46_ = (1024 * ((Class276) this).anInt2923 / (modelPart.ya() - modelPart.RA()));
		...
		class_ra.method5043(new Matrix43f());
		Matrix43f class222 = new Matrix43f();
		class222.method2062(0.0F, 0.0F, (float) (50 - modelPart.AA()));
		modelPart.method4739(class222, null, 1);
		...
		class_ra.ba(2, 0);
		class_ra.drawFilledBox(0, 0, ((Class276) this).anInt2923, ((Class276) this).anInt2923, 0, 0);
	...
	void method2582(GraphicsToolkit class_ra, Class276 class276_60_) {
		...
		if (class64 != null) {
			...
			if (((Class276) this).anInt2927 != 0) {
				...
				int i_64_ = Class220.SINE[i_63_];
				int i_65_ = Class220.COSINE[i_63_];
			...
			if (((Class276) this).anInt2921 != 0) {
				...
				int i_68_ = Class220.SINE[i_67_];
				int i_69_ = Class220.COSINE[i_67_];
			...
			ModelPart modelPart = class_ra.method5037(class64, 2048, 0, 64, 768);
			int i_71_ = modelPart.ya() - modelPart.RA();
			int i_72_ = modelPart.o() - modelPart.YA();
			...
			Matrix43f class222_76_ = class_ra.method5178();
			class222_76_.method2062(0.0F, 0.0F, (float) (50 - modelPart.AA()));
			modelPart.method4739(class222_76_, null, 1);
			((Class276) this).aClass57_2925 = class_ra.method5033(0, 0, ((Class276) this).anInt2923, ((Class276) this).anInt2923, true);
			((Class276) this).aClass57_2925.method632(0, 0, 3);
			class_ra.method5182(class233);
			class_ra.r(anIntArray2938[0], anIntArray2938[1], anIntArray2938[2], anIntArray2938[3]);
