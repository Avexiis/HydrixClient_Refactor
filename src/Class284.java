...
public class Class284 {
	...
	public final synchronized void method2679(Class298_Sub19 class298_sub19, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("lu.b(").append(')').toString());
		}
	}
		...
		try {
			if (!((Class284) this).aBoolean3053) {
				...
				try {
					...
					for (/**/; (l > (6353619706144323107L * ((Class284) this).aLong3051 + 5000L)); l = TimeUtils.getTime((byte) 1)) {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("lu.p(").append(')').toString());
		}
	}
	...
	final void method2681(int i, int i_2_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("lu.d(").append(')').toString());
		}
	}
	...
	final void method2682(int[] is, int i) {
		...
		((Class284) this).aLong3051 = TimeUtils.getTime((byte) 1) * -2662467539374708341L;
	}
	...
	void method2683(Component component, byte i) throws Exception {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("lu.q(").append(')').toString());
		}
	}
	...
	void method2684(int i, int i_17_) throws Exception {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("lu.n(").append(')').toString());
		}
	}
	...
	void method2685() throws Exception {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("lu.z(").append(')').toString());
		}
	}
	...
	void method2686(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("lu.y(").append(')').toString());
		}
	}
	...
	void method2687(short i) throws Exception {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("lu.t(").append(')').toString());
		}
	}
	...
	int method2688(int i) throws Exception {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("lu.s(").append(')').toString());
		}
	}
	...
	public final synchronized void method2689(int i) {
		try {
			...
			try {
				...
				method2686(331463442);
				((Class284) this).aLong3060 = ((TimeUtils.getTime((byte) 1) + 2000L) * -3392636722701155847L);
			}
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("lu.i(").append(')').toString());
		}
	}
	...
	public final synchronized void method2690(byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("lu.k(").append(')').toString());
		}
	}
	...
	final void method2691(Class298_Sub19 class298_sub19, int i, byte i_19_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("lu.r(").append(')').toString());
		}
	}
	...
	static final void method2693(ClientScript2 class403, int i) {
		try {
			...
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = class105.width * -2093041337;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("lu.oc(").append(')').toString());
		}
	}
	...
	static final void method2694(IComponentDefinition class105, ClientScript2 class403, int i) {
		try {
			...
			NPCType class503 = Class15.aClass507_224.method6269(class105.anInt1151 * 572201537, 2035169508);
			...
			LocalizedString.markComponentForRedraw(class105, -579030149);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("lu.qi(").append(')').toString());
		}
	}
	...
	static final void method2696(IComponentDefinition class105, RSInterface RSInterface, ClientScript2 class403, short i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("lu.gp(").append(')').toString());
		}
	}
	...
	static final void method2697(ClientScript2 class403, int i) {
		try {
			...
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = LocType.method5788((char) i_27_, (short) 160) ? 1 : 0;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("lu.zq(").append(')').toString());
		}
	}
}
