...
public class Class284_Sub1 extends Class284 {
	...
	void method2683(Component component, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aas.q(").append(')').toString());
		}
	}
	...
	int method2688(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aas.s(").append(')').toString());
		}
	}
	...
	void method2686(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aas.y(").append(')').toString());
		}
	}
	...
	void method2687(short i) throws LineUnavailableException {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aas.t(").append(')').toString());
		}
	}
	...
	void method2684(int i, int i_5_) throws LineUnavailableException {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aas.n(").append(')').toString());
		}
	}
	...
	static final void method2708(ClientScript2 class403, int i) {
		try {
			...
			Class288.method2728(class105, RSInterface, class403, -1432183738);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aas.eb(").append(')').toString());
		}
	}
}
