...
public final class Class285 {
	...
	public static String method2709(int i, int i_0_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("lv.f(").append(')').toString());
		}
	}
	...
	public static void method2710(int i, byte i_1_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("lv.b(").append(')').toString());
		}
	}
	...
	static final void method2711(ClientScript2 class403, byte i) {
		try {
			...
			Language.method5758(class105, class403, 378164107);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("lv.cx(").append(')').toString());
		}
	}
	...
	static final void method2712(int i, int i_2_, int i_3_, int i_4_, int i_5_, int i_6_, int i_7_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("lv.u(").append(')').toString());
		}
	}
		...
		try {
			if (!ContextMenu.menuOpen) {
				...
				if (!((Class298_Sub37_Sub15) class298_sub37_sub15).aBoolean9668) {
					...
					for (class298_sub37_sub5 = ((Class298_Sub37_Sub5) ContextMenu.aClass437_5470.get(l)); class298_sub37_sub5 != null; class298_sub37_sub5 = ((Class298_Sub37_Sub5) ContextMenu.aClass437_5470.method5813(-1565779381))) {
					...
					for (Class298_Sub37_Sub5 class298_sub37_sub5 = ((Class298_Sub37_Sub5) ContextMenu.aClass461_5482.method5984(-1184499761)); class298_sub37_sub5 != null; class298_sub37_sub5 = ((Class298_Sub37_Sub5) ContextMenu.aClass461_5482.method5985(79001809))) {
						if (((Class298_Sub37_Sub5) class298_sub37_sub5).aString9585.equals(((Class298_Sub37_Sub15) class298_sub37_sub15).aString9657)) {
							boolean bool = false;
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("lv.m(").append(')').toString());
		}
	}
}
