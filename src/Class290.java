...
public class Class290 {
	...
	static final void method2747(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("mb.rw(").append(')').toString());
		}
	}
	...
	static final void method2748(ClientScript2 class403, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("mb.adb(").append(')').toString());
		}
	}
	...
	public static final int method2749(int i, int i_2_, int i_3_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("mb.q(").append(')').toString());
		}
	}
	...
	public static void method2750(int i, int i_4_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("mb.d(").append(')').toString());
		}
	}
}
