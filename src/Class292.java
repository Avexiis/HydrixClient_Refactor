...
public class Class292 {
	...
	static final void method2812(ClientScript2 class403, int i) {
		try {
			...
			Class522.method6326(class105, RSInterface, class403, -1946261030);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("md.hk(").append(')').toString());
		}
	}
	...
	static final void method2813(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("md.aax(").append(')').toString());
		}
	}
	...
	static final void method2814(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("md.apt(").append(')').toString());
		}
	}
	...
	static void method2816(IComponentDefinition class105, int i, int i_6_, byte i_7_) {
		try {
			if (class105.aByte1146 == 0)
				...
				class105.anInt1143 = (-1014229119 * (class105.anInt1286 * 1499181983 + (i - -2093041337 * class105.width) / 2));
			else if (2 == class105.aByte1146)
				class105.anInt1143 = -1014229119 * (i - class105.width * -2093041337 - 1499181983 * class105.anInt1286);
			else if (class105.aByte1146 == 3)
				class105.anInt1143 = (i * (1499181983 * class105.anInt1286) >> 14) * -1014229119;
			else if (4 == class105.aByte1146)
				class105.anInt1143 = -1014229119 * ((i - -2093041337 * class105.width) / 2 + (i * (1499181983 * class105.anInt1286) >> 14));
			else
				class105.anInt1143 = (i - -2093041337 * class105.width - (1499181983 * class105.anInt1286 * i >> 14)) * -1014229119;
			if (class105.aByte1147 == 0)
				class105.anInt1155 = 705123139 * class105.anInt1159;
			else if (class105.aByte1147 == 1)
				class105.anInt1155 = ((class105.anInt1159 * -901738979 + (i_6_ - 457937409 * class105.height) / 2) * 1145252063);
			else if (class105.aByte1147 == 2)
				class105.anInt1155 = (i_6_ - 457937409 * class105.height - -901738979 * class105.anInt1159) * 1145252063;
				...
				class105.anInt1155 = (((-901738979 * class105.anInt1159 * i_6_ >> 14) + (i_6_ - 457937409 * class105.height) / 2) * 1145252063);
			else
				class105.anInt1155 = 1145252063 * (i_6_ - class105.height * 457937409 - (class105.anInt1159 * -901738979 * i_6_ >> 14));
			if (GameClient.aBoolean8846 && (GameClient.method2801(class105).anInt7416 * -1266165749 != 0 || 0 == class105.type * -1215239439)) {
				if (class105.anInt1143 * 1354508417 < 0)
					class105.anInt1143 = 0;
				else if ((class105.anInt1143 * 1354508417 + -2093041337 * class105.width) > i)
					class105.anInt1143 = -1014229119 * (i - -2093041337 * class105.width);
				if (class105.anInt1155 * -749038817 < 0)
					class105.anInt1155 = 0;
				else if ((class105.anInt1155 * -749038817 + 457937409 * class105.height) > i_6_)
					class105.anInt1155 = 1145252063 * (i_6_ - 457937409 * class105.height);
			}
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("md.li(").append(')').toString());
		}
	}
	...
	public static void method2817(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("md.u(").append(')').toString());
		}
	}
}
