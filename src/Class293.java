...
public class Class293 {
	...
	static final void method2818(ClientScript2 class403, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("me.aa(").append(')').toString());
		}
	}
	...
	static final void method2819(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("me.tw(").append(')').toString());
		}
	}
	...
	static final void method2820(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("me.wc(").append(')').toString());
		}
	}
	...
	static final void method2821(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("me.xu(").append(')').toString());
		}
	}
	...
	static void method2823(int i, boolean bool, byte i_3_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("me.u(").append(')').toString());
		}
	}
