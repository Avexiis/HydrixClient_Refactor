...
public class Class295 {
	...
	public void method2827(int i, int i_0_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("mg.movemouse(").append(')').toString());
		}
	}
	...
	public void method2828(Component component, int[] is, int i, int i_1_, Point point) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("mg.setcustomcursor(").append(')').toString());
		}
	}
}
