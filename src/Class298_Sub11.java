...
public class Class298_Sub11 extends Node {
	...
	void method2902(byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aaq.a(").append(')').toString());
		}
	}
	...
	static final void method2903(ClientScript2 class403, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aaq.so(").append(')').toString());
		}
	}
}
