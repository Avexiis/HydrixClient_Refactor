...
public class Class298_Sub13 extends Node {
	...
	Class298_Sub13(Packet class298_sub53) {
		class298_sub53.pos = (class298_sub53.payload.length - 3) * 116413311;
		...
		i_1_ += i_7_ + i_9_;
		int i_13_ = class298_sub53.pos * 385051775;
		int i_14_ = i + i_2_ + i_3_ + i_4_ + i_5_ + i_6_ + i_7_ + i_8_ + i_9_;
		for (int i_15_ = 0; i_15_ < i_14_; i_15_++)
			class298_sub53.method3609(1692297361);
		i_1_ += class298_sub53.pos * 385051775 - i_13_;
		int i_16_ = class298_sub53.pos * 385051775;
		int i_17_ = 0;
		int i_18_ = 0;
		int i_19_ = 0;
		int i_20_ = 0;
		...
		int i_31_ = 0;
		int i_32_ = class298_sub53.pos * 385051775;
		class298_sub53.pos += i_27_ * 116413311;
		int i_33_ = class298_sub53.pos * 385051775;
		class298_sub53.pos += i_8_ * 116413311;
		int i_34_ = class298_sub53.pos * 385051775;
		class298_sub53.pos += i_7_ * 116413311;
		int i_35_ = class298_sub53.pos * 385051775;
		class298_sub53.pos += i_6_ * 116413311;
		int i_36_ = class298_sub53.pos * 385051775;
		class298_sub53.pos += i_17_ * 116413311;
		int i_37_ = class298_sub53.pos * 385051775;
		class298_sub53.pos += i_19_ * 116413311;
		int i_38_ = class298_sub53.pos * 385051775;
		class298_sub53.pos += i_21_ * 116413311;
		int i_39_ = class298_sub53.pos * 385051775;
		class298_sub53.pos += (i_4_ + i_5_ + i_8_) * 116413311;
		int i_40_ = class298_sub53.pos * 385051775;
		class298_sub53.pos += i_4_ * 116413311;
		int i_41_ = class298_sub53.pos * 385051775;
		class298_sub53.pos += i_28_ * 116413311;
		int i_42_ = class298_sub53.pos * 385051775;
		class298_sub53.pos += i_5_ * 116413311;
		int i_43_ = class298_sub53.pos * 385051775;
		class298_sub53.pos += i_18_ * 116413311;
		int i_44_ = class298_sub53.pos * 385051775;
		class298_sub53.pos += i_20_ * 116413311;
		int i_45_ = class298_sub53.pos * 385051775;
		class298_sub53.pos += i_22_ * 116413311;
		int i_46_ = class298_sub53.pos * 385051775;
		class298_sub53.pos += i_9_ * 116413311;
		int i_47_ = class298_sub53.pos * 385051775;
		class298_sub53.pos += i_6_ * 116413311;
		int i_48_ = class298_sub53.pos * 385051775;
		class298_sub53.pos += i_23_ * 116413311;
		int i_49_ = class298_sub53.pos * 385051775;
		class298_sub53.pos += i_24_ * 116413311;
		int i_50_ = class298_sub53.pos * 385051775;
		class298_sub53.pos += i_25_ * 116413311;
		int i_51_ = class298_sub53.pos * 385051775;
		class298_sub53.pos += i_26_ * 116413311;
		int i_52_ = class298_sub53.pos * 385051775;
		class298_sub53.pos += i_2_ * 349239933;
		((Class298_Sub13) this).aByteArray7258 = new byte[i_1_];
		Packet class298_sub53_53_ = new Packet(((Class298_Sub13) this).aByteArray7258);
		...
		class298_sub53.pos = i_13_ * 116413311;
		int i_54_ = 0;
		int i_55_ = 0;
		int i_56_ = 0;
		int i_57_ = 0;
		...
		for (int i_61_ = 0; i_61_ < i; i_61_++) {
			...
			class298_sub53_53_.pos += 465653244;
			int i_62_ = class298_sub53_53_.pos * 385051775;
			int i_63_ = -1;
			while_6_: do {
				for (;;) {
					int i_64_ = class298_sub53.method3609(1692297361);
					class298_sub53_53_.method3639(i_64_, -1081187550);
					int i_65_ = class298_sub53.payload[i_31_++] & 0xff;
					...
					if (i_65_ == 23) {
						...
						class298_sub53_53_.writeByte((class298_sub53.payload[i_52_++]));
						class298_sub53_53_.writeByte((class298_sub53.payload[i_52_++]));
						class298_sub53_53_.writeByte((class298_sub53.payload[i_52_++]));
					} else {
						i_54_ ^= i_65_ >> 4;
						if (i_63_ == 0) {
							...
							i_55_ += class298_sub53.payload[i_39_++];
							i_56_ += class298_sub53.payload[i_40_++];
							...
							i_55_ += class298_sub53.payload[i_39_++];
							i_57_ += class298_sub53.payload[i_42_++];
							class298_sub53_53_.writeByte(i_55_ & 0x7f);
							class298_sub53_53_.writeByte(i_57_ & 0x7f);
						} else if (i_63_ == 2) {
							if (bool)
								class298_sub53_53_.writeByte(176 + i_54_);
							i_29_ = i_29_ + (class298_sub53.payload[i_16_++]) & 0x7f;
							class298_sub53_53_.writeByte(i_29_);
							int i_66_;
							if (i_29_ == 0 || i_29_ == 32)
								i_66_ = class298_sub53.payload[i_46_++];
							else if (i_29_ == 1)
								i_66_ = class298_sub53.payload[i_36_++];
							else if (i_29_ == 33)
								i_66_ = class298_sub53.payload[i_43_++];
							else if (i_29_ == 7)
								i_66_ = class298_sub53.payload[i_37_++];
							else if (i_29_ == 39)
								i_66_ = class298_sub53.payload[i_44_++];
							else if (i_29_ == 10)
								i_66_ = class298_sub53.payload[i_38_++];
							else if (i_29_ == 42)
								i_66_ = class298_sub53.payload[i_45_++];
							else if (i_29_ == 99)
								i_66_ = class298_sub53.payload[i_48_++];
							else if (i_29_ == 98)
								i_66_ = class298_sub53.payload[i_49_++];
							else if (i_29_ == 101)
								i_66_ = class298_sub53.payload[i_50_++];
							else if (i_29_ == 100)
								i_66_ = class298_sub53.payload[i_51_++];
							else if (i_29_ == 64 || i_29_ == 65 || i_29_ == 120 || i_29_ == 121 || i_29_ == 123)
								i_66_ = class298_sub53.payload[i_32_++];
							else
								i_66_ = class298_sub53.payload[i_41_++];
							i_66_ += is[i_29_];
							is[i_29_] = i_66_;
							...
							class298_sub53_53_.writeByte((class298_sub53.payload[i_46_++]));
						}
					}
				}
				throw new RuntimeException();
			} while (false);
			class298_sub53_53_.method3599((class298_sub53_53_.pos * 385051775) - i_62_, 1397495562);
		}
	}
	...
	static Class298_Sub13 method2905(Js5 class243, int i, int i_83_) {
		...
		if (is == null)
			return null;
		return new Class298_Sub13(new Packet(is));
	}
