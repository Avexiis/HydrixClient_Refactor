...
public class Class298_Sub14 extends Node {
	...
	static final void method2907(IComponentDefinition class105, RSInterface RSInterface, ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aaw.ol(").append(')').toString());
		}
	}
	...
	static void method2908(ClientScript2 class403, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aaw.apb(").append(')').toString());
		}
	}
}
