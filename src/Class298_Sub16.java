...
public class Class298_Sub16 extends Node {
	...
	void method2913(int i, int i_2_, int i_3_, float f) {
		if (((Class298_Sub16) this).anInt7284 != -1) {
			MaterialRaw materialRaw = ((Class298_Sub16) this).aClass_ra_Sub3_7288.anInterface_ma5299.method174(((Class298_Sub16) this).anInt7284, 833044999);
			int i_4_ = materialRaw.aByte533 & 0xff;
			if (i_4_ != 0 && materialRaw.aByte529 != 4) {
				int i_5_;
				if (i_3_ < 0)
					i_5_ = 0;
				else if (i_3_ > 127)
			...
			int i_8_ = materialRaw.aByte534 & 0xff;
			if (i_8_ != 0) {
				i_8_ += 256;
	...
	Class298_Sub16(Class_xa_Sub1 class_xa_sub1, int i, int i_23_, Class78 class78) {
		...
		byte i_24_ = 10;
		if (i >= 0) {
			MaterialRaw materialRaw = ((Class298_Sub16) this).aClass_ra_Sub3_7288.anInterface_ma5299.method174(i, 1520533155);
			if (materialRaw.aByte529 > 0)
				i_24_ = materialRaw.aByte529;
		}
