...
public class Class298_Sub17_Sub1 extends Class298_Sub17 {
	...
	void method2918(Class298_Sub25 class298_sub25, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("agh.f(").append(')').toString());
		}
	}
	...
	void method2917(Packet class298_sub53, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("agh.a(").append(')').toString());
		}
	}
