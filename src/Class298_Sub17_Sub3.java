...
public class Class298_Sub17_Sub3 extends Class298_Sub17 {
	...
	void method2917(Packet class298_sub53, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("agk.a(").append(')').toString());
		}
	}
	...
	void method2918(Class298_Sub25 class298_sub25, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("agk.f(").append(')').toString());
		}
	}
	...
	static final void method2924(ClientScript2 class403, short i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("agk.by(").append(')').toString());
		}
	}
}
