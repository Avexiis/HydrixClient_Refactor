...
public class Class298_Sub19_Sub3 extends Class298_Sub19 {
	...
	LinkedNodeList aLinkedNodeList_9259 = new LinkedNodeList();
	int anInt9260 = 0;
	int anInt9261;
	int anInt9262;
	...
	public void method3030(int i, byte i_5_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aii.av(").append(')').toString());
		}
	}
	...
	synchronized void method2934(int[] is, int i, int i_6_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aii.k(").append(')').toString());
		}
	}
	...
	synchronized void method2935(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aii.d(").append(')').toString());
		}
	}
	...
	synchronized int method3031(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aii.at(").append(')').toString());
		}
	}
	...
	Class298_Sub30 method3032(int i, double d) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aii.al(").append(')').toString());
		}
	}

	synchronized Class298_Sub30 method3033(int i) {
		try {
			return (Class298_Sub30) ((Class298_Sub19_Sub3) this).aLinkedNodeList_9259.method5939(1766612795);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aii.ah(").append(')').toString());
		}
	}
	...
	synchronized void method3034(Class298_Sub30 class298_sub30, int i) {
		try {
			for (/**/; ((Class298_Sub19_Sub3) this).anInt9260 * 528037965 >= 100; ((Class298_Sub19_Sub3) this).anInt9260 -= -1862483835)
				((Class298_Sub19_Sub3) this).aLinkedNodeList_9259.method5936(2084948407);
			((Class298_Sub19_Sub3) this).aLinkedNodeList_9259.addlast(class298_sub30, -332995145);
			((Class298_Sub19_Sub3) this).anInt9260 += -1862483835;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aii.az(").append(')').toString());
		}
	}
	...
	synchronized void method3035(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aii.ap(").append(')').toString());
		}
	}
	...
	synchronized void method3036(boolean bool, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aii.af(").append(')').toString());
		}
	}
	...
	int method2929() {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aii.p(").append(')').toString());
		}
	}
	...
	Class298_Sub19 method2931() {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aii.b(").append(')').toString());
		}
	}
	...
	Class298_Sub19 method2930() {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aii.f(").append(')').toString());
		}
	}

	static final void method3037(int i) {
		try {
			for (int i_11_ = 0; i_11_ < -1230451913 * GameClient.npcCount; i_11_++) {
				int i_12_ = GameClient.npcIndicies[i_11_];
				LinkableObject linkableObject = ((LinkableObject) GameClient.npcs.get((long) i_12_));
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aii.hj(").append(')').toString());
		}
	}
	...
	synchronized double method3038(int i) {
		try {
			if (528037965 * ((Class298_Sub19_Sub3) this).anInt9260 < 1)
				return -1.0;
			Class298_Sub30 class298_sub30 = (Class298_Sub30) ((Class298_Sub19_Sub3) this).aLinkedNodeList_9259.method5939(1766612795);
			if (null == class298_sub30)
				return -1.0;
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aii.as(").append(')').toString());
		}
	}
	...
	public static int method3039(Random random, int i, byte i_13_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aii.q(").append(')').toString());
		}
	}
	...
	synchronized void method3040(byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aii.ai(").append(')').toString());
		}
	}
	...
	public static void method3041(Canvas canvas, short i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aii.ad(").append(')').toString());
		}
	}
	...
	static final void method3042(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aii.bk(").append(')').toString());
		}
	}
