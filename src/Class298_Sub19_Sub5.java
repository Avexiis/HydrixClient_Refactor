...
public class Class298_Sub19_Sub5 extends Class298_Sub19 {
	...
	void method3050(Class298_Sub11 class298_sub11, int[] is, int i, int i_0_, int i_1_, int i_2_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ait.av(").append(')').toString());
		}
	}
	...
	Class298_Sub19 method2930() {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ait.f(").append(')').toString());
		}
	}
	...
	Class298_Sub19 method2931() {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ait.b(").append(')').toString());
		}
	}
	...
	int method2929() {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ait.p(").append(')').toString());
		}
	}
	...
	void method3051(Class298_Sub11 class298_sub11, int i, int i_7_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ait.at(").append(')').toString());
		}
	}
	...
	void method2934(int[] is, int i, int i_10_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ait.k(").append(')').toString());
		}
	}
	...
	void method2935(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ait.d(").append(')').toString());
		}
	}
