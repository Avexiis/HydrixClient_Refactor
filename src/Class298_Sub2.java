...
public class Class298_Sub2 extends Node {
	static SeqTypeList aClass395_7165;
	public LinkedNodeList aLinkedNodeList_7166 = new LinkedNodeList();
	...
	static final void method2847(int i, int i_0_, int i_1_, int i_2_, byte i_3_) {
		try {
			if (i - i_1_ >= Class372_Sub1.anInt4051 * -1424479739 && i_1_ + i <= Class372_Sub1.anInt4048 * 1135094847 && i_0_ - i_1_ >= Class372_Sub1.anInt4049 * 1155384281 && i_0_ + i_1_ <= Class372_Sub1.anInt4050 * -1062447355)
				ObjectTypeList.method5797(i, i_0_, i_1_, i_2_, -586727793);
			else
				Class308.method3782(i, i_0_, i_1_, i_2_, 179222192);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aad.x(").append(')').toString());
		}
	}
	...
	static final void method2848(ClientScript2 class403, int i) {
		try {
			...
			Class194.method1870(class105, RSInterface, class403, (byte) -5);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aad.jo(").append(')').toString());
		}
	}
	...
	static final void method2849(ClientScript2 class403, int i) {
		try {
			...
			Class249.method2393(class105, RSInterface, class403, 131231409);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aad.ij(").append(')').toString());
		}
	}
	...
	static final void method2850(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aad.ze(").append(')').toString());
		}
	}
}
