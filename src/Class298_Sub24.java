...
public abstract class Class298_Sub24 extends Node {
	...
	void method3073(OggPacket oggpacket, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("abi.a(").append(')').toString());
		}
	}
	...
	public static void method3080(Js5 class243, Js5 class243_0_, Js5 class243_1_, Js5 class243_2_, int i) {
		try {
			...
			SpotAnimTypeList.aRSInterfaceArray4165 = new RSInterface[Class270.aClass243_2894.method2296(1202427542)];
