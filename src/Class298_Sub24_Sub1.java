...
public class Class298_Sub24_Sub1 extends Class298_Sub24 {
	...
	void method3074(OggPacket oggpacket, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aiy.f(").append(')').toString());
		}
	}
	...
	void method3075(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aiy.b(").append(')').toString());
		}
	}
	...
	double method3081(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aiy.s(").append(')').toString());
		}
	}
	...
	public Class298_Sub19_Sub3 method3082(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aiy.n(").append(')').toString());
		}
	}
	...
	int method3083(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aiy.z(").append(')').toString());
		}
	}
}
