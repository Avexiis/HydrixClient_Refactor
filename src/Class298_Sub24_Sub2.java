...
public class Class298_Sub24_Sub2 extends Class298_Sub24 {
	...
	void method3075(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ajd.b(").append(')').toString());
		}
	}
	...
	void method3074(OggPacket oggpacket, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ajd.f(").append(')').toString());
		}
	}
