...
public class Class298_Sub24_Sub3 extends Class298_Sub24 {
	...
	float method3084(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ajq.n(").append(')').toString());
		}
	}
	...
	double method3085(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ajq.s(").append(')').toString());
		}
	}
	...
	long method3086(byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ajq.z(").append(')').toString());
		}
	}
	...
	boolean method3087(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ajq.y(").append(')').toString());
		}
	}
	...
	void method3075(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ajq.b(").append(')').toString());
		}
	}
	...
	public Object method3088(Interface15 interface15, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ajq.c(").append(')').toString());
		}
	}
	...
	void method3077(OggPacket oggpacket) {
		if (!((Class298_Sub24_Sub3) this).aBoolean9293) {
			...
			((Class298_Sub24_Sub3) this).aLong9292 = TimeUtils.getTime((byte) 1) * 4704549656485466045L;
	...
	void method3074(OggPacket oggpacket, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ajq.f(").append(')').toString());
		}
	}
	...
	void method3089(int i, byte i_2_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ajq.q(").append(')').toString());
		}
	}
	...
	public static boolean method3090(int i, int i_3_) {
		try {
			...
			if (Class118.aClass88_1402 == Class88.aClass88_808) {
				...
				WorldMapLabelList.method4125(class298_sub53, -2093041337);
				int i_4_ = class298_sub53.readUnsignedByte();
				for (int i_5_ = 0; i_5_ < i_4_; i_5_++)
					Class87.aLinkedNodeList_799.addlast(new Class298_Sub7(class298_sub53), -51345743);
				int i_6_ = class298_sub53.readUnsignedSmart();
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ajq.a(").append(')').toString());
		}
	}
}
