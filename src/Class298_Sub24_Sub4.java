...
public class Class298_Sub24_Sub4 extends Class298_Sub24 {
	...
	void method3074(OggPacket oggpacket, int i) {
		try {
			if (((Class298_Sub24_Sub4) this).anInt7352 * -1312498565 <= 0 || "SUB".equals(((Class298_Sub24_Sub4) this).aString9305)) {
				Packet class298_sub53 = new Packet(oggpacket.getData());
				...
				if (-1312498565 * ((Class298_Sub24_Sub4) this).anInt7352 <= 8) {
					...
					if (0 == i_0_) {
						...
						if (i_4_ < 0 || i_4_ > (class298_sub53.payload.length - 385051775 * class298_sub53.pos))
							throw new IllegalStateException();
						((Class298_Sub24_Sub4) this).aString9300 = Class214.method1995((class298_sub53.payload), (class298_sub53.pos * 385051775), i_4_, -730069426);
					}
					if ((i_0_ | 0x80) != 0)
						return;
				}
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ajv.f(").append(')').toString());
		}
	}
	...
	String method3091(byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ajv.q(").append(')').toString());
		}
	}
	...
	public float method3092(byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ajv.n(").append(')').toString());
		}
	}
	...
	public float method3093(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ajv.s(").append(')').toString());
		}
	}
	...
	public String method3094(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ajv.z(").append(')').toString());
		}
	}
		...
		if (((Class298_Sub24_Sub4) this).anInt7352 * -1312498565 <= 0 || "SUB".equals(((Class298_Sub24_Sub4) this).aString9305)) {
			...
			if (-1312498565 * ((Class298_Sub24_Sub4) this).anInt7352 <= 8) {
				...
				if (0 == i) {
					...
					if (i_8_ < 0 || i_8_ > (class298_sub53.payload.length - 385051775 * class298_sub53.pos))
						throw new IllegalStateException();
					((Class298_Sub24_Sub4) this).aString9300 = Class214.method1995(class298_sub53.payload, (class298_sub53.pos * 385051775), i_8_, -932621904);
				}
				if ((i | 0x80) != 0)
					return;
			}
		...
		if (((Class298_Sub24_Sub4) this).anInt7352 * -1312498565 <= 0 || "SUB".equals(((Class298_Sub24_Sub4) this).aString9305)) {
			...
			if (-1312498565 * ((Class298_Sub24_Sub4) this).anInt7352 <= 8) {
				...
				if (0 == i) {
					...
					if (i_12_ < 0 || i_12_ > (class298_sub53.payload.length - 385051775 * class298_sub53.pos))
						throw new IllegalStateException();
					((Class298_Sub24_Sub4) this).aString9300 = Class214.method1995(class298_sub53.payload, (class298_sub53.pos * 385051775), i_12_, -854138275);
				}
				if ((i | 0x80) != 0)
					return;
			}
		...
		if (((Class298_Sub24_Sub4) this).anInt7352 * -1312498565 <= 0 || "SUB".equals(((Class298_Sub24_Sub4) this).aString9305)) {
			...
			if (-1312498565 * ((Class298_Sub24_Sub4) this).anInt7352 <= 8) {
				...
				if (0 == i) {
					...
					if (i_16_ < 0 || i_16_ > (class298_sub53.payload.length - 385051775 * class298_sub53.pos))
						throw new IllegalStateException();
					((Class298_Sub24_Sub4) this).aString9300 = Class214.method1995(class298_sub53.payload, (class298_sub53.pos * 385051775), i_16_, 1348372434);
				}
				if ((i | 0x80) != 0)
					return;
			}
	...
	void method3075(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ajv.b(").append(')').toString());
		}
	}
