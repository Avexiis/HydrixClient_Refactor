...
public class Class298_Sub25 extends Node {
	...
	public Class298_Sub25(Packet class298_sub53) {
	...
	public int[] method3095(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("abj.f(").append(')').toString());
		}
	}
	...
	void method3096(Class163 class163, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("abj.b(").append(')').toString());
		}
	}
	...
	public int method3097(String string, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("abj.i(").append(')').toString());
		}
	}

	void method3098(Packet class298_sub53, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("abj.k(").append(')').toString());
		}
	}
	...
	void method3099(int i, byte i_4_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("abj.a(").append(')').toString());
		}
	}
	...
	void method3100(int i, int i_5_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("abj.p(").append(')').toString());
		}
	}
	...
	static final void method3101(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("abj.si(").append(')').toString());
		}
	}

	static final void method3102(ClientScript2 class403, int i) {
		try {
			MapDetails mapDetails = WorldMap.method3705(((ClientScript2) class403).anIntArray5244[(((ClientScript2) class403).anInt5239 -= -391880689) * 681479919]);
			if (mapDetails == null || null == mapDetails.aString9641)
				((ClientScript2) class403).anObjectArray5240[((((ClientScript2) class403).anInt5241 += 969361751) * -203050393) - 1] = "";
			else
				((ClientScript2) class403).anObjectArray5240[((((ClientScript2) class403).anInt5241 += 969361751) * -203050393) - 1] = mapDetails.aString9641;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("abj.adf(").append(')').toString());
		}
	}
	...
	static final void method3103(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("abj.bs(").append(')').toString());
		}
	}
}
