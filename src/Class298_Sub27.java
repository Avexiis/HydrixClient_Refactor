...
public class Class298_Sub27 extends Node {
	...
	public static void method3105(short i) {
		try {
			...
			while (iterator.hasNext()) {
				...
				clickableGeometry.method4223();
			}
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("abl.p(").append(')').toString());
		}
	}
	...
	static final void method3106(ClientScript2 class403, short i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("abl.rj(").append(')').toString());
		}
	}
	...
	static void method3107(int i, int i_2_, int i_3_, int i_4_, int i_5_, int i_6_, int i_7_, byte i_8_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("abl.ad(").append(')').toString());
		}
	}
}
