...
public class Class298_Sub28 extends Node {
	...
	static final void method3108(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("abm.af(").append(')').toString());
		}
	}
	...
	public static final void method3109(byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("abm.i(").append(')').toString());
		}
	}
	...
	static String method3110(Throwable throwable, byte i) throws IOException {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("abm.b(").append(')').toString());
		}
	}
}
