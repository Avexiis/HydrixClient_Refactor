...
public class Class298_Sub30 extends Node {
	...
	long method3112(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("abo.a(").append(')').toString());
		}
	}
	...
	static void method3113(Class413 class413, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("abo.r(").append(')').toString());
		}
	}
}
