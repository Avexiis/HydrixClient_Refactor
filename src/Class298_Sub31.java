...
public class Class298_Sub31 extends Node {
	...
	static final void method3114(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("abp.amd(").append(')').toString());
		}
	}
	...
	static final String method3115(String string, String string_0_, String string_1_, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("abp.i(").append(')').toString());
		}
	}
}
