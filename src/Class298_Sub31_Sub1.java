...
public abstract class Class298_Sub31_Sub1 extends Class298_Sub31 {
	...
	public String toString() {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("afb.toString(").append(')').toString());
		}
	}
	...
	public Class100 method3118(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("afb.b(").append(')').toString());
		}
	}
	...
	public int method3120(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("afb.i(").append(')').toString());
		}
	}
	...
	String method3121(byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("afb.f(").append(')').toString());
		}
	}
	...
	public Class100 method3122(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("afb.p(").append(')').toString());
		}
	}
