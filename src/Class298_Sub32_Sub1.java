...
public class Class298_Sub32_Sub1 extends TextureOperation {
	...
	void method3137(int i, Packet class298_sub53, byte i_0_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("agb.r(").append(')').toString());
		}
	}
	...
	int[] method3131(int i, int i_25_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("agb.i(").append(')').toString());
		}
	}

	void method3141(int i, Packet class298_sub53) {
		if (i == 0)
			((Class298_Sub32_Sub1) this).anInt9319 = class298_sub53.readUnsignedShort() * 1334499193;
	}

	void method3142(int i, Packet class298_sub53) {
		if (i == 0)
			((Class298_Sub32_Sub1) this).anInt9319 = class298_sub53.readUnsignedShort() * 1334499193;
	}
}
