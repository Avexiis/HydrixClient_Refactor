...
public class Class298_Sub32_Sub10 extends TextureOperation {
	int anInt9390;
	int anInt9391;
	int anInt9392;

	void method3195(int i, Packet class298_sub53) {
		switch (i) {
		case 0:
			method3196(class298_sub53.g3(), -184590167);
		}
	}
	...
	int[][] method3132(int i, byte i_0_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("agx.k(").append(')').toString());
		}
	}

	void method3137(int i, Packet class298_sub53, byte i_5_) {
		try {
			switch (i) {
			case 0:
				method3196(class298_sub53.g3(), -1376773689);
			}
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("agx.r(").append(')').toString());
		}
	}
	...
	void method3196(int i, int i_6_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("agx.ac(").append(')').toString());
		}
	}

	void method3197(int i, Packet class298_sub53) {
		switch (i) {
		case 0:
			method3196(class298_sub53.g3(), 593056600);
		}
	}
	...
	public static void method3200(Class95 class95, int i, int i_15_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("agx.h(").append(')').toString());
		}
	}
}
