...
public class Class298_Sub32_Sub11 extends TextureOperation {
	...
	void method3201(int i, Packet class298_sub53) {
		if (0 == i)
	...
	int method3135(short i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("agy.q(").append(')').toString());
		}
	}
	...
	void method3128(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("agy.f(").append(')').toString());
		}
	}
	...
	boolean method3203(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("agy.ac(").append(')').toString());
		}
	}

	void method3137(int i, Packet class298_sub53, byte i_0_) {
		try {
			if (0 == i)
				((Class298_Sub32_Sub11) this).anInt9395 = class298_sub53.readUnsignedShort() * -715315885;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("agy.r(").append(')').toString());
		}
	}
	...
	int[][] method3132(int i, byte i_1_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("agy.k(").append(')').toString());
		}
	}

	void method3204(int i, Packet class298_sub53) {
		if (0 == i)
			((Class298_Sub32_Sub11) this).anInt9395 = class298_sub53.readUnsignedShort() * -715315885;
	}
	...
	static final void method3208(ClientScript2 class403, int i) {
		try {
			if (GameClient.aString8919 != null)
				((ClientScript2) class403).anObjectArray5240[((((ClientScript2) class403).anInt5241 += 969361751) * -203050393) - 1] = GameClient.aString8919;
			else
				((ClientScript2) class403).anObjectArray5240[((((ClientScript2) class403).anInt5241 += 969361751) * -203050393) - 1] = "";
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("agy.wj(").append(')').toString());
		}
	}
}
