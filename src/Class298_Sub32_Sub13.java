...
public class Class298_Sub32_Sub13 extends TextureOperation {
	int[] method3131(int i, int i_0_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ahb.i(").append(')').toString());
		}
	}
	...
	int method3212(int i, int i_5_, byte i_6_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ahb.ac(").append(')').toString());
		}
	}
