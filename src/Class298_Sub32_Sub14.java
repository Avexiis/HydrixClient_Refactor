...
public class Class298_Sub32_Sub14 extends TextureOperation {
	...
	void method3137(int i, Packet class298_sub53, byte i_0_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ahc.r(").append(')').toString());
		}
	}

	void method3214(int i, Packet class298_sub53) {
		if (0 == i)
			aBoolean7382 = class298_sub53.readUnsignedByte() == 1;
	}
	...
	int[][] method3132(int i, byte i_1_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ahc.k(").append(')').toString());
		}
	}
	...
	int[] method3131(int i, int i_14_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ahc.i(").append(')').toString());
		}
	}

	void method3217(int i, Packet class298_sub53) {
		if (0 == i)
			aBoolean7382 = class298_sub53.readUnsignedByte() == 1;
	}
