...
public class Class298_Sub32_Sub15 extends TextureOperation {
	...
	int[] method3131(int i, int i_0_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ahd.i(").append(')').toString());
		}
	}
	...
	int[][] method3132(int i, byte i_3_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ahd.k(").append(')').toString());
		}
	}
	...
	void method3133(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ahd.x(").append(')').toString());
		}
	}
	...
	void method3137(int i, Packet class298_sub53, byte i_12_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ahd.r(").append(')').toString());
		}
	}
	...
	void method3225(int i, Packet class298_sub53) {
		switch (i) {
		case 1:
			((Class298_Sub32_Sub15) this).anInt9405 = class298_sub53.readUnsignedShort() * 1566671509;
			break;
	...
	void method3226(int i, Packet class298_sub53) {
		switch (i) {
		case 1:
			((Class298_Sub32_Sub15) this).anInt9405 = class298_sub53.readUnsignedShort() * 1566671509;
			break;
