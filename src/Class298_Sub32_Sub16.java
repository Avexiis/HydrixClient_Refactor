...
public class Class298_Sub32_Sub16 extends TextureOperation {
	...
	void method3137(int i, Packet class298_sub53, byte i_13_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ahe.r(").append(')').toString());
		}
	}
	...
	int[][] method3132(int i, byte i_14_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ahe.k(").append(')').toString());
		}
	}
	...
	int[] method3131(int i, int i_34_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ahe.i(").append(')').toString());
		}
	}

	void method3231(int i, Packet class298_sub53) {
		switch (i) {
		case 1:
			((Class298_Sub32_Sub16) this).anInt9409 = class298_sub53.readUnsignedByte() * 853096051;
			break;
	...
	void method3232(int i, Packet class298_sub53) {
		switch (i) {
		case 1:
			((Class298_Sub32_Sub16) this).anInt9409 = class298_sub53.readUnsignedByte() * 853096051;
			break;
