...
public class Class298_Sub32_Sub17 extends TextureOperation {
	...
	int[] method3131(int i, int i_0_) {
		try {
			...
			if (aClass257_7384.aBoolean2810) {
				...
				for (int i_4_ = 0; i_4_ < Class250.anInt2755 * -1474554145; i_4_++) {
					...
					for (int i_8_ = i_2_ - 1; i_8_ <= i_3_; i_8_++) {
						...
						for (int i_10_ = i_6_ - 1; i_10_ <= i_7_; i_10_++) {
							...
							if (i_14_ < (-1479855355 * Class298_Sub32_Sub23.anInt9477)) {
								Class484.anInt6057 = HitType.anInt3865 * 335526737;
								HitType.anInt3865 = GameContext.anInt5325 * 1817789725;
								...
								Class484.anInt6057 = HitType.anInt3865 * 335526737;
								HitType.anInt3865 = 1817789725 * GameContext.anInt5325;
								GameContext.anInt5325 = -1560604925 * i_14_;
							} else if (i_14_ < -472479385 * HitType.anInt3865) {
								Class484.anInt6057 = HitType.anInt3865 * 335526737;
								HitType.anInt3865 = -1652063657 * i_14_;
					...
					case 2:
						...
						break;
					case 3:
						is[i_4_] = -472479385 * HitType.anInt3865;
						break;
					case 4:
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ahf.i(").append(')').toString());
		}
	}
	...
	void method3133(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ahf.x(").append(')').toString());
		}
	}
	...
	void method3236(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ahf.ac(").append(')').toString());
		}
	}
			...
			for (int i_19_ = 0; i_19_ < Class250.anInt2755 * -1474554145; i_19_++) {
				...
				for (int i_23_ = i_17_ - 1; i_23_ <= i_18_; i_23_++) {
					...
					for (int i_25_ = i_21_ - 1; i_25_ <= i_22_; i_25_++) {
						...
						} else if (i_29_ < -472479385 * HitType.anInt3865) {
							Class484.anInt6057 = HitType.anInt3865 * 335526737;
							HitType.anInt3865 = -1652063657 * i_29_;
				...
				case 2:
					...
					break;
				case 3:
					is[i_19_] = -472479385 * HitType.anInt3865;
					break;
				case 4:
			...
			for (int i_33_ = 0; i_33_ < Class250.anInt2755 * -1474554145; i_33_++) {
				...
				for (int i_37_ = i_31_ - 1; i_37_ <= i_32_; i_37_++) {
					...
					for (int i_39_ = i_35_ - 1; i_39_ <= i_36_; i_39_++) {
						...
						} else if (i_43_ < -472479385 * HitType.anInt3865) {
							Class484.anInt6057 = HitType.anInt3865 * 335526737;
							HitType.anInt3865 = -1652063657 * i_43_;
				...
				case 2:
					...
					break;
				case 3:
					is[i_33_] = -472479385 * HitType.anInt3865;
					break;
				case 4:
	...
	void method3137(int i, Packet class298_sub53, byte i_44_) {
		try {
			switch (i) {
			case 5:
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ahf.r(").append(')').toString());
		}
	}
	...
	void method3240(int i, Packet class298_sub53) {
		switch (i) {
		case 5:
			((Class298_Sub32_Sub17) this).anInt9428 = class298_sub53.readUnsignedByte() * -648032245;
			break;
	...
	void method3241(int i, Packet class298_sub53) {
		switch (i) {
		case 5:
			((Class298_Sub32_Sub17) this).anInt9428 = class298_sub53.readUnsignedByte() * -648032245;
			break;
