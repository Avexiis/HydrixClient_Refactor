...
public class Class298_Sub32_Sub18 extends TextureOperation {
	int anInt9434 = 0;
	...
	void method3243(int i, Packet class298_sub53) {
		switch (i) {
		case 3:
	...
	void method3137(int i, Packet class298_sub53, byte i_0_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ahg.r(").append(')').toString());
		}
	}
	...
	void method3133(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ahg.x(").append(')').toString());
		}
	}

	void method3244(int i, Packet class298_sub53) {
		switch (i) {
		case 3:
			((Class298_Sub32_Sub18) this).anInt9442 = class298_sub53.readUnsignedByte() * -190415455;
			break;
	...
	int[] method3131(int i, int i_8_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ahg.i(").append(')').toString());
		}
	}
