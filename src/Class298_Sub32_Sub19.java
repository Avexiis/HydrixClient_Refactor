...
public class Class298_Sub32_Sub19 extends TextureOperation {
	static boolean aBoolean9443 = false;
	static int anInt9444 = 32768;
	int anInt9445 = 1905754112;

	void method3250(int i, Packet class298_sub53) {
		switch (i) {
		case 1:
	...
	void method3137(int i, Packet class298_sub53, byte i_0_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ahh.r(").append(')').toString());
		}
	}
	...
	int[][] method3132(int i, byte i_1_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ahh.k(").append(')').toString());
		}
	}
	...
	void method3133(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ahh.x(").append(')').toString());
		}
	}
	...
	void method3252(int i, Packet class298_sub53) {
		switch (i) {
		case 1:
			aBoolean7382 = class298_sub53.readUnsignedByte() == 1;
			break;
	...
	int[] method3131(int i, int i_48_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ahh.i(").append(')').toString());
		}
	}
