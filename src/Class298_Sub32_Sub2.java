...
public class Class298_Sub32_Sub2 extends TextureOperation {
	...
	final void method3143(int[][] is, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("agd.ac(").append(')').toString());
		}
	}
	...
	int[] method3131(int i, int i_5_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("agd.i(").append(')').toString());
		}
	}
	...
	int[][] method3132(int i, byte i_6_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("agd.k(").append(')').toString());
		}
	}

	void method3137(int i, Packet class298_sub53, byte i_19_) {
		try {
			if (0 == i) {
				...
				for (int i_20_ = 0; (i_20_ < ((Class298_Sub32_Sub2) this).aClass98Array9321.length); i_20_++) {
					...
					case 1:
						...
						break;
					case 2:
						((Class298_Sub32_Sub2) this).aClass98Array9321[i_20_] = MagnetConfig.method783(class298_sub53, 505653408);
						break;
					}
				}
			} else if (i == 1)
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("agd.r(").append(')').toString());
		}
	}
	...
	void method3146(int i, Packet class298_sub53) {
		if (0 == i) {
			((Class298_Sub32_Sub2) this).aClass98Array9321 = new Class98[class298_sub53.readUnsignedByte()];
			for (int i_22_ = 0; i_22_ < ((Class298_Sub32_Sub2) this).aClass98Array9321.length; i_22_++) {
				...
				case 1:
					...
					break;
				case 2:
					((Class298_Sub32_Sub2) this).aClass98Array9321[i_22_] = MagnetConfig.method783(class298_sub53, 634970133);
					break;
				}
			}
		} else if (i == 1)
	...
	void method3147(int i, Packet class298_sub53) {
		if (0 == i) {
			((Class298_Sub32_Sub2) this).aClass98Array9321 = new Class98[class298_sub53.readUnsignedByte()];
			for (int i_24_ = 0; i_24_ < ((Class298_Sub32_Sub2) this).aClass98Array9321.length; i_24_++) {
				...
				case 1:
					...
					break;
				case 2:
					((Class298_Sub32_Sub2) this).aClass98Array9321[i_24_] = MagnetConfig.method783(class298_sub53, 892412290);
					break;
				}
			}
		} else if (i == 1)
	...
	static final void method3150(ClientScript2 class403, int i) {
		try {
			...
			RSInterface RSInterface = SpotAnimTypeList.aRSInterfaceArray4165[i_50_ >> 16];
			Class301_Sub1.method3712(class105, RSInterface, class403, (byte) 31);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("agd.de(").append(')').toString());
		}
	}
}
