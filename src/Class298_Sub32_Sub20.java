...
public class Class298_Sub32_Sub20 extends TextureOperation {
	...
	int[] method3131(int i, int i_7_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ahi.i(").append(')').toString());
		}
	}

	void method3137(int i, Packet class298_sub53, byte i_15_) {
		try {
			switch (i) {
			case 1:
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ahi.r(").append(')').toString());
		}
	}
	...
	void method3261(int i, Packet class298_sub53) {
		switch (i) {
		case 1:
			((Class298_Sub32_Sub20) this).anInt9451 = class298_sub53.readUnsignedByte() * 325240011;
			break;
	...
	void method3262(int i, Packet class298_sub53) {
		switch (i) {
		case 1:
			((Class298_Sub32_Sub20) this).anInt9451 = class298_sub53.readUnsignedByte() * 325240011;
			break;
	...
	public static void method3263(int i, boolean bool, int i_23_, boolean bool_24_, int i_25_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ahi.u(").append(')').toString());
		}
	}
}
