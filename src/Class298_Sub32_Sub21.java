...
public class Class298_Sub32_Sub21 extends TextureOperation {
	...
	void method3264(int i, int i_0_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ahj.am(").append(')').toString());
		}
	}
	...
	void method3133(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ahj.x(").append(')').toString());
		}
	}
	...
	void method3265(short i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ahj.ac(").append(')').toString());
		}
	}

	void method3137(int i, Packet class298_sub53, byte i_12_) {
		try {
			if (i == 0) {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ahj.r(").append(')').toString());
		}
	}
	...
	void method3268(int i, Packet class298_sub53) {
		if (i == 0) {
	...
	void method3269(int i, Packet class298_sub53) {
		if (i == 0) {
	...
	int[][] method3132(int i, byte i_31_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ahj.k(").append(')').toString());
		}
	}
	...
	static final void method3273(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ahj.yw(").append(')').toString());
		}
	}
}
