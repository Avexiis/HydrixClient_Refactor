...
public class Class298_Sub32_Sub22 extends TextureOperation {
	...
	int[][] method3132(int i, byte i_0_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ahk.k(").append(')').toString());
		}
	}
	...
	int[] method3131(int i, int i_12_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ahk.i(").append(')').toString());
		}
	}

	void method3274(int i, Packet class298_sub53) {
		switch (i) {
		case 0:
	...
	void method3278(int i, Packet class298_sub53) {
		switch (i) {
		case 0:
			((Class298_Sub32_Sub22) this).anInt9463 = class298_sub53.readUnsignedShort() * 380991419;
			break;
	...
	void method3137(int i, Packet class298_sub53, byte i_44_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ahk.r(").append(')').toString());
		}
	}
}
