...
public class Class298_Sub32_Sub23 extends TextureOperation {
	int anInt9469;
	...
	int[] method3131(int i, int i_2_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ahl.i(").append(')').toString());
		}
	}
	...
	void method3137(int i, Packet class298_sub53, byte i_16_) {
		try {
			switch (i) {
			case 0:
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ahl.r(").append(')').toString());
		}
	}
	...
	void method3280(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ahl.ac(").append(')').toString());
		}
	}
	...
	void method3133(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ahl.x(").append(')').toString());
		}
	}
	...
	void method3283(int i, Packet class298_sub53) {
		switch (i) {
		case 0:
			((Class298_Sub32_Sub23) this).anInt9472 = class298_sub53.readUnsignedShort() * -1530549365;
			break;
	...
	void method3287(int i, Packet class298_sub53) {
		switch (i) {
		case 0:
			((Class298_Sub32_Sub23) this).anInt9472 = class298_sub53.readUnsignedShort() * -1530549365;
			break;
