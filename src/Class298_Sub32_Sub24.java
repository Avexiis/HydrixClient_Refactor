...
public class Class298_Sub32_Sub24 extends TextureOperation {
	...
	int[] method3131(int i, int i_0_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ahm.i(").append(')').toString());
		}
	}
	...
	void method3137(int i, Packet class298_sub53, byte i_21_) {
		try {
			if (i == 0)
				aBoolean7382 = class298_sub53.readUnsignedByte() == 1;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ahm.r(").append(')').toString());
		}
	}
	...
	int[][] method3132(int i, byte i_32_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ahm.k(").append(')').toString());
		}
	}

	void method3291(int i, Packet class298_sub53) {
		if (i == 0)
			aBoolean7382 = class298_sub53.readUnsignedByte() == 1;
	}
	...
	void method3293(int i, Packet class298_sub53) {
		if (i == 0)
			aBoolean7382 = class298_sub53.readUnsignedByte() == 1;
	}
}
