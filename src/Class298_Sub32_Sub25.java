...
public class Class298_Sub32_Sub25 extends TextureOperation {
	...
	int[] method3131(int i, int i_0_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ahn.i(").append(')').toString());
		}
	}

	void method3137(int i, Packet class298_sub53, byte i_3_) {
		try {
			if (0 == i)
				aBoolean7382 = class298_sub53.readUnsignedByte() == 1;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ahn.r(").append(')').toString());
		}
	}
	...
	void method3297(int i, Packet class298_sub53) {
		if (0 == i)
			aBoolean7382 = class298_sub53.readUnsignedByte() == 1;
	}

	void method3298(int i, Packet class298_sub53) {
		if (0 == i)
			aBoolean7382 = class298_sub53.readUnsignedByte() == 1;
	}
	...
	final void method3299(int i, int i_13_, int i_14_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ahn.ac(").append(')').toString());
		}
	}
	...
	int[][] method3132(int i, byte i_22_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ahn.k(").append(')').toString());
		}
	}
}
