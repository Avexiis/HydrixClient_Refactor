...
public class Class298_Sub32_Sub26 extends TextureOperation {
	...
	void method3301(int i, Packet class298_sub53) {
		switch (i) {
		case 1:
	...
	int[] method3131(int i, int i_0_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aho.i(").append(')').toString());
		}
	}
	...
	void method3137(int i, Packet class298_sub53, byte i_86_) {
		try {
			switch (i) {
			case 1:
				aBoolean7382 = class298_sub53.readUnsignedByte() == 1;
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aho.r(").append(')').toString());
		}
	}
	...
	void method3304(int i, Packet class298_sub53) {
		switch (i) {
		case 1:
			aBoolean7382 = class298_sub53.readUnsignedByte() == 1;
			break;
	...
	int[][] method3132(int i, byte i_113_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aho.k(").append(')').toString());
		}
	}
		...
		try {
			if (Class378.method4671(i, null, -1677271827)) {
				if (class298_sub51 != null && !class298_sub51.method3573(364199740))
					...
					RSInterface RSInterface = SpotAnimTypeList.aRSInterfaceArray4165[i];
					GameClient.method2800(RSInterface, RSInterface.method1295((byte) -55), -1, i_258_, i_259_, i_260_, i_261_, i_262_, i_263_, i_264_, i_265_);
				}
			}
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aho.lt(").append(')').toString());
		}
	}
}
