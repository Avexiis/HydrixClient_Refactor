...
public class Class298_Sub32_Sub27 extends TextureOperation {
	...
	int[] method3131(int i, int i_0_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ahp.i(").append(')').toString());
		}
	}
	...
	void method3310(int i, Packet class298_sub53) {
		switch (i) {
		case 0:
	...
	void method3311(int i, Packet class298_sub53) {
		switch (i) {
		case 0:
			((Class298_Sub32_Sub27) this).anInt9497 = ((class298_sub53.readUnsignedByte() << 12) / 255 * 1128895529);
		}
	...
	void method3137(int i, Packet class298_sub53, byte i_1_) {
		try {
			switch (i) {
			case 0:
				((Class298_Sub32_Sub27) this).anInt9497 = ((class298_sub53.readUnsignedByte() << 12) / 255 * 1128895529);
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ahp.r(").append(')').toString());
		}
	}
}
