...
public class Class298_Sub32_Sub28 extends TextureOperation {
	...
	int[] method3131(int i, int i_0_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ahq.i(").append(')').toString());
		}
	}
	...
	int[][] method3132(int i, byte i_15_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ahq.k(").append(')').toString());
		}
	}
	...
	void method3137(int i, Packet class298_sub53, byte i_60_) {
		try {
			switch (i) {
			case 1:
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ahq.r(").append(')').toString());
		}
	}
	...
	void method3314(int i, Packet class298_sub53) {
		switch (i) {
		case 1:
			((Class298_Sub32_Sub28) this).anInt9500 = class298_sub53.readUnsignedByte() * -804145351;
			break;
	...
	void method3315(int i, Packet class298_sub53) {
		switch (i) {
		case 1:
			((Class298_Sub32_Sub28) this).anInt9500 = class298_sub53.readUnsignedByte() * -804145351;
			break;
