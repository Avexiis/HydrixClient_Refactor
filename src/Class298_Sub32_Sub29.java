...
public class Class298_Sub32_Sub29 extends TextureOperation {
	int anInt9503 = -1358727707;
	int anInt9504;
	int[] anIntArray9505;
	int anInt9506;

	void method3318(int i, Packet class298_sub53) {
		if (i == 0)
	...
	int[][] method3132(int i, byte i_0_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ahr.k(").append(')').toString());
		}
	}
	...
	int method3136(byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ahr.n(").append(')').toString());
		}
	}
	...
	void method3130(int i, int i_10_, int i_11_) {
		try {
			...
			if (((Class298_Sub32_Sub29) this).anInt9503 * -69124077 >= 0 && null != JAGLib.anInterface_ma3166) {
				int i_12_ = ((JAGLib.anInterface_ma3166.method174(-69124077 * ((Class298_Sub32_Sub29) this).anInt9503, 816226410).aBoolean518) ? 64 : 128);
				((Class298_Sub32_Sub29) this).anIntArray9505 = (JAGLib.anInterface_ma3166.method171(-69124077 * ((Class298_Sub32_Sub29) this).anInt9503, 1.0F, i_12_, i_12_, false, 215810850));
				((Class298_Sub32_Sub29) this).anInt9506 = 1374319031 * i_12_;
				((Class298_Sub32_Sub29) this).anInt9504 = -1283564585 * i_12_;
			}
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ahr.a(").append(')').toString());
		}
	}
	...
	void method3324(int i, int i_31_) {
		...
		if (((Class298_Sub32_Sub29) this).anInt9503 * -69124077 >= 0 && null != JAGLib.anInterface_ma3166) {
			int i_32_ = ((JAGLib.anInterface_ma3166.method174(-69124077 * ((Class298_Sub32_Sub29) this).anInt9503, 1192750196).aBoolean518) ? 64 : 128);
			((Class298_Sub32_Sub29) this).anIntArray9505 = (JAGLib.anInterface_ma3166.method171(-69124077 * ((Class298_Sub32_Sub29) this).anInt9503, 1.0F, i_32_, i_32_, false, -234790231));
	...
	void method3128(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ahr.f(").append(')').toString());
		}
	}
	...
	void method3137(int i, Packet class298_sub53, byte i_33_) {
		try {
			if (i == 0)
				((Class298_Sub32_Sub29) this).anInt9503 = class298_sub53.readUnsignedShort() * 1358727707;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ahr.r(").append(')').toString());
		}
	}
	...
	void method3330(int i, int i_34_) {
		...
		if (((Class298_Sub32_Sub29) this).anInt9503 * -69124077 >= 0 && null != JAGLib.anInterface_ma3166) {
			int i_35_ = ((JAGLib.anInterface_ma3166.method174(-69124077 * ((Class298_Sub32_Sub29) this).anInt9503, 607579585).aBoolean518) ? 64 : 128);
			((Class298_Sub32_Sub29) this).anIntArray9505 = (JAGLib.anInterface_ma3166.method171(-69124077 * ((Class298_Sub32_Sub29) this).anInt9503, 1.0F, i_35_, i_35_, false, 626013006));
			((Class298_Sub32_Sub29) this).anInt9506 = 1374319031 * i_35_;
			((Class298_Sub32_Sub29) this).anInt9504 = -1283564585 * i_35_;
		}
	}

	void method3331(int i, Packet class298_sub53) {
		if (i == 0)
			((Class298_Sub32_Sub29) this).anInt9503 = class298_sub53.readUnsignedShort() * 1358727707;
	}
}
