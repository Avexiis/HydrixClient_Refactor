...
public class Class298_Sub32_Sub3 extends TextureOperation {
	...
	int[] method3131(int i, int i_0_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("age.i(").append(')').toString());
		}
	}
	...
	final int[] method3152(int i, byte i_4_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("age.ac(").append(')').toString());
		}
	}

	void method3153(int i, Packet class298_sub53) {
		if (0 == i) {
	...
	void method3154(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("age.am(").append(')').toString());
		}
	}
	...
	void method3133(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("age.x(").append(')').toString());
		}
	}

	void method3137(int i, Packet class298_sub53, byte i_39_) {
		try {
			if (0 == i) {
				((Class298_Sub32_Sub3) this).anInt9329 = class298_sub53.readUnsignedByte() * 417209465;
				((Class298_Sub32_Sub3) this).anIntArrayArray9330 = new int[class298_sub53.readUnsignedByte()][2];
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("age.r(").append(')').toString());
		}
	}
	...
	final void method3155(byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("age.bd(").append(')').toString());
		}
	}
	...
	void method3159(int i, Packet class298_sub53) {
		if (0 == i) {
			((Class298_Sub32_Sub3) this).anInt9329 = class298_sub53.readUnsignedByte() * 417209465;
			((Class298_Sub32_Sub3) this).anIntArrayArray9330 = new int[class298_sub53.readUnsignedByte()][2];
