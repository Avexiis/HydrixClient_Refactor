...
public class Class298_Sub32_Sub30 extends TextureOperation {
	...
	int[] method3131(int i, int i_0_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ahs.i(").append(')').toString());
		}
	}
	...
	public static int method3334(Js5 class243, byte i) {
		try {
			...
			if (class243.method2310(Class82_Sub6.anInt6842 * -2107184677, -457216440))
				i_1_++;
			if (class243.method2310(VarClientTypeList.anInt6092 * -1624054445, -457216440))
				i_1_++;
