...
public class Class298_Sub32_Sub31 extends TextureOperation {
	int anInt9507;
	int anInt9508;
	int anInt9509 = 0;
	int anInt9510;

	void method3335(int i, Packet class298_sub53) {
		switch (i) {
		case 0:
	...
	void method3137(int i, Packet class298_sub53, byte i_10_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aht.r(").append(')').toString());
		}
	}
	...
	int[] method3131(int i, int i_21_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aht.i(").append(')').toString());
		}
	}

	void method3338(int i, Packet class298_sub53) {
		switch (i) {
		case 0:
			((Class298_Sub32_Sub31) this).anInt9507 = class298_sub53.readUnsignedShort() * -1944832501;
			break;
	...
	public static boolean method3339(int i, int i_32_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aht.a(").append(')').toString());
		}
	}
}
