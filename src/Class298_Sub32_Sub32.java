...
public class Class298_Sub32_Sub32 extends TextureOperation {
	int anInt9511 = 0;
	static int anInt9512 = 0;
	static int anInt9513 = 4096;
	int anInt9514 = -1593028608;

	void method3340(int i, Packet class298_sub53) {
		switch (i) {
		case 0:
	...
	int[] method3131(int i, int i_0_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ahu.i(").append(')').toString());
		}
	}
	...
	void method3137(int i, Packet class298_sub53, byte i_10_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ahu.r(").append(')').toString());
		}
	}

	void method3343(int i, Packet class298_sub53) {
		switch (i) {
		case 0:
			((Class298_Sub32_Sub32) this).anInt9511 = class298_sub53.readUnsignedShort() * 1298582163;
			break;
	...
	static final void method3344(ClientScript2 class403, byte i) {
		try {
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = SceneryShadowPreference.aBoolean8385 ? 1 : 0;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ahu.us(").append(')').toString());
		}
	}
	...
	public static void method3345(String[] strings, int[] is, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ahu.b(").append(')').toString());
		}
	}
}
