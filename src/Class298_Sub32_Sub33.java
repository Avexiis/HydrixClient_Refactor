...
public class Class298_Sub32_Sub33 extends TextureOperation {
	...
	void method3346(int i, Packet class298_sub53) {
		switch (i) {
		case 6:
	...
	int[] method3131(int i, int i_0_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ahv.i(").append(')').toString());
		}
	}
	...
	void method3137(int i, Packet class298_sub53, byte i_81_) {
		try {
			switch (i) {
			case 6:
				((Class298_Sub32_Sub33) this).anInt9531 = class298_sub53.readUnsignedByte() * 1663137711;
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ahv.r(").append(')').toString());
		}
	}
	...
	final void method3349(Random random, int[][] is, int i, int i_122_, int i_123_, int i_124_, int i_125_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ahv.ac(").append(')').toString());
		}
	}
	...
	void method3352(int i, Packet class298_sub53) {
		switch (i) {
		case 6:
			((Class298_Sub32_Sub33) this).anInt9531 = class298_sub53.readUnsignedByte() * 1663137711;
			break;
	...
	void method3133(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ahv.x(").append(')').toString());
		}
	}
}
