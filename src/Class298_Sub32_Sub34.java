...
public class Class298_Sub32_Sub34 extends TextureOperation {
	...
	void method3354(short i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ahw.bd(").append(')').toString());
		}
	}
	...
	int method3355(int i, int i_2_, int i_3_, int i_4_, int i_5_, int i_6_, int i_7_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ahw.am(").append(')').toString());
		}
	}

	void method3137(int i, Packet class298_sub53, byte i_18_) {
		try {
			switch (i) {
			case 2:
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ahw.r(").append(')').toString());
		}
	}
	...
	void method3356(int i, int[] is, int i_20_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ahw.ac(").append(')').toString());
		}
	}

	void method3357(int i, Packet class298_sub53) {
		switch (i) {
		case 2:
	...
	int[] method3131(int i, int i_68_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ahw.i(").append(')').toString());
		}
	}
	...
	void method3361(int i, Packet class298_sub53) {
		switch (i) {
		case 2:
	...
	void method3133(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ahw.x(").append(')').toString());
		}
	}
	...
	static final void method3364(IComponentDefinition class105, RSInterface RSInterface, ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ahw.ng(").append(')').toString());
		}
	}
}
