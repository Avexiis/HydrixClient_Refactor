...
public class Class298_Sub32_Sub35 extends TextureOperation {
	int anInt9550;
	...
	int[][] method3132(int i, byte i_0_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ahx.k(").append(')').toString());
		}
	}
	...
	void method3137(int i, Packet class298_sub53, byte i_18_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ahx.r(").append(')').toString());
		}
	}

	void method3365(int i, Packet class298_sub53) {
		switch (i) {
		case 0:
			((Class298_Sub32_Sub35) this).anInt9550 = class298_sub53.readUnsignedShort() * 1837433191;
			break;
	...
	void method3366(int i, Packet class298_sub53) {
		switch (i) {
		case 0:
			((Class298_Sub32_Sub35) this).anInt9550 = class298_sub53.readUnsignedShort() * 1837433191;
			break;
