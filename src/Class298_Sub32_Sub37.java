...
public class Class298_Sub32_Sub37 extends TextureOperation {
	...
	void method3137(int i, Packet class298_sub53, byte i_7_) {
		try {
			switch (i) {
			case 0:
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ahz.r(").append(')').toString());
		}
	}
	...
	int[] method3131(int i, int i_15_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ahz.i(").append(')').toString());
		}
	}

	void method3376(int i, Packet class298_sub53) {
		switch (i) {
		case 0:
			((Class298_Sub32_Sub37) this).anInt9558 = class298_sub53.readUnsignedShort() * 2065121421;
		}
	...
	void method3377(int i, Packet class298_sub53) {
		switch (i) {
		case 0:
			((Class298_Sub32_Sub37) this).anInt9558 = class298_sub53.readUnsignedShort() * 2065121421;
		}
