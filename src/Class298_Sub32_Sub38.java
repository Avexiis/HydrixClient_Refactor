...
public class Class298_Sub32_Sub38 extends TextureOperation {
	int anInt9559;
	int anInt9560;
	int anInt9561;
	...
	int[] method3131(int i, int i_0_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aie.i(").append(')').toString());
		}
	}
	...
	void method3133(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aie.x(").append(')').toString());
		}
	}
	...
	boolean method3379(int i, int i_8_, int i_9_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aie.am(").append(')').toString());
		}
	}
	...
	boolean method3380(int i, int i_12_, int i_13_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aie.ac(").append(')').toString());
		}
	}
	...
	void method3384(int i, Packet class298_sub53) {
		switch (i) {
		case 5:
	...
	void method3137(int i, Packet class298_sub53, byte i_23_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aie.r(").append(')').toString());
		}
	}

	void method3385(int i, Packet class298_sub53) {
		switch (i) {
		case 5:
			((Class298_Sub32_Sub38) this).anInt9560 = class298_sub53.readUnsignedShort() * -1402300779;
			break;
	...
	public static int method3387(int i, int i_31_, int i_32_, int i_33_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aie.u(").append(')').toString());
		}
	}
}
