...
public class Class298_Sub32_Sub39 extends TextureOperation {
	int anInt9566;
	...
	void method3137(int i, Packet class298_sub53, byte i_0_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aio.r(").append(')').toString());
		}
	}
	...
	void method3388(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aio.ac(").append(')').toString());
		}
	}
	...
	void method3133(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aio.x(").append(')').toString());
		}
	}
	...
	int[] method3131(int i, int i_21_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aio.i(").append(')').toString());
		}
	}
	...
	void method3394(int i, Packet class298_sub53) {
		switch (i) {
		case 0:
			((Class298_Sub32_Sub39) this).anInt9570 = class298_sub53.readUnsignedByte() * 382646931;
			break;
	...
	void method3395(int i, Packet class298_sub53) {
		switch (i) {
		case 0:
			((Class298_Sub32_Sub39) this).anInt9570 = class298_sub53.readUnsignedByte() * 382646931;
			break;
