...
public class Class298_Sub32_Sub4 extends TextureOperation {
	int anInt9332;
	...
	int[][] method3132(int i, byte i_8_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("agg.k(").append(')').toString());
		}
	}
	...
	void method3162(int i, int i_17_, int i_18_, int i_19_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("agg.am(").append(')').toString());
		}
	}

	void method3163(int i, Packet class298_sub53) {
		switch (i) {
		case 0:
	...
	void method3164(int i, Packet class298_sub53) {
		switch (i) {
		case 0:
	...
	void method3165(int i, int i_28_, int i_29_, int i_30_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("agg.ac(").append(')').toString());
		}
	}
	...
	void method3137(int i, Packet class298_sub53, byte i_45_) {
		try {
			switch (i) {
			case 0:
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("agg.r(").append(')').toString());
		}
	}
}
