...
public class Class298_Sub32_Sub6 extends TextureOperation {
	...
	void method3137(int i, Packet class298_sub53, byte i_0_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("agq.r(").append(')').toString());
		}
	}
	...
	int[][] method3132(int i, byte i_2_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("agq.k(").append(')').toString());
		}
	}

	void method3175(int i, Packet class298_sub53) {
		switch (i) {
		case 1:
			((Class298_Sub32_Sub6) this).anInt9358 = class298_sub53.readUnsignedShort() * 1987830015;
			break;
	...
	void method3176(int i, Packet class298_sub53) {
		switch (i) {
		case 1:
			((Class298_Sub32_Sub6) this).anInt9358 = class298_sub53.readUnsignedShort() * 1987830015;
			break;
