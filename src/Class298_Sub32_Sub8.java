...
public class Class298_Sub32_Sub8 extends TextureOperation {
	...
	void method3181(int i, Packet class298_sub53) {
		switch (i) {
		case 6:
	...
	int[] method3131(int i, int i_0_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("agu.i(").append(')').toString());
		}
	}
	...
	void method3133(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("agu.x(").append(')').toString());
		}
	}

	void method3137(int i, Packet class298_sub53, byte i_13_) {
		try {
			switch (i) {
			case 6:
				((Class298_Sub32_Sub8) this).anInt9379 = class298_sub53.readUnsignedShort() * 216958721;
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("agu.r(").append(')').toString());
		}
	}
	...
	void method3183(short i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("agu.ac(").append(')').toString());
		}
	}
	...
	void method3187(int i, Packet class298_sub53) {
		switch (i) {
		case 6:
			((Class298_Sub32_Sub8) this).anInt9379 = class298_sub53.readUnsignedShort() * 216958721;
			break;
