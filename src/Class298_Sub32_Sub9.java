...
public class Class298_Sub32_Sub9 extends TextureOperation {
	...
	int[] method3131(int i, int i_11_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("agw.i(").append(')').toString());
		}
	}

	void method3191(int i, Packet class298_sub53) {
		switch (i) {
		case 2:
	...
	void method3137(int i, Packet class298_sub53, byte i_16_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("agw.r(").append(')').toString());
		}
	}

	void method3193(int i, Packet class298_sub53) {
		switch (i) {
		case 2:
			aBoolean7382 = class298_sub53.readUnsignedByte() == 1;
			break;
	...
	int[][] method3132(int i, byte i_17_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("agw.k(").append(')').toString());
		}
	}
