...
public class Class298_Sub34 extends Node {
	...
	boolean method3397(Class272 class272, byte[] is, int[] is_0_, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("abs.f(").append(')').toString());
		}
	}
	...
	Class298_Sub34(byte[] is) {
		...
		int i;
		for (i = 0; 0 != (class298_sub53.payload[i + 385051775 * class298_sub53.pos]); i++) {
			/* empty */
		}
		byte[] is_4_ = new byte[i];
		for (int i_5_ = 0; i_5_ < i; i_5_++)
			is_4_[i_5_] = class298_sub53.readByte();
		class298_sub53.pos += 116413311;
		i++;
		int i_6_ = 385051775 * class298_sub53.pos;
		class298_sub53.pos += 116413311 * i;
		int i_7_;
		for (i_7_ = 0; ((class298_sub53.payload[class298_sub53.pos * 385051775 + i_7_]) != 0); i_7_++) {
			/* empty */
		}
		...
		class298_sub53.pos += 116413311;
		i_7_++;
		int i_10_ = class298_sub53.pos * 385051775;
		class298_sub53.pos += i_7_ * 116413311;
		int i_11_;
		for (i_11_ = 0; ((class298_sub53.payload[385051775 * class298_sub53.pos + i_11_]) != 0); i_11_++) {
			/* empty */
		}
		...
		int i_24_;
		for (i_24_ = 0; ((class298_sub53.payload[i_24_ + 385051775 * class298_sub53.pos]) != 0); i_24_++) {
			/* empty */
		}
			...
			if (((Class298_Sub34) this).anIntArray7393[i_35_] != 0) {
				if (0 == i_30_) {
					if (i_31_ < is_4_.length)
						...
						i_30_ = -1;
					i_34_ = class298_sub53.payload[i_6_++] - 1;
				}
			...
			if (((Class298_Sub34) this).anIntArray7393[i_37_] != 0) {
				if (0 == i_30_) {
					if (i_31_ < is_8_.length)
						...
						i_30_ = -1;
					i_36_ = class298_sub53.payload[i_10_++] + 16 << 2;
				}
	...
	void method3398(byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("abs.b(").append(')').toString());
		}
	}
}
