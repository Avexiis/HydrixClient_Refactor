...
public class Class298_Sub37 extends Node {
	...
	public void method3402(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("abv.c(").append(')').toString());
		}
	}

	public static int calculateRoute(int startX, int startY, int size, Class336 class336, Region planeClipData, boolean alternativeRoute, int[] calculatedPositionXsArray, int[] calculatedPositionYsArray) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("abv.a(").append(')').toString());
		}
	}
	...
	static final void method3404(ClientScript2 class403, byte i) {
		try {
			...
			MapDetails mapDetails = WorldMap.method3705(i_29_);
			if (mapDetails == null) {
				((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919) - 1] = 0;
				((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919) - 1] = 0;
			} else {
				((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919) - 1] = (-2052483955 * mapDetails.anInt9647 - mapDetails.anInt9650 * 1364716801);
				((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919) - 1] = (929385381 * mapDetails.anInt9646 - mapDetails.anInt9649 * 1345239131);
			}
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("abv.adj(").append(')').toString());
		}
	}

	static Class98_Sub2 method3405(Packet class298_sub53, int i) {
		try {
			return new Class98_Sub2(class298_sub53.readShort(1780611979), class298_sub53.readShort(2084327915), class298_sub53.readShort(1750072102), class298_sub53.readShort(1941131752), class298_sub53.g3(), class298_sub53.readUnsignedByte());
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("abv.r(").append(')').toString());
		}
	}
}
