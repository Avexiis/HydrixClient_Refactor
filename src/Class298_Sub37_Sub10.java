...
public class Class298_Sub37_Sub10 extends Class298_Sub37 {
	...
	void method3443(Packet class298_sub53, int i, byte i_0_) {
		try {
			if (2 == i)
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aiq.f(").append(')').toString());
		}
	}

	void method3444(Packet class298_sub53, byte i) {
		try {
			for (;;) {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aiq.a(").append(')').toString());
		}
	}
