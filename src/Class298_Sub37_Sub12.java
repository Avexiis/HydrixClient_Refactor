...
public class Class298_Sub37_Sub12 extends Class298_Sub37 {
	...
	void method3445(int i) {
		try {
			aLong7406 = ((aLong7406 * -5533549728640346679L & ~0x7fffffffffffffffL | TimeUtils.getTime((byte) 1) + 500L) * 1476940603538232441L);
			aClass461_9607.method5982(this, (byte) -90);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ais.bf(").append(')').toString());
		}
	}
	...
	int method3446(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ais.by(").append(')').toString());
		}
	}
	...
	long method3447(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ais.bm(").append(')').toString());
		}
	}
	...
	long method3448(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ais.bc(").append(')').toString());
		}
	}
	...
	void method3449(byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ais.be(").append(')').toString());
		}
	}
}
