...
public class Class298_Sub37_Sub14 extends Class298_Sub37 {
	...
	void method3456(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aiv.x(").append(')').toString());
		}
	}

	void method3457(Packet class298_sub53, int i) {
		try {
			for (;;) {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aiv.a(").append(')').toString());
		}
	}
	...
	public int method3458(int i, int i_2_, int i_3_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aiv.u(").append(')').toString());
		}
	}

	public String method3459(Packet class298_sub53, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aiv.p(").append(')').toString());
		}
	}
	...
	public int method3461(short i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aiv.k(").append(')').toString());
		}
	}
	...
	public String method3462(byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aiv.i(").append(')').toString());
		}
	}
	...
	void method3463(Packet class298_sub53, int i, int i_8_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aiv.f(").append(')').toString());
		}
	}
	...
	public void method3464(Packet class298_sub53, int[] is, int i) {
		try {
			if (null != ((Class298_Sub37_Sub14) this).anIntArray9656) {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aiv.b(").append(')').toString());
		}
	}
}
