...
public class Class298_Sub37_Sub16_Sub2 extends Class298_Sub37_Sub16 {
	...
	int method3468(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aks.f(").append(')').toString());
		}
	}
	...
	byte[] method3465(short i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aks.a(").append(')').toString());
		}
	}
