...
public class Class298_Sub37_Sub5 extends Class298_Sub37 {
	...
	boolean method3416(Class298_Sub37_Sub15 class298_sub37_sub15, int i) {
		try {
			...
			while (class298_sub37_sub15_0_ != null) {
				if (VarClientType.method6069((((Class298_Sub37_Sub15) class298_sub37_sub15).anInt9662 * 946432351), (((Class298_Sub37_Sub15) class298_sub37_sub15_0_).anInt9662 * 946432351), -537262415)) {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aij.f(").append(')').toString());
		}
	}
	...
	int method3417(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aij.a(").append(')').toString());
		}
	}
	...
	boolean method3418(Class298_Sub37_Sub15 class298_sub37_sub15, int i) {
		try {
			...
			if (-628325139 * ((Class298_Sub37_Sub5) this).anInt9583 == 0) {
				...
				ContextMenu.aClass348_5464.put(this, ((((Class298_Sub37_Sub15) class298_sub37_sub15).aLong9666) * 6619564980435866523L));
				return false;
			}
			return i_1_ != method3417(-912976938);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aij.b(").append(')').toString());
		}
	}
	...
	static final void method3419(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aij.ps(").append(')').toString());
		}
	}
}
