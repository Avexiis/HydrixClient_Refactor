...
public class Class298_Sub37_Sub7 extends Class298_Sub37 {
	...
	void method3424(Packet class298_sub53, int i) {
		try {
			for (;;) {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aim.a(").append(')').toString());
		}
	}
	...
	public int method3425(int i, int i_1_, short i_2_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aim.b(").append(')').toString());
		}
	}
	...
	void method3426(Packet class298_sub53, int i, int i_3_) {
		try {
			if (i == 249) {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aim.f(").append(')').toString());
		}
	}
	...
	public String method3427(int i, String string, byte i_8_) {
		try {
			if (((Class298_Sub37_Sub7) this).aClass437_9594 == null)
				return string;
			LinkableObject linkableObject = (LinkableObject) ((Class298_Sub37_Sub7) this).aClass437_9594.get((long) i);
			if (linkableObject == null)
				return string;
			return (String) linkableObject.anObject7366;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aim.p(").append(')').toString());
		}
	}
	...
	public static void method3428(Entity class365_sub1_sub1_sub2, int[] is, int[] is_9_, int[] is_10_, int i) {
		try {
			for (int i_11_ = 0; i_11_ < is.length; i_11_++) {
				...
				for (int i_15_ = 0; (0 != i_13_ && i_15_ < (class365_sub1_sub1_sub2.aClass438_Sub2_Sub1Array10112).length); i_13_ >>>= 1) {
					if ((i_13_ & 0x1) == 0) {
						...
						SeqType class391 = Class501.aClass395_6122.method4903(i_12_, (byte) -80);
						int i_16_ = class391.anInt4184 * -1117238071;
						Animator_Sub2_Sub1 class438_sub2_sub1 = (class365_sub1_sub1_sub2.aClass438_Sub2_Sub1Array10112[i_15_]);
						...
						if (class438_sub2_sub1 == null || !class438_sub2_sub1.method5819((byte) -3)) {
							class438_sub2_sub1 = class365_sub1_sub1_sub2.aClass438_Sub2_Sub1Array10112[i_15_] = (new Animator_Sub2_Sub1(class365_sub1_sub1_sub2));
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aim.ix(").append(')').toString());
		}
	}
	...
	static final void method3429(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aim.zy(").append(')').toString());
		}
	}
}
