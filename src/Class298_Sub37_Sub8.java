...
public class Class298_Sub37_Sub8 extends Class298_Sub37 {
	...
	void method3430(Packet class298_sub53, int i) {
		try {
			for (;;) {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ain.a(").append(')').toString());
		}
	}
	...
	public int method3431(char c, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ain.b(").append(')').toString());
		}
	}
	...
	void method3432(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ain.i(").append(')').toString());
		}
	}
	...
	public int method3433(char c, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ain.p(").append(')').toString());
		}
	}

	void method3434(Packet class298_sub53, int i, int i_5_) {
		try {
			do {
				if (1 == i)
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ain.f(").append(')').toString());
		}
	}
	...
	static final void method3435(ClientScript2 class403, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ain.adt(").append(')').toString());
		}
	}
}
