...
public class Class298_Sub37_Sub9_Sub1 extends Class298_Sub37_Sub9 {
	...
	Object method3437(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aki.a(").append(')').toString());
		}
	}
	...
	boolean method3438(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aki.f(").append(')').toString());
		}
	}
