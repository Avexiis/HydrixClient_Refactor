...
public final class Class298_Sub38 extends Node {
	...
	static Class298_Sub38 aClass298Sub38_7415 = new Class298_Sub38(0, -1);
	...
	public final boolean method3492(byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("abw.a(").append(')').toString());
		}
	}
	...
	public final int method3493(byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("abw.i(").append(')').toString());
		}
	}
	...
	public final boolean method3494(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("abw.k(").append(')').toString());
		}
	}
	...
	public final boolean method3495(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("abw.d(").append(')').toString());
		}
	}
	...
	public final boolean method3496(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("abw.u(").append(')').toString());
		}
	}

	public final int method3497(byte i) {
		try {
			return MagnetConfig.method784(anInt7416 * -1266165749, (byte) 105);
		} catch (RuntimeException runtimeexception) {
	...
	public final boolean method3498(int i, byte i_0_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("abw.f(").append(')').toString());
		}
	}
	...
	static final void method3499(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("abw.aei(").append(')').toString());
		}
	}
	...
	static void method3501(ClientScript2 class403, short i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("abw.x(").append(')').toString());
		}
	}
	...
	public static final void method3502(String string, int i, int i_3_) {
		try {
			...
			Class298_Sub36 class298_sub36 = Class18.method359(OutgoingPacket.CHANGE_FRIEND_CHAT_PACKET, class25.aClass449_330, (byte) 82);
			class298_sub36.buffer.writeByte(1 + Class58.method693(string, 986937694));
			class298_sub36.buffer.writeString(string, 2107789256);
			class298_sub36.buffer.writeByte128(i, 1999137832);
			class25.writeOutboundPacket(class298_sub36, (byte) -112);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("abw.mg(").append(')').toString());
		}
	}
