	...
	static void method3504(Class298_Sub37_Sub5 class298_sub37_sub5, int i, int i_1_) {
		try {
			if (ContextMenu.menuOpen) {
				...
				i_2_ += 8;
				int i_4_ = (21 + (((Class298_Sub37_Sub5) class298_sub37_sub5).anInt9583 * -628325139 * (-411680299 * ContextMenu.anInt5467)));
				SpotAnimTypeList.anInt4166 = ((ContextMenu.aBoolean5496 ? 26 : 22) + (-411680299 * ContextMenu.anInt5467 * ((((Class298_Sub37_Sub5) class298_sub37_sub5).anInt9583) * -628325139))) * 1396848787;
				int i_5_ = (Class134.anInt6343 * 608683427 + -1347746885 * Class88.anInt806);
				if (i_5_ + i_2_ > -2110394505 * Class462.canvasWidth)
				...
				ContextMenu.aClass298_Sub37_Sub5_5472 = class298_sub37_sub5;
			}
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("abx.q(").append(')').toString());
		}
	}

	static void method3505(GraphicsToolkit class_ra, WorldMapArea worldMapArea, WorldMapLabel worldMapLabel, int i, int i_8_, int i_9_, int i_10_, Class4 class4, int i_11_) {
		try {
			int i_12_ = i_8_ - i_10_ / 2 - 5;
			int i_13_ = i_9_ + 2;
			if (594838161 * worldMapLabel.anInt3787 != 0)
				class_ra.method5015(i_12_, i_13_, i_10_ + 10, i_9_ + i * class4.method309() - i_13_ + 1, 594838161 * worldMapLabel.anInt3787, (byte) 7);
			if (0 != worldMapLabel.anInt3802 * -828737913)
				class_ra.method5014(i_12_, i_13_, i_10_ + 10, i_9_ + i * class4.method309() - i_13_ + 1, worldMapLabel.anInt3802 * -828737913, -1130300720);
			int i_14_ = -1836991893 * worldMapLabel.anInt3781;
			if (worldMapArea.aBoolean7611 && 1364087215 * worldMapLabel.anInt3782 != -1)
				i_14_ = 1364087215 * worldMapLabel.anInt3782;
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("abx.bj(").append(')').toString());
		}
	}

	static final void method3506(int i) {
		try {
			int i_16_ = 256 + -712176128 * VarClanSettings.anInt4089;
			...
			if (1534163843 * Class21.anInt276 >= 100) {
				Class367.anInt4000 = -1475884800 + VarClanSettings.anInt4089 * -1222509056;
			...
			i_16_ = 256 + Ground.anInt6292 * -589460992;
			...
			if (GameClient.anInt8756 * -104436553 < i_23_) {
				GameClient.anInt8756 += ((((i_23_ - GameClient.anInt8756 * -104436553 >> 3) * (1179258959 * Class427.anInt5362) / 1000) + Class128_Sub1.anInt8556 * 298687157) << 3) * -648269561;
				if (GameClient.anInt8756 * -104436553 > i_23_)
					GameClient.anInt8756 = i_23_ * -648269561;
			}
			if (-104436553 * GameClient.anInt8756 > i_23_) {
				GameClient.anInt8756 -= (-648269561 * ((1179258959 * Class427.anInt5362 * (GameClient.anInt8756 * -104436553 - i_23_ >> 3) / 1000) + 298687157 * Class128_Sub1.anInt8556 << 3));
				if (-104436553 * GameClient.anInt8756 < i_23_)
					GameClient.anInt8756 = i_23_ * -648269561;
			}
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("abx.ho(").append(')').toString());
		}
	}

	static final void method3507(IComponentDefinition class105, RSInterface RSInterface, ClientScript2 class403, int i) {
		try {
			String string = (String) (((ClientScript2) class403).anObjectArray5240[(((ClientScript2) class403).anInt5241 -= 969361751) * -203050393]);
			if (Class298_Sub6.method2863(string, class403, -1593702044) != null)
				string = string.substring(0, string.length() - 1);
			class105.onMouseHoverTextScript = Class128_Sub2.method1441(string, class403, -2046058202);
			class105.hasScripts = true;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("abx.lg(").append(')').toString());
		}
	}
}
