...
public class Class298_Sub40_Sub1 extends Class298_Sub40 {
	...
	void method3510(Class162 class162, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("afd.f(").append(')').toString());
		}
	}
	...
	void method3508(Packet class298_sub53, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("afd.a(").append(')').toString());
		}
	}
	...
	static final void method3514(ClientScript2 class403, int i) {
		try {
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = MovementType.method2624(-333964684).method242(694163818);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("afd.ahc(").append(')').toString());
		}
	}
}
