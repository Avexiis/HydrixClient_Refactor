...
public class Class298_Sub40_Sub11 extends Class298_Sub40 {
	...
	void method3508(Packet class298_sub53, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("agr.a(").append(')').toString());
		}
	}
	...
	void method3510(Class162 class162, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("agr.f(").append(')').toString());
		}
	}
