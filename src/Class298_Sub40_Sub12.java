...
public class Class298_Sub40_Sub12 extends Class298_Sub40 {
	...
	void method3508(Packet class298_sub53, int i) {
		try {
			((Class298_Sub40_Sub12) this).anInt9729 = class298_sub53.readUnsignedInt() * 1958209175;
			((Class298_Sub40_Sub12) this).anInt9728 = class298_sub53.readUnsignedInt() * 7382949;
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("agv.a(").append(')').toString());
		}
	}
	...
	void method3510(Class162 class162, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("agv.f(").append(')').toString());
		}
	}
	...
	static final int method3516(int i, int i_0_, int i_1_, int i_2_, byte i_3_) {
		try {
			int i_4_ = 65536 - Class220.COSINE[8192 * i_1_ / i_2_] >> 1;
			return (i_4_ * i_0_ >> 16) + ((65536 - i_4_) * i >> 16);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("agv.j(").append(')').toString());
		}
	}
}
