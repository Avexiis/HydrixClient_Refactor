...
public class Class298_Sub41 extends Node {
	Class298_Sub23 aClass298_Sub23_7420;
	static LinkedNodeList aLinkedNodeList_7421 = new LinkedNodeList();
	int anInt7422;
	int anInt7423;
	int anInt7424;
	int anInt7425;
	...
	int anInt7454;
	static LinkedNodeList aLinkedNodeList_7455 = new LinkedNodeList();
	...
	void method3519(int i) {
		try {
			...
			if (null != ((Class298_Sub41) this).aClass432_7435) {
				LocType class432 = (((Class298_Sub41) this).aClass432_7435.method5777((GameClient.cutsceneStage * 1596783995 == 0 ? (Interface23) Class87.anInterface23_796 : Class128.aClass148_6331), 2115683030));
				if (null != class432) {
				...
				if (i_1_ != i_0_) {
					...
					NPCType class503 = (((Class298_Sub41) this).aClass365_Sub1_Sub1_Sub2_Sub1_7433.definition);
					...
					if (class503 != null) {
						...
						((Class298_Sub41) this).anInt7430 = 0;
						((Class298_Sub41) this).anInt7449 = 0;
						((Class298_Sub41) this).aBoolean7444 = (((Class298_Sub41) this).aClass365_Sub1_Sub1_Sub2_Sub1_7433.definition.aBoolean6180);
						((Class298_Sub41) this).anInt7452 = -1197363456;
						((Class298_Sub41) this).anInt7441 = -900102912;
					}
				}
			} else if ((((Class298_Sub41) this).aClass365_Sub1_Sub1_Sub2_Sub2_7434) != null) {
				((Class298_Sub41) this).anInt7443 = (FloTypeList.method4652((((Class298_Sub41) this).aClass365_Sub1_Sub1_Sub2_Sub2_7434), 906629819)) * 502744039;
				((Class298_Sub41) this).aBoolean7444 = (((Class298_Sub41) this).aClass365_Sub1_Sub1_Sub2_Sub2_7434.isMale);
				((Class298_Sub41) this).anInt7430 = (((((Class298_Sub41) this).aClass365_Sub1_Sub1_Sub2_Sub2_7434.turnLeftAnimation) * 780357347) << 9) * 1644605369;
				((Class298_Sub41) this).anInt7429 = 0;
				((Class298_Sub41) this).anInt7449 = -1138033583 * (((Class298_Sub41) this).aClass365_Sub1_Sub1_Sub2_Sub2_7434.turnRightAnimation);
				((Class298_Sub41) this).anInt7452 = -1197363456;
				((Class298_Sub41) this).anInt7441 = -900102912;
			}
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("abz.b(").append(')').toString());
		}
	}
