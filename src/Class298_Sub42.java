...
public class Class298_Sub42 extends Node {
	int anInt7457;
	int anInt7458;
	int anInt7459;
	int anInt7460;
	...
	boolean method3520(int i, int i_0_, int i_1_, int i_2_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aca.f(").append(')').toString());
		}
	}
	...
	boolean method3521(int i, int i_3_, int i_4_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aca.a(").append(')').toString());
		}
	}
	...
	boolean method3522(int i, int i_5_, byte i_6_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aca.b(").append(')').toString());
		}
	}
	...
	void method3523(int i, int i_7_, int[] is, int i_8_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aca.p(").append(')').toString());
		}
	}
	...
	void method3524(int i, int i_17_, int[] is, int i_18_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aca.i(").append(')').toString());
		}
	}
}
