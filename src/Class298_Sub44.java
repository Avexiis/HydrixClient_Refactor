...
public class Class298_Sub44 extends Node {
	...
	void method3528(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("acc.a(").append(')').toString());
		}
	}

	public void writeMachineInformation(Packet buffer, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("acc.f(").append(')').toString());
		}
	}
	...
	public int method3530(int i) {
		try {
			int i_1_ = 38;
			i_1_ += Js5ConfigGroup.method1310(((Class298_Sub44) this).aString7502, (byte) -1);
			i_1_ += Js5ConfigGroup.method1310(((Class298_Sub44) this).aString7503, (byte) -1);
			i_1_ += Js5ConfigGroup.method1310(((Class298_Sub44) this).aString7482, (byte) -1);
			i_1_ += Js5ConfigGroup.method1310(((Class298_Sub44) this).aString7505, (byte) -1);
			i_1_ += Js5ConfigGroup.method1310(((Class298_Sub44) this).aString7496, (byte) -1);
			i_1_ += Js5ConfigGroup.method1310(((Class298_Sub44) this).aString7511, (byte) -1);
			return i_1_;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("acc.b(").append(')').toString());
		}
	}
	...
	public Class298_Sub44(boolean bool) {
		if (bool) {
			...
			int i_2_ = 0;
			try {
				for (/**/; i < Js5ConfigGroup.aString1462.length(); i++) {
					int i_3_ = Js5ConfigGroup.aString1462.charAt(i);
					if (i_3_ < 48 || i_3_ > 57)
						break;
			...
			i = Js5ConfigGroup.aString1462.indexOf('.', 2) + 1;
			i_2_ = 0;
			try {
				for (/**/; i < Js5ConfigGroup.aString1462.length(); i++) {
					int i_4_ = Js5ConfigGroup.aString1462.charAt(i);
					if (i_4_ < 48 || i_4_ > 57)
						break;
			...
			i = Js5ConfigGroup.aString1462.indexOf('_', 4) + 1;
			i_2_ = 0;
			try {
				for (/**/; i < Js5ConfigGroup.aString1462.length(); i++) {
					int i_5_ = Js5ConfigGroup.aString1462.charAt(i);
					if (i_5_ < 48 || i_5_ > 57)
						break;
			...
			((Class298_Sub44) this).anInt7469 = GameShell.maximumMemory * -633367115;
			if (154600941 * anInt7492 > 3)
				((Class298_Sub44) this).anInt7498 = GameShell.availableCPU * -1360223467;
			else
			...
			try {
				...
				if (is_6_ != null && is_6_.length % 5 == 0) {
					...
					if (null != class472) {
						Packet class298_sub53 = new Packet(13);
					...
					Packet class298_sub53 = new Packet(49);
