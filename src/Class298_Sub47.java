...
public class Class298_Sub47 extends Node {
	...
	static void method3535(Player player, boolean bool, int i) {
		try {
			if (-278777595 * ContextMenu.actionCount < 410) {
				if (player == Class287.myPlayer) {
					...
					if (player.currentHitpoints * 242930343 == 0) {
						...
						if (-1 != (Class287.myPlayer.animationDelay) * 1792775047 && -1 != 1792775047 * (player.animationDelay)) {
							int i_1_ = (((1792775047 * (Class287.myPlayer.animationDelay)) < (player.animationDelay * 1792775047)) ? (1792775047 * (Class287.myPlayer.animationDelay)) : (player.animationDelay * 1792775047));
							int i_2_ = ((696798311 * (Class287.myPlayer.maxHitpoints)) - 696798311 * (player.maxHitpoints));
							if (i_2_ < 0)
								i_2_ = -i_2_;
							if (i_2_ > i_1_)
								bool_0_ = false;
						...
						if (player.maxHitpoints * 696798311 >= (player.turnAnimation * 1868645317))
							...
							string = new StringBuilder().append(player.getFullName(true, -2010483537)).append(bool_0_ ? (Class18.method358((player.maxHitpoints) * 696798311, (696798311 * (Class287.myPlayer.maxHitpoints)), (byte) 4)) : Class285.method2709(16777215, -1929125845)).append(Symbol.OPEN_PARENTHESES).append(string_3_).append(696798311 * (player.maxHitpoints)).append("+").append((1868645317 * (player.turnAnimation)) - (player.maxHitpoints) * 696798311).append(Symbol.CLOSE_PARENTHESES).toString();
							...
							if (GameClient.aStringArray8820[i_4_] != null) {
								...
								if ((GameClient.aGameContext_8944 == GameContext.aGameContext_5320) && (GameClient.aStringArray8820[i_4_].equalsIgnoreCase(LocalizedString.BUTTON_ATTACK.getText(DynamicLight.ACTIVE_LANGUAGE, -875414210)))) {
									...
									if ((0 != (Class287.myPlayer.teamId) * -1473655357) && (-1473655357 * (player.teamId)) != 0) {
										if ((player.teamId) * -1473655357 == (Class287.myPlayer.teamId) * -1473655357)
											i_5_ = (short) 2000;
										else
											i_5_ = (short) 0;
								...
								Class234.method2174(GameClient.aStringArray8820[i_4_], new StringBuilder().append(Class285.method2709(16777215, -1822012281)).append(string).toString(), i_7_, i_6_, -1, (long) (1888274983 * (player.entityIndex)), 0, 0, true, false, (long) ((player.entityIndex) * 1888274983), false, -1451194858);
							}
						}
					} else
						Class234.method2174(new StringBuilder().append(Class285.method2709(13421772, -1997294576)).append(string).toString(), "", -1, -1, 0, 0L, 0, 0, false, true, (long) (player.entityIndex * 1888274983), false, -1271989822);
					if (!bool) {
