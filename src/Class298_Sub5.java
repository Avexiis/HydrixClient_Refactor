...
public class Class298_Sub5 extends Node {
	...
	void method2857(int i, int i_2_, int i_3_, float f) {
		if (((Class298_Sub5) this).anInt7199 != -1) {
			MaterialRaw materialRaw = ((Class298_Sub5) this).aClass_ra_Sub2_7197.anInterface_ma5299.method174(((Class298_Sub5) this).anInt7199, 1908731420);
	...
	void method2861(int[] is, int i) {
		...
		if (i_16_ > 0) {
			((Class298_Sub5) this).aClass46_Sub1_7201.method19(5123, class298_sub53_sub1.payload, class298_sub53_sub1.pos * 385051775);
