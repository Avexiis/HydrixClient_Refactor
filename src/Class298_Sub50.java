...
public abstract class Class298_Sub50 extends Node {
	...
	static Class211[] method3566(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("acr.a(").append(')').toString());
		}
	}
	...
	public static void method3567(int i, int i_0_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("acr.s(").append(')').toString());
		}
	}
}
