...
public final class Class298_Sub50_Sub1 extends Class298_Sub50 {
	...
	public int method3546(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ajn.a(").append(')').toString());
		}
	}
	...
	public int method3547(byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ajn.f(").append(')').toString());
		}
	}
	...
	public int method3560(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ajn.b(").append(')').toString());
		}
	}
	...
	public long method3549(byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ajn.i(").append(')').toString());
		}
	}
	...
	public void method3550(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ajn.d(").append(')').toString());
		}
	}
	...
	public int method3548(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ajn.p(").append(')').toString());
		}
	}
