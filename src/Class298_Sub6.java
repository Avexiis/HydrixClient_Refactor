...
public class Class298_Sub6 extends Node {
	...
	int anInt7204;
	int anInt7205;
	WorldMapArea aWorldMapArea_7206;
	int anInt7207;
	int anInt7208;
	...
	boolean method2862(int i, int i_0_, byte i_1_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aaj.a(").append(')').toString());
		}
	}

	Class298_Sub6(WorldMapArea worldMapArea) {
		...
		((Class298_Sub6) this).aWorldMapArea_7206 = worldMapArea;
	}
	...
	static final int[] method2863(String string, ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aaj.kl(").append(')').toString());
		}
	}
}
