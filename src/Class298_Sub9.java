...
public class Class298_Sub9 extends Node {
	...
	final ModelPart method2891(GraphicsToolkit class_ra, int i, Animator animator, int i_0_, boolean bool, Class366 class366, byte i_1_) {
		try {
			...
			if (animator != null)
				i_2_ |= animator.method5829(-1790708337);
			long l = method2892(is, i_0_, null != class366 ? class366.anIntArray3973 : null, bool, 551500137);
			if (aClass348_7223 != null)
				modelPart = (ModelPart) aClass348_7223.get(l);
			if (null == modelPart || class_ra.method5017(modelPart.m(), i_2_) != 0) {
				if (modelPart != null)
					i_2_ = class_ra.method5004(i_2_, modelPart.m());
				int i_5_ = i_2_;
				...
				if (null != class366)
					i_5_ |= 0x4000;
				modelPart = class_ra.method5037(class64, i_5_, anInt7225 * 1310831989, 66, 850);
				if (class366 != null) {
					for (int i_16_ = 0; i_16_ < 10; i_16_++) {
						for (int i_17_ = 0; (i_17_ < Class366.aShortArrayArray3970[i_16_].length); i_17_++) {
							if (class366.anIntArray3973[i_16_] < (Class22.aShortArrayArrayArray278[i_16_][i_17_]).length)
								modelPart.X((Class366.aShortArrayArray3970[i_16_][i_17_]), (Class22.aShortArrayArrayArray278[i_16_][i_17_][class366.anIntArray3973[i_16_]]));
						}
					}
				}
				if (null != aClass348_7223) {
					modelPart.KA(i_2_);
					aClass348_7223.put(modelPart, l);
				}
			}
			if (animator == null)
				return modelPart;
			ModelPart modelPart_18_ = modelPart.method4755((byte) 1, i_2_, true);
			animator.method5839(modelPart_18_, 0, -1119502581);
			return modelPart_18_;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aam.n(").append(')').toString());
		}
	}
	...
	long method2892(int[] is, int i, int[] is_19_, boolean bool, int i_20_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aam.q(").append(')').toString());
		}
	}

	static void method2893(Packet class298_sub53, int i) {
		try {
			for (int i_23_ = 0; i_23_ < 1017276543 * Class24.anInt9950; i_23_++) {
				int i_24_ = class298_sub53.readUnsignedSmart();
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aam.p(").append(')').toString());
		}
	}
}
