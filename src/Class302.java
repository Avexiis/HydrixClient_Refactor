...
public class Class302 {
	...
	public void method3714(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("mo.a(").append(')').toString());
		}
	}
	...
	static final void method3715(ClientScript2 class403, byte i) {
		try {
			...
			ContextMenu.aBoolean5496 = false;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("mo.afj(").append(')').toString());
		}
	}
	...
	static boolean method3716(int i, int i_0_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("mo.bb(").append(')').toString());
		}
	}
	...
	static final void method3717(long l) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("mo.f(").append(')').toString());
		}
	}
	...
	static void method3718(int i, int i_1_, int i_2_, int i_3_, int i_4_, int i_5_, int i_6_, int i_7_, int i_8_, int i_9_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("mo.ax(").append(')').toString());
		}
	}
}
