...
public abstract class Class308 {
	...
	public Class298_Sub24_Sub1 method3763(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("mu.r(").append(')').toString());
		}
	}
	...
	public void method3764(String string, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("mu.s(").append(')').toString());
		}
	}
	...
	void method3765(int i) throws IOException {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("mu.p(").append(')').toString());
		}
	}
	...
	void method3767(byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("mu.i(").append(')').toString());
		}
	}
	...
	boolean method3768(int i) {
		try {
			...
			return (0.0 == d || ((double) TimeUtils.getTime((byte) 1) >= (double) ((Class308) this).aClass298_Sub24_Sub3_3278.method3086((byte) 0) + 1000.0 / d));
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("mu.k(").append(')').toString());
		}
	}
	...
	void method3769(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("mu.d(").append(')').toString());
		}
	}
	...
	public Class298_Sub24_Sub3 method3770(byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("mu.x(").append(')').toString());
		}
	}
	...
	public void method3771(byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("mu.u(").append(')').toString());
		}
	}
	...
	public Class298_Sub24_Sub4 method3772(byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("mu.q(").append(')').toString());
		}
	}
	...
	public boolean method3773(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("mu.n(").append(')').toString());
		}
	}
	...
	Class298_Sub24 method3774(byte i) throws IOException {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("mu.f(").append(')').toString());
		}
	}
	...
	public void method3776(boolean bool, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("mu.y(").append(')').toString());
		}
	}
	...
	public double method3779(short i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("mu.z(").append(')').toString());
		}
	}
	...
	public void method3780(byte i) throws IOException {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("mu.b(").append(')').toString());
		}
	}
	...
	static final void method3781(ClientScript2 class403, byte i) {
		try {
			...
			RSInterface RSInterface = SpotAnimTypeList.aRSInterfaceArray4165[i_6_ >> 16];
			Class380.method4681(class105, RSInterface, class403, 1808304001);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("mu.la(").append(')').toString());
		}
	}
	...
	static final void method3783(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("mu.dh(").append(')').toString());
		}
	}
	...
	public static void method3784(byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("mu.a(").append(')').toString());
		}
	}
}
