...
public class Class309_Sub1 extends Class309 {
	...
	int method3791(long l) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aaf.i(").append(')').toString());
		}
	}
	...
	long method3794(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aaf.k(").append(')').toString());
		}
	}
	...
	long method3805(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aaf.e(").append(')').toString());
		}
	}
	...
	void method3788(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aaf.b(").append(')').toString());
		}
	}
	...
	long method3789(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aaf.p(").append(')').toString());
		}
	}
	...
	static final void method3806(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aaf.dm(").append(')').toString());
		}
	}
	...
	public static SubIncommingPacket[] method3807(byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aaf.a(").append(')').toString());
		}
	}
}
