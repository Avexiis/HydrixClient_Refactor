...
public class Class309_Sub2 extends Class309 {
	...
	long method3794(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aau.k(").append(')').toString());
		}
	}
	...
	int method3791(long l) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aau.i(").append(')').toString());
		}
	}
	...
	void method3788(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aau.b(").append(')').toString());
		}
	}
	...
	long method3789(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aau.p(").append(')').toString());
		}
	}
	...
	long method3808(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aau.e(").append(')').toString());
		}
	}
