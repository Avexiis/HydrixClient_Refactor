...
public class Class31 {
	...
	Class31(Class_ra_Sub2 class_ra_sub2, Class44 class44, Class_xa_Sub3 class_xa_sub3, int i, int i_9_, int i_10_, int i_11_, int i_12_) {
		...
		if (i_14_ > 0) {
			Packet class298_sub53 = new Packet(i_14_ * 2);
			...
			((Class31) this).anInterface2_392 = (((Class31) this).aClass_ra_Sub2_386.method5284(5123, class298_sub53.payload, class298_sub53.pos * 385051775, false));
