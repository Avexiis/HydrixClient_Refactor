...
public class Class310 implements Interface17 {
	...
	static void method3810(GraphicsToolkit class_ra, int i) {
		try {
			...
			Class101.aClass264_1084.method2488(LocalizedString.BUTTON_CHOOSE_OPTION.getText(DynamicLight.ACTIVE_LANGUAGE, -875414210), -1347746885 * Class88.anInt806 + 3, 1089948687 * TileText.anInt7658 + 14, i_6_, -1, 1583712486);
			...
			if (!ContextMenu.aBoolean5471) {
				...
				for (Class298_Sub37_Sub15 class298_sub37_sub15 = ((Class298_Sub37_Sub15) ContextMenu.aLinkedNodeList_5480.method5939(1766612795)); class298_sub37_sub15 != null; class298_sub37_sub15 = ((Class298_Sub37_Sub15) ContextMenu.aLinkedNodeList_5480.method5944(49146))) {
					...
					GraphicsToolkit.method5192(i_7_, i_8_, -1347746885 * Class88.anInt806, 1089948687 * TileText.anInt7658, 608683427 * Class134.anInt6343, 1396607435 * Class448.anInt5619, i_10_, class298_sub37_sub15, Class101.aClass264_1084, GroundSpotAnimUpdate.CONSOLE_PRIMARY_FONT, -1, -256, 247690373);
					i_9_++;
				}
			} else {
				int i_11_ = 0;
				for (Class298_Sub37_Sub5 class298_sub37_sub5 = ((Class298_Sub37_Sub5) ContextMenu.aClass461_5482.method5984(198728515)); null != class298_sub37_sub5; class298_sub37_sub5 = ((Class298_Sub37_Sub5) ContextMenu.aClass461_5482.method5985(30142288))) {
					...
					if (1 == (((Class298_Sub37_Sub5) class298_sub37_sub5).anInt9583) * -628325139)
						GraphicsToolkit.method5192(i_7_, i_8_, -1347746885 * Class88.anInt806, TileText.anInt7658 * 1089948687, 608683427 * Class134.anInt6343, Class448.anInt5619 * 1396607435, i_12_, ((Class298_Sub37_Sub15) (((Class298_Sub37_Sub5) class298_sub37_sub5).aClass461_9584.aClass298_Sub37_5679.aClass298_Sub37_7405)), Class101.aClass264_1084, GroundSpotAnimUpdate.CONSOLE_PRIMARY_FONT, -1, -256, 1821923505);
					else
						EnvironmentMap.method763(i_7_, i_8_, Class88.anInt806 * -1347746885, 1089948687 * TileText.anInt7658, Class134.anInt6343 * 608683427, Class448.anInt5619 * 1396607435, i_12_, class298_sub37_sub5, Class101.aClass264_1084, GroundSpotAnimUpdate.CONSOLE_PRIMARY_FONT, -1, -256, (byte) -19);
					i_11_++;
				}
				if (null != ContextMenu.aClass298_Sub37_Sub5_5472) {
					...
					for (Class298_Sub37_Sub15 class298_sub37_sub15 = ((Class298_Sub37_Sub15) ((Class298_Sub37_Sub5) ContextMenu.aClass298_Sub37_Sub5_5472).aClass461_9584.method5984(-783790871)); null != class298_sub37_sub15; class298_sub37_sub15 = ((Class298_Sub37_Sub15) ((Class298_Sub37_Sub5) ContextMenu.aClass298_Sub37_Sub5_5472).aClass461_9584.method5985(505275870))) {
						...
						GraphicsToolkit.method5192(i_7_, i_8_, 805710735 * Class461.anInt5681, -1370784315 * Class501.anInt6119, 2054409059 * Class420.anInt5345, SpotAnimTypeList.anInt4166 * -1855216229, i_13_, class298_sub37_sub15, Class101.aClass264_1084, GroundSpotAnimUpdate.CONSOLE_PRIMARY_FONT, -1, -256, 916241136);
						i_11_++;
					}
				}
			}
