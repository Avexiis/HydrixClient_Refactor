...
public class Class313 {
	...
	public static void method3820(int i, int i_0_, boolean bool, int i_1_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("n.a(").append(')').toString());
		}
	}
	...
	static int[] method3821(Class298_Sub37_Sub15 class298_sub37_sub15, byte i) {
		try {
			...
			if (Class398.method4920(946432351 * (((Class298_Sub37_Sub15) class298_sub37_sub15).anInt9662), (short) 300))
				...
				LinkableObject linkableObject = ((LinkableObject) (GameClient.npcs.get((long) (int) (2236412381003659263L * ((Class298_Sub37_Sub15) class298_sub37_sub15).aLong9661))));
				...
				LocType class432 = (GameClient.map.method2641(150013546).list((int) (2236412381003659263L * (((Class298_Sub37_Sub15) class298_sub37_sub15).aLong9661) >>> 32 & 0x7fffffffL)));
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("n.ag(").append(')').toString());
		}
	}
	...
	static final void method3822(ClientScript2 class403, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("n.qm(").append(')').toString());
		}
	}
}
