...
public final class Class315 {
	...
	static final void method3834(SubIncommingPacket class206, short i) {
		try {
			RsBitsBuffer class298_sub53_sub2 = ((Class25) GameClient.gameConnection).aClass298_Sub53_Sub2_333;
			if (SubIncommingPacket.aClass206_2347 == class206) {
				...
				if (GameClient.map.method2674(-586078948) != Class266.aClass266_2846)
					LocalizedString.handleSceneObjectAction(FloTypeList.basePlane * -191892109, i_13_, i_14_, i_11_, i_9_, i_10_, i_7_, -1921538188);
				...
				LocType class432 = GameClient.map.method2641(-527347356).list(i_21_);
				...
				if (class432.shapes != null) {
					...
					i_23_ = class432.models[i_24_].length;
				}
				int i_26_ = 0;
				...
				if (1 == (i_22_ & 0x1))
					ClanSettings.method4579(-191892109 * FloTypeList.basePlane, i_19_, i_20_, i_17_, i_21_, i_16_, null, (byte) -43);
				else {
					int[] is = null;
					if ((i_22_ & 0x2) == 2) {
						is = new int[i_23_];
						for (int i_28_ = 0; i_28_ < i_23_; i_28_++)
							is[i_28_] = class298_sub53_sub2.readUnsignedInt();
					}
					short[] is_29_ = null;
					if (4 == (i_22_ & 0x4)) {
					...
					ClanSettings.method4579(-191892109 * FloTypeList.basePlane, i_19_, i_20_, i_17_, i_21_, i_16_, new Class435((ObjectDeque.aLong7163 * -5796734886992507517L), is, is_29_, is_31_), (byte) 8);
					ObjectDeque.aLong7163 += 2843605614692854059L;
				}
				...
				if (GameClient.map.method2674(99999280).method2522((byte) -3) || (i_38_ >= 0 && i_39_ >= 0 && (i_38_ < GameClient.map.upperX(-1871735876)) && (i_39_ < GameClient.map.upperY(-164212893))))
					Class420.method5606(-191892109 * FloTypeList.basePlane, i_38_, i_39_, i_36_, -1, i_34_, i_35_, 322889547);
				...
				if (i_51_ == 255)
					i_51_ = -1;
				if (GameClient.map.method2674(-135283377) != Class266.aClass266_2846) {
					if (i_41_ >= 0 && i_42_ >= 0 && (i_41_ < GameClient.map.upperX(-2115187525)) && i_42_ < GameClient.map.upperY(1222512663) && i_43_ >= 0 && i_44_ >= 0 && (i_43_ < GameClient.map.upperX(-2121627992)) && (i_44_ < GameClient.map.upperY(-2081531222)) && i_46_ != 65535) {
						i_41_ = 256 + 512 * i_41_;
						i_42_ = 256 + 512 * i_42_;
						i_43_ = 256 + i_43_ * 512;
						i_44_ = i_44_ * 512 + 256;
						...
						i_48_ <<= 2;
						i_52_ <<= 2;
						Class365_Sub1_Sub1_Sub1 class365_sub1_sub1_sub1 = (new Class365_Sub1_Sub1_Sub1(GameClient.map.method2675(-1611682495), i_46_, -191892109 * FloTypeList.basePlane, FloTypeList.basePlane * -191892109, i_41_, i_42_, i_47_, i_49_ + GameClient.anInt8884 * 443738891, GameClient.anInt8884 * 443738891 + i_50_, i_51_, i_52_, 0, i_45_, i_48_, bool, -1));
						class365_sub1_sub1_sub1.method4405(i_43_, i_44_, Class356.method4271(i_43_, i_44_, (-191892109 * FloTypeList.basePlane), -1671970391) - i_48_, 443738891 * GameClient.anInt8884 + i_49_, -53743739);
						GameClient.projectiles.addlast(new Class298_Sub37_Sub2(class365_sub1_sub1_sub1), 719403792);
					}
				}
				...
				int i_55_ = i_54_ + worldTile.y * 283514611;
				int i_56_ = Class162.baseTileX * 134435705 + (i_53_ >> 4 & 0x7);
				int i_57_ = worldTile.x * -1760580017 + i_56_;
				...
				boolean bool = (i_56_ >= 0 && i_54_ >= 0 && i_56_ < GameClient.map.upperX(-2010293889) && (i_54_ < GameClient.map.upperY(-747226515)));
				if (bool || GameClient.map.method2674(131556130).method2522((byte) -65)) {
					GameContext.method5576(FloTypeList.basePlane * -191892109, i_57_, i_55_, new Class298_Sub12(i_59_, i_58_), -369193084);
					if (bool)
						Class173.method1820(-191892109 * FloTypeList.basePlane, i_56_, i_54_, 1649431547);
				}
			} else if (class206 == SubIncommingPacket.aClass206_2348) {
				int i_60_ = class298_sub53_sub2.readUnsignedInt();
				int i_61_ = class298_sub53_sub2.readUnsignedByte();
				GameClient.map.method2641(267585287).list(i_60_).method5771(i_61_, (byte) 28);
				...
				int i_64_ = 283514611 * worldTile.y + i_63_;
				int i_65_ = (i_62_ >> 4 & 0x7) + 134435705 * Class162.baseTileX;
				int i_66_ = i_65_ + -1760580017 * worldTile.x;
				...
				if (null != GameClient.groundTiles) {
					Class298_Sub2 class298_sub2 = ((Class298_Sub2) (GameClient.groundTiles.get((long) (-191892109 * FloTypeList.basePlane << 28 | i_64_ << 14 | i_66_))));
					if (class298_sub2 != null) {
						for (Class298_Sub12 class298_sub12 = ((Class298_Sub12) class298_sub2.aLinkedNodeList_7166.method5939(1766612795)); null != class298_sub12; class298_sub12 = (Class298_Sub12) class298_sub2.aLinkedNodeList_7166.method5944(49146)) {
							if ((class298_sub12.anInt7257 * 1768239597 == (i_67_ & 0x7fff)) && (567630807 * ((Class298_Sub12) class298_sub12).anInt7256 == i_68_)) {
								...
								GameContext.method5576((FloTypeList.basePlane * -191892109), i_66_, i_64_, class298_sub12, -2035381169);
								break;
							}
						}
						if (i_65_ >= 0 && i_63_ >= 0 && i_65_ < GameClient.map.upperX(-2131588637) && i_63_ < GameClient.map.upperY(-523876912))
							Class173.method1820((-191892109 * FloTypeList.basePlane), i_65_, i_63_, 1760601086);
					}
				}
				...
				if (GameClient.map.method2674(39788259).method2522((byte) 29) || (i_77_ >= 0 && i_78_ >= 0 && (i_77_ < GameClient.map.upperX(-2063854515)) && (i_78_ < GameClient.map.upperY(-1828303048))))
					Class420.method5606(-191892109 * FloTypeList.basePlane, i_77_, i_78_, i_82_, i_83_, i_80_, i_81_, 2010363527);
				...
				int i_89_ = worldTile.y * 283514611 + i_88_;
				int i_90_ = Class162.baseTileX * 134435705 + (i_87_ >> 4 & 0x7);
				int i_91_ = -1760580017 * worldTile.x + i_90_;
				if (i_84_ != -442628795 * GameClient.playerIndex) {
					boolean bool = (i_90_ >= 0 && i_88_ >= 0 && i_90_ < GameClient.map.upperX(-2004210913) && i_88_ < GameClient.map.upperY(133385720));
					if (bool || GameClient.map.method2674(1297675002).method2522((byte) -41)) {
						GameContext.method5576(-191892109 * FloTypeList.basePlane, i_91_, i_89_, new Class298_Sub12(i_85_, i_86_), 1214818737);
						if (bool)
							Class173.method1820((FloTypeList.basePlane * -191892109), i_90_, i_88_, 1328737922);
					}
				}
				...
				if (i_107_ == 255)
					i_107_ = -1;
				if (GameClient.map.method2674(781301439) != Class266.aClass266_2846) {
					if (i_93_ >= 0 && i_94_ >= 0 && i_93_ < GameClient.map.upperX(-2097499815) * 2 && i_94_ < GameClient.map.upperX(-1925634796) * 2 && i_98_ >= 0 && i_99_ >= 0 && i_98_ < GameClient.map.upperY(-2066893296) * 2 && (i_99_ < GameClient.map.upperY(1895360083) * 2) && 65535 != i_102_) {
						i_93_ *= 256;
						i_94_ = 256 * i_94_;
						i_98_ = 256 * i_98_;
						i_99_ *= 256;
				...
				if (GameClient.map.method2674(569302746) != Class266.aClass266_2846) {
					if (i_110_ >= 0 && i_111_ >= 0 && (i_110_ < GameClient.map.upperX(-2099610751)) && (i_111_ < GameClient.map.upperY(-358830712))) {
						int i_119_ = 1 + i_114_;
						if ((Class287.myPlayer.scenePositionXQueue[0]) >= i_110_ - i_119_ && (Class287.myPlayer.scenePositionXQueue[0]) <= i_119_ + i_110_ && (Class287.myPlayer.scenePositionYQueue[0]) >= i_111_ - i_119_ && (Class287.myPlayer.scenePositionYQueue[0]) <= i_119_ + i_111_)
							Class69.method789(i_112_, i_115_, i_116_, i_117_, ((-191892109 * FloTypeList.basePlane << 24) + (i_110_ << 16) + (i_111_ << 8) + i_114_), i_118_, -1062229425);
					}
				}
				...
				if (GameClient.map.method2674(1544127575) != Class266.aClass266_2846) {
					if (i_121_ >= 0 && i_122_ >= 0 && (i_121_ < GameClient.map.upperX(-2060803867)) && (i_122_ < GameClient.map.upperY(210266167))) {
						if (-1 == i_123_) {
							Class298_Sub37_Sub3 class298_sub37_sub3 = ((Class298_Sub37_Sub3) (GameClient.animatedObjects.get((long) (i_121_ << 16 | i_122_))));
							...
							int i_129_ = FloTypeList.basePlane * -191892109;
							if (i_129_ < 3 && GameClient.map.method2654(1627070231).method2320(i_121_, i_122_, 575492228))
								i_129_++;
							Class365_Sub1_Sub1_Sub3 class365_sub1_sub1_sub3 = (new Class365_Sub1_Sub1_Sub3(GameClient.map.method2675(-1611682495), i_123_, i_125_, -191892109 * FloTypeList.basePlane, i_129_, i_127_, Class356.method4271(i_127_, i_128_, (FloTypeList.basePlane * -191892109), -1861382449) - i_124_, i_128_, i_121_, i_121_, i_122_, i_122_, i_126_, false));
							GameClient.animatedObjects.method5817((new Class298_Sub37_Sub3(class365_sub1_sub1_sub3)), (long) (i_121_ << 16 | i_122_));
						}
					}
				}
				...
				if (GameClient.map.method2674(39884684) != Class266.aClass266_2846) {
					if (i_131_ >= 0 && i_132_ >= 0 && (i_131_ < GameClient.map.upperX(-2049168352)) && (i_132_ < GameClient.map.upperY(91496889))) {
						int i_140_ = i_135_ + 1;
						if ((Class287.myPlayer.scenePositionXQueue[0]) >= i_131_ - i_140_ && (Class287.myPlayer.scenePositionXQueue[0]) <= i_140_ + i_131_ && (Class287.myPlayer.scenePositionYQueue[0]) >= i_132_ - i_140_ && (Class287.myPlayer.scenePositionYQueue[0]) <= i_140_ + i_132_)
							Class336_Sub4.method4103(i_133_, i_136_, i_137_, i_138_, ((i_131_ << 16) + ((-191892109 * FloTypeList.basePlane) << 24) + (i_132_ << 8) + i_135_), bool, i_139_, -889648047);
					}
				}
				...
				int i_144_ = 283514611 * worldTile.y + i_143_;
				int i_145_ = 134435705 * Class162.baseTileX + (i_142_ >> 4 & 0x7);
				int i_146_ = i_145_ + -1760580017 * worldTile.x;
				Class298_Sub2 class298_sub2 = ((Class298_Sub2) (GameClient.groundTiles.get((long) (FloTypeList.basePlane * -191892109 << 28 | i_144_ << 14 | i_146_))));
				if (class298_sub2 != null) {
					...
					if (class298_sub2.aLinkedNodeList_7166.method5946(-1293494081))
						class298_sub2.unlink(-1460969981);
					if (i_145_ >= 0 && i_143_ >= 0 && (i_145_ < GameClient.map.upperX(-1929078790)) && (i_143_ < GameClient.map.upperY(-999181271)))
						Class173.method1820(FloTypeList.basePlane * -191892109, i_145_, i_143_, 547814341);
				}
			} else {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("nd.jh(").append(')').toString());
		}
	}
	...
	static void method3835(int i, int i_147_, int i_148_, int i_149_, int i_150_, byte i_151_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("nd.h(").append(')').toString());
		}
	}
	...
	static final void method3836(int i, int i_156_, int i_157_, int i_158_, int i_159_, int i_160_, byte i_161_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("nd.q(").append(')').toString());
		}
	}
	...
	public static void method3838(int i, int i_190_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("nd.ad(").append(')').toString());
		}
	}
}
