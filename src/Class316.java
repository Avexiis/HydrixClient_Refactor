...
public class Class316 implements Runnable {
	...
	void method3839(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ne.i(").append(')').toString());
		}
	}
	...
	public void run() {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ne.run(").append(')').toString());
		}
	}
	...
	boolean method3840(int i, int i_1_) throws IOException {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ne.a(").append(')').toString());
		}
	}
	...
	int method3841(byte i) throws IOException {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ne.f(").append(')').toString());
		}
	}
	...
	void method3842(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ne.p(").append(')').toString());
		}
	}
	...
	int method3843(byte[] is, int i, int i_5_, byte i_6_) throws IOException {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ne.b(").append(')').toString());
		}
	}
	...
	static final void method3844(int i, HashTable class437, int i_10_) {
		try {
			if (-1 != i && class437.get((long) i) == null)
				class437.method5817(new Node(), (long) i);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ne.d(").append(')').toString());
		}
	}
}
