...
public abstract class Class318 {
	...
	static final void method3870(ClientScript2 class403, int i) {
		try {
			if (GameClient.anInt8942 * 1131012101 == 0)
				...
				((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919) - 1] = GameClient.anInt8941 * -1054937867;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ng.vb(").append(')').toString());
		}
	}
	...
	static final void method3871(ClientScript2 class403, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ng.yo(").append(')').toString());
		}
	}
	...
	static final void method3872(ClientScript2 class403, int i) {
		try {
			...
			GameClient.aShort8928 = (short) (((ClientScript2) class403).anIntArray5244[((ClientScript2) class403).anInt5239 * 681479919]);
			if (GameClient.aShort8928 <= 0)
				GameClient.aShort8928 = (short) 256;
			GameClient.aShort8929 = (short) (((ClientScript2) class403).anIntArray5244[681479919 * ((ClientScript2) class403).anInt5239 + 1]);
			if (GameClient.aShort8929 <= 0)
				GameClient.aShort8929 = (short) 205;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ng.akb(").append(')').toString());
		}
	}
	...
	static void method3873(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ng.lk(").append(')').toString());
		}
	}
	...
	public static Container method3874(byte i) {
		try {
			...
			return EnumType.mainApplet;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ng.t(").append(')').toString());
		}
	}

	static final void method3875(IComponentDefinition class105, RSInterface RSInterface, ClientScript2 class403, int i) {
		try {
			...
			LocalizedString.markComponentForRedraw(class105, -903706483);
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ng.ck(").append(')').toString());
		}
	}
}
