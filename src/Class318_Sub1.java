...
public class Class318_Sub1 extends Class318 {
	...
	public boolean isAvailable(int i, byte i_1_) throws IOException {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("acl.f(").append(')').toString());
		}
	}
	...
	public int method3857(int i) throws IOException {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("acl.b(").append(')').toString());
		}
	}
	...
	public int readBytes(byte[] is, int i, int i_2_, byte i_3_) throws IOException {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("acl.p(").append(')').toString());
		}
	}
	...
	public void method3868(byte[] is, int i, int i_4_, int i_5_) throws IOException {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("acl.i(").append(')').toString());
		}
	}
	...
	public void method3860(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("acl.k(").append(')').toString());
		}
	}
	...
	public void method3867(byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("acl.d(").append(')').toString());
		}
	}
	...
	protected void finalize() {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("acl.finalize(").append(')').toString());
		}
	}
	...
	static final void method3876(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("acl.uv(").append(')').toString());
		}
	}
}
