...
public abstract class Class319 {
	...
	public boolean method3881(byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("nh.d(").append(')').toString());
		}
	}
	...
	static void method3900(GraphicsToolkit class_ra, int i, int i_0_, int i_1_, int i_2_, int i_3_, Class264 class264, GameFont gameFont, String string, int i_4_) {
		try {
			...
			if (Class313.aClass57_3299 == null || Class423.aClass57_5356 == null) {
				if (Class158.aClass243_6364.method2310(Class362.anInt3918 * 142643703, -457216440) && Class158.aClass243_6364.method2310(((ToolkitPreference.anInt8400) * 1757615047), -457216440)) {
					Class313.aClass57_3299 = (class_ra.method5125(Class89.method987(Class158.aClass243_6364, Class362.anInt3918 * 142643703, 0), true));
					Class89 class89 = Class89.method987(Class158.aClass243_6364, (ToolkitPreference.anInt8400 * 1757615047), 0);
					Class423.aClass57_5356 = class_ra.method5125(class89, true);
					class89.method992();
					Class74.aClass57_700 = class_ra.method5125(class89, true);
				} else
					class_ra.drawFilledBox(i, i_0_, i_1_, i_3_, i_5_ << 24 | 1018380409 * IPAddress.anInt5958, 1);
			}
			if (Class313.aClass57_3299 != null && Class423.aClass57_5356 != null) {
	...
	static final void method3901(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("nh.uu(").append(')').toString());
		}
	}
	...
	static boolean method3902(int i, int i_12_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("nh.fn(").append(')').toString());
		}
	}
	...
	public static final void method3903(byte i) {
		try {
			...
			Class298_Sub36 class298_sub36 = Class18.method359(OutgoingPacket.JOIN_FRIEND_CHAT_PACKET, class25.aClass449_330, (byte) 59);
			class298_sub36.buffer.writeByte(0);
			class25.writeOutboundPacket(class298_sub36, (byte) -71);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("nh.ml(").append(')').toString());
		}
	}
	...
	static void method3904(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("nh.ae(").append(')').toString());
		}
	}
}
