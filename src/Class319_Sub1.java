...
public class Class319_Sub1 extends Class319 implements MouseListener, MouseMotionListener, MouseWheelListener {
	...
	public boolean method3878(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aci.p(").append(')').toString());
		}
	}
	...
	void method3905(Component component, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aci.at(").append(')').toString());
		}
	}
	...
	void method3906(int i) {
		try {
			if (null != ((Class319_Sub1) this).aComponent7702) {
				...
				((Class319_Sub1) this).aLinkedNodeList_7697 = null;
				((Class319_Sub1) this).aLinkedNodeList_7691 = null;
			}
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aci.ah(").append(')').toString());
		}
	}
	...
	void method3907(int i, int i_0_, int i_1_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aci.al(").append(')').toString());
		}
	}
	...
	public boolean method3887(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aci.i(").append(')').toString());
		}
	}

	Class319_Sub1(Component component, boolean bool) {
		((Class319_Sub1) this).aLinkedNodeList_7691 = new LinkedNodeList();
	...
	void method3908(int i, int i_2_, int i_3_, int i_4_, int i_5_) {
		try {
			...
			((Class319_Sub1) this).aLinkedNodeList_7691.addlast(class298_sub50_sub1, 534328737);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aci.ai(").append(')').toString());
		}
	}
	...
	public boolean method3880(byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aci.k(").append(')').toString());
		}
	}
	...
	public int getMouseY(byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aci.x(").append(')').toString());
		}
	}
	...
	public void method3882(byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aci.q(").append(')').toString());
		}
	}
	...
	public synchronized void mouseClicked(MouseEvent mouseevent) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aci.mouseClicked(").append(')').toString());
		}
	}
	...
	public synchronized void mouseEntered(MouseEvent mouseevent) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aci.mouseEntered(").append(')').toString());
		}
	}
	...
	public synchronized void mouseExited(MouseEvent mouseevent) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aci.mouseExited(").append(')').toString());
		}
	}
	...
	int method3909(MouseEvent mouseevent, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aci.az(").append(')').toString());
		}
	}
	...
	public synchronized void mousePressed(MouseEvent mouseevent) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aci.mousePressed(").append(')').toString());
		}
	}
	...
	public synchronized void mouseReleased(MouseEvent mouseevent) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aci.mouseReleased(").append(')').toString());
		}
	}
	...
	public synchronized void mouseDragged(MouseEvent mouseevent) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aci.mouseDragged(").append(')').toString());
		}
	}
	...
	public synchronized void mouseMoved(MouseEvent mouseevent) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aci.mouseMoved(").append(')').toString());
		}
	}
	...
	public synchronized void mouseWheelMoved(MouseWheelEvent mousewheelevent) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aci.mouseWheelMoved(").append(')').toString());
		}
...
//			    Class255.method2435("You can not zoom any farther inwards!", 93254474);
	...
	public synchronized void method3877() {
		...
		LinkedNodeList linkedNodeList = ((Class319_Sub1) this).aLinkedNodeList_7697;
		((Class319_Sub1) this).aLinkedNodeList_7697 = ((Class319_Sub1) this).aLinkedNodeList_7691;
		((Class319_Sub1) this).aLinkedNodeList_7691 = linkedNodeList;
		((Class319_Sub1) this).aLinkedNodeList_7691.method5943((byte) 1);
	}
	...
	public synchronized void method3886(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aci.b(").append(')').toString());
		}
	}
	...
	public Class298_Sub50 method3896() {
		return ((Class298_Sub50) ((Class319_Sub1) this).aLinkedNodeList_7697.method5936(2123266868));
	}

	public Class298_Sub50 method3885() {
		return ((Class298_Sub50) ((Class319_Sub1) this).aLinkedNodeList_7697.method5936(2127727655));
	}
	...
	public int getMouseX(byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aci.u(").append(')').toString());
		}
	}

	public Class298_Sub50 method3879(int i) {
		try {
			return (Class298_Sub50) ((Class319_Sub1) this).aLinkedNodeList_7697.method5936(2114584348);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aci.r(").append(')').toString());
		}
	}
