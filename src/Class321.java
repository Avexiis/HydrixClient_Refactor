...
public class Class321 {
	...
	void method3915(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("nj.b(").append(')').toString());
		}
	}
	...
	void method3916(GraphicsToolkit class_ra, int i, int i_0_, int i_1_, int i_2_, int i_3_, int i_4_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("nj.a(").append(')').toString());
		}
	}
	...
	public void method3917(int i, int i_5_, int i_6_, int i_7_, int i_8_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("nj.f(").append(')').toString());
		}
	}
	...
	void method3918(int i, boolean bool, byte i_9_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("nj.p(").append(')').toString());
		}
	}

	public Class321(GraphicsToolkit class_ra, int i, Packet class298_sub53, int i_12_) {
	...
	static final void method3919(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("nj.wd(").append(')').toString());
		}
	}
	...
	static final void method3920(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("nj.wm(").append(')').toString());
		}
	}
	...
	static final void method3921(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("nj.zt(").append(')').toString());
		}
	}
	...
	static final void method3922(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("nj.afa(").append(')').toString());
		}
	}
	...
	static String method3923(int i, int i_28_, boolean bool, int i_29_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("nj.x(").append(')').toString());
		}
	}
	...
	static final void method3924(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("nj.ady(").append(')').toString());
		}
	}
	...
	static final void method3925(IComponentDefinition class105, RSInterface RSInterface, ClientScript2 class403, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("nj.iy(").append(')').toString());
		}
	}
	...
	static final void method3926(int i, int i_35_, int i_36_, int i_37_, int i_38_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("nj.q(").append(')').toString());
		}
	}
	...
	public static void method3927(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("nj.k(").append(')').toString());
		}
	}
		...
		try {
			...
			try {
				if (i == 1)
					...
					Class255.sendDevConsoleMsg(new StringBuilder().append("").append(914379507 * GameShell.anInt6467).toString(), 1771664525);
				else if (i == 24) {
					...
					Class255.sendDevConsoleMsg(new StringBuilder().append("").append(i_41_).toString(), 1598262745);
				} else if (10 == i) {
					...
					Class255.sendDevConsoleMsg(new StringBuilder().append("").append(i_43_).toString(), 840220855);
					...
					Class255.sendDevConsoleMsg(new StringBuilder().append("").append(i_43_).toString(), 1145170625);
				} else if (15 == i)
					Class255.sendDevConsoleMsg((VertexNormal.jagexLibraryManager.method264(-242181565) ? "Success" : "Failure"), 1719326530);
				else if (2 == i)
					...
					Class255.sendDevConsoleMsg(new StringBuilder().append((int) sceneObjectPosition.x >> 9).append(" ").append((int) sceneObjectPosition.z >> 9).toString(), 2030018099);
				} else if (i == 7) {
					SceneObjectPosition sceneObjectPosition = (Class287.myPlayer.method4337().aSceneObjectPosition_2599);
					Class255.sendDevConsoleMsg(new StringBuilder().append("").append(GameClient.map.method2675(-1611682495).aGroundArray3517[(Class287.myPlayer.plane)].method6341((int) sceneObjectPosition.x >> 9, (int) sceneObjectPosition.z >> 9, (byte) -102)).toString(), 417961088);
				} else if (i == 3) {
					Class255.sendDevConsoleMsg(new StringBuilder().append(IComponentDefinition.aClass348_1135.method4192(-262201221)).append(" ").append(IComponentDefinition.aClass348_1135.method4188(-480173906)).toString(), 1301637250);
					Class255.sendDevConsoleMsg(new StringBuilder().append(IComponentDefinition.aClass348_1138.method4192(509188014)).append(" ").append(IComponentDefinition.aClass348_1138.method4188(2067697941)).toString(), 1826870364);
					Class255.sendDevConsoleMsg(new StringBuilder().append(Class298_Sub32_Sub14.aClass477_9400.aClass340_5995.method4135()).append(" ").append(Class298_Sub32_Sub14.aClass477_9400.aClass340_5995.method4133()).toString(), 1449325870);
				} else if (i == 6)
				...
				Class255.sendDevConsoleMsg(LocalizedString.MESSAGE_COMMAND_EXECUTION_ERROR.getText(ACTIVE_LANGUAGE, -875414210), 1297300690);
			}
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("nj.h(").append(')').toString());
		}
	}
}
