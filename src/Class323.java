...
public abstract class Class323 {
	...
	static final void method3946(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("nl.aeu(").append(')').toString());
		}
	}

	static final void method3947(IComponentDefinition class105, RSInterface RSInterface, ClientScript2 class403, int i) {
		try {
			if (4 == class105.type * -1215239439)
				Class165.method1781(class105, RSInterface, class403, (short) 8629);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("nl.gx(").append(')').toString());
		}
	}
	...
	static void method3948(GraphicsToolkit class_ra, int i, int i_5_, int i_6_, int i_7_, int i_8_, int i_9_, byte i_10_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("nl.aq(").append(')').toString());
		}
	}
