...
public final class Class323_Sub1 extends Class323 implements KeyListener, FocusListener {
	...
	LinkedNodeList aLinkedNodeList_7706 = new LinkedNodeList();
	static int anInt7707 = 112;
	boolean[] aBooleanArray7708;
	Component aComponent7709;
	LinkedNodeList aLinkedNodeList_7710 = new LinkedNodeList();
	...
	void method3950(Component component, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("acn.h(").append(')').toString());
		}
	}
	...
	void method3951(int i) {
		try {
			if (null != ((Class323_Sub1) this).aComponent7709) {
				...
				((Class323_Sub1) this).aLinkedNodeList_7706.method5943((byte) 1);
				((Class323_Sub1) this).aLinkedNodeList_7710.method5943((byte) 1);
			}
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("acn.v(").append(')').toString());
		}
	}
	...
	void method3952(int i, char c, int i_1_, int i_2_) {
		try {
			...
			((Class298_Sub43) class298_sub43).aLong6509 = TimeUtils.getTime((byte) 1) * -6780259989437506341L;
			((Class323_Sub1) this).aLinkedNodeList_7710.addlast(class298_sub43, -134660083);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("acn.g(").append(')').toString());
		}
	}

	public Interface16 method3937(byte i) {
		try {
			return (Interface16) ((Class323_Sub1) this).aLinkedNodeList_7706.method5936(2081715499);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("acn.p(").append(')').toString());
		}
	}
	...
	public boolean method3936(int i, int i_3_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("acn.b(").append(')').toString());
		}
	}
	...
	public void method3938(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("acn.i(").append(')').toString());
		}
	}
	...
	void method3953(KeyEvent keyevent, int i, int i_4_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("acn.c(").append(')').toString());
		}
	}
	...
	public synchronized void method3942(int i) {
		try {
			((Class323_Sub1) this).aLinkedNodeList_7706.method5943((byte) 1);
			for (Class298_Sub43 class298_sub43 = (Class298_Sub43) ((Class323_Sub1) this).aLinkedNodeList_7710.method5936(2094124912); null != class298_sub43; class298_sub43 = (Class298_Sub43) ((Class323_Sub1) this).aLinkedNodeList_7710.method5936(2145579859)) {
				...
				if (0 == (((Class298_Sub43) class298_sub43).anInt6506 * 1490207653)) {
					if (!((Class323_Sub1) this).aBooleanArray7708[(((Class298_Sub43) class298_sub43).anInt6508 * 122236875)]) {
						...
						((Class323_Sub1) this).aLinkedNodeList_7706.addlast(class298_sub43_6_, 1964794553);
					...
					((Class323_Sub1) this).aLinkedNodeList_7706.addlast(class298_sub43, -407108127);
				} else if (1 == (((Class298_Sub43) class298_sub43).anInt6506 * 1490207653)) {
					if (((Class323_Sub1) this).aBooleanArray7708[(((Class298_Sub43) class298_sub43).anInt6508 * 122236875)]) {
						((Class323_Sub1) this).aLinkedNodeList_7706.addlast(class298_sub43, 1996250465);
					...
					for (int i_7_ = 0; i_7_ < 112; i_7_++) {
						if (((Class323_Sub1) this).aBooleanArray7708[i_7_]) {
							...
							((Class323_Sub1) this).aLinkedNodeList_7706.addlast(class298_sub43_8_, 98009925);
							((Class323_Sub1) this).aBooleanArray7708[i_7_] = false;
						}
					}
				} else if (3 == (((Class298_Sub43) class298_sub43).anInt6506 * 1490207653))
					((Class323_Sub1) this).aLinkedNodeList_7706.addlast(class298_sub43, 1631613634);
			}
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("acn.f(").append(')').toString());
		}
	}
	...
	public synchronized void keyReleased(KeyEvent keyevent) {
		try {
			if (keyevent.getKeyCode() == KeyEvent.VK_SHIFT)
				Loader.isShifting = false;
			method3953(keyevent, 1, 1838328599);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("acn.keyReleased(").append(')').toString());
		}
	}
	...
	public synchronized void keyTyped(KeyEvent keyevent) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("acn.keyTyped(").append(')').toString());
		}
	}
	...
	public void focusGained(FocusEvent focusevent) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("acn.focusGained(").append(')').toString());
		}
	}
	...
	int method3954(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("acn.e(").append(')').toString());
		}
	}
	...
	public synchronized void focusLost(FocusEvent focusevent) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("acn.focusLost(").append(')').toString());
		}
	}

	public Interface16 method3939() {
		return ((Interface16) ((Class323_Sub1) this).aLinkedNodeList_7706.method5936(2115276453));
	}
	...
	public Interface16 method3940() {
		return ((Interface16) ((Class323_Sub1) this).aLinkedNodeList_7706.method5936(2103688875));
	}
	...
	public synchronized void keyPressed(KeyEvent keyevent) {
		try {
			if (keyevent.isControlDown() && keyevent.getKeyCode() == KeyEvent.VK_V) {
				try {
					...
					for (char c : text.toCharArray()) {
						if (Class398.method4921(c, 503878234)) {
							method3952(3, c, -1, -1849643187);
						}
					}
			...
			if (keyevent.getKeyCode() == KeyEvent.VK_SHIFT)
				Loader.isShifting = true;
		    if (keyevent.isShiftDown() && keyevent.getKeyCode() == KeyEvent.VK_PAGE_DOWN) {
...
//				    DevConsole.method2435("You can not zoom any farther outwards!", 93254474);
		    ...
		    if (keyevent.getKeyCode() == KeyEvent.VK_ESCAPE) {
				...
				if (class25 != null) {
				    Class298_Sub36 class298_sub36 = Class18.method359(OutgoingPacket.ESCAPE_PRESSED_PACKET, class25.aClass449_330, (byte) 74);
				    class25.writeOutboundPacket(class298_sub36, (byte) -56);
				}
				return;
			    }
		    
			    if (keyevent.isShiftDown() && keyevent.getKeyCode() == KeyEvent.VK_PAGE_UP) {
...
//				    DevConsole.method2435("You can not zoom any farther inwards!", 93254474);
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("acn.keyPressed(").append(')').toString());
		}
	}
	...
	public synchronized void method3935() {
		((Class323_Sub1) this).aLinkedNodeList_7706.method5943((byte) 1);
		for (Class298_Sub43 class298_sub43 = (Class298_Sub43) ((Class323_Sub1) this).aLinkedNodeList_7710.method5936(2122541864); null != class298_sub43; class298_sub43 = (Class298_Sub43) ((Class323_Sub1) this).aLinkedNodeList_7710.method5936(2131772835)) {
			...
			if (0 == ((Class298_Sub43) class298_sub43).anInt6506 * 1490207653) {
				if (!((Class323_Sub1) this).aBooleanArray7708[(((Class298_Sub43) class298_sub43).anInt6508 * 122236875)]) {
					...
					((Class323_Sub1) this).aLinkedNodeList_7706.addlast(class298_sub43_10_, 1485790720);
					((Class323_Sub1) this).aBooleanArray7708[(((Class298_Sub43) class298_sub43).anInt6508 * 122236875)] = true;
				}
				((Class298_Sub43) class298_sub43).anInt6506 = -985343910;
				((Class323_Sub1) this).aLinkedNodeList_7706.addlast(class298_sub43, 1477219467);
			} else if (1 == (((Class298_Sub43) class298_sub43).anInt6506 * 1490207653)) {
				if (((Class323_Sub1) this).aBooleanArray7708[(((Class298_Sub43) class298_sub43).anInt6508 * 122236875)]) {
					((Class323_Sub1) this).aLinkedNodeList_7706.addlast(class298_sub43, 1423768539);
					((Class323_Sub1) this).aBooleanArray7708[(((Class298_Sub43) class298_sub43).anInt6508 * 122236875)] = false;
				}
			} else if (1490207653 * ((Class298_Sub43) class298_sub43).anInt6506 == -1) {
				for (int i = 0; i < 112; i++) {
					if (((Class323_Sub1) this).aBooleanArray7708[i]) {
						...
						((Class323_Sub1) this).aLinkedNodeList_7706.addlast(class298_sub43_11_, 1448812234);
						((Class323_Sub1) this).aBooleanArray7708[i] = false;
					}
				}
			} else if (3 == (((Class298_Sub43) class298_sub43).anInt6506 * 1490207653))
				((Class323_Sub1) this).aLinkedNodeList_7706.addlast(class298_sub43, 1538711449);
		}
	}

	public synchronized void method3944() {
		((Class323_Sub1) this).aLinkedNodeList_7706.method5943((byte) 1);
		for (Class298_Sub43 class298_sub43 = (Class298_Sub43) ((Class323_Sub1) this).aLinkedNodeList_7710.method5936(2115108568); null != class298_sub43; class298_sub43 = (Class298_Sub43) ((Class323_Sub1) this).aLinkedNodeList_7710.method5936(2096117527)) {
			...
			if (0 == ((Class298_Sub43) class298_sub43).anInt6506 * 1490207653) {
				if (!((Class323_Sub1) this).aBooleanArray7708[(((Class298_Sub43) class298_sub43).anInt6508 * 122236875)]) {
					...
					((Class323_Sub1) this).aLinkedNodeList_7706.addlast(class298_sub43_12_, 957532762);
					((Class323_Sub1) this).aBooleanArray7708[(((Class298_Sub43) class298_sub43).anInt6508 * 122236875)] = true;
				}
				((Class298_Sub43) class298_sub43).anInt6506 = -985343910;
				((Class323_Sub1) this).aLinkedNodeList_7706.addlast(class298_sub43, 568318912);
			} else if (1 == (((Class298_Sub43) class298_sub43).anInt6506 * 1490207653)) {
				if (((Class323_Sub1) this).aBooleanArray7708[(((Class298_Sub43) class298_sub43).anInt6508 * 122236875)]) {
					((Class323_Sub1) this).aLinkedNodeList_7706.addlast(class298_sub43, 953828364);
					((Class323_Sub1) this).aBooleanArray7708[(((Class298_Sub43) class298_sub43).anInt6508 * 122236875)] = false;
				}
			} else if (1490207653 * ((Class298_Sub43) class298_sub43).anInt6506 == -1) {
				for (int i = 0; i < 112; i++) {
					if (((Class323_Sub1) this).aBooleanArray7708[i]) {
						...
						((Class323_Sub1) this).aLinkedNodeList_7706.addlast(class298_sub43_13_, 961213075);
						((Class323_Sub1) this).aBooleanArray7708[i] = false;
					}
				}
			} else if (3 == (((Class298_Sub43) class298_sub43).anInt6506 * 1490207653))
				((Class323_Sub1) this).aLinkedNodeList_7706.addlast(class298_sub43, 287234432);
		}
	}
	...
	public static void method3955(int i, int i_14_, int i_15_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("acn.u(").append(')').toString());
		}
	}
}
