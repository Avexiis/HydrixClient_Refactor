...
public class Class324 {
	...
	public void method3956(int i) {
		try {
			...
			while (iterator.hasNext()) {
				...
				iterator.remove();
				VarPlayerTypeList.method1918(class335, (byte) -40);
			}
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("nn.a(").append(')').toString());
		}
	}
	...
	void method3957(Class335 class335, int i) {
		try {
				...
				if (((Class324) this).aBoolean3446) {
					...
					while (iterator.hasNext()) {
						...
						if (class335_1_.aClass365_Sub1_3616 == class365_sub1) {
							iterator.remove();
							VarPlayerTypeList.method1918(class335_1_, (byte) -92);
						}
					}
				}
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("nn.f(").append(')').toString());
		}
	}
	...
	static final void method3958(IComponentDefinition class105, RSInterface RSInterface, ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("nn.ot(").append(')').toString());
		}
	}
	...
	static final void method3959(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("nn.qj(").append(')').toString());
		}
	}
	...
	static void method3960(ClientScript2 class403, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("nn.d(").append(')').toString());
		}
	}
}
