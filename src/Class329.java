...
public final class Class329 {
	...
	boolean method3991(int i, byte[] is, int i_0_, boolean bool, int i_1_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ns.b(").append(')').toString());
		}
	}
	...
	public byte[] method3992(int i, int i_17_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ns.a(").append(')').toString());
		}
	}
	...
	public boolean method3993(int i, byte[] is, int i_38_, int i_39_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ns.f(").append(')').toString());
		}
	}
	...
	public String toString() {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ns.toString(").append(')').toString());
		}
	}
	...
	static void method3994(byte i) {
		try {
			if (JAGLib.anIntArray3165 == null) {
				JAGLib.anIntArray3165 = new int[65536];
				Class379.anIntArray4098 = new int[65536];
				double d = 0.7; //no hue-shift
				for (int i_43_ = 0; i_43_ < 65536; i_43_++) {
					...
					JAGLib.anIntArray3165[i_43_] = i_58_ & 0xffffff;
					int i_59_ = i_55_ + ((i_56_ << 8) + (i_57_ << 16));
					Class379.anIntArray4098[i_43_] = i_59_;
				}
			}
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ns.p(").append(')').toString());
		}
	}
	...
	static final void method3995(ClientScript2 class403, byte i) {
		try {
			...
			String string = (((ClientScript2) class403).aClass162_5252.method1755(-937307905 * GameClient.aGameContext_8944.gameType << 16 | i_60_, -1713280768));
			String string_61_;
			if (null == string)
				string_61_ = "";
			else
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ns.bi(").append(')').toString());
		}
	}
	...
	static final void method3996(ClientScript2 class403, int i) {
		try {
			...
			RSInterface RSInterface = SpotAnimTypeList.aRSInterfaceArray4165[i_62_ >> 16];
			Class231.method2131(class105, RSInterface, class403, -2030984421);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ns.mi(").append(')').toString());
		}
	}
	...
	static final void method3997(ClientScript2 class403, int i) {
		try {
			...
			Class298_Sub36 class298_sub36 = Class18.method359(OutgoingPacket.aClass198_2073, GameClient.gameConnection.aClass449_330, (byte) 13);
			class298_sub36.buffer.writeByte(string.length() + 1);
			class298_sub36.buffer.writeString(string, 2108270585);
			GameClient.gameConnection.writeOutboundPacket(class298_sub36, (byte) -64);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ns.sn(").append(')').toString());
		}
	}
}
