...
public class Class330 implements Runnable {
	...
	void method3998(byte[] is, int i, int i_0_, int i_1_) throws IOException {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("nt.f(").append(')').toString());
		}
	}
	...
	boolean method3999(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("nt.a(").append(')').toString());
		}
	}
	...
	void method4000(byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("nt.p(").append(')').toString());
		}
	}
	...
	void method4001(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("nt.b(").append(')').toString());
		}
	}
	...
	public void run() {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("nt.run(").append(')').toString());
		}
	}
	...
	static final void method4002(ClientScript2 class403, byte i) {
		try {
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = (Class287.myPlayer.maxHitpoints * 696798311);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("nt.ue(").append(')').toString());
		}
	}
	...
	static final void method4003(ClientScript2 class403, int i) {
		try {
			...
			VarClanSettings.method4659(i_5_, 2048910777);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("nt.ahi(").append(')').toString());
		}
	}
	...
	static final void method4004(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("nt.bm(").append(')').toString());
		}
	}
	...
	public static void method4005(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("nt.k(").append(')').toString());
		}
	}

	static final boolean method4006(int i, int i_6_, Class336 class336, Region region, int i_7_) {
		try {
			int i_8_ = i;
			int i_9_ = i_6_;
			int i_10_ = 64;
