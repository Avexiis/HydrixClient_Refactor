...
public class Class336_Sub2 extends Class336 {
	...
	static final void method4096(ClientScript2 class403, int i) {
		try {
			...
			RSInterface.method1298(class105, RSInterface, class403, (byte) 35);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ace.ii(").append(')').toString());
		}
	}
	...
	static void method4097(ClientScript2 class403, short i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ace.w(").append(')').toString());
		}
	}
}
