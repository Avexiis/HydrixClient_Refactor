...
public class Class336_Sub3 extends Class336 {
	...
	static final void method4098(ClientScript2 class403, byte i) {
		try {
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = GraphicsAutoSetup.clientPreferences.texturePreference.getValue(2118701003) == 1 ? 1 : 0;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("acg.akw(").append(')').toString());
		}
	}
	...
	static final void method4099(ClientScript2 class403, int i) {
		try {
			...
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = -1993792969 * class105.transparency;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("acg.po(").append(')').toString());
		}
	}
	...
	static final void method4100(ClientScript2 class403, int i) {
		try {
			...
			EnumType class483 = Class51.aClass475_506.getClientScriptMap(i_7_, 1528209569);
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = class483.method6129((byte) 77);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("acg.vc(").append(')').toString());
		}
	}
	...
	static final void method4101(ClientScript2 class403, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("acg.ada(").append(')').toString());
		}
	}
	...
	static final void method4102(ClientScript2 class403, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("acg.amn(").append(')').toString());
		}
	}
}
