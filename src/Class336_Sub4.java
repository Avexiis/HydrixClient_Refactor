...
public class Class336_Sub4 extends Class336 {
	...
	public boolean method4090(int i, int i_0_, int i_1_, Region region, int i_2_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ack.a(").append(')').toString());
		}
	}
	...
	public static Class297 method4103(int i, int i_7_, int i_8_, int i_9_, int i_10_, boolean bool, int i_11_, int i_12_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ack.y(").append(')').toString());
		}
	}
	...
	public static void method4104(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ack.k(").append(')').toString());
		}
	}
}
