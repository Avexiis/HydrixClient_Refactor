...
public class Class336_Sub6 extends Class336 {
	public boolean method4091(int i, int i_0_, int i_1_, Region region) {
	...
	public boolean method4089(int i, int i_2_, int i_3_, Region region) {
		return (-1331662251 * toX == i_2_ && i_3_ == 1517720743 * toY);
	}

	public boolean method4090(int i, int i_4_, int i_5_, Region region, int i_6_) {
		try {
			return (-1331662251 * toX == i_4_ && i_5_ == 1517720743 * toY);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("acy.a(").append(')').toString());
		}
	}
	...
	static final void method4106(ClientScript2 class403, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("acy.ww(").append(')').toString());
		}
	}

	public static void method4107(Huffman huffman, int i) {
		try {
			Class106.aHuffman_1308 = huffman;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("acy.a(").append(')').toString());
		}
	}
