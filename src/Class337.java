...
public class Class337 {
	...
	static final void method4109(ClientScript2 class403, int i) {
		try {
			...
			VarClanSettings varClanSettings = Class299.aClanSettings_3199.method4576(i_0_, -1387183809);
			if (null == varClanSettings)
				throw new RuntimeException();
			Integer integer = (((ClientScript2) class403).aClass162_5252.method1754((GameClient.aGameContext_8944.gameType * -937307905 << 16 | varClanSettings.anInt4086 * -1808461691), varClanSettings.anInt4087 * -2047408817, varClanSettings.anInt4088 * -530058953, -1943222730));
			int i_1_;
			if (integer == null)
				i_1_ = 0;
			else
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ob.bh(").append(')').toString());
		}
	}
	...
	static final void method4110(ClientScript2 class403, byte i) {
		try {
			...
			Class234.method2184(class105, RSInterface, class403, (byte) 57);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ob.ca(").append(')').toString());
		}
	}
	...
	static final void method4111(ClientScript2 class403, byte i) {
		try {
			...
			GameShell.method2787(class105, RSInterface, class403, 1932699563);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ob.fb(").append(')').toString());
		}
	}
	...
	static final void method4112(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ob.aba(").append(')').toString());
		}
	}
}
