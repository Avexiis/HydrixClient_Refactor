...
public abstract class Class343 {
	...
	public boolean method4155(byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("oh.f(").append(')').toString());
		}
	}
	...
	public boolean method4156(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("oh.b(").append(')').toString());
		}
	}
	...
	public boolean method4157(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("oh.p(").append(')').toString());
		}
	}
	...
	public boolean method4158(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("oh.a(").append(')').toString());
		}
	}
	...
	static final void method4159(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("oh.at(").append(')').toString());
		}
	}
	...
	public static final int method4161(int i, int i_1_, byte i_2_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("oh.n(").append(')').toString());
		}
	}
	...
	static boolean method4162(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("oh.ne(").append(')').toString());
		}
	}
}
