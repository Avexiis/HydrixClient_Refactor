...
public final class Class354 {
	...
	public Class298_Sub37 method4253(long l) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ot.a(").append(')').toString());
		}
	}
	...
	public void method4254(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ot.b(").append(')').toString());
		}
	}
	...
	public void method4255(Class298_Sub37 class298_sub37, long l) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ot.f(").append(')').toString());
		}
	}
	...
	static final void method4256(ClientScript2 class403, int i) {
		try {
			...
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = GameClient.method2801(class105).method3497((byte) 14);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ot.sr(").append(')').toString());
		}
	}
	...
	static final void method4258(ClientScript2 class403, int i) {
		try {
			...
			Class52_Sub1_Sub1.method568(class105, RSInterface, class403, (byte) 88);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ot.dt(").append(')').toString());
		}
	}
		...
		try {
			if (0 == Class234.anInt2596 * 363912581) {
				...
				if (!((Class221) Class479.aClass479_6004.method6101(-1994130525)).method2050(-88973782)) {
					Atmosphere.gameClientInstance.method2766(1045646617);
			...
			if (363912581 * Class234.anInt2596 == 1) {
				...
				Class479.aClass479_6011.method6102(new Class223(UnderlayTypeList.aClass243_5641), 1106252958);
				Class479.aClass479_6007.method6102(new Class223(Class284_Sub1.configsJs5), -82697463);
				...
				Class479.aClass479_6024.method6102(new Class223(Skybox.aClass243_2965), 4556211);
				Class479.aClass479_6022.method6102(new Class237(TimeUtils.js5_huffman, "huffman"), 827266290);
			...
			if (bool) {
				if (!((Class221) Class479.aClass479_6009.method6101(-1994130525)).method2050(104668639))
					GameClient.aBoolean8806 = Atmosphere.gameClientInstance.method2767(-2027084439);
	...
	static final void method4260(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ot.qs(").append(')').toString());
		}
	}
}
