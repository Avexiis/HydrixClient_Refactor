...
public class Class355 implements Interface19 {
	...
	public boolean method239(Class298_Sub50 class298_sub50, Interface16[] interface16s, int i, Class323 class323, int i_2_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ov.a(").append(')').toString());
		}
	}
	...
	static boolean method4261(int i, int i_7_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ov.p(").append(')').toString());
		}
	}
	...
	static int method4263(int i, int i_8_, byte i_9_) {
		try {
			if (Class424.aClass424_6592.anInt6613 * -1976050083 == i || -1976050083 * Class424.aClass424_6594.anInt6613 == i)
				return Wall.anIntArray9938[i_8_ & 0x3];
			return Wall.anIntArray9937[i_8_ & 0x3];
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ov.by(").append(')').toString());
		}
	}
	...
	static final void method4264(ClientScript2 class403, short i) {
		try {
			...
			if (class497.method6206(1883696427))
				((ClientScript2) class403).anObjectArray5240[((((ClientScript2) class403).anInt5241 += 969361751) * -203050393) - 1] = GameClient.map.method2641(-1837734772).list(i_10_).method5770(i_11_, class497.aString6101, 1595133323);
			else
				((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919) - 1] = (GameClient.map.method2641(767453715).list(i_10_).method5776(i_11_, class497.anInt6100 * -388931549, (byte) 2));
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ov.abf(").append(')').toString());
		}
	}
	...
	static void method4265(int i, int i_12_, int i_13_, int i_14_, int i_15_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ov.af(").append(')').toString());
		}
	}
}
