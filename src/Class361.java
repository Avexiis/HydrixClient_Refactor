...
public final class Class361 {
	...
	static final void method4303(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("pa.mb(").append(')').toString());
		}
	}
	...
	public static int method4304(CharSequence charsequence, int i, int i_0_, byte[] is, int i_1_, byte i_2_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("pa.k(").append(')').toString());
		}
	}
	...
	static void method4305(ClientScript2 class403, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("pa.j(").append(')').toString());
		}
	}
	...
	static void method4306(String[] strings, int[] is, int i, int i_5_, int i_6_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("pa.p(").append(')').toString());
		}
	}
}
