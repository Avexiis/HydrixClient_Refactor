...
public class Class365 {
	...
	boolean positionDirty;
	Matrix43f positionMatrix;
	...
	public final void method4340(SceneObjectPosition sceneObjectPosition) {
		this.aClass235_3958.aSceneObjectPosition_2599.method2013(sceneObjectPosition);
		method4344();
	...
	public final void method4341(float f, float f_1_, float f_2_) {
		this.aClass235_3958.aSceneObjectPosition_2599.method2007(f, f_1_, f_2_);
		method4344();
		if (this.aClass365_3956 != null) {
			this.aClass365_3956.method4342();
		}
	...
	final Matrix43f method4347() {
		if (this.positionDirty) {
			...
			this.positionMatrix.method2076(method4337());
		}
	...
	Class365() {
		...
		new Class233();
		new Class233();
		this.positionMatrix = new Matrix43f();
		this.positionDirty = true;
		this.aClass365_3963 = null;
		this.aClass365_3956 = null;
		this.aClass365_3965 = null;
