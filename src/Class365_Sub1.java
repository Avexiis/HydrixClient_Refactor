...
public abstract class Class365_Sub1 extends Class365 {
	...
	public SceneGraph aSceneGraph_7722;
	public byte plane;
	...
	int method4356(byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("adp.dh(").append(')').toString());
		}
	}
	...
	void method4362(int i, int i_7_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("adp.dx(").append(')').toString());
		}
	}
	...
	public int method4363(byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("adp.bx(").append(')').toString());
		}
	}
	...
	Class365_Sub1(SceneGraph sceneGraph) {
		aSceneGraph_7722 = sceneGraph;
	}
	...
	int method4392(int i, int i_17_, Class298_Sub10[] class298_sub10s, int i_18_) {
		try {
			long l = (((SceneGraph) aSceneGraph_7722).aLongArrayArrayArray3554[plane][i][i_17_]);
			long l_19_ = 0L;
			int i_20_ = 0;
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("adp.ds(").append(')').toString());
		}
	}
	...
	static final void method4401(IComponentDefinition class105, RSInterface RSInterface, ClientScript2 class403, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("adp.is(").append(')').toString());
		}
	}
	...
	static final void method4402(ClientScript2 class403, byte i) {
		try {
			...
			RSInterface RSInterface = SpotAnimTypeList.aRSInterfaceArray4165[i_24_ >> 16];
			TileFlags.method2323(class105, RSInterface, class403, 1982682635);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("adp.fx(").append(')').toString());
		}
	}
	...
	static void method4403(byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("adp.v(").append(')').toString());
		}
	}
}
