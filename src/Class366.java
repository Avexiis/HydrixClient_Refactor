...
public class Class366 {
	...
	public void method4538(int i, int i_0_, IdentityKitTypeList identityKitTypeList, int i_1_) {
		try {
			int i_2_ = anIntArray3972[i];
			if (identityKitTypeList.method1579(i_0_, -1709524743) != null) {
				((Class366) this).anIntArray3969[i_2_] = i_0_ | ~0x7fffffff;
				method4542(-1951489461);
			}
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("pf.f(").append(')').toString());
		}
	}
	...
	public void method4539(int i, int i_3_, byte i_4_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("pf.b(").append(')').toString());
		}
	}
	...
	public void method4540(boolean bool, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("pf.p(").append(')').toString());
		}
	}
	...
	public void method4541(int i, int i_5_, Class477 class477, byte i_6_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("pf.i(").append(')').toString());
		}
	}
	...
	void method4542(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("pf.k(").append(')').toString());
		}
	}

	public ModelPart method4543(GraphicsToolkit class_ra, int i, IdentityKitTypeList identityKitTypeList, Class507 class507, Class477 class477, SeqTypeList class395, Interface23 interface23, Animator animator, int i_15_) {
		try {
			if (-1 != anInt3974 * 164936249)
				return (class507.method6269(anInt3974 * 164936249, 491367243).method6237(class_ra, i, interface23, animator, null, -218177955));
			int i_16_ = animator != null ? i | animator.method5829(-1790708337) : i;
			ModelPart modelPart;
			synchronized (aClass348_3980) {
				modelPart = (ModelPart) aClass348_3980.get(5093099708756449067L * (((Class366) this).aLong3975));
			}
			if (modelPart == null || class_ra.method5017(modelPart.m(), i_16_) != 0) {
				if (null != modelPart)
					i_16_ = class_ra.method5004(i_16_, modelPart.m());
				int i_17_ = i_16_;
				boolean bool = false;
				for (int i_18_ = 0; i_18_ < ((Class366) this).anIntArray3969.length; i_18_++) {
					...
					if ((i_19_ & 0x40000000) != 0) {
						...
						if (!class477.getItemDefinitions(i_19_ & 0x3fffffff).method6035(aBoolean3977, class464, (byte) 0))
							bool = true;
					} else if ((i_19_ & ~0x7fffffff) != 0 && !identityKitTypeList.method1579(i_19_ & 0x3fffffff, -939984800).method1475(-783889357))
						bool = true;
				}
				if (bool)
					return null;
				...
				for (int i_21_ = 0; i_21_ < ((Class366) this).anIntArray3969.length; i_21_++) {
					...
					if (0 != (i_22_ & 0x40000000)) {
						...
						Model class64 = identityKitTypeList.method1579(i_22_ & 0x3fffffff, -276971058).method1476(1209505122);
						if (null != class64)
							class64s[i_20_++] = class64;
					}
				}
				...
				i_17_ |= 0x4000;
				modelPart = class_ra.method5037(class64, i_17_, anInt3981 * 1931277641, 64, 768);
				for (int i_23_ = 0; i_23_ < 10; i_23_++) {
					for (int i_24_ = 0; i_24_ < aShortArrayArray3970[i_23_].length; i_24_++) {
						if (anIntArray3973[i_23_] < (Class22.aShortArrayArrayArray278[i_23_][i_24_]).length)
							modelPart.X(aShortArrayArray3970[i_23_][i_24_], (Class22.aShortArrayArrayArray278[i_23_][i_24_][anIntArray3973[i_23_]]));
					}
				}
				modelPart.KA(i_16_);
				synchronized (aClass348_3980) {
					aClass348_3980.put(modelPart, (((Class366) this).aLong3975 * 5093099708756449067L));
				}
			}
			if (null == animator)
				return modelPart;
			ModelPart modelPart_25_ = modelPart.method4755((byte) 4, i_16_, true);
			animator.method5839(modelPart_25_, 0, -1353467740);
			return modelPart_25_;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("pf.u(").append(')').toString());
		}
	}

	public ModelPart method4544(GraphicsToolkit class_ra, int i, IdentityKitTypeList identityKitTypeList, SeqTypeList class395, Animator animator, int i_26_, int i_27_, int i_28_, byte i_29_) {
		try {
			int i_30_ = animator != null ? i | animator.method5829(-1790708337) : i;
			long l = (long) i_28_ << 32 | (long) (i_27_ << 16) | (long) i_26_;
			ModelPart modelPart;
			synchronized (aClass348_3980) {
				modelPart = (ModelPart) aClass348_3980.get(l);
			}
			do {
				if (modelPart == null || class_ra.method5017(modelPart.m(), i_30_) != 0) {
					if (null != modelPart)
						i_30_ = class_ra.method5004(i_30_, modelPart.m());
					int i_31_ = i_30_;
					Model[] class64s = new Model[3];
					int i_32_ = 0;
					if (identityKitTypeList.method1579(i_26_, -1760783131).method1475(-783889357) && identityKitTypeList.method1579(i_27_, -1162557302).method1475(-783889357) && identityKitTypeList.method1579(i_28_, -839635617).method1475(-783889357)) {
						Model class64 = identityKitTypeList.method1579(i_26_, -156721354).method1476(1042420956);
						if (class64 != null)
							class64s[i_32_++] = class64;
						class64 = identityKitTypeList.method1579(i_27_, 773247218).method1476(74933704);
						if (class64 != null)
							class64s[i_32_++] = class64;
						class64 = identityKitTypeList.method1579(i_28_, 744132841).method1476(552695292);
						if (null != class64)
							class64s[i_32_++] = class64;
						class64 = new Model(class64s, i_32_);
						i_31_ |= 0x4000;
						modelPart = class_ra.method5037(class64, i_31_, 1931277641 * anInt3981, 64, 768);
						for (int i_33_ = 0; i_33_ < 10; i_33_++) {
							for (int i_34_ = 0; i_34_ < aShortArrayArray3970[i_33_].length; i_34_++) {
								if (anIntArray3973[i_33_] < (Class22.aShortArrayArrayArray278[i_33_][i_34_]).length)
									modelPart.X((aShortArrayArray3970[i_33_][i_34_]), (Class22.aShortArrayArrayArray278[i_33_][i_34_][anIntArray3973[i_33_]]));
							}
						}
						modelPart.KA(i_30_);
						synchronized (aClass348_3980) {
							aClass348_3980.put(modelPart, l);
							break;
						}
					}
					return null;
			...
			if (animator == null)
				return modelPart;
			modelPart = modelPart.method4755((byte) 4, i_30_, true);
			animator.method5839(modelPart, 0, -716564268);
			return modelPart;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("pf.x(").append(')').toString());
		}
	}

	public ModelPart method4545(GraphicsToolkit class_ra, int i, Class349 class349, IdentityKitTypeList identityKitTypeList, Class507 class507, Class477 class477, SeqTypeList class395, Interface23 interface23, Animator animator, Animator animator_35_, Animator[] animators, int[] is, int i_36_, boolean bool, Class405 class405, int i_37_) {
		try {
			if (anInt3974 * 164936249 != -1)
				return (class507.method6269(anInt3974 * 164936249, 1899433887).method6246(class_ra, i, class349, interface23, animator, animator_35_, animators, is, i_36_, null, -884053309));
			int i_38_ = i;
			...
			if (null != animator) {
				SeqType class391 = animator.method5820(28542107);
				if (null != class391 && (609841829 * class391.mainhandObj >= 0 || 1548903495 * class391.offhandObj >= 0)) {
					...
					if (class391.mainhandObj * 609841829 >= 0 && -1 != -817429509 * class405.anInt5266) {
						bool_40_ = true;
						if (65535 == class391.mainhandObj * 609841829) {
							...
							is_39_[-817429509 * class405.anInt5266] = 609841829 * class391.mainhandObj | 0x40000000;
					...
					if (1548903495 * class391.offhandObj >= 0 && -1 != class405.anInt5270 * -2126257265) {
						bool_41_ = true;
						if (class391.offhandObj * 1548903495 == 65535) {
							...
							is_39_[-2126257265 * class405.anInt5270] = 1548903495 * class391.offhandObj | 0x40000000;
			...
			for (int i_49_ = 0; i_49_ < i_48_; i_49_++) {
				if (animators[i_49_] != null) {
					i_38_ |= animators[i_49_].method5829(-1790708337);
					bool_47_ = true;
				}
			}
			if (null != animator) {
				i_38_ |= animator.method5829(-1790708337);
				bool_47_ = true;
			}
			if (null != animator_35_) {
				i_38_ |= animator_35_.method5829(-1790708337);
				bool_47_ = true;
			}
			...
			synchronized (aClass348_3979) {
				modelPart = (ModelPart) aClass348_3979.get(l);
			}
			...
			if (null == modelPart || class_ra.method5017(modelPart.m(), i_38_) != 0) {
				if (null != modelPart)
					i_38_ = class_ra.method5004(i_38_, modelPart.m());
				int i_52_ = i_38_;
				...
				for (int i_54_ = 0; i_54_ < is_39_.length; i_54_++) {
					...
					if ((i_55_ & 0x40000000) != 0) {
						...
						if (!class477.getItemDefinitions(i_55_ & 0x3fffffff).method6034(aBoolean3977, class464, (byte) -1))
							bool_53_ = true;
					} else if ((i_55_ & ~0x7fffffff) != 0 && !identityKitTypeList.method1579(i_55_ & 0x3fffffff, 1033806901).method1477(169549971))
						bool_53_ = true;
				}
				if (bool_53_) {
					if (-1L != (4366628042331861927L * ((Class366) this).aLong3966)) {
						synchronized (aClass348_3979) {
							modelPart = (ModelPart) (aClass348_3979.get(4366628042331861927L * ((Class366) this).aLong3966));
						}
					}
					if (null == modelPart || class_ra.method5017(modelPart.m(), i_38_) != 0)
						return null;
					...
					for (int i_59_ = 0; i_59_ < is_39_.length; i_59_++) {
						...
						if (0 != (i_60_ & 0x40000000)) {
							...
							Model class64 = identityKitTypeList.method1579(i_60_ & 0x3fffffff, -959041423).method1474((byte) 93);
							if (null != class64)
								class64s[i_59_] = class64;
						}
					}
					...
					i_52_ |= 0x4000;
					modelPart = class_ra.method5037(class64, i_52_, 1931277641 * anInt3981, 64, 850);
					for (int i_69_ = 0; i_69_ < 10; i_69_++) {
						for (int i_70_ = 0; i_70_ < aShortArrayArray3970[i_69_].length; i_70_++) {
							if (anIntArray3973[i_69_] < (Class22.aShortArrayArrayArray278[i_69_][i_70_]).length)
								modelPart.X(aShortArrayArray3970[i_69_][i_70_], (Class22.aShortArrayArrayArray278[i_69_][i_70_][anIntArray3973[i_69_]]));
						}
					}
					if (bool) {
						modelPart.KA(i_38_);
						synchronized (aClass348_3979) {
							aClass348_3979.put(modelPart, l);
						}
						((Class366) this).aLong3966 = l * -2813682692256545769L;
					}
				}
			}
			ModelPart modelPart_71_ = modelPart.method4755((byte) 4, i_38_, true);
			if (!bool_47_ && !bool_50_)
				return modelPart_71_;
			...
			if (bool_50_ && class222s != null) {
				for (int i_72_ = 0; i_72_ < is.length; i_72_++) {
					if (null != class222s[i_72_])
						modelPart_71_.method4741(class222s[i_72_], 1 << i_72_, true);
				}
			}
			int i_73_ = 0;
			int i_74_ = 1;
			while (i_73_ < i_48_) {
				if (null != animators[i_73_])
					animators[i_73_].method5830(modelPart_71_, 0, i_74_, (byte) 57);
				i_73_++;
				i_74_ <<= 1;
			}
			if (bool_50_) {
				for (i_73_ = 0; i_73_ < is.length; i_73_++) {
					if (-1 == is[i_73_]) {
						...
						modelPart_71_.method4741(class222, 1 << i_73_, false);
					}
				}
			}
			if (bool_50_ && class222s != null) {
				for (i_73_ = 0; i_73_ < is.length; i_73_++) {
					if (class222s[i_73_] != null)
						modelPart_71_.method4741(class222s[i_73_], 1 << i_73_, false);
				}
			}
			if (animator != null && null != animator_35_)
				Class400.method4929(modelPart_71_, animator, animator_35_, -2147197181);
			else if (null != animator)
				animator.method5839(modelPart_71_, 0, -390031954);
			else if (null != animator_35_)
				animator_35_.method5839(modelPart_71_, 0, 1377070013);
			return modelPart_71_;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("pf.d(").append(')').toString());
		}
	}
	...
	public void method4546(int i, int[] is, Class464[] class464s, int[] is_75_, boolean bool, int i_76_, int i_77_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("pf.a(").append(')').toString());
		}
	}
	...
	static void method4547(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("pf.z(").append(')').toString());
		}
	}
}
