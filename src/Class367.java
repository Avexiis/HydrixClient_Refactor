...
public class Class367 {
	...
	static final void method4549(ClientScript2 class403, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("pg.xh(").append(')').toString());
		}
	}

	static int method4550(char c, Language language, int i) {
		try {
			int i_3_ = c << 4;
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("pg.p(").append(')').toString());
		}
	}
	...
	static void method4551(IComponentDefinition class105, int i, int i_5_, int i_6_) {
		try {
			...
			if (null != class117) {
				OverlayType.activeToolkit.r(i, i_5_, -2093041337 * class105.width + i, (i_5_ + class105.height * 457937409));
				if (Class3.anInt56 * -64305285 < 3) {
					int i_7_ = (int) -GameClient.aFloat8949;
					i_7_ = i_7_ + -1840255270 * GameClient.anInt8801 & 0x3fff;
					i_7_ <<= 2;
					IdentityKitTypeList.aClass57_1562.method639(((float) i + (float) (class105.width * -2093041337) / 2.0F), ((float) i_5_ + (float) (class105.height * 457937409) / 2.0F), 4135, i_7_, class117.aClass_ta1397, i, i_5_);
				} else
					OverlayType.activeToolkit.DA(-16777216, class117.aClass_ta1397, i, i_5_);
			}
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("pg.lp(").append(')').toString());
		}
	}
	...
	static final void method4552(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("pg.rf(").append(')').toString());
		}
	}
}
