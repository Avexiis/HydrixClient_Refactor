...
public class Class368 {
	...
	static final void method4553(ClientScript2 class403, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ph.lr(").append(')').toString());
		}
	}
	...
	public static long method4554(CharSequence charsequence, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ph.n(").append(')').toString());
		}
	}
	...
	static void method4555(short i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ph.v(").append(')').toString());
		}
	}

	static void method4556(GraphicsToolkit class_ra, WorldMapArea worldMapArea, WorldMapLabel worldMapLabel, int i) {
		try {
			Class57 class57 = worldMapLabel.method4240(class_ra, 774929674);
			if (class57 != null) {
				int i_5_ = class57.method623();
				if (class57.method625() > i_5_)
					i_5_ = class57.method625();
				int i_6_ = 10;
				int i_7_ = 1333098669 * worldMapArea.anInt7609;
				int i_8_ = worldMapArea.anInt7606 * -685779893;
				int i_9_ = 0;
				int i_10_ = 0;
				int i_11_ = 0;
				...
				int i_14_ = worldMapArea.anInt7609 * 1333098669 + i_5_ / 2;
				int i_15_ = -685779893 * worldMapArea.anInt7606;
				...
				int i_16_ = ((int) (Math.atan2((double) (i_7_ - (1333098669 * (worldMapArea.anInt7609))), (double) (i_8_ - (worldMapArea.anInt7606 * -685779893))) / 3.141592653589793 * 32767.0) & 0xffff);
				...
				if (worldMapLabel.aString3792 != null) {
					...
					if (worldMapLabel.anInt3787 * 594838161 != 0)
						class_ra.method5015(i_17_, i_18_, i_19_ - i_17_, i_20_ - i_18_, worldMapLabel.anInt3787 * 594838161, (byte) 7);
					if (0 != worldMapLabel.anInt3802 * -828737913)
						class_ra.method5014(i_17_, i_18_, i_19_ - i_17_, i_20_ - i_18_, worldMapLabel.anInt3802 * -828737913, 98431177);
					for (int i_21_ = 0; i_21_ < i_9_; i_21_++) {
						String string = Class301_Sub1.aStringArray7638[i_21_];
						if (i_21_ < i_9_ - 1)
							string = string.substring(0, string.length() - 4);
						Class52.aClass4_508.method308(class_ra, string, i_14_, i_15_, (worldMapLabel.anInt3781 * -1836991893), true);
						i_15_ += Class52.aClass4_508.method309();
					}
				}
				if (-1 != worldMapLabel.anInt3785 * 715019623 || worldMapLabel.aString3792 != null) {
					...
					DiskFile.aLinkedNodeList_5986.addlast(class298_sub6, 2005332883);
				}
			}
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ph.ba(").append(')').toString());
		}
	}
	...
	static final void method4557(ClientScript2 class403, int i) {
		try {
			...
			IComponentDefinition class105 = ((Class390) class390).aClass105_4168;
			RSInterface RSInterface = ((Class390) class390).aRSInterface_4167;
			Class409.method4973(class105, RSInterface, class403, (byte) 74);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ph.cb(").append(')').toString());
		}
	}
}
