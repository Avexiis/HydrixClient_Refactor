...
public class Class369 {
	...
	void method4558(Packet class298_sub53, int i) {
		try {
			for (;;) {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("pi.a(").append(')').toString());
		}
	}

	void method4559(Packet class298_sub53, int i, int i_1_) {
		try {
			if (1 == i)
				...
				for (int i_3_ = 0; i_3_ < i_2_; i_3_++) {
					...
					((Class369) this).anIntArrayArray4010[i_3_][1] = class298_sub53.readUnsignedInt();
					((Class369) this).anIntArrayArray4010[i_3_][2] = class298_sub53.readUnsignedInt();
				}
			} else if (4 == i) {
				...
				for (int i_5_ = 0; i_5_ < i_4_; i_5_++) {
					...
					((Class369) this).anIntArrayArray4021[i_5_][1] = class298_sub53.readUnsignedInt();
					((Class369) this).anIntArrayArray4021[i_5_][2] = class298_sub53.readUnsignedInt();
				}
			} else if (i == 5)
				...
				for (int i_7_ = 0; i_7_ < i_6_; i_7_++)
					((Class369) this).anIntArray4015[i_7_] = class298_sub53.readUnsignedInt();
			} else if (12 == i)
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("pi.f(").append(')').toString());
		}
	}
	...
	void method4560(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("pi.b(").append(')').toString());
		}
	}
	...
	public boolean method4561(Interface23 interface23, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("pi.k(").append(')').toString());
		}
	}
	...
	public boolean method4562(Interface23 interface23, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("pi.d(").append(')').toString());
		}
	}
	...
	public boolean method4563(Interface23 interface23, int[] is, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("pi.u(").append(')').toString());
		}
	}
	...
	public boolean method4564(Interface23 interface23, int i, int i_30_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("pi.s(").append(')').toString());
		}
	}
	...
	public boolean method4565(int[] is, int i, byte i_32_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("pi.r(").append(')').toString());
		}
	}
	...
	public boolean method4566(Interface23 interface23, int i, int i_33_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("pi.q(").append(')').toString());
		}
	}
	...
	public boolean method4567(Interface23 interface23, int i, int i_34_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("pi.n(").append(')').toString());
		}
	}
	...
	public int method4568(int i, int i_36_, byte i_37_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("pi.p(").append(')').toString());
		}
	}
	...
	public boolean method4569(Interface23 interface23, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("pi.x(").append(')').toString());
		}
	}
	...
	public String method4570(int i, String string, int i_38_) {
		try {
			if (null == ((Class369) this).aClass437_4018)
				return string;
			LinkableObject linkableObject = ((LinkableObject) ((Class369) this).aClass437_4018.get((long) i));
			if (linkableObject == null)
				return string;
			return (String) linkableObject.anObject7366;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("pi.i(").append(')').toString());
		}
	}
	...
	static final void method4571(ClientScript2 class403, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("pi.xd(").append(')').toString());
		}
	}
	...
	public static void method4572(int i, int i_40_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("pi.v(").append(')').toString());
		}
	}
}
