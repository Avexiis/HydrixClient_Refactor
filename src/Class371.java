...
public class Class371 {
	...
	void method4580(Packet class298_sub53, int i) {
		try {
			boolean bool = false;
			for (;;) {
				...
				if (1 == opcode) {
					...
					anInt4042 = class298_sub53.g3() * -990069469;
				else if (opcode == 6)
					anInt4031 = class298_sub53.g3() * 1632959877;
				else if (7 == opcode) {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("pk.a(").append(')').toString());
		}
	}
	...
	public Class371(Js5 class243) {
		...
		method4580(new Packet(is), -1224635914);
	}
	...
	static void method4581(ClientScript2 class403, short i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("pk.c(").append(')').toString());
		}
	}

	static final void method4582(IComponentDefinition class105, RSInterface RSInterface, ClientScript2 class403, int i) {
		try {
			String string = (String) (((ClientScript2) class403).anObjectArray5240[(((ClientScript2) class403).anInt5241 -= 969361751) * -203050393]);
			if (Class298_Sub6.method2863(string, class403, -1435282371) != null)
				string = string.substring(0, string.length() - 1);
			class105.onMouseLeaveScript = Class128_Sub2.method1441(string, class403, -2046058202);
			class105.hasScripts = true;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("pk.lk(").append(')').toString());
		}
	}
	...
	static final void method4583(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("pk.aiw(").append(')').toString());
		}
	}
	...
	static void method4584(int i, String string, boolean bool, byte i_11_) {
		try {
			...
			LocalizedString.resetGraphicsToolkit(-77044061);
			Class267.method2528(600492820);
			Wall.method4533(i, string, bool, (short) 256);
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("pk.fk(").append(')').toString());
		}
	}
	...
	static final void method4585(ClientScript2 class403, int i) {
		try {
			...
			MapDetails mapDetails = Class298_Sub7.method2864(-577360818);
			if (mapDetails != null) {
				boolean bool = mapDetails.method3453(i_12_ >> 28 & 0x3, i_12_ >> 14 & 0x3fff, i_12_ & 0x3fff, Class388.anIntArray4156, -253186022);
				if (bool)
					Class118.method1293(Class388.anIntArray4156[1], Class388.anIntArray4156[2], -548972447);
			}
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("pk.ado(").append(')').toString());
		}
	}
	...
	static final void method4586(ClientScript2 class403, byte i) {
		try {
			...
			GameClient.aShort8923 = (short) (((ClientScript2) class403).anIntArray5244[((ClientScript2) class403).anInt5239 * 681479919]);
			if (GameClient.aShort8923 <= 0)
				GameClient.aShort8923 = (short) 256;
			GameClient.aShort8931 = (short) (((ClientScript2) class403).anIntArray5244[1 + 681479919 * ((ClientScript2) class403).anInt5239]);
			if (GameClient.aShort8931 <= 0)
				GameClient.aShort8931 = (short) 320;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("pk.akt(").append(')').toString());
		}
	}
}
