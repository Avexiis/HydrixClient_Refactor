...
public class Class372 {
	...
	static final void method4587(ClientScript2 class403, int i) {
		try {
			...
			Class97_Sub1.method1043(((i_0_ >> 14 & 0x3fff) - worldTile.x * -1760580017), ((i_0_ & 0x3fff) - 283514611 * worldTile.y), i_1_ << 2, i_2_, i_3_, false);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("pl.aga(").append(')').toString());
		}
	}
	...
	public static boolean method4589(int i, String string, int i_4_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("pl.f(").append(')').toString());
		}
	}

	public static Js5 loadIndex(Js5Archive class111, boolean bool, int i, boolean bool_5_, int i_6_) {
		try {
			if (null == OverlayType.aChecksumTableEntryArray4072)
				OverlayType.aChecksumTableEntryArray4072 = new ChecksumTableEntry[Class356.method4268(1608416895)];
			Class329 class329 = null;
			int i_7_ = class111.method1233(958180062);
			if (null != GameClient.aClass484_6476)
				class329 = new Class329(i_7_, GameClient.aClass484_6476, Class497.aClass484Array6106[i_7_], 1500000);
			OverlayType.aChecksumTableEntryArray4072[i_7_] = Class203.aClass225_2337.method2095(i_7_, class329, (Class365_Sub1_Sub3_Sub2.aClass329_9933), 311001416);
			OverlayType.aChecksumTableEntryArray4072[i_7_].method2278((byte) 2);
			return new Js5(OverlayType.aChecksumTableEntryArray4072[i_7_], bool, i);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("pl.fz(").append(')').toString());
		}
	}
	...
	public static void method4591(IComponentDefinition[] class105s, int i, int i_8_, int i_9_, boolean bool, short i_10_) {
		try {
			for (int i_11_ = 0; i_11_ < class105s.length; i_11_++) {
				...
				if (null == class105) {
				...
				} else if (1573706803 * class105.parentId != i) {
					if (i_10_ == 255)
						break;
				} else {
					Class82_Sub10.method904(class105, i_8_, i_9_, bool, (byte) 59);
					Class292.method2816(class105, i_8_, i_9_, (byte) -3);
					if (684246511 * class105.anInt1166 > (1867913305 * class105.anInt1168 - -2093041337 * class105.width))
					...
					if (-1424956747 * class105.anInt1167 > (2053897963 * class105.anInt1169 - class105.height * 457937409))
						class105.anInt1167 = (2097037087 * class105.anInt1169 - class105.height * -900266595);
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("pl.ky(").append(')').toString());
		}
	}
	...
	static void method4592(int i) {
		try {
			...
			for (int i_12_ = 0; i_12_ < 2048; i_12_++) {
				...
				Class10.playersMovementTypes[i_12_] = MovementType.TYPE_1.type;
				Class10.aClass410Array138[i_12_] = null;
			}
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("pl.x(").append(')').toString());
		}
	}

	static final boolean method4593(int i, int i_13_, int i_14_, Class336 class336, Region region, byte i_15_) {
		try {
			int i_16_ = i;
			int i_17_ = i_13_;
			int i_18_ = 64;
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("pl.p(").append(')').toString());
		}
	}
	...
	static void method4595(int i) {
		try {
			...
			IdentityKitTypeList.aClass57_1562 = null;
			SpotAnimation.aClass57_573 = null;
			Class250.aClass57Array2766 = null;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("pl.u(").append(')').toString());
		}
	}
}
