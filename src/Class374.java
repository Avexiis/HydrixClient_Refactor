...
public abstract class Class374 {
	int anInt4073;
	LinkedNodeList aLinkedNodeList_4074 = new LinkedNodeList();
	long aLong4075;
	long aLong4076 = -3541606857845020581L;
	int anInt4077;
	public static int[] anIntArray4078;

	abstract void method4612(Packet class298_sub53, Class298_Sub50 class298_sub50);

	abstract void method4613();

	void method4614(int i) {
		try {
			((Class374) this).aLinkedNodeList_4074.method5943((byte) 1);
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("po.f(").append(')').toString());
		}
	}
	...
	int method4615(Class298_Sub50 class298_sub50, int i, byte i_0_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("po.p(").append(')').toString());
		}
	}

	abstract int method4616(int i);

	abstract void method4617(Packet class298_sub53, Class298_Sub50 class298_sub50, byte i);
	...
	void method4620(Class298_Sub50 class298_sub50, int i) {
		try {
			((Class374) this).aLinkedNodeList_4074.addlast(class298_sub50, 357494730);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("po.b(").append(')').toString());
		}
	}
	...
	void method4626(int i) {
		try {
			if (method4619(-304373014)) {
				...
				int i_2_ = 0;
				int i_3_ = 0;
				Iterator iterator = ((Class374) this).aLinkedNodeList_4074.iterator();
				while (iterator.hasNext()) {
					Class298_Sub50 class298_sub50 = (Class298_Sub50) iterator.next();
					if (class298_sub36 != null && (385051775 * (class298_sub36.buffer.pos) - i_1_) >= 252 - (6 + method4616(-1861387813))) {
						if (i <= 775068819)
					...
					if (i_5_ == 954406595 * ((Class374) this).anInt4073 && -782291875 * ((Class374) this).anInt4077 == i_4_)
						...
						if (class298_sub36 == null) {
							...
							i_1_ = 385051775 * (class298_sub36.buffer.pos);
							class298_sub36.buffer.pos += 232826622;
							i_2_ = 0;
							i_3_ = 0;
						}
						int i_6_;
						...
						if (i_8_ < 8 && i_6_ >= -32 && i_6_ <= 31 && i_7_ >= -32 && i_7_ <= 31) {
							i_6_ += 32;
							i_7_ += 32;
							class298_sub36.buffer.writeShort(i_7_ + ((i_6_ << 6) + (i_8_ << 12)), 16711935);
						} else if (i_8_ < 32 && i_6_ >= -128 && i_6_ <= 127 && i_7_ >= -128 && i_7_ <= 127) {
							i_6_ += 128;
							i_7_ += 128;
							class298_sub36.buffer.writeByte(128 + i_8_);
							class298_sub36.buffer.writeShort((i_6_ << 8) + i_7_, 16711935);
						} else if (i_8_ < 32) {
							class298_sub36.buffer.writeByte(i_8_ + 192);
							if (-1 == i_5_ || -1 == i_4_)
								class298_sub36.buffer.writeInt(-2147483648, -1667030496);
							else
								class298_sub36.buffer.writeInt(i_5_ | i_4_ << 16, -1192850117);
						} else {
							class298_sub36.buffer.writeShort((i_8_ & 0x1fff) + 57344, 16711935);
							if (i_5_ == -1 || i_4_ == -1)
								class298_sub36.buffer.writeInt(-2147483648, -1243424394);
							else
								class298_sub36.buffer.writeInt(i_5_ | i_4_ << 16, 84476800);
						}
						i_3_++;
						method4617(class298_sub36.buffer, class298_sub50, (byte) 0);
						((Class374) this).aLong4075 = (class298_sub50.method3549((byte) 123) * 142159167877835417L);
						class298_sub50.method3550(1701654239);
					}
				}
				if (class298_sub36 != null) {
					class298_sub36.buffer.method3649(385051775 * (class298_sub36.buffer.pos) - i_1_, (byte) -33);
					int i_9_ = 385051775 * (class298_sub36.buffer.pos);
					class298_sub36.buffer.pos = i_1_ * 116413311;
					class298_sub36.buffer.writeByte(i_2_ / i_3_);
					class298_sub36.buffer.writeByte(i_2_ % i_3_);
					class298_sub36.buffer.pos = 116413311 * i_9_;
					GameClient.gameConnection.writeOutboundPacket(class298_sub36, (byte) -85);
				}
			}
			method4618((byte) 1);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("po.a(").append(')').toString());
		}
	}

	abstract void method4627(Packet class298_sub53, Class298_Sub50 class298_sub50);
	...
	abstract void method4630(Packet class298_sub53, Class298_Sub50 class298_sub50);

	abstract Class298_Sub36 method4631();

	abstract void method4632(Packet class298_sub53, Class298_Sub50 class298_sub50);
	...
	static final void method4636(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("po.yq(").append(')').toString());
		}
	}
	...
	static final void method4637(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("po.xq(").append(')').toString());
		}
	}
	...
	static final void method4638(ClientScript2 class403, short i) {
		try {
			...
			Class241.method2247(class105, RSInterface, class403, -533196439);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("po.eg(").append(')').toString());
		}
	}
}
