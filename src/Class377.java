...
public class Class377 {
	...
	public Class377(Js5 class243) {
		...
		method4661(new Packet(is), 1724191904);
	}

	void method4661(Packet class298_sub53, int i) {
		try {
			for (;;) {
				...
				if (1 == i_0_)
					anInterface19_4091 = LocType.method5786(class298_sub53, (byte) -47);
			}
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("pr.a(").append(')').toString());
		}
	}
	...
	static final void method4662(ClientScript2 class403, int i) {
		try {
			...
			Class135.method1490(class105, RSInterface, class403, 1344346794);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("pr.gl(").append(')').toString());
		}
	}

	static final void method4663(ClientScript2 class403, int i) {
		try {
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = GraphicsAutoSetup.clientPreferences.aGroundDecorPreference_7548.method5660(-575221319) ? 1 : 0;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("pr.anr(").append(')').toString());
		}
	}
	...
	public static String method4664(long l) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("pr.f(").append(')').toString());
		}
	}

	static final void method4665(IComponentDefinition class105, RSInterface RSInterface, ClientScript2 class403, short i) {
		try {
			class105.aBoolean1182 = (((ClientScript2) class403).anIntArray5244[(((ClientScript2) class403).anInt5239 -= -391880689) * 681479919]) == 1;
			LocalizedString.markComponentForRedraw(class105, -275285651);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("pr.fs(").append(')').toString());
		}
	}
	...
	static final void method4666(ClientScript2 class403, byte i) {
		try {
			...
			Class393.method4891(class105, RSInterface, class403, (byte) -121);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("pr.hd(").append(')').toString());
		}
	}
	...
	static final void method4667(ClientScript2 class403, int i) {
		try {
			...
			if (2 == 1131012101 * GameClient.anInt8942 && i_5_ >= 0 && i_5_ < GameClient.anInt8941 * -1054937867)
				((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919) - 1] = GameClient.aBooleanArray8722[i_5_] ? 1 : 0;
			else
				((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919) - 1] = 0;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("pr.wt(").append(')').toString());
		}
	}
	...
	static final void method4668(ClientScript2 class403, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("pr.xw(").append(')').toString());
		}
	}
}
