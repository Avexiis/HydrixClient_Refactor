...
public class Class379 {
	...
	static final void method4672(ClientScript2 class403, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("pt.abe(").append(')').toString());
		}
	}
	...
	public static void method4673(Js5 class243, int i) {
		try {
			...
			VarClientTypeList.anInt6092 = class243.getArchiveIdByName("mapdots", -1089743906) * -1409898789;
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("pt.f(").append(')').toString());
		}
	}
	...
	static final void method4674(int i) {
		try {
			...
			for (int i_2_ = 0; i_2_ < GameClient.map.upperX(-2029823795); i_2_++) {
				for (int i_3_ = 0; i_3_ < GameClient.map.upperY(-105400653); i_3_++) {
					if (Class143.method1577((sceneGraph.aClass326ArrayArrayArray3516), i_1_, i_2_, i_3_, true, -777988087))
						i_1_++;
					if (i_1_ >= 512)
						return;
				}
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("pt.iu(").append(')').toString());
		}
	}
	...
	static final void method4675(ClientScript2 class403, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("pt.pg(").append(')').toString());
		}
	}
}
