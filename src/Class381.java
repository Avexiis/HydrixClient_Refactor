...
public class Class381 {
	...
	void method4683(Packet class298_sub53, int i) {
		try {
			for (;;) {
				...
				if (1 == i_0_)
					anInterface19_4113 = LocType.method5786(class298_sub53, (byte) -24);
				else if (i_0_ == 2)
					anInterface19_4109 = LocType.method5786(class298_sub53, (byte) 2);
				else if (3 == i_0_)
					anInterface19_4111 = LocType.method5786(class298_sub53, (byte) -93);
				else if (4 == i_0_)
					anInterface19_4112 = LocType.method5786(class298_sub53, (byte) -56);
				else if (i_0_ == 5)
					aClass355_4116 = SceneryShadowPreference.method5651(class298_sub53, (byte) -80);
				else if (i_0_ == 6)
					aClass355_4114 = SceneryShadowPreference.method5651(class298_sub53, (byte) 68);
				else if (i_0_ == 7)
					aClass355_4115 = SceneryShadowPreference.method5651(class298_sub53, (byte) 9);
				else if (8 == i_0_)
					LocType.method5786(class298_sub53, (byte) -104);
				else if (i_0_ == 9)
					LocType.method5786(class298_sub53, (byte) -11);
				else if (i_0_ == 10)
					LocType.method5786(class298_sub53, (byte) -108);
				else if (11 == i_0_)
					aBoolean4118 = true;
				else if (i_0_ == 12)
					anInt4110 = class298_sub53.readUnsignedInt() * 1848816991;
				else if (13 == i_0_)
					anInt4117 = class298_sub53.readUnsignedInt() * 1126272039;
			}
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("pv.a(").append(')').toString());
		}
	}

	public Class381(Js5 class243) {
		byte[] is = class243.method2294((Class380.aClass380_4106.anInt4108 * -363169051), (byte) 29);
		method4683(new Packet(is), 1436577561);
	}
	...
	public static int[][] method4684(int i, int i_1_, int i_2_, int i_3_, int i_4_, int i_5_, float f, boolean bool, byte i_6_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("pv.be(").append(')').toString());
		}
	}
}
