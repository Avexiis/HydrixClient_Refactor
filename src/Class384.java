public class Class384 {
	...
	static final void method4695(ClientScript2 class403, int i) {
		try {
			...
			Class486.method6157(class105, RSInterface, class403, (byte) 1);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("py.fj(").append(')').toString());
		}
	}
	...
	static final void method4696(ClientScript2 class403, int i) {
		try {
			...
			// if (!Settings.DISABLE_CS_MAP_CHAR_CHECK) {
			...
			// }
			if (i_2_ == 115) {
				class403.anObjectArray5240[(class403.anInt5241 += 969361751) * -203050393 - 1] = class483
						.method6122(i_4_, (byte) 60);
			} else {
				class403.anIntArray5244[(class403.anInt5239 += -391880689) * 681479919 - 1] = class483.method6125(i_4_,
						2053522267);
			}
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("py.vz(").append(')').toString());
	}
	}
	...
	static void method4699(String string, boolean bool, int i, int i_6_, String string_7_, boolean bool_8_,
		...
		try {
			...
			int i_12_ = 0;
			for (int i_13_ = 0; i_13_ < Class298_Sub32_Sub14.aClass477_9400.itemDefinitionsLength
					* -888767613; i_13_++) {
				...
				if (bool && !class468.aBoolean5734) {
					...
					if (0 != 935029595 * class468.anInt5765) {
					...
					} else if (class468.itemName.toLowerCase().indexOf(string) == -1) {
						if (i_9_ == 8221) {
						...
						if (i_12_ >= 250) {
							...
							MagnetConfig.aShortArray678 = null;
							return;
						}
						if (i_12_ >= is.length) {
			...
			MagnetConfig.aShortArray678 = is;
			...
			for (int i_16_ = 0; i_16_ < 367592105 * Class344.anInt3688; i_16_++) {
				strings[i_16_] = Class298_Sub32_Sub14.aClass477_9400.getItemDefinitions(is[i_16_]).itemName;
			}
			Class223.method2085(strings, MagnetConfig.aShortArray678, -1747372319);
			}
		catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("py.nh(").append(')').toString());
		}
	}
	...
	static final void method4700(ClientScript2 class403, int i) {
		try {
			...
			ContextMenu.method5805(class105, RSInterface, class403, -2016583860);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("py.ms(").append(')').toString());
		}
	}
	...
	static final void method4701(ClientScript2 class403, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("py.ahe(").append(')').toString());
		}
	}

	static final void method4702(ClientScript2 class403, int i) {
		try {
			MapDetails mapDetails = Class298_Sub7.method2864(-598938437);
			if (mapDetails != null) {
				boolean bool = mapDetails.method3451(WorldMap.mapX + 1196508279 * Class82_Sub14.anInt6875, 1882038855 * VarClanSettings.anInt4090 + WorldMap.mapY, Class388.anIntArray4156, -1054516511);
				if (bool) {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("py.aeg(").append(')').toString());
		}
	}
	...
	public static void method4703(int i, byte i_17_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("py.p(").append(')').toString());
		}
	}
}