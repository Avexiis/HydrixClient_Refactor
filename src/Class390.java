...
public class Class390 {
	RSInterface aRSInterface_4167;
	IComponentDefinition aClass105_4168;

	boolean method4866(RSInterface RSInterface, int i, int i_0_, int i_1_) {
		try {
			if (RSInterface != null) {
				IComponentDefinition class105 = RSInterface.method1297(i, (short) 15753);
				if (null != class105) {
					((Class390) this).aRSInterface_4167 = RSInterface;
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("qd.b(").append(')').toString());
		}
	}
	...
	boolean method4867(int i, int i_2_, int i_3_) {
		try {
			...
			if (class105 != null) {
				((Class390) this).aRSInterface_4167 = SpotAnimTypeList.aRSInterfaceArray4165[i >> 16];
				((Class390) this).aClass105_4168 = class105;
				return true;
			}
			method4869((byte) 92);
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("qd.f(").append(')').toString());
		}
	}

	IComponentDefinition method4868(int i) {
		try {
			return (((Class390) this).aRSInterface_4167.method1297(((Class390) this).aClass105_4168.interfacehash * -440872681, (short) 10433));
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("qd.a(").append(')').toString());
		}
	}

	void method4869(byte i) {
		try {
			((Class390) this).aRSInterface_4167 = null;
			((Class390) this).aClass105_4168 = null;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("qd.p(").append(')').toString());
		}
	}
	...
	static final void method4870(ClientScript2 class403, short i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("qd.aez(").append(')').toString());
		}
	}
	...
	public static int method4871(byte i) {
		try {
			...
			int i_5_ = (int) (TimeUtils.getTime((byte) 1) - l);
	...
	static final void method4872(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("qd.rb(").append(')').toString());
		}
	}
	...
	static final void method4874(ClientScript2 class403, int i) {
		try {
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = (int) GameClient.aFloat8757 >> 3;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("qd.agr(").append(')').toString());
		}
	}
	...
	static final void method4875(Class298_Sub37_Sub15 class298_sub37_sub15, ClientScript2 class403, byte i) {
		try {
			...
			((ClientScript2) class403).anObjectArray5240[((((ClientScript2) class403).anInt5241 += 969361751) * -203050393 - 1)] = VarPlayerType.method1933(class298_sub37_sub15, -532801249);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("qd.v(").append(')').toString());
		}
	}
