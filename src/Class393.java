...
final class Class393 implements Runnable {
	public void run() {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("qg.run(").append(')').toString());
		}
	}

	static final void method4890(ClientScript2 class403, int i) {
		try {
			Class343_Sub1 class343_sub1 = Wall.method4537(-1844616011);
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("qg.alh(").append(')').toString());
		}
	}

	static final void method4891(IComponentDefinition class105, RSInterface RSInterface, ClientScript2 class403, byte i) {
		try {
			...
			if (class105.component * -1309843523 == -1 && !RSInterface.aBoolean1403)
				IntegerPreferenceField.method5623(class105.interfacehash * -440872681, 2026838544);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("qg.hx(").append(')').toString());
		}
	}

	static synchronized GraphicsToolkit method4892(int i, Canvas canvas, Interface_ma interface_ma, Js5 class243, int i_0_, int i_1_, int i_2_, int i_3_) {
		try {
			if (i == 0)
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("qg.f(").append(')').toString());
		}
	}
	...
	static final void method4893(ClientScript2 class403, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("qg.pl(").append(')').toString());
		}
	}
	...
	static final void method4894(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("qg.zb(").append(')').toString());
		}
	}
	...
	static final void method4895(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("qg.rn(").append(')').toString());
		}
	}
