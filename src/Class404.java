...
public class Class404 implements Runnable {
	...
	public Class396 method4946(String string, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("qu.a(").append(')').toString());
		}
	}
	...
	void method4947(Object object, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("qu.b(").append(')').toString());
		}
	}
	...
	public void method4948(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("qu.f(").append(')').toString());
		}
	}
	...
	public void run() {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("qu.run(").append(')').toString());
		}
	}
	...
	static final void method4949(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("qu.ag(").append(')').toString());
		}
	}
	...
	static final void method4950(ClientScript2 class403, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("qu.aai(").append(')').toString());
		}
	}
	...
	static final void method4953(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("qu.pv(").append(')').toString());
		}
	}
	...
	static final void method4954(ClientScript2 class403, int i) {
		try {
			...
			Class102.method1085(class105, RSInterface, class403, -1934689497);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("qu.do(").append(')').toString());
		}
	}
}
