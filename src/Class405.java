...
public class Class405 {
	...
	public Class405(Js5 class243) {
		...
		method4955(new Packet(is), 1286712749);
		if (anIntArray5267 == null)
			throw new RuntimeException("");
	}

	void method4955(Packet class298_sub53, int i) {
		try {
			for (;;) {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("qv.a(").append(')').toString());
		}
	}

	static final void method4956(ClientScript2 class403, byte i) {
		try {
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = GameClient.aBoolean8802 ? 1 : 0;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("qv.uq(").append(')').toString());
		}
	}
	...
	public static void method4957(Class297 class297, short i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("qv.j(").append(')').toString());
		}
	}
	...
	static final void method4958(int i) {
		try {
			...
			if (-257444687 * GameClient.WINDOW_PANE_ID != -1)
				FluType.method5884(-257444687 * GameClient.WINDOW_PANE_ID, 186134073);
			...
			GameClient.anInt8832 = -1390800553 * GameClient.anInt8884;
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("qv.ig(").append(')').toString());
		}
	}
	...
	static void method4959(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("qv.r(").append(')').toString());
		}
	}
}
