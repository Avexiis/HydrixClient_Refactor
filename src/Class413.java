...
public class Class413 implements Interface21 {
	...
	public int method242(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("rd.f(").append(')').toString());
		}
	}
	...
	static void method5582(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("rd.t(").append(')').toString());
		}
	}
	...
	public static void method5583(int i, short i_0_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("rd.q(").append(')').toString());
		}
	}
	...
	public static boolean method5584(int i, int i_1_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("rd.fo(").append(')').toString());
		}
	}
}
