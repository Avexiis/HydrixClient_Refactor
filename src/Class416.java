...
public class Class416 {
	...
	public static synchronized byte[] method5589(int i, short i_0_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("rg.a(").append(')').toString());
		}
	}
	...
	public static int method5590(int i, byte i_2_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("rg.p(").append(')').toString());
		}
	}
	...
	static final void method5591(ClientScript2 class403, byte i) {
		try {
			...
			Class7.method310(class105, RSInterface, class403, (byte) 119);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("rg.ou(").append(')').toString());
		}
	}
}
