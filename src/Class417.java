...
public class Class417 {
	...
	public int method5592(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("rh.f(").append(')').toString());
		}
	}
	...
	public boolean method5593(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("rh.b(").append(')').toString());
		}
	}
	...
	public int method5594(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("rh.a(").append(')').toString());
		}
	}
	...
	static final void method5595(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("rh.wo(").append(')').toString());
		}
	}
}
