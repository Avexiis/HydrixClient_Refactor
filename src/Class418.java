...
public final class Class418 {
	...
	static final void method5596(ClientScript2 class403, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ri.ro(").append(')').toString());
		}
	}
	...
	static void method5597(ClientScript2 class403, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ri.n(").append(')').toString());
		}
	}
	...
	static final void method5599(ClientScript2 class403, int i) {
		try {
			...
			Class372_Sub1.method4597(class105, RSInterface, class403, -750827082);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ri.ne(").append(')').toString());
		}
	}
	...
	static void method5600(int i, int i_3_, int i_4_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ri.ar(").append(')').toString());
		}
	}
	...
	static void method5601(byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ri.r(").append(')').toString());
		}
	}
}
