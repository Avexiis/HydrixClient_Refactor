...
public class Class42 {
	...
	boolean method481(int i, int i_0_, int i_1_, int i_2_) {
		...
		if (((Class42) this).anInt456 != i_1_ || ((Class42) this).anInt449 != i_2_) {
			...
			for (Node node = ((Class42) this).aClass458_451.method5967(1528300499); node != ((Class42) this).aClass458_451.aNode_5668; node = node.aNode_3187)
				((Class298_Sub8) node).method2871((((Class42) this).anInt456), (((Class42) this).anInt449));
	...
	void method486() {
		...
		if (!((Class42) this).aClass458_451.method5970((byte) 106)) {
			for (Node node = ((Class42) this).aClass458_451.method5967(1803490493); node != ((Class42) this).aClass458_451.aNode_5668; node = node.aNode_3187)
				((Class298_Sub8) node).method2870();
		}
		((Class42) this).anInt449 = 1;
