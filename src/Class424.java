...
public class Class424 implements Interface21 {
	...
	public int method242(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ro.f(").append(')').toString());
		}
	}
	...
	static final void method5735(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ro.abs(").append(')').toString());
		}
	}
}
