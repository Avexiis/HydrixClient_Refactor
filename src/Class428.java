...
public class Class428 implements Interface21 {
	...
	public int method242(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("rs.f(").append(')').toString());
		}
	}
	...
	static final void method5752(ClientScript2 class403, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("rs.sl(").append(')').toString());
		}
	}
}
