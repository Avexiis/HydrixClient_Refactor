...
public class Class431 implements Interface15 {
	...
	public Object method214(int[] is, int i, int i_6_, int i_7_, int i_8_, boolean bool, int i_9_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("rv.a(").append(')').toString());
		}
	}
	...
	public static boolean method5763(byte[] is, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("rv.f(").append(')').toString());
		}
	}
	...
	public static boolean method5764(char c, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("rv.z(").append(')').toString());
		}
	}
	...
	static final void method5765(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("rv.aky(").append(')').toString());
		}
	}
	...
	static void method5766(int i) {
		try {
			...
			for (int i_15_ = 0; i_15_ < 2048; i_15_++)
				GameClient.players[i_15_] = null;
			Class287.myPlayer = null;
			for (int i_16_ = 0; i_16_ < 1962237353 * GameClient.anInt8772; i_16_++) {
				Entity class365_sub1_sub1_sub2 = ((Entity) GameClient.aLinkableObjectArray8816[i_16_].anObject7366);
			...
			RSInterface.method1304(2030440577);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("rv.ae(").append(')').toString());
		}
	}
	...
	public static void method5767(int i, Js5 class243, int i_18_, int i_19_, int i_20_, boolean bool, int i_21_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("rv.r(").append(')').toString());
		}
	}
	...
	public static void method5768(Entity class365_sub1_sub1_sub2, int[] is, int i, boolean bool, byte i_22_) {
		try {
			if (null != class365_sub1_sub1_sub2.anIntArray10093) {
				...
				if (bool_23_ && animator.method5819((byte) -38)) {
					SeqType class391 = class365_sub1_sub1_sub2.projectileAnimator.method5820(1190945096);
					int i_25_ = class391.anInt4184 * -1117238071;
					if (1 == i_25_)
						animator.method5835(i, (byte) 81);
					if (i_25_ == 2)
						animator.method5842(1476401100);
				}
			}
			...
			for (int i_27_ = 0; i_27_ < is.length; i_27_++) {
				...
				if (null == class365_sub1_sub1_sub2.anIntArray10093 || -1 == class365_sub1_sub1_sub2.anIntArray10093[i_27_] || ((Class501.aClass395_6122.method4903(is[i_27_], (byte) -62).anInt4178) * -1445588039 >= (Class501.aClass395_6122.method4903(class365_sub1_sub1_sub2.anIntArray10093[i_27_], (byte) -47).anInt4178) * -1445588039)) {
					...
					class365_sub1_sub1_sub2.projectileAnimator.method5828(i, -1445580533);
					if (bool)
			...
			if (bool_26_) {
				...
				class365_sub1_sub1_sub2.projectileAnimator.method5828(i, -1445580533);
				if (bool)
					class365_sub1_sub1_sub2.anInt10125 = -526956429 * class365_sub1_sub1_sub2.moveQueueSize;
			}
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("rv.ke(").append(')').toString());
		}
	}
}
