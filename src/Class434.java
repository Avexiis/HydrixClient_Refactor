...
public class Class434 {
	...
	void method5800(Packet class298_sub53, int i, int i_0_) {
		try {
			if (i == 1) {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ry.f(").append(')').toString());
		}
	}

	void method5801(Packet class298_sub53, int i) {
		try {
			for (;;) {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ry.a(").append(')').toString());
		}
	}
	...
	static boolean method5802(int i) {
		try {
			return Class492.method6184(IdentityKitTypeList.aClass381_1563.aClass355_4115, 1089632340);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ry.b(").append(')').toString());
		}
	}
	...
	static final void method5803(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ry.bz(").append(')').toString());
		}
	}
}
