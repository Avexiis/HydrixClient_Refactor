...
public final class Class439 {
	...
	public static final void method5850(String string, int i) {
		try {
				...
				if ((-1054937867 * GameClient.anInt8941 >= 200 && !GameClient.aBoolean8807) || -1054937867 * GameClient.anInt8941 >= 200)
					...
					if (null != string_0_) {
						...
						if (Class173.method1824((Class287.myPlayer.username), -712250197).equals(string_0_))
							...
							class298_sub36.buffer.writeByte(Class58.method693(string, -92805385));
							class298_sub36.buffer.writeString(string, 2126537806);
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("sc.mk(").append(')').toString());
		}
	}
	...
	public static void method5851(int i, int i_7_) {
		try {
			if (i != GameClient.anInt8752 * -1233866115) {
				...
				if (i == 5 || 13 == i)
					VarClientType.method6070(760519077);
				...
				if (i == 4 || 6 == i)
					...
					VarClientType.method6070(1162411214);
				else if (i == 2)
					Class70.method805((byte) 0);
				if (HitType.method4287(i, -1178041789)) {
					GameClient.map.method2673((byte) 75);
				...
				if (HitType.method4287(i, 299941911) || i == 5 || 13 == i)
					OverlayType.activeToolkit.method5176();
				GameClient.anInt8752 = -705702187 * i;
			}
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("sc.fd(").append(')').toString());
		}
	}
}
