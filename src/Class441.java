...
public class Class441 {
	...
	static final String method5866(int i, int i_2_) {
		try {
			...
			if (string.length() > 9) {
				return new StringBuilder().append(" ").append(Class285.method2709(65408, -2039864554)).append(string.substring(0, string.length() - 8)).append(LocalizedString.LABEL_SHORT_M.getText(Class321.ACTIVE_LANGUAGE, -875414210)).append(" (").append(string).append(")").append(Class26.aString356).toString();
			}
			if (string.length() > 6) {
				return new StringBuilder().append(" ").append(Class285.method2709(16777215, -1284566910)).append(string.substring(0, string.length() - 4)).append(LocalizedString.LABEL_SHORT_K.getText(Class321.ACTIVE_LANGUAGE, -875414210)).append(" (").append(string).append(")").append(Class26.aString356).toString();
			}
