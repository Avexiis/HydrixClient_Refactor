...
public class Class442 {
	...
	public Class302 method5868(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("sg.p(").append(')').toString());
		}
	}
	...
	public void method5869(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("sg.a(").append(')').toString());
		}
	}
	...
	public void method5870(Class302 class302, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("sg.f(").append(')').toString());
		}
	}
	...
	public Class302 method5871(byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("sg.b(").append(')').toString());
		}
	}
	...
	public Class302 method5872(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("sg.i(").append(')').toString());
		}
	}
	...
	static final void method5873(ClientScript2 class403, byte i) {
		try {
			...
			if (null != Class301_Sub1.aClass437_7637) {
				Node node = Class301_Sub1.aClass437_7637.get((long) i_0_);
				if (node != null && !bool)
					node.unlink(-1460969981);
				else if (null == node && bool) {
					node = new Node();
					Class301_Sub1.aClass437_7637.method5817(node, (long) i_0_);
				}
			}
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("sg.aes(").append(')').toString());
		}
	}
	...
	static final void method5874(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("sg.apc(").append(')').toString());
		}
	}

	static final void method5875(ClientScript2 class403, byte i) {
		try {
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = GameClient.aBoolean8646 ? 1 : 0;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("sg.ako(").append(')').toString());
		}
	}
	...
	static final void method5876(ClientScript2 class403, int i) {
		try {
			...
			WorldMapLabel worldMapLabel = Class363.aWorldMapLabelList_3931.method4116(i_1_, -2066562424);
			if (null == worldMapLabel.aString3792)
				...
				((ClientScript2) class403).anObjectArray5240[((((ClientScript2) class403).anInt5241 += 969361751) * -203050393) - 1] = worldMapLabel.aString3792;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("sg.ame(").append(')').toString());
		}
	}
	...
	static final void method5877(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("sg.pi(").append(')').toString());
		}
	}

	static final void method5878(ClientScript2 class403, int i) {
		try {
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = MagnetDefinitions.method1859((byte) -52);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("sg.aex(").append(')').toString());
		}
	}
	...
	static final void method5879(int i) {
		try {
			...
			Class212.aIdentityKitTypeList_2433.method1582(5, -754640866);
			GameClient.map.method2641(1725751477).method5794(5, (byte) 49);
			...
			Class158_Sub1.aSpotAnimTypeList_8568.method4859(5, 2135509320);
			Class472.configLoader.method3826(5, (byte) -13);
			Class440.aVarPlayerTypeList_5582.method1916(5, (byte) 0);
			SceneryShadowPreference.aClass445_8384.method5894(5, (byte) 79);
			Class82_Sub16.aClass427_6886.method5746(5, 1584837468);
			Class99.aVarClanTypeList_951.method6304(5, 977511908);
			Class299.aClanSettings_3199.method4573(5, 181310577);
			Class94.aClass349_913.method4200(5, (byte) -101);
			Class363.aWorldMapLabelList_3931.method4117(5, (byte) 14);
			Js5ConfigGroup.aMapIconTypeList_1463.method6163(5, -718074838);
			Class92.aClass504_905.method6249(5, (byte) 46);
			VarBitType.aClass317_3472.method3847(5, -2144491274);
			...
			ContextMenu.aClass348_5500.method4186(5, -1070209353);
			Class388.aClass348_4153.method4186(5, 424638982);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("sg.gf(").append(')').toString());
		}
	}
}
