...
public final class Class448 {
	...
	public void method5907(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("sm.p(").append(')').toString());
		}
	}
	...
	public void method5908(Class302_Sub3 class302_sub3, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("sm.a(").append(')').toString());
		}
	}
	...
	public Class302_Sub3 method5909(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("sm.b(").append(')').toString());
		}
	}
	...
	public int method5910(short i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("sm.i(").append(')').toString());
		}
	}
	...
	public Class302_Sub3 method5911(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("sm.f(").append(')').toString());
		}
	}
	...
	static final void method5912(int i, int i_1_, int i_2_, int i_3_, int i_4_, int i_5_, int i_6_, int i_7_, int i_8_) {
		try {
			if (!Class378.method4671(i, null, -1216775650)) {
				...
				Class422_Sub24.method5714(SpotAnimTypeList.aRSInterfaceArray4165[i].method1295((byte) -87), -1, i_1_, i_2_, i_3_, i_4_, i_5_, i_6_, i_7_, i_7_ < 0, (byte) 0);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("sm.kt(").append(')').toString());
		}
	}
	...
	static final void method5913(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("sm.be(").append(')').toString());
		}
	}
}
