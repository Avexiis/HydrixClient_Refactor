	...
	Class45(Class_ra_Sub2 class_ra_sub2) {
		...
		if (!((Class45) this).aBoolean480) {
			...
			for (int i = 0; i < 16; i++) {
				...
				((Class45) this).aClass30_Sub2Array487[i] = new Class30_Sub2(class_ra_sub2, 3553, Class55.aClass55_565, TextEncoder.aTextEncoder_717, 128, 128, true, is, Class55.aClass55_565, false);
			}
			((Class45) this).aClass30_Sub2Array483 = new Class30_Sub2[16];
			for (int i = 0; i < 16; i++) {
				byte[] is = Class415.method5586(anObject479, i * 32768, 32768, (byte) 1);
				((Class45) this).aClass30_Sub2Array483[i] = new Class30_Sub2(class_ra_sub2, 3553, Class55.aClass55_565, TextEncoder.aTextEncoder_717, 128, 128, true, is, Class55.aClass55_565, false);
			}
		} else {
			byte[] is = Class338.method4114(anObject488, false, -1069979681);
			((Class45) this).aClass30_Sub4_482 = new Class30_Sub4(class_ra_sub2, Class55.aClass55_565, TextEncoder.aTextEncoder_717, 128, 128, 16, is, Class55.aClass55_565);
			is = Class338.method4114(anObject479, false, -2082451325);
			((Class45) this).aClass30_Sub4_484 = new Class30_Sub4(class_ra_sub2, Class55.aClass55_565, TextEncoder.aTextEncoder_717, 128, 128, 16, is, Class55.aClass55_565);
			...
			if (class49.method528()) {
				...
				((Class45) this).aClass30_Sub4_485 = new Class30_Sub4(class_ra_sub2, Class55.aClass55_557, TextEncoder.aTextEncoder_717, 128, 128, 16);
				Class30_Sub4 class30_sub4 = new Class30_Sub4(class_ra_sub2, Class55.aClass55_559, TextEncoder.aTextEncoder_717, 128, 128, 16, is, Class55.aClass55_559);
