...
public class Class455 {
	...
	void method5953(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("st.f(").append(')').toString());
		}
	}
	...
	void method5954(byte[] is, long l) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("st.b(").append(')').toString());
		}
	}
	...
	void method5955(byte[] is, int i, int i_9_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("st.p(").append(')').toString());
		}
	}
	...
	void method5956(byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("st.a(").append(')').toString());
		}
	}
	...
	public static void method5957(int i, int i_26_, int i_27_, int i_28_, int i_29_, int i_30_, int i_31_, int i_32_) {
		try {
			if (i_27_ == i_28_)
				...
				AntialiasPreference.method5676(i, i_26_, i_27_, i_28_, i_29_, i_30_, i_31_, -568588475);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("st.ae(").append(')').toString());
		}
	}
		...
		try {
			for (int i_36_ = 7; i_36_ >= 0; i_36_--) {
				for (int i_37_ = 127; i_37_ >= 0; i_37_--) {
					...
					int i_39_ = JAGLib.anIntArray3165[i_38_];
					Class216.method2000(false, true, (short) -6266);
					class_ra.drawFilledBox(i + (class105.width * -2093041337 * i_37_ >> 7), i_33_ + ((7 - i_36_) * (class105.height * 457937409) >> 3), (class105.width * -2093041337 >> 7) + 1, (457937409 * class105.height >> 3) + 1, i_39_, 0);
				}
			}
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("st.f(").append(')').toString());
