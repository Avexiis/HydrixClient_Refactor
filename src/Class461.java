...
public class Class461 implements Iterable {
	...
	public void method5982(Class298_Sub37 class298_sub37, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("sz.f(").append(')').toString());
		}
	}
	...
	public Class298_Sub37 method5983(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("sz.i(").append(')').toString());
		}
	}
	...
	public Class298_Sub37 method5984(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("sz.k(").append(')').toString());
		}
	}
	...
	public Class298_Sub37 method5985(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("sz.u(").append(')').toString());
		}
	}
	...
	public int method5986(short i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("sz.x(").append(')').toString());
		}
	}
	...
	public Iterator iterator() {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("sz.iterator(").append(')').toString());
		}
	}
	...
	Class298_Sub37 method5987(Class298_Sub37 class298_sub37, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("sz.d(").append(')').toString());
		}
	}
	...
	public void method5988(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("sz.a(").append(')').toString());
		}
	}
	...
	static void method5989(Class298_Sub41 class298_sub41, int i, int i_2_, int i_3_, int i_4_, int i_5_) {
		try {
					...
					if ((((Class298_Sub41) class298_sub41).aClass298_Sub19_Sub2_7447) == null) {
						if ((391847895 * ((Class298_Sub41) class298_sub41).anInt7443) >= 0) {
							...
							if (((Class298_Sub41) class298_sub41).aBoolean7444) {
								...
								if (null != class278) {
									Class298_Sub26_Sub1 class298_sub26_sub1 = (class278.method2601().method3104(MovementType.aClass270_6546));
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("sz.n(").append(')').toString());
		}
	}
}
