...
public class Class462 {
	...
	static String method5990(String string, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("t.a(").append(')').toString());
		}
	}
	...
	static final void method5991(ClientScript2 class403, int i) {
		try {
			...
			Class409.method4973(class105, RSInterface, class403, (byte) 106);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("t.ce(").append(')').toString());
		}
	}
	...
	static final void method5993(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("t.zh(").append(')').toString());
		}
	}
}
