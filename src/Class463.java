...
public class Class463 {
	...
	public static ObjectTypeList aClass433_5689;
	...
	static final void method6008(ClientScript2 class403, byte i) {
		try {
			...
			Class225.method2102(class105, RSInterface, class403, (short) -9329);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("tc.jk(").append(')').toString());
		}
	}
	...
	public static void method6009(int i, int i_0_, int i_1_, int i_2_, int i_3_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("tc.f(").append(')').toString());
		}
	}
	...
	static final void method6010(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("tc.ew(").append(')').toString());
		}
	}
	...
	static void method6011(GraphicsToolkit class_ra, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("tc.aj(").append(')').toString());
		}
	}
	...
	static final int method6012(int i, int i_5_, int i_6_, int i_7_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("tc.p(").append(')').toString());
		}
	}
	...
	static void method6013(GraphicsToolkit class_ra, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("tc.l(").append(')').toString());
		}
	}
	...
	static void method6014(int i, int i_8_, int i_9_, int i_10_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("tc.cm(").append(')').toString());
		}
	}
}
