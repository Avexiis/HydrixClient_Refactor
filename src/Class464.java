...
public class Class464 {
	...
	public static final void method6015(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("td.hr(").append(')').toString());
		}
	}
	...
	static final void method6016(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("td.am(").append(')').toString());
		}
	}
}
