...
public class Class465 implements Interface18 {
	...
	public long method231() {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("te.a(").append(')').toString());
		}
	}
	...
	static final void method6018(IComponentDefinition class105, RSInterface RSInterface, ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("te.ld(").append(')').toString());
		}
	}
	...
	static final void method6019(ClientScript2 class403, short i) {
		try {
			...
			BASType class350 = Class94.aClass349_913.method4202(i_9_, (byte) 24);
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("te.abx(").append(')').toString());
		}
	}
}
