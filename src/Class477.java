...
public class Class477 {
	...
	Language aLanguage_5997;
	GameContext aGameContext_5998;
	...
	public ItemDefinitions getItemDefinitions(int itemId, boolean forceNew) {
		try {
			...
			if (!forceNew && OLD_ITEMS && itemId != 4712) { // disable ahrim body
				is = (((Class477) this).aClass243_5990.getFileFromArchive(Js5ConfigGroup.aClass120_1429.method1307(itemId + (Class298_Sub32_Sub14.aClass477_9400.itemDefinitionsLength * -888767613), -100335020), Js5ConfigGroup.aClass120_1429.method1305(itemId + (Class298_Sub32_Sub14.aClass477_9400.itemDefinitionsLength * -888767613), -1698958016), (byte) -74));
				oldItem = true;
			}
			if (is == null) {
				synchronized (((Class477) this).aClass243_5990) {
					is = (((Class477) this).aClass243_5990.getFileFromArchive(Js5ConfigGroup.aClass120_1429.method1307(itemId, -100335020), Js5ConfigGroup.aClass120_1429.method1305(itemId, -1698958016), (byte) -74));
					oldItem = false;
				}
			}
			...
			if (null != is)
				itemdefinition.decode(new Packet(is), oldItem);
			...
			if (!((Class477) this).aBoolean5999 && itemdefinition.aBoolean5731) {
				...
				if (null != ((ItemDefinitions) itemdefinition).aClass437_5766) {
					boolean bool = false;
					for (Node node = ((ItemDefinitions) itemdefinition).aClass437_5766.method5816(1739772889); node != null; node = ((ItemDefinitions) itemdefinition).aClass437_5766.method5815((byte) -94)) {
						Class497 class497 = (((Class477) this).aClass504_5989.method6251((int) (node.aLong3188 * 7051297995265073167L), -1474104007));
			...
			synchronized (((Class477) this).aClass348_5993) {
				((Class477) this).aClass348_5993.put(itemdefinition, (long) itemId);
			}
			return itemdefinition;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("tq.a(").append(')').toString());
		}
	}
	...
	public Class57 method6085(GraphicsToolkit class_ra, int i, int i_1_, int i_2_, int i_3_, int i_4_, Class366 class366, int i_5_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("tq.f(").append(')').toString());
		}
	}
	...
	public Class57 method6086(GraphicsToolkit class_ra, GraphicsToolkit class_ra_6_, int i, int i_7_, int i_8_, int i_9_, boolean bool, boolean bool_10_, int i_11_, Class264 class264, Class366 class366, int i_12_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("tq.b(").append(')').toString());
		}
	}
	...
	public void method6087(int i, int i_15_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("tq.i(").append(')').toString());
		}
	}
	...
	public void method6088(short i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("tq.k(").append(')').toString());
		}
	}
	...
	public void method6089(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("tq.d(").append(')').toString());
		}
	}

	public Class477(GameContext gameContext, Language language, boolean bool, Class504 class504, Js5 class243, Js5 class243_16_) {
		((Class477) this).aGameContext_5998 = gameContext;
		((Class477) this).aLanguage_5997 = language;
		...
		if (null != ((Class477) this).aClass243_5990) {
			...
			if (true)
				...
				itemDefinitionsLength = (i * Js5ConfigGroup.aClass120_1429.method1306((short) 15063) + ((Class477) this).aClass243_5990.method2316(i, -1996628421)) * -1797723349;
		} else
			itemDefinitionsLength = 0;
		if (((Class477) this).aGameContext_5998 == GameContext.aGameContext_5320)
			((Class477) this).aStringArray5988 = (new String[] { null, null, LocalizedString.ACTION_TAKE.getText((((Class477) this).aLanguage_5997), -875414210), null, null, LocalizedString.BUTTON_EXAMINE.getText((((Class477) this).aLanguage_5997), -875414210) });
		else
			((Class477) this).aStringArray5988 = (new String[] { null, null, LocalizedString.ACTION_TAKE.getText((((Class477) this).aLanguage_5997), -875414210), null, null, null });
		((Class477) this).aStringArray6000 = (new String[] { null, null, null, null, LocalizedString.ACTION_DROP.getText((((Class477) this).aLanguage_5997), -875414210) });
	}
	...
	public void method6090(int i, byte i_17_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("tq.x(").append(')').toString());
		}
	}
	...
	public void method6091(byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("tq.u(").append(')').toString());
		}
	}
	...
	public void method6092(boolean bool, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("tq.p(").append(')').toString());
		}
	}
	...
	public void method6093(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("tq.r(").append(')').toString());
		}
	}

	static final void method6094(int i, byte i_18_) {
		try {
			JagexLibraryManager.method3753((byte) -70);
			int i_19_ = (Class440.aVarPlayerTypeList_5582.method1914(i, -482836609).anInt2359 * -65795773);
			if (0 != i_19_) {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("tq.lh(").append(')').toString());
		}
	}

	static final void method6095(ClientScript2 class403, int i) {
		try {
			Class298_Sub36.method3401(0, 0, (GameClient.aClass105_8819.width * -2093041337), (GameClient.aClass105_8819.height * 457937409), false, 1934343255);
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = -505673857 * GameClient.anInt8664;
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = 1387083365 * GameClient.anInt8939;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("tq.aku(").append(')').toString());
		}
	}
