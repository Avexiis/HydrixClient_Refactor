...
public class Class478 {
	static LinkedNodeList aLinkedNodeList_6002 = new LinkedNodeList();

	Class478() throws Throwable {
		throw new Error();
	}

	static final void method6097(IComponentDefinition class105, RSInterface RSInterface, ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ts.id(").append(')').toString());
		}
	}
	...
	public static final int method6098(String string, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ts.lg(").append(')').toString());
		}
	}
	...
	static void method6099(Js5 class243, int i, int i_2_, int i_3_, boolean bool, long l) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ts.p(").append(')').toString());
		}
	}
}
