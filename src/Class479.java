...
public class Class479 {
	...
	public int method6100(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("tt.f(").append(')').toString());
		}
	}
	...
	public Interface24 method6101(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("tt.p(").append(')').toString());
		}
	}
	...
	public void method6102(Interface24 interface24, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("tt.i(").append(')').toString());
		}
	}
	...
	public void method6103(int i, int i_0_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("tt.b(").append(')').toString());
		}
	}
	...
	public static Class479[] method6104(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("tt.a(").append(')').toString());
		}
	}
	...
	static final void method6105(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("tt.aco(").append(')').toString());
		}
	}
	...
	static final void method6106(ClientScript2 class403, byte i) {
		try {
			...
			Class116.method1271(class105, RSInterface, class403, (byte) -76);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("tt.cz(").append(')').toString());
		}
	}
	...
	static final void method6107(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("tt.ok(").append(')').toString());
		}
	}
}
