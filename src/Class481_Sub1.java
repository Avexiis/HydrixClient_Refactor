...
public class Class481_Sub1 extends Class481 {
	...
	Socket method6114(String string, int i, String string_0_, int i_1_) throws IOException {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aes.q(").append(')').toString());
		}
	}
	...
	Socket method6115(Proxy proxy, int i) throws IOException {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aes.r(").append(')').toString());
		}
	}
	...
	public Socket method6111(int i) throws IOException {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aes.f(").append(')').toString());
		}
	}
}
