...
public class Class482 {
	...
	static void method6116(Packet class298_sub53, byte i) {
		try {
			if ((class298_sub53.payload.length - class298_sub53.pos * 385051775) >= 1) {
				int i_0_ = class298_sub53.readUnsignedByte();
				if (i_0_ >= 0 && i_0_ <= 1 && (class298_sub53.payload.length - class298_sub53.pos * 385051775) >= 2) {
					int i_1_ = class298_sub53.readUnsignedShort();
					if ((class298_sub53.payload.length - class298_sub53.pos * 385051775) >= i_1_ * 6) {
						for (int i_2_ = 0; i_2_ < i_1_; i_2_++) {
							...
							if (i_3_ < Class374.anIntArray4078.length) {
								if (!Class254.aBooleanArray2790[i_3_]) {
									...
									if ((Class320.aVarClientTypeList_6550.method6191(i_3_, (byte) 10).aChar5968) == '1') {
										if (i_4_ < -1)
											continue;
										if (i_4_ > 1) {
											if (i != 3) {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("tw.q(").append(')').toString());
		}
	}
	...
	static final void method6117(ClientScript2 class403, int i) {
		try {
			...
			Class116.method1271(class105, RSInterface, class403, (byte) -55);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("tw.cg(").append(')').toString());
		}
	}
	...
	static File method6118(String string, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("tw.f(").append(')').toString());
		}
	}
	...
	static void method6119(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("tw.b(").append(')').toString());
		}
	}
	...
	static final void method6121(int i, int i_12_, int i_13_, int i_14_, int i_15_, int i_16_, int i_17_, int i_18_) {
		try {
			...
			int i_25_ = i_16_;
			if (i_21_ != 0) {
				i_24_ = -i_25_ * Class220.SINE[i_21_] >> 14;
				i_25_ = Class220.COSINE[i_21_] * i_25_ >> 14;
			}
			if (0 != i_22_) {
				i_23_ = Class220.SINE[i_22_] * i_25_ >> 14;
				i_25_ = Class220.COSINE[i_22_] * i_25_ >> 14;
			}
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("tw.je(").append(')').toString());
		}
	}
}
