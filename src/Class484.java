...
public class Class484 {
	...
	public void method6133(int i) throws IOException {
		try {
			method6138((byte) 63);
			((Class484) this).aClass476_6045.close();
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ty.a(").append(')').toString());
		}
	}
	...
	public void method6134(byte[] is, int i, int i_0_, int i_1_) throws IOException {
		try {
			do {
				try {
					...
					if (i_0_ > ((Class484) this).aByteArray6050.length) {
						...
						((Class484) this).aClass476_6045.write(is, i, i_0_);
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ty.d(").append(')').toString());
		}
	}
	...
	public long method6135(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ty.b(").append(')').toString());
		}
	}
	...
	public void method6136(byte[] is, int i) throws IOException {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ty.p(").append(')').toString());
		}
	}
	...
	void method6137(int i) throws IOException {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ty.k(").append(')').toString());
		}
	}
	...
	void method6138(byte i) throws IOException {
		try {
			if (-3151226325898744411L * ((Class484) this).aLong6051 != -1L) {
				...
				((Class484) this).aClass476_6045.write(((Class484) this).aByteArray6050, 0, ((Class484) this).anInt6053 * 447269525);
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ty.u(").append(')').toString());
		}
	}
	...
	public void method6139(byte[] is, int i, int i_9_, int i_10_) throws IOException {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ty.i(").append(')').toString());
		}
	}
	...
	public void method6140(long l) throws IOException {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ty.f(").append(')').toString());
		}
	}

	public Class484(DiskFile class476, int i, int i_20_) throws IOException {
	...
	static final void method6142(IComponentDefinition class105, RSInterface RSInterface, ClientScript2 class403, int i) {
		try {
			...
			class105.tempZoomDistance = (-1066050969 * (((ClientScript2) class403).anIntArray5244[5 + 681479919 * ((ClientScript2) class403).anInt5239]));
			LocalizedString.markComponentForRedraw(class105, -212905305);
			if (class105.component * -1309843523 == -1 && !RSInterface.aBoolean1403) {
				Class509.method6286(class105.interfacehash * -440872681, 1280161457);
				Class70.method808(class105.interfacehash * -440872681, 1365886574);
			}
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ty.dw(").append(')').toString());
		}
	}
}
