/* MapIconTypeList - Decompiled by JODE
...
public class Class487 {
	...
	public Class496 method6159(int i, int i_0_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ub.a(").append(')').toString());
		}
	}
	...
	static final void method6164(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ub.aaa(").append(')').toString());
		}
	}
	...
	static final void method6165(int i, int i_5_, int i_6_, int i_7_, int i_8_, int i_9_, int i_10_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ub.r(").append(')').toString());
		}
	}
}
