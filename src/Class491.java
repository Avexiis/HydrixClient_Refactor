...
public class Class491 {
	...
	public void method6171(byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("uf.f(").append(')').toString());
		}
	}
	...
	public Class492 method6172(int i, int i_0_) {
		try {
			...
			synchronized (((Class491) this).aClass243_6076) {
				is = (((Class491) this).aClass243_6076.getFileFromArchive(-1006924897 * Js5ConfigGroup.aClass120_1438.anInt1460, i, (byte) -68));
			}
			class492 = new Class492();
			((Class492) class492).aClass491_6082 = this;
			if (is != null)
				class492.method6180(new Packet(is), 1638036980);
			synchronized (((Class491) this).aClass348_6079) {
				((Class491) this).aClass348_6079.put(class492, (long) i);
			}
			return class492;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("uf.a(").append(')').toString());
		}
	}
	...
	public void method6173(short i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("uf.p(").append(')').toString());
		}
	}
	...
	public void method6174(int i, byte i_1_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("uf.b(").append(')').toString());
		}
	}

	public Class491(GameContext gameContext, Language language, Js5 class243, Js5 class243_2_) {
		...
		((Class491) this).aClass243_6076.method2316((Js5ConfigGroup.aClass120_1438.anInt1460) * -1006924897, -1015661848);
	}
	...
	static final void method6175(long l) {
		try {
			...
			int i = 1734240325 * GameClient.anInt8817 + (int) sceneObjectPosition.x;
			int i_3_ = GameClient.anInt8742 * 1874511679 + (int) sceneObjectPosition.z;
			...
			GameClient.aFloat8949 += (float) l * GameClient.aFloat8759 / 6.0F;
			GameClient.aFloat8757 += GameClient.aFloat8760 * (float) l / 6.0F;
			Class91.method1002((byte) 116);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("uf.hx(").append(')').toString());
		}
	}
	...
	static final void method6177(IComponentDefinition class105, ClientScript2 class403, int i) {
		try {
			...
			NPCType class503 = Class15.aClass507_224.method6269(class105.anInt1151 * 572201537, -834875221);
			...
			LocalizedString.markComponentForRedraw(class105, -548507081);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("uf.ql(").append(')').toString());
		}
	}
	...
	static void method6178(int i, int i_10_, int i_11_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("uf.ap(").append(')').toString());
		}
	}
}
