...
public class Class493 {
	...
	void method6186(Packet class298_sub53, int i) {
		try {
			for (;;) {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ui.a(").append(')').toString());
		}
	}

	void method6187(Packet class298_sub53, int i, byte i_1_) {
		try {
			if (i == 1)
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ui.f(").append(')').toString());
		}
	}
	...
	public static void method6188(Js5 class243, int i) {
		try {
			...
			Class344.aClickableGeometryArray3679 = new ClickableGeometry[1 + (Class65.anIntArray658[1197525581 * Class344.anInt3675])];
	...
	static boolean method6189(int i, byte i_2_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ui.bl(").append(')').toString());
		}
	}
	...
	public static char method6190(byte i, int i_3_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ui.p(").append(')').toString());
		}
	}
}
