...
public class Class50 {
	...
	public static IComponentDefinition getIComponentDefinitions(int parentHash, byte dummyValue) {
		try {
			...
			if (parentId > SpotAnimTypeList.aRSInterfaceArray4165.length)
				return null;
			if (null == SpotAnimTypeList.aRSInterfaceArray4165[parentId] || (SpotAnimTypeList.aRSInterfaceArray4165[parentId].method1297(parentHash, (short) 3713) == null)) {
				boolean bool = Class378.method4671(parentId, null, -957339129);
				if (!bool)
					return null;
			}
			return SpotAnimTypeList.aRSInterfaceArray4165[parentId].method1297(parentHash, (short) 19883);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("c.f(").append(')').toString());
		}
	}

	public static void method530(int i, int i_2_) {
		try {
			Class298_Sub36 class298_sub36 = Class18.method359(OutgoingPacket.aClass198_2004, GameClient.gameConnection.aClass449_330, (byte) 24);
			class298_sub36.buffer.writeInt(-1, -106491517);
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("c.ax(").append(')').toString());
		}
	}
	...
	static final void method532(ClientScript2 class403, byte i) {
		try {
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = -1168328513 * GameClient.anInt8837;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("c.abh(").append(')').toString());
		}
	}
	...
	static void method533(long[] ls, int[] is, int i, int i_3_, int i_4_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("c.d(").append(')').toString());
		}
	}
	...
	static void method534(byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("c.i(").append(')').toString());
		}
	}

	static final void method535(int i, byte i_12_) {
		try {
			int i_13_ = (GameClient.anInt8884 * 443738891 - GameClient.anInt8921 * -1656615113);
			if (i_13_ >= 100) {
				...
				Class482.method6121(1103750049 * Class75.anInt708, Class356.method4271((int) sceneObjectPosition.x, (int) sceneObjectPosition.z, 1855729883 * Class99.anInt952, -1800819540) - 200, 1346160791 * Class106.anInt1309, i_14_, i_15_, 600 + (i_14_ >> 3) * 3 << 2, i, -1059521295);
				...
				GameClient.anInt8756 = ((int) ((float) (-104436553 * GameClient.anInt8756 - Class21.anInt277 * 827399463) * f + (float) (Class21.anInt277 * 827399463)) * -648269561);
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("c.hz(").append(')').toString());
		}
	}
	...
	static final void method536(ClientScript2 class403, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("c.xr(").append(')').toString());
		}
	}
	...
	static final void method537(ClientScript2 class403, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("c.an(").append(')').toString());
		}
	}
	...
	static final void method538(ClientScript2 class403, byte i) {
		try {
			...
			Class365_Sub1.method4401(class105, RSInterface, class403, (byte) -16);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("c.ih(").append(')').toString());
		}
	}
}
