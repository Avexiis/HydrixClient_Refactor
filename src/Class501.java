...
public final class Class501 {
	...
	public static SeqTypeList aClass395_6122;
	...
	public void method6222(Object object, Object object_0_, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("us.a(").append(')').toString());
		}
	}
	...
	void method6223(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("us.i(").append(')').toString());
		}
	}
	...
	public ArrayList method6224(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("us.b(").append(')').toString());
		}
	}
	...
	public void method6225(Object object, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("us.f(").append(')').toString());
		}
	}
	...
	void method6226(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("us.p(").append(')').toString());
		}
	}
	...
	public static void method6227(boolean bool, int i) {
		try {
			...
			Class287.myPlayer.method4341((float) (GameClient.map.upperX(-1895849411) * 512 / 2), 0.0F, (float) (GameClient.map.upperY(501771104) * 512 / 2));
			Class287.myPlayer.scenePositionXQueue[0] = GameClient.map.upperX(-1873805931) / 2;
			Class287.myPlayer.scenePositionYQueue[0] = GameClient.map.upperY(2001443939) / 2;
			Class146.anInt1575 = 0;
			Class367.anInt4000 = 0;
			if (3 == ObjectDeque.anInt7164 * -863531439) {
				Class367.anInt4000 = (1374340743 * VarClanSettings.anInt4089 << 9) * 547882953;
				Class146.anInt1575 = (Class82_Sub4.anInt6832 * -1548077269 << 9) * 309839105;
			} else
				Class397.method4913((byte) 90);
			GameClient.map.method2640((byte) -45).forceUpdate(-1834713428);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("us.fs(").append(')').toString());
		}
	}
	...
	static final void method6228(ClientScript2 class403, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("us.qx(").append(')').toString());
		}
	}
	...
	static boolean method6229(RsBitsBuffer class298_sub53_sub2, int i, int i_14_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("us.k(").append(')').toString());
		}
	}
	...
	static void method6230(int i, String string, int i_41_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("us.at(").append(')').toString());
		}
	}
