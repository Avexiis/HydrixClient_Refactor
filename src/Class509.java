...
public class Class509 {
	...
	void method6283(Packet class298_sub53, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("va.a(").append(')').toString());
		}
	}

	Interface5 method6284(Packet class298_sub53, Class146 class146, int i) {
		try {
			...
			if (class146 == Class146.aClass146_1565)
				return NPCType.method6247(class298_sub53, 1486124265);
			...
			if (Class146.aClass146_1564 == class146)
				return TimeUtils.method1318(class298_sub53, (byte) -71);
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("va.f(").append(')').toString());
		}
	}
	...
	static final void method6285(ClientScript2 class403, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("va.aaw(").append(')').toString());
		}
	}
	...
	public static void method6286(int i, int i_3_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("va.n(").append(')').toString());
		}
	}
}
