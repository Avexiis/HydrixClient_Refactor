...
public class Class513 implements Interface21 {
	...
	public int method242(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("vg.f(").append(')').toString());
		}
	}
	...
	public String toString() {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("vg.toString(").append(')').toString());
		}
	}
	...
	static final void method6292(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("vg.oh(").append(')').toString());
		}
	}
	...
	static void method6293(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("vg.b(").append(')').toString());
		}
	}
}
