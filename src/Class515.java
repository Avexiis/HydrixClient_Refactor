...
public class Class515 {
	...
	public Class510[] method6294(int i, int i_0_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("vo.b(").append(')').toString());
		}
	}
	...
	public Class509 method6295(int i, byte i_4_) {
		try {
			...
			class509.method6283(new Packet(is), -391228687);
			return class509;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("vo.f(").append(')').toString());
		}
	}

	public Class515(GameContext gameContext, Language language, Js5 class243) {
		((Class515) this).aClass243_6229 = class243;
		Packet class298_sub53 = new Packet(((Class515) this).aClass243_6229.getFileFromArchive(0, 0, (byte) -99));
		int i = ((null == class298_sub53.payload || class298_sub53.payload.length < 1) ? -1 : class298_sub53.readUnsignedByte());
		if (i < 4) {
	...
	public boolean method6296(byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("vo.p(").append(')').toString());
		}
	}
	...
	Class521 method6297(int i, int i_25_, int i_26_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("vo.a(").append(')').toString());
		}
	}
	...
	static final void method6298(ClientScript2 class403, int i) {
		try {
			...
			VarBitType.method3978(class105, RSInterface, class403, 1968177988);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("vo.lz(").append(')').toString());
		}
	}
}
