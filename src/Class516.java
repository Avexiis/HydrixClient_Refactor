...
public class Class516 {
	...
	public static final void method6299(String string, int i) {
		try {
			if (!string.equals("")) {
				...
				Class298_Sub36 class298_sub36 = Class18.method359(OutgoingPacket.JOIN_FRIEND_CHAT_PACKET, class25.aClass449_330, (byte) 113);
				class298_sub36.buffer.writeByte(Class58.method693(string, 148630832));
				class298_sub36.buffer.writeString(string, 2138604047);
				class25.writeOutboundPacket(class298_sub36, (byte) -81);
			}
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("vs.ma(").append(')').toString());
		}
	}

	static final void method6300(int i, int i_1_, int i_2_, int i_3_, Class435 class435, byte i_4_) {
		try {
			if (i_2_ >= 1 && i_3_ >= 1 && i_2_ <= GameClient.map.upperX(-1894377459) - 2 && i_3_ <= GameClient.map.upperY(793681614) - 2) {
				if (GameClient.map.method2675(-1611682495) != null) {
					Interface3 interface3 = GameClient.map.method2644(112641684).method2241(i, i_1_, i_2_, i_3_, 2002986961);
					if (interface3 != null) {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("vs.u(").append(')').toString());
		}
	}
	...
	static final void method6301(ClientScript2 class403, int i) {
		try {
			...
			Class240_Sub1.method2244(class105, RSInterface, class403, (byte) -14);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("vs.om(").append(')').toString());
		}
	}
	...
	static final void method6302(ClientScript2 class403, int i) {
		try {
			...
			GameClient.map.method2667(1924605464);
			Class3.writePreferences();
			GameClient.aBoolean8666 = false;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("vs.ana(").append(')').toString());
		}
	}
	...
	static final void method6303(ClientScript2 class403, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("vs.rh(").append(')').toString());
		}
	}
}
