...
public class Class521 {
	...
	static final void method6322(ClientScript2 class403, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("vz.ahh(").append(')').toString());
		}
	}
	...
	public static Class146[] method6323(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("vz.a(").append(')').toString());
		}
	}
}
