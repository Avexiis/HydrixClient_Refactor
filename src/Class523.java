...
final class Class523 implements Interface17 {
	public boolean method229(Class365_Sub1_Sub1 class365_sub1_sub1, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("x.a(").append(')').toString());
		}
	}
	...
	static final void method6329(IComponentDefinition class105, ClientScript2 class403, int i) {
		try {
			...
			NPCType class503 = Class15.aClass507_224.method6269(class105.anInt1151 * 572201537, -87546938);
			...
			if (i_1_ < 0 || i_1_ >= class503.chatHeads.length)
				throw new RuntimeException("");
			class105.aClass498_1307.models[i_1_] = i_0_;
			LocalizedString.markComponentForRedraw(class105, -339426215);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("x.qp(").append(')').toString());
		}
	}
	...
	public static final void method6330(IComponentDefinition class105, int i, int i_2_, int i_3_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("x.ls(").append(')').toString());
		}
	}

	public static final IComponentDefinition method6331(RSInterface RSInterface, IComponentDefinition class105, int i) {
		try {
			if (-1 != 1573706803 * class105.parentId)
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("x.ku(").append(')').toString());
		}
	}
	...
	public static void method6332(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("x.i(").append(')').toString());
		}
	}
	...
	static Class298_Sub50_Sub1 method6333(int i, int i_5_, int i_6_, long l, int i_7_, int i_8_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("x.av(").append(')').toString());
		}
	}

	public static GraphicsToolkit method6334(int i, Canvas canvas, Interface_ma interface_ma, Js5 class243, int i_10_, int i_11_) {
		try {
			int i_12_ = 0;
			int i_13_ = 0;
			if (null != canvas) {
