...
public class Class524 implements Runnable {
	...
	public String method6376(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("y.a(").append(')').toString());
		}
	}
	...
	public void run() {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("y.run(").append(')').toString());
		}
	}
	...
	static final int method6377(int i, int i_0_, int i_1_, int i_2_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("y.w(").append(')').toString());
		}
	}
}
