...
public class Class525 {
	...
	static final void method6378(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("z.pa(").append(')').toString());
		}
	}
	...
	public static int method6379(CharSequence charsequence, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("z.q(").append(')').toString());
		}
	}
