...
public abstract class Class52_Sub2_Sub1 extends Class52_Sub2 {
	...
	final boolean method546() {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("afi.i(").append(')').toString());
		}
	}
	...
	void method591(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("afi.z(").append(')').toString());
		}
	}
	...
	final boolean method136() {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("afi.p(").append(')').toString());
		}
	}
	...
	public int method552() {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("afi.f(").append(')').toString());
		}
	}
	...
	final void method582(int i, int i_1_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("afi.e(").append(')').toString());
		}
	}
	...
	public int method545() {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("afi.a(").append(')').toString());
		}
	}
