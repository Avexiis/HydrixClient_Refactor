...
public class Class58 {
	...
	public static int method692(int i, int i_2_, int i_3_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ci.d(").append(')').toString());
		}
	}
	...
	public static int method693(String string, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ci.s(").append(')').toString());
		}
	}

	static boolean method694(int i) {
		try {
			if (ContextMenu.aClass298_Sub37_Sub15_5477 == null)
				return false;
			if ((((Class298_Sub37_Sub15) ContextMenu.aClass298_Sub37_Sub15_5477).anInt9662) * 946432351 >= 2000)
				((Class298_Sub37_Sub15) ContextMenu.aClass298_Sub37_Sub15_5477).anInt9662 -= -853837264;
			if (1007 == 946432351 * ((Class298_Sub37_Sub15) ContextMenu.aClass298_Sub37_Sub15_5477).anInt9662)
				return true;
			return false;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ci.x(").append(')').toString());
		}
	}

	public static Class134 method695(Packet class298_sub53, int i) {
		try {
			int i_6_ = class298_sub53.readUnsignedByte();
			Class139 class139 = (Class491.method6176((byte) 12)[class298_sub53.readUnsignedByte()]);
			Class133 class133 = (Huffman.method1255(334501262)[class298_sub53.readUnsignedByte()]);
			...
			int i_11_ = class298_sub53.readUnsignedInt();
			int i_12_ = class298_sub53.readUnsignedInt();
			int i_13_ = class298_sub53.readUnsignedInt();
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ci.a(").append(')').toString());
		}
	}
}
