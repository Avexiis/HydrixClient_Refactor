...
public class Class61 {
	...
	Class30_Sub2 method716(int i, int i_0_) {
		...
		if (!((Class61) this).anInterface_ma604.method170(i, (short) 25920))
			return null;
		MaterialRaw materialRaw = ((Class61) this).anInterface_ma604.method174(i, 107897040);
		if (i_0_ == -1)
			i_0_ = (materialRaw.aBoolean518 ? 64 : (((Class_ra_Sub2) ((Class61) this).aClass_ra_Sub2_606).anInt8118));
		Class30_Sub2 class30_sub2;
		if (!materialRaw.aBoolean543 || !((Class61) this).aClass_ra_Sub2_606.method5054()) {
			int[] is;
			if (materialRaw.anInt528 * -2138060883 == 2 || !Class298_Sub32_Sub31.method3339(materialRaw.aByte529, -769385379))
