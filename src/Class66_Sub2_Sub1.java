		...
		if (((Class66_Sub2_Sub1) this).anInterface9_Impl1_9102 == null) {
			...
			for (int i_0_ = 0; i_0_ < 6; i_0_++) {
				if (!interface_ma.method170(anIntArray9109[i_0_], (short) 4664))
					return null;
				MaterialRaw materialRaw = interface_ma.method174(anIntArray9109[i_0_], 1025120075);
				int i_1_ = materialRaw.aBoolean518 ? 64 : 128;
				if (i_1_ > i)
					i = i_1_;
				if (materialRaw.aByte537 > 0)
					bool = true;
			}
		...
		if (((Class66_Sub2_Sub1) this).anInterface9_Impl1_9102 == null) {
			...
			for (int i_8_ = 0; i_8_ < 6; i_8_++) {
				if (!interface_ma.method170(anIntArray9109[i_8_], (short) 30897))
					return null;
				MaterialRaw materialRaw = interface_ma.method174(anIntArray9109[i_8_], 548251560);
				int i_9_ = materialRaw.aBoolean518 ? 64 : 128;
				if (i_9_ > i)
					i = i_9_;
				if (materialRaw.aByte537 > 0)
					bool = true;
