...
public class Class69 {
	...
	public static Class147 method787(int i, byte i_0_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("cu.f(").append(')').toString());
		}
	}
	...
	public static void method788(boolean bool, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("cu.r(").append(')').toString());
		}
	}
	...
	public static Class297 method789(int i, int i_2_, int i_3_, int i_4_, int i_5_, int i_6_, int i_7_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("cu.s(").append(')').toString());
		}
	}
	...
	static Class367[] method790(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("cu.a(").append(')').toString());
		}
	}
	...
	static final void method791(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("cu.ad(").append(')').toString());
		}
	}
	...
	static final void method792(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("cu.ahk(").append(')').toString());
		}
	}
			...
			for (int i_12_ = 0; i_12_ < i_11_; i_12_++) {
				...
				if (null != player && (Class287.myPlayer != player) && player.username != null && player.username.equalsIgnoreCase(string)) {
					...
					if (i == 1)
						...
						class198 = OutgoingPacket.aClass198_2010;
					else if (i == 5)
						class198 = OutgoingPacket.aClass198_2070;
					else if (6 == i)
						class198 = OutgoingPacket.aClass198_2042;
					else if (7 == i)
						class198 = OutgoingPacket.aClass198_2056;
					else if (9 == i)
						class198 = OutgoingPacket.aClass198_2049;
					if (class198 != null) {
						Class298_Sub36 class298_sub36 = Class18.method359(class198, (GameClient.gameConnection.aClass449_330), (byte) 102);
						class298_sub36.buffer.writeByte(0);
						class298_sub36.buffer.writeShortLE128(is[i_12_]);
						GameClient.gameConnection.writeOutboundPacket(class298_sub36, (byte) -127);
					}
					bool = true;
					break;
				}
	...
	static int method794(IComponentDefinition class105, int i, int i_13_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("cu.mb(").append(')').toString());
		}
	}
		...
		try {
			do {
				...
				try {
					...
					if (604206485 * ReferenceTable.anInt6559 > 0) {
						Class79.anInt734 = 508662283;
						Class79.aClass298_Sub19_Sub1_737.method2961(((604206485 * ReferenceTable.anInt6559 > Class79.anInt739 * 643426275) ? Class79.anInt739 * 643426275 : 604206485 * ReferenceTable.anInt6559), 1723899960);
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("cu.t(").append(')').toString());
		}
	}
	...
	static final void method796(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("cu.agq(").append(')').toString());
		}
	}
}
