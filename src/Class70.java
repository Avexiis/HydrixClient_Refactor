...
public final class Class70 {
	...
	public void method797(byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("cv.a(").append(')').toString());
		}
	}
	...
	public int method798(int i, int i_0_) {
		try {
			...
			VarPlayerType varPlayerType = Class440.aVarPlayerTypeList_5582.method1914(i, 976929284);
			if ('i' != varPlayerType.aChar2358)
				return -1;
			return 0;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("cv.b(").append(')').toString());
		}
	}
	...
	public int method799(int i, int i_1_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("cv.p(").append(')').toString());
		}
	}
	...
	public void method800(int i, int i_4_, byte i_5_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("cv.f(").append(')').toString());
		}
	}
	...
	public static void method801(int i, int i_6_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("cv.k(").append(')').toString());
		}
	}
	...
	static void method802(GraphicsToolkit class_ra, int i, int i_7_, int i_8_, int i_9_, int i_10_, int i_11_, int i_12_, int i_13_) {
		try {
			...
			Interface3 interface3 = (Interface3) sceneGraph.method4031(i, i_7_, i_8_, 987531084);
			if (null != interface3) {
				LocType class432 = (GameClient.map.method2641(-1178105216).list(interface3.method32((byte) 20)));
			...
			interface3 = (Interface3) sceneGraph.method4035(i, i_7_, i_8_, GameClient.anInterface17_8960, -1880419927);
			if (null != interface3) {
				LocType class432 = (GameClient.map.method2641(-258471564).list(interface3.method32((byte) -26)));
			...
			interface3 = (Interface3) sceneGraph.method4058(i, i_7_, i_8_, (byte) 125);
			if (null != interface3) {
				LocType class432 = (GameClient.map.method2641(541526744).list(interface3.method32((byte) 49)));
				int i_20_ = interface3.method30((short) 12476) & 0x3;
				if (-1 != -1204256389 * class432.anInt5400)
					Class82.method871(class_ra, class432, i_20_, i_9_, i_10_, (byte) 79);
			}
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("cv.u(").append(')').toString());
		}
	}
	...
	public static void method803(int i, String string, int i_21_, int i_22_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("cv.n(").append(')').toString());
		}
	}
	...
	public static final int method807(int i, int i_26_, int i_27_, int i_28_, int i_29_, byte i_30_) {
		try {
			if (GameClient.map.method2675(-1611682495) == null)
				return 0;
			if (i_29_ < 3) {
				TileFlags tileFlags = GameClient.map.method2654(1767942332);
				int i_31_ = i >> 9;
				int i_32_ = i_26_ >> 9;
				if (i_27_ < 0 || i_28_ < 0 || (i_27_ > GameClient.map.upperX(-1972690353) - 1) || i_28_ > GameClient.map.upperY(-61619148) - 1)
					return 0;
				if (i_31_ < 1 || i_32_ < 1 || (i_31_ > GameClient.map.upperX(-1988640932) - 1) || (i_32_ > GameClient.map.upperY(-694658273) - 1))
					return 0;
				boolean bool = 0 != ((tileFlags.flags[1][i >> 9][i_26_ >> 9]) & 0x2);
				if ((i & 0x1ff) == 0) {
					boolean bool_33_ = (((tileFlags.flags[1][i_31_ - 1][i_26_ >> 9]) & 0x2) != 0);
					boolean bool_34_ = 0 != ((tileFlags.flags[1][i_31_][i_26_ >> 9]) & 0x2);
					if (bool_34_ != bool_33_)
						bool = 0 != ((tileFlags.flags[1][i_27_][i_28_]) & 0x2);
				}
				if ((i_26_ & 0x1ff) == 0) {
					boolean bool_35_ = (((tileFlags.flags[1][i >> 9][i_32_ - 1]) & 0x2) != 0);
					boolean bool_36_ = ((tileFlags.flags[1][i >> 9][i_32_] & 0x2) != 0);
					if (bool_36_ != bool_35_)
						bool = ((tileFlags.flags[1][i_27_][i_28_]) & 0x2) != 0;
				}
				if (bool)
					i_29_++;
			}
			return GameClient.map.method2675(-1611682495).aGroundArray3517[i_29_].method6340(i, i_26_, -1371980258);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("cv.ja(").append(')').toString());
		}
	}
	...
	public static void method808(int i, int i_37_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("cv.z(").append(')').toString());
		}
	}
}
