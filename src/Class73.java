...
public final class Class73 {
	...
	public void method814(int i, int i_0_, int i_1_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("cz.f(").append(')').toString());
		}
	}
	...
	public int method815(int i, byte i_2_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("cz.p(").append(')').toString());
		}
	}
	...
	public void method816(byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("cz.a(").append(')').toString());
		}
	}
	...
	public int method817(int i, int i_5_) {
		try {
			...
			Class485 class485 = SceneryShadowPreference.aClass445_8384.method5892(i, 1792178977);
			if ('i' != class485.aChar6058)
				return -1;
			return 0;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("cz.b(").append(')').toString());
		}
	}
	...
	static final void method819(ClientScript2 class403, int i) {
		try {
			...
			Class318.method3875(class105, RSInterface, class403, -1870622749);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("cz.cn(").append(')').toString());
		}
	}
	...
	static final void method820(ClientScript2 class403, byte i) {
		try {
			...
			SeqType.method4887(class105, RSInterface, class403, (byte) -38);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("cz.dd(").append(')').toString());
		}
	}

	static final void method821(IComponentDefinition class105, RSInterface RSInterface, ClientScript2 class403, short i) {
		try {
			...
			if (i_8_ != class105.anInt1290 * 1347982601) {
				if (-1 != i_8_) {
					...
					class105.aAnimator_1152.method5821(i_8_, -1614086942);
				} else
					class105.aAnimator_1152 = null;
				class105.anInt1290 = 1587382585 * i_8_;
				LocalizedString.markComponentForRedraw(class105, -1503687245);
			}
			if (-1 == -1309843523 * class105.component && !RSInterface.aBoolean1403)
				Class365_Sub1_Sub1_Sub5.method4490(-440872681 * class105.interfacehash, -1349352488);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("cz.eu(").append(')').toString());
		}
	}

	public static String method822(Class298_Sub37_Sub15 class298_sub37_sub15, int i) {
		try {
			if (ContextMenu.menuOpen || class298_sub37_sub15 == null)
				return "";
			return ((Class298_Sub37_Sub15) class298_sub37_sub15).aString9667;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("cz.az(").append(')').toString());
		}
	}
}
