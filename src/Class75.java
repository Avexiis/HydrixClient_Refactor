...
public class Class75 {
	...
	void method833(int i, int i_0_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("da.a(").append(')').toString());
		}
	}

	Class75(Packet class298_sub53) {
	...
	public static final Class284 method834(Component component, int i, int i_3_, int i_4_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("da.f(").append(')').toString());
		}
	}

	static final void method835(IComponentDefinition class105, RSInterface RSInterface, ClientScript2 class403, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("da.js(").append(')').toString());
		}
	}
	...
	static final void method836(ClientScript2 class403, byte i) {
		try {
			...
			if (Class301_Sub1.aClass437_7637 != null) {
				Node node = Class301_Sub1.aClass437_7637.get((long) i_6_);
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("da.aey(").append(')').toString());
		}
	}
	...
	static void method837(Class298_Sub37_Sub5 class298_sub37_sub5, int i) {
		try {
			...
			for (Class298_Sub37_Sub5 class298_sub37_sub5_7_ = ((Class298_Sub37_Sub5) ContextMenu.aClass461_5482.method5984(-1268764084)); class298_sub37_sub5_7_ != null; class298_sub37_sub5_7_ = ((Class298_Sub37_Sub5) ContextMenu.aClass461_5482.method5985(-1549897657))) {
				if (VarClientType.method6069(class298_sub37_sub5.method3417(-610126190), class298_sub37_sub5_7_.method3417(-1229609996), -537262415)) {
			...
			if (!bool)
				ContextMenu.aClass461_5482.method5982(class298_sub37_sub5, (byte) -51);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("da.h(").append(')').toString());
		}
	}
	...
	static final void method838(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("da.fv(").append(')').toString());
		}
	}
}
