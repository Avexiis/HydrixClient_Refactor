...
public class Class77 {
	...
	static final void method839(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("dc.acq(").append(')').toString());
		}
	}
	...
	public static byte[] method840(CharSequence charsequence, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("dc.i(").append(')').toString());
		}
	}
	...
	public static boolean method841(int i, int i_3_, byte i_4_) {
		try {
			...
			if (i_3_ != -1 || class105.type * -1215239439 != 0) {
				...
				for (Class298_Sub37_Sub15 class298_sub37_sub15 = ((Class298_Sub37_Sub15) ContextMenu.aLinkedNodeList_5480.method5939(1766612795)); class298_sub37_sub15 != null; class298_sub37_sub15 = ((Class298_Sub37_Sub15) ContextMenu.aLinkedNodeList_5480.method5944(49146))) {
					if (58 == 946432351 * ((Class298_Sub37_Sub15) class298_sub37_sub15).anInt9662 || 1007 == 946432351 * ((Class298_Sub37_Sub15) class298_sub37_sub15).anInt9662 || 946432351 * ((Class298_Sub37_Sub15) class298_sub37_sub15).anInt9662 == 25 || 946432351 * ((Class298_Sub37_Sub15) class298_sub37_sub15).anInt9662 == 57 || 30 == (((Class298_Sub37_Sub15) class298_sub37_sub15).anInt9662) * 946432351) {
						for (IComponentDefinition class105_7_ = Class50.getIComponentDefinitions((((Class298_Sub37_Sub15) class298_sub37_sub15).anInt9663) * -502720623, (byte) -39); null != class105_7_; class105_7_ = Class523.method6331((SpotAnimTypeList.aRSInterfaceArray4165[(((class105_7_.interfacehash) * -440872681) >> 16)]), class105_7_, -1653818376)) {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("dc.ah(").append(')').toString());
		}
	}
	...
	static void method842(int i, short i_8_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("dc.cj(").append(')').toString());
		}
	}
}
