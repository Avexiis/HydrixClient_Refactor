...
public class Class78 {
	...
	static boolean method844(byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("dd.p(").append(')').toString());
		}
	}
	...
	static final void method846(ClientScript2 class403, short i) {
		try {
			...
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = GameClient.anIntArray8829[i_8_];
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("dd.tr(").append(')').toString());
		}
	}
}
