...
public class Class80 {
	...
	void method852(Class94 class94, int i, int i_4_) {
		try {
			...
			class365_sub1_sub1_sub2.moveQueueSize = 0;
			for (int i_6_ = ((Class80) this).anIntArray750.length - 1; i_6_ >= 0; i_6_--) {
				...
				class365_sub1_sub1_sub2.scenePositionXQueue[class365_sub1_sub1_sub2.moveQueueSize * 2050671733] = i_8_ >> 16;
				class365_sub1_sub1_sub2.scenePositionYQueue[2050671733 * class365_sub1_sub1_sub2.moveQueueSize] = i_8_ & 0xffff;
				byte i_9_ = MovementType.TYPE_1.type;
				if (0 == i_7_)
					i_9_ = MovementType.aMovementType_6545.type;
				else if (2 == i_7_)
					i_9_ = MovementType.aMovementType_6541.type;
				class365_sub1_sub1_sub2.moveDir[class365_sub1_sub1_sub2.moveQueueSize * 2050671733] = i_9_;
				class365_sub1_sub1_sub2.moveQueueSize += -1013322787;
			}
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("df.a(").append(')').toString());
		}
	}
	...
	static final void method854(ClientScript2 class403, byte i) {
		try {
			...
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = class105.height * 457937409;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("df.qn(").append(')').toString());
		}
	}
	...
	static final void method855(byte i) {
		try {
			...
			int i_14_ = 0;
			int i_15_ = 3;
			if (0 == GameClient.cutsceneStage * 1596783995) {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("df.ii(").append(')').toString());
		}
	}
	...
	static final void method856(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("df.aas(").append(')').toString());
		}
	}
}
