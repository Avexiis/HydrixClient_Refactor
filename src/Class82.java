...
public abstract class Class82 {
	...
	void method867(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("di.b(").append(')').toString());
		}
	}

	Class82(Packet class298_sub53) {
	...
	boolean method870(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("di.p(").append(')').toString());
		}
	}
	...
	static void method871(GraphicsToolkit class_ra, LocType class432, int i, int i_0_, int i_1_, byte i_2_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("di.x(").append(')').toString());
		}
	}
	...
	public static void method872(int i, byte i_7_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("di.i(").append(')').toString());
		}
	}
	...
	static final void method873(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("di.md(").append(')').toString());
		}
	}
	...
	static final void method874(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("di.aab(").append(')').toString());
		}
	}
	...
	static final void method876(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("di.acf(").append(')').toString());
		}
	}
}
