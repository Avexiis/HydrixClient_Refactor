...
public class Class82_Sub1 extends Class82 {
	...
	public void method869() {
		Class87.entities[812968099 * ((Class82_Sub1) this).anInt6816].method1016((byte) 46);
	}

	public void method866(int i) {
		try {
			Class87.entities[812968099 * ((Class82_Sub1) this).anInt6816].method1016((byte) 15);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("xb.f(").append(')').toString());
		}
	}

	Class82_Sub1(Packet class298_sub53) {
		super(class298_sub53);
		((Class82_Sub1) this).anInt6816 = class298_sub53.readUnsignedShort() * -1614214389;
	}

	public void method868() {
		Class87.entities[812968099 * ((Class82_Sub1) this).anInt6816].method1016((byte) 66);
	}
