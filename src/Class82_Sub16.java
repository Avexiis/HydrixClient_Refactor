...
public class Class82_Sub16 extends Class82 {
	...
	public void method866(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("yd.f(").append(')').toString());
		}
	}
	...
	Class82_Sub16(Packet class298_sub53) {
	...
	void method867(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("yd.b(").append(')').toString());
		}
	}
