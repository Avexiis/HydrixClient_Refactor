...
public class Class82_Sub17 extends Class82 {
	...
	public void method868() {
		Class94 class94 = (Class87.entities[((Class82_Sub17) this).anInt6889 * -824702981]);
	...
	public void method866(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("yf.f(").append(')').toString());
		}
	}

	Class82_Sub17(Packet class298_sub53) {
	...
	static void method918(IComponentDefinition class105, int i, int i_0_, int i_1_) {
		try {
			ContextMenu.aClass105_5486 = class105;
			ContextMenu.anInt5487 = i * -1021462033;
			ContextMenu.anInt5502 = i_0_ * -1325119769;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("yf.av(").append(')').toString());
		}
	}
	...
	static final void method919(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("yf.aib(").append(')').toString());
		}
	}
	...
	public static void method920(int[] is, int[] is_2_, int i, int i_3_, int i_4_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("yf.i(").append(')').toString());
		}
	}
	...
	static final void method921(ClientScript2 class403, byte i) {
		try {
			...
			GameClient.anInt8837 = 1583527743 * (((ClientScript2) class403).anIntArray5244[681479919 * ((ClientScript2) class403).anInt5239]);
			...
			GameClient.anInt8913 = (-1777248765 * (((ClientScript2) class403).anIntArray5244[2 + ((ClientScript2) class403).anInt5239 * 681479919]));
			Class25 class25 = Language.method5760((short) 512);
			Class298_Sub36 class298_sub36 = Class18.method359(OutgoingPacket.aClass198_2053, class25.aClass449_330, (byte) 32);
			class298_sub36.buffer.writeByte(-1168328513 * GameClient.anInt8837);
			class298_sub36.buffer.writeByte(1790024195 * Class110.aClass459_6404.anInt5673);
			class298_sub36.buffer.writeByte(GameClient.anInt8913 * -1710848853);
			class25.writeOutboundPacket(class298_sub36, (byte) -13);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("yf.abz(").append(')').toString());
		}
	}
}
