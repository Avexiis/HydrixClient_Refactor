...
public abstract class Class82_Sub19 extends Class82 {
	...
	Class82_Sub19(Packet class298_sub53) {
	...
	boolean method870(int i) {
		try {
			Class398 class398 = Class158_Sub1.aSpotAnimTypeList_8568.method4857((720810617 * ((Class82_Sub19) this).anInt6895), -2111155708);
			boolean bool = class398.method4919((byte) 51);
			SeqType class391 = Class501.aClass395_6122.method4903(1505778629 * class398.anInt5205, (byte) 13);
			bool &= class391.method4880(1053460676);
			return bool;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ym.p(").append(')').toString());
		}
	}

	boolean method924() {
		Class398 class398 = (Class158_Sub1.aSpotAnimTypeList_8568.method4857(720810617 * ((Class82_Sub19) this).anInt6895, -1729093071));
		boolean bool = class398.method4919((byte) 82);
		SeqType class391 = Class501.aClass395_6122.method4903(1505778629 * class398.anInt5205, (byte) -7);
		bool &= class391.method4880(2049469908);
		return bool;
	}

	static final void method925(IComponentDefinition class105, RSInterface RSInterface, ClientScript2 class403, int i) {
		try {
			class105.aBoolean1180 = (((ClientScript2) class403).anIntArray5244[(((ClientScript2) class403).anInt5239 -= -391880689) * 681479919]) == 1;
			LocalizedString.markComponentForRedraw(class105, 564764353);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ym.fo(").append(')').toString());
		}
	}
	...
	public static void method926(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ym.cx(").append(')').toString());
		}
	}
	...
	static final void method927(ClientScript2 class403, int i) {
		try {
			...
			EnumType class483 = Class51.aClass475_506.getClientScriptMap(i_0_, 1528209569);
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ym.vf(").append(')').toString());
		}
	}
	...
	static final void method928(ClientScript2 class403, int i) {
		try {
			...
			Class323.method3947(class105, RSInterface, class403, 845844637);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ym.gr(").append(')').toString());
		}
	}
	...
	static final void method929(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ym.rc(").append(')').toString());
		}
	}
	...
	static final void method930(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ym.xg(").append(')').toString());
		}
	}
}
