...
public class Class82_Sub2 extends Class82 {
	...
	Class82_Sub2(Packet class298_sub53) {
	...
	public void method866(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("xc.f(").append(')').toString());
		}
	}

	public static int method878(int i, int i_0_, boolean bool, int i_1_) {
		try {
			Class298_Sub9 class298_sub9 = DevConsole.method2437(i, bool, -147362451);
