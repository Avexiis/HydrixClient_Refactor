...
public class Class82_Sub20 extends Class82 {
	...
	Class82_Sub20(Packet class298_sub53) {
	...
	public void method866(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("yn.f(").append(')').toString());
		}
	}

	static void method933(byte i) {
		try {
			Class298_Sub36 class298_sub36 = Class18.method359(OutgoingPacket.RECEIVE_PACKET_COUNT_PACKET, GameClient.gameConnection.aClass449_330, (byte) 17);
			class298_sub36.buffer.writeInt(GameClient.anInt8713 * -2059460167, -1112529192);
			GameClient.gameConnection.writeOutboundPacket(class298_sub36, (byte) -106);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("yn.ns(").append(')').toString());
		}
	}
	...
	public static void method934(int i, byte i_0_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("yn.l(").append(')').toString());
		}
	}
	...
	static void method935(int i, int i_1_, int i_2_, int i_3_, int i_4_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("yn.am(").append(')').toString());
		}
	}
}
