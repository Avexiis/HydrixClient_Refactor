...
public class Class82_Sub22 extends Class82 {
	...
	boolean method939() {
		Class398 class398 = (Class158_Sub1.aSpotAnimTypeList_8568.method4857(1632084697 * ((Class82_Sub22) this).anInt6908, -1743709088));
		boolean bool = class398.method4919((byte) 119);
		SeqType class391 = Class501.aClass395_6122.method4903(class398.anInt5205 * 1505778629, (byte) -66);
		bool &= class391.method4880(1883883362);
		return bool;
	}

	Class82_Sub22(Packet class298_sub53, int i, int i_0_) {
		...
		if (0 == i_0_) {
			int i_2_ = class298_sub53.readUnsignedInt();
		...
		((Class82_Sub22) this).anInt6904 = class298_sub53.g3() * 856962157;
	...
	boolean method870(int i) {
		try {
			Class398 class398 = Class158_Sub1.aSpotAnimTypeList_8568.method4857((1632084697 * ((Class82_Sub22) this).anInt6908), -1845152840);
			boolean bool = class398.method4919((byte) 118);
			SeqType class391 = Class501.aClass395_6122.method4903(class398.anInt5205 * 1505778629, (byte) -64);
			bool &= class391.method4880(1376129821);
			return bool;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("yu.p(").append(')').toString());
		}
	}
	...
	public void method868() {
		...
		if (227468397 * ((Class82_Sub22) this).anInt6902 >= 0) {
			...
			Entity class365_sub1_sub1_sub2 = Class87.entities[((Class82_Sub22) this).anInt6905 * -153670819].method1015(1193612238);
			SceneObjectPosition sceneObjectPosition = class365_sub1_sub1_sub2.method4337().aSceneObjectPosition_2599;
			i = (int) sceneObjectPosition.x;
			i_3_ = (int) sceneObjectPosition.z;
		...
		if (916056717 * ((Class82_Sub22) this).anInt6907 >= 0) {
			...
			Entity class365_sub1_sub1_sub2 = Class87.entities[((Class82_Sub22) this).anInt6909 * -1629854861].method1015(143521447);
			SceneObjectPosition sceneObjectPosition = class365_sub1_sub1_sub2.method4337().aSceneObjectPosition_2599;
			i_5_ = (int) sceneObjectPosition.x;
			i_6_ = (int) sceneObjectPosition.z;
			if (i_4_ < 0)
				i_4_ = class365_sub1_sub1_sub2.plane;
		}
		int i_7_ = ((Class82_Sub22) this).anInt6914 * 1745275777 << 2;
		Class365_Sub1_Sub1_Sub1 class365_sub1_sub1_sub1 = (new Class365_Sub1_Sub1_Sub1(GameClient.map.method2675(-1611682495), ((Class82_Sub22) this).anInt6908 * 1632084697, i_4_, i_4_, i, i_3_, ((Class82_Sub22) this).anInt6916 * 266943569 << 2, GameClient.anInt8884 * 443738891, (929559909 * ((Class82_Sub22) this).anInt6904 + GameClient.anInt8884 * 443738891), -1300008271 * ((Class82_Sub22) this).anInt6915, i_7_, ((Class82_Sub22) this).anInt6905 * -153670819 + 1, 1 + -1629854861 * ((Class82_Sub22) this).anInt6909, ((Class82_Sub22) this).anInt6912 * 172590773 << 2, false, 0));
		class365_sub1_sub1_sub1.method4405(i_5_, i_6_, 172590773 * ((Class82_Sub22) this).anInt6912 << 2, (GameClient.anInt8884 * 443738891 + 929559909 * ((Class82_Sub22) this).anInt6904), -414343918);
		GameClient.projectiles.addlast(new Class298_Sub37_Sub2(class365_sub1_sub1_sub1), 1292621740);
	}
	...
	public void method869() {
		...
		if (227468397 * ((Class82_Sub22) this).anInt6902 >= 0) {
			...
			Entity class365_sub1_sub1_sub2 = Class87.entities[((Class82_Sub22) this).anInt6905 * -153670819].method1015(1656183484);
			SceneObjectPosition sceneObjectPosition = class365_sub1_sub1_sub2.method4337().aSceneObjectPosition_2599;
			i = (int) sceneObjectPosition.x;
			i_8_ = (int) sceneObjectPosition.z;
		...
		if (916056717 * ((Class82_Sub22) this).anInt6907 >= 0) {
			...
			Entity class365_sub1_sub1_sub2 = Class87.entities[((Class82_Sub22) this).anInt6909 * -1629854861].method1015(43837883);
			SceneObjectPosition sceneObjectPosition = class365_sub1_sub1_sub2.method4337().aSceneObjectPosition_2599;
			i_10_ = (int) sceneObjectPosition.x;
			i_11_ = (int) sceneObjectPosition.z;
			if (i_9_ < 0)
				i_9_ = class365_sub1_sub1_sub2.plane;
		}
		...
		class365_sub1_sub1_sub1.method4405(i_10_, i_11_, 172590773 * ((Class82_Sub22) this).anInt6912 << 2, (GameClient.anInt8884 * 443738891 + 929559909 * ((Class82_Sub22) this).anInt6904), 1238518641);
		GameClient.projectiles.addlast(new Class298_Sub37_Sub2(class365_sub1_sub1_sub1), 489461607);
	}
	...
	public void method866(int i) {
		try {
			...
			if (227468397 * ((Class82_Sub22) this).anInt6902 >= 0) {
				...
				Entity class365_sub1_sub1_sub2 = Class87.entities[((Class82_Sub22) this).anInt6905 * -153670819].method1015(1024446891);
				SceneObjectPosition sceneObjectPosition = class365_sub1_sub1_sub2.method4337().aSceneObjectPosition_2599;
				i_13_ = (int) sceneObjectPosition.x;
				i_14_ = (int) sceneObjectPosition.z;
			...
			if (916056717 * ((Class82_Sub22) this).anInt6907 >= 0) {
				...
				Entity class365_sub1_sub1_sub2 = Class87.entities[((Class82_Sub22) this).anInt6909 * -1629854861].method1015(1821624579);
				SceneObjectPosition sceneObjectPosition = class365_sub1_sub1_sub2.method4337().aSceneObjectPosition_2599;
				i_16_ = (int) sceneObjectPosition.x;
				i_17_ = (int) sceneObjectPosition.z;
				if (i_15_ < 0)
					i_15_ = class365_sub1_sub1_sub2.plane;
			}
			...
			class365_sub1_sub1_sub1.method4405(i_16_, i_17_, 172590773 * ((Class82_Sub22) this).anInt6912 << 2, (GameClient.anInt8884 * 443738891 + 929559909 * ((Class82_Sub22) this).anInt6904), 1057769456);
			GameClient.projectiles.addlast(new Class298_Sub37_Sub2(class365_sub1_sub1_sub1), -428713736);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("yu.f(").append(')').toString());
		}
	}
	...
	static final void method940(int[] is, int i, int i_19_, int i_20_, int i_21_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("yu.b(").append(')').toString());
		}
	}
}
