...
public class Class82_Sub23 extends Class82 {
	...
	Class82_Sub23(Packet class298_sub53) {
	...
	boolean method870(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("yv.p(").append(')').toString());
		}
	}
	...
	public void method866(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("yv.f(").append(')').toString());
		}
	}
}
