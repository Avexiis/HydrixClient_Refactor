...
public class Class82_Sub6 extends Class82 {
	...
	public void method866(int i) {
		try {
			Entity class365_sub1_sub1_sub2 = Class87.entities[((Class82_Sub6) this).anInt6840 * -2094920785].method1015(1714980357);
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("xm.f(").append(')').toString());
		}
	}

	boolean method870(int i) {
		try {
			SeqType class391 = Class501.aClass395_6122.method4903((2090514815 * (((Class82_Sub6) this).anInt6839)), (byte) 111);
	...
	public void method869() {
		Entity class365_sub1_sub1_sub2 = Class87.entities[((Class82_Sub6) this).anInt6840 * -2094920785].method1015(318010293);
		if (0 == 237701933 * ((Class82_Sub6) this).anInt6838)
	...
	public void method868() {
		Entity class365_sub1_sub1_sub2 = Class87.entities[((Class82_Sub6) this).anInt6840 * -2094920785].method1015(1968398843);
		if (0 == 237701933 * ((Class82_Sub6) this).anInt6838)
	...
	boolean method884() {
		SeqType class391 = Class501.aClass395_6122.method4903(2090514815 * ((Class82_Sub6) this).anInt6839, (byte) 25);
		return class391.method4880(524582595);
	}

	Class82_Sub6(Packet class298_sub53) {
	...
	public static Class298_Sub36 method885(int i) {
		try {
			...
			class298_sub36.buffer = new RsBitsBuffer(5000);
			return class298_sub36;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("xm.b(").append(')').toString());
		}
	}
	...
	public static int method886(int i, int i_0_, boolean bool, int i_1_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("xm.a(").append(')').toString());
		}
	}
	...
	static final void method887(ClientScript2 class403, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("xm.yj(").append(')').toString());
		}
	}
