...
public class Class82_Sub7 extends Class82 {
	...
	public void method866(int i) {
		try {
			...
			GameClient.anInt8770 = -1367521861 * ((Class82_Sub7) this).anInt6849;
			GameClient.anInt8857 = 0;
			GameClient.anInt8852 = 2019692335 * ((Class82_Sub7) this).anInt6852;
			GameClient.anInt8774 = -970762691 * ((Class82_Sub7) this).anInt6850;
			GameClient.anInt8769 = -2694169;
			GameClient.anInt8771 = ((Class82_Sub7) this).anInt6847 * -1957420531;
			ObjectDeque.anInt7164 = -734758223;
			Class397.method4913((byte) 66);
			GameClient.aBoolean8725 = true;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("xp.f(").append(')').toString());
		}
	}
	...
	Class82_Sub7(Packet class298_sub53) {
	...
	static void method889(Class233 class233, boolean bool, float f, float f_0_, float f_1_, float f_2_, int i, int i_3_, int i_4_) {
		try {
			int i_5_ = GameClient.map.method2635(-115794055);
			int i_6_ = GameClient.map.method2634((byte) -118);
			class233.method2152(f, f_0_, f_1_, f_2_, (float) i_6_, (float) i_5_, (float) i, (float) i_3_);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("xp.fj(").append(')').toString());
		}
	}
	...
	static final void decodePlayersMasks(RsBitsBuffer stream, int i) {
		try {
			for (int i_7_ = 0; i_7_ < -1281683379 * Class10.anInt139; i_7_++) {
				...
				Player player = GameClient.players[playerIndex];
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("xp.d(").append(')').toString());
		}
	}
