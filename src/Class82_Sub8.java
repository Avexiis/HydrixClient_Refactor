...
public class Class82_Sub8 extends Class82 {
	...
	public void method866(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("xq.f(").append(')').toString());
		}
	}
	...
	Class82_Sub8(Packet class298_sub53, boolean bool) {
		...
		((Class82_Sub8) this).anInt6854 = class298_sub53.readUnsignedInt() * -914937375;
	}
	...
	static final void method892(ClientScript2 class403, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("xq.qw(").append(')').toString());
		}
	}
	...
	public static void method893(int i, int i_1_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("xq.u(").append(')').toString());
		}
	}
	...
	static void method895(int i, int i_3_, int i_4_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("xq.as(").append(')').toString());
		}
	}
	...
	static void method896(int i, int i_5_, int i_6_, int i_7_, boolean bool, int i_8_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("xq.d(").append(')').toString());
		}
	}
	...
	static final void method897(ClientScript2 class403, byte i) {
		try {
			...
			else if (Class325.aLong3454 * -247648477838985581L > TimeUtils.getTime((byte) 1) - 1000L)
				((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919) - 1] = 1;
			else {
				Class474.aBoolean5974 = true;
				Class298_Sub36 class298_sub36 = Class18.method359(OutgoingPacket.aClass198_2071, GameClient.aClass25_8693.aClass449_330, (byte) 42);
				class298_sub36.buffer.writeInt(-1351839083 * Class117.anInt1399, -933492277);
				GameClient.aClass25_8693.writeOutboundPacket(class298_sub36, (byte) -36);
				((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919) - 1] = 0;
			}
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("xq.alo(").append(')').toString());
		}
	}
}
