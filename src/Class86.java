...
public class Class86 {
	...
	void method959(byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("dm.f(").append(')').toString());
		}
	}
	...
	boolean method960(byte i) {
		try {
			if (766413265 * ((Class86) this).anInt786 >= 0) {
				LocType class432 = Class463.aClass433_5689.list(((((Class86) this).anInt786) * 766413265));
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("dm.b(").append(')').toString());
		}
	}
	...
	void method961(int i, int i_3_, int i_4_, int i_5_, byte i_6_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("dm.a(").append(')').toString());
		}
	}
	...
	public static DiskFile getPreferenceFile(String id, String prefix, boolean read) {
		...
		do {
			if (preferencesFile.exists()) {
				DiskFile file;
				try {
					file = new DiskFile(preferencesFile, "rw", 10000L);
		...
		do {
			if (!read && preferencesOther.exists()) {
				DiskFile class476;
				try {
					class476 = new DiskFile(preferencesOther, "rw", 10000L);
				} catch (IOException ioexception) {
					break;
				}
				return class476;
	...
	public static int method964(int i, byte i_16_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("dm.r(").append(')').toString());
		}
	}
	...
	static final void method965(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("dm.xo(").append(')').toString());
		}
	}
	...
	public static void method967(int i, int i_28_, int i_29_, int i_30_) {
		try {
			if (Class298_Sub37_Sub10.aClass95_9602 != null && Class298_Sub37_Sub10.aClass95_9602.method1029((byte) 74) && (Class298_Sub37_Sub10.aClass95_9602.anInt921 * 1941368041 == i)) {
				...
				Class298_Sub36 class298_sub36 = Class18.method359(OutgoingPacket.aClass198_2004, GameClient.gameConnection.aClass449_330, (byte) 49);
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("dm.g(").append(')').toString());
		}
	}
}
