...
public class Class87 {
	...
	public static LinkedNodeList aLinkedNodeList_799 = new LinkedNodeList();
	static int anInt800;
	static int anInt801;
	...
	static final void method968(ClientScript2 class403, int i) {
		try {
			...
			Animator.method5846(string, i_0_ == 1, i_1_, i_2_, -671916771);
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("dn.abj(").append(')').toString());
		}
	}
	...
	static final void method969(ClientScript2 class403, int i) {
		try {
			...
			Class298_Sub32_Sub5.method3174(class105, RSInterface, class403, -1818514022);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("dn.nx(").append(')').toString());
		}
	}
	...
	public static int method970(int i, int i_4_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("dn.d(").append(')').toString());
		}
	}
	...
	static void method971(IComponentDefinition class105, int i, int i_6_, int i_7_) {
		try {
			...
			for (int i_8_ = 9; i_8_ >= 5; i_8_--) {
				...
				if (string != null)
					Class234.method2174(string, class105.aString1228, Class69.method794(class105, i_8_, -1663637577), 1007, class105.zds3 * -1232467723, (long) (1 + i_8_), -1309843523 * class105.component, -440872681 * class105.interfacehash, true, false, (long) (-1309843523 * class105.component << 32 | -440872681 * class105.interfacehash), false, -1971978132);
			}
			String string = Class88.method977(class105, -1338609331);
			if (null != string)
				Class234.method2174(string, class105.aString1228, class105.anInt1232 * 2120029245, 25, -1232467723 * class105.zds3, 0L, -1309843523 * class105.component, class105.interfacehash * -440872681, true, false, (long) ((class105.component * -1309843523 << 32) | -440872681 * class105.interfacehash), false, -1797794884);
			for (int i_9_ = 4; i_9_ >= 0; i_9_--) {
				String string_10_ = Class380.method4682(class105, i_9_, (byte) 92);
				if (null != string_10_)
					Class234.method2174(string_10_, class105.aString1228, Class69.method794(class105, i_9_, -1654084952), 57, class105.zds3 * -1232467723, (long) (1 + i_9_), -1309843523 * class105.component, -440872681 * class105.interfacehash, true, false, (long) (class105.component * -1309843523 << 32 | class105.interfacehash * -440872681), false, -1801587230);
			}
