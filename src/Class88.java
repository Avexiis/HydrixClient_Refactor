...
public class Class88 {
	...
	static final void method972(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("do.sv(").append(')').toString());
		}
	}

	static final void method973(ClientScript2 class403, int i) {
		try {
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = (Class12.aClass298_Sub44_9946.cpuClockSpeed * 399637415 < 512 || GameClient.aBoolean8646 || GameClient.aBoolean8662) ? 1 : 0;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("do.akp(").append(')').toString());
		}
	}
	...
	static final void method974(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("do.anl(").append(')').toString());
		}
	}
	...
	static final void method975(ClientScript2 class403, int i) {
		try {
			...
			SpotAnimTypeList.method4862(class105, RSInterface, class403, -2146430395);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("do.cp(").append(')').toString());
		}
	}
	...
	static boolean method976(int i, int i_3_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("do.fh(").append(')').toString());
		}
	}
	...
	static String method977(IComponentDefinition class105, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("do.mn(").append(')').toString());
		}
	}
	...
	static final void method978(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("do.afk(").append(')').toString());
		}
	}
}
