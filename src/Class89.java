...
public class Class89 {
	...
	public static Class89[] method982(byte[] is) {
		...
		class298_sub53.pos = (is.length - 7 - i * 8 - (i_12_ - 1) * 3) * 116413311;
		int[] is_18_ = new int[i_12_];
		for (int i_19_ = 1; i_19_ < i_12_; i_19_++) {
			is_18_[i_19_] = class298_sub53.g3();
			if (is_18_[i_19_] == 0)
				is_18_[i_19_] = 1;
		}
	...
	/*	NO-OP  */
	/*  This method used to draw translucent colors over sprites  */
	/*  It was part of Jagex's anti-cheat back in the day. It blocked color bots.  */
	/*  It made chat crowns look all funky so I disabled it. Took me weeks to find this mf. -Xeon  */
	}
