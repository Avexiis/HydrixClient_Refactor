...
public class Class91 {
	...
	static final void method998(ClientScript2 class403, int i) {
		try {
			...
			Class518.method6315(class105, RSInterface, class403, 783841228);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ds.fa(").append(')').toString());
		}
	}
	...
	static final void method999(ClientScript2 class403, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ds.zx(").append(')').toString());
		}
	}
	...
	static final void method1000(ClientScript2 class403, int i) {
		try {
			...
			Class410.method4984(class105, RSInterface, class403, (byte) 7);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ds.ox(").append(')').toString());
		}
	}
	...
	static final void method1002(byte i) {
		try {
			if (GameClient.aFloat8757 < 1104.0F)
				GameClient.aFloat8757 = 1104.0F;
			if (GameClient.aFloat8757 > 2874.0F)
				GameClient.aFloat8757 = 2874.0F;
			...
			TileFlags tileFlags = GameClient.map.method2654(1252790814);
			...
			int i_6_ = 0;
			if (i_3_ > 3 && i_4_ > 3 && i_3_ < GameClient.map.upperX(-1981660153) - 4 && i_4_ < GameClient.map.upperY(1904630701) - 4) {
				for (int i_7_ = i_3_ - 4; i_7_ <= 4 + i_3_; i_7_++) {
					for (int i_8_ = i_4_ - 4; i_8_ <= 4 + i_4_; i_8_++) {
						int i_9_ = Class99.anInt952 * 1855729883;
						if (i_9_ < 3 && tileFlags.method2320(i_7_, i_8_, -316177210))
							i_9_++;
						int i_10_ = 0;
						byte[][] is = GameClient.map.method2637(i_9_, 300700071);
						if (null != is)
							i_10_ = (is[i_7_][i_8_] & 0xff) * 8 << 2;
						if (null != sceneGraph.aGroundArray3517 && sceneGraph.aGroundArray3517[i_9_] != null) {
							int i_11_ = (i_5_ - (sceneGraph.aGroundArray3517[i_9_].method6341(i_7_, i_8_, (byte) -39) - i_10_));
							if (i_11_ > i_6_)
								i_6_ = i_11_;
						}
					}
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ds.hl(").append(')').toString());
		}
	}
}
