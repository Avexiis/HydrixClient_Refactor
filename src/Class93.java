...
final class Class93 implements Interface23 {
	...
	public int method252(int i, byte i_0_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("du.d(").append(')').toString());
		}
	}
	...
	public int method250(int i, byte i_1_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("du.u(").append(')').toString());
		}
	}
	...
	static final void method1009(ClientScript2 class403, int i) {
		try {
			if (null != GameClient.aString8804)
				((ClientScript2) class403).anObjectArray5240[((((ClientScript2) class403).anInt5241 += 969361751) * -203050393) - 1] = Class227.method2114(GameClient.aString8804, 864183945);
			else
				((ClientScript2) class403).anObjectArray5240[((((ClientScript2) class403).anInt5241 += 969361751) * -203050393) - 1] = "";
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("du.wy(").append(')').toString());
		}
	}
	...
	public static void method1010(Class457 class457, Frame frame, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("du.b(").append(')').toString());
		}
	}

	public static void method1011(byte i) {
		try {
			Class478.aLinkedNodeList_6002 = new LinkedNodeList();
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("du.a(").append(')').toString());
		}
	}
	...
	public static void method1012(Class298_Sub50 class298_sub50, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("du.p(").append(')').toString());
		}
	}
	...
	static final void method1013(int i, int i_2_, long l) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("du.jd(").append(')').toString());
		}
	}
	...
	public static boolean method1014(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("du.k(").append(')').toString());
		}
	}
}
