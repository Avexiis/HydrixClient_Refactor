...
public final class Class94 {
	...
	Class94(Packet class298_sub53, int i) {
	...
	public Entity method1015(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("dv.p(").append(')').toString());
		}
	}
	...
	void method1016(byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("dv.f(").append(')').toString());
		}
	}
	...
	void method1017(int i, int i_1_, int i_2_, int i_3_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("dv.b(").append(')').toString());
		}
	}
		...
		try {
			if (!aBoolean912) {
				...
				if (1762367763 * anInt909 >= 0) {
					((Class94) this).aClass365_Sub1_Sub1_Sub2_Sub1_910 = (new NPC(GameClient.map.method2675(-1611682495), 25));
					((Class94) this).aClass365_Sub1_Sub1_Sub2_Sub1_910.entityIndex = ((Class94) this).anInt906 * 302956801;
					((Class94) this).aClass365_Sub1_Sub1_Sub2_Sub1_910.anInt10075 = GameClient.anInt8884 * -128551287;
					...
					((Class94) this).aClass365_Sub1_Sub1_Sub2_Sub1_910.updateSize(-2095128707 * (((Class94) this).aClass365_Sub1_Sub1_Sub2_Sub1_910.definition.size), -1254496694);
					((Class94) this).aClass365_Sub1_Sub1_Sub2_Sub1_910.anInt10115 = -1186616623 * (((((Class94) this).aClass365_Sub1_Sub1_Sub2_Sub1_910.definition.anInt6181) * -1927065533) << 3);
					((Class94) this).aClass365_Sub1_Sub1_Sub2_Sub1_910.anInt10071 = (((Class87.anInt803 += 2029434363) * -132903629 - 1) * -689024993);
				} else {
					((Class94) this).aClass365_Sub1_Sub1_Sub2_Sub2_911 = (new Player(GameClient.map.method2675(-1611682495), 25));
					((Class94) this).aClass365_Sub1_Sub1_Sub2_Sub2_911.sendAppearence(Class128_Sub1.aClass298_Sub53_8555, (byte) 3);
					((Class94) this).aClass365_Sub1_Sub1_Sub2_Sub2_911.entityIndex = 302956801 * ((Class94) this).anInt906;
					((Class94) this).aClass365_Sub1_Sub1_Sub2_Sub2_911.anInt10075 = -128551287 * GameClient.anInt8884;
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("dv.a(").append(')').toString());
		}
	}
	...
	boolean method1019(int i) {
		try {
			if (anInt909 * 1762367763 >= 0) {
				NPCType class503 = Class15.aClass507_224.method6269(1762367763 * anInt909, 2059716043);
				boolean bool = class503.method6238(-1621243143);
				if (((Class94) this).anIntArray907 == null) {
					BASType class350 = aClass349_913.method4202((class503.basid * 525312939), (byte) 47);
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("dv.i(").append(')').toString());
		}
	}
	...
	static final void method1021(ClientScript2 class403, int i) {
		try {
			...
			Class127.method1419(class105, RSInterface, class403, 1780401940);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("dv.gb(").append(')').toString());
		}
	}
	...
	static final void method1022(ClientScript2 class403, int i) {
		try {
			...
			IComponentDefinition class105 = ((Class390) class390).aClass105_4168;
			RSInterface RSInterface = ((Class390) class390).aRSInterface_4167;
			Class21.method365(class105, RSInterface, true, 0, class403, 338177533);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("dv.hn(").append(')').toString());
		}
	}
	...
	static final void method1023(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("dv.aif(").append(')').toString());
		}
	}
	...
	static final void method1024(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("dv.apd(").append(')').toString());
		}
	}
	...
	static final void method1025(ClientScript2 class403, int i) {
		try {
			if (GameClient.playerRights * 1806357379 >= 2)
				((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919) - 1] = 1806357379 * GameClient.playerRights;
			else
				((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919) - 1] = 0;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("dv.tb(").append(')').toString());
		}
	}
	...
	static final void method1026(ClientScript2 class403, int i) {
		try {
			...
			if (-257444687 * GameClient.WINDOW_PANE_ID != -1) {
				if (i_12_ == 0) {
					((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919) - 1] = GameClient.WINDOW_PANE_ID * -257444687;
					return;
				}
				i_12_--;
			}
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("dv.alc(").append(')').toString());
		}
	}
}
