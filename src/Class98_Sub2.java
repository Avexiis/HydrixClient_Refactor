...
public class Class98_Sub2 extends Class98 {
	...
	void method1054(int i, int i_1_, byte i_2_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("yh.a(").append(')').toString());
		}
	}
	...
	void method1047(int i, int i_7_, byte i_8_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("yh.f(").append(')').toString());
		}
	}
	...
	void method1048(int i, int i_10_, byte i_11_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("yh.b(").append(')').toString());
		}
	}
	...
	static void method1061(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("yh.y(").append(')').toString());
		}
	}
	...
	static final void method1062(ClientScript2 class403, int i) {
		try {
			...
			Class298_Sub36 class298_sub36 = Class18.method359(OutgoingPacket.CHAT_TYPE_PACKET, class25.aClass449_330, (byte) 56);
			class298_sub36.buffer.writeByte(i_26_);
			class25.writeOutboundPacket(class298_sub36, (byte) -69);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("yh.abr(").append(')').toString());
		}
	}
	...
	static final void method1063(ClientScript2 class403, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("yh.vu(").append(')').toString());
		}
	}
	...
	public static void method1064(Class502 class502, int i, int i_27_, Class400 class400, Class365_Sub1_Sub4_Sub1 class365_sub1_sub4_sub1, int i_28_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("yh.x(").append(')').toString());
		}
	}

	static void method1065(byte i) {
		try {
			for (Class298_Sub37_Sub5 class298_sub37_sub5 = ((Class298_Sub37_Sub5) ContextMenu.aClass461_5482.method5984(-431286975)); null != class298_sub37_sub5; class298_sub37_sub5 = ((Class298_Sub37_Sub5) ContextMenu.aClass461_5482.method5985(-2120194897))) {
				if ((-628325139 * ((Class298_Sub37_Sub5) class298_sub37_sub5).anInt9583) > 1) {
					((Class298_Sub37_Sub5) class298_sub37_sub5).anInt9583 = 0;
					ContextMenu.aClass348_5464.put(class298_sub37_sub5, (6619564980435866523L * ((Class298_Sub37_Sub15) (Class298_Sub37_Sub15) (((Class298_Sub37_Sub5) class298_sub37_sub5).aClass461_9584.aClass298_Sub37_5679.aClass298_Sub37_7405)).aLong9666));
			...
			ContextMenu.aClass437_5470.method5811((byte) -19);
			ContextMenu.aClass461_5482.method5988(-116656816);
			MovementType.method2618(ContextMenu.aClass298_Sub37_Sub15_5466, 1921095656);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("yh.ax(").append(')').toString());
		}
	}
	...
	static final void method1066(ClientScript2 class403, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("yh.amq(").append(')').toString());
		}
	}
}
