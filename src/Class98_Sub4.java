...
public class Class98_Sub4 extends Class98 {
	...
	void method1054(int i, int i_1_, byte i_2_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("yy.a(").append(')').toString());
		}
	}
	...
	void method1048(int i, int i_20_, byte i_21_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("yy.b(").append(')').toString());
		}
	}
	...
	void method1047(int i, int i_35_, byte i_36_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("yy.f(").append(')').toString());
		}
	}
	...
	static final void method1068(ClientScript2 class403, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("yy.rq(").append(')').toString());
		}
	}
	...
	static final int method1069(int i, int i_38_, int i_39_, int i_40_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("yy.c(").append(')').toString());
		}
	}
}
