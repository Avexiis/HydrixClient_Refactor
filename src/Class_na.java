...
public abstract class Class_na extends Class298_Sub37 {
	...
	public static Class298_Sub37_Sub15 method3476(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("na.al(").append(')').toString());
		}
	}
	...
	static final void method3477(ClientScript2 class403, int i) {
		try {
			...
			Class145.method1595(class105, RSInterface, class403, -866344405);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("na.mr(").append(')').toString());
		}
	}
	...
	public static final void method3478(int i) {
		try {
			...
			ObjectDeque.anInt7164 = 621176181;
			Class418.anInt5339 = -1001372047;
			Class100.anInt1081 = 178575833;
			GameClient.anInt8921 = 727655629 * GameClient.anInt8884;
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("na.hb(").append(')').toString());
		}
	}
		...
		try {
			...
			if (null != class298_sub25 && i >= 0 && i < 649879491 * class298_sub25.anInt7356) {
				...
				if (-1 == class163.aByte1683) {
					...
					Class298_Sub36 class298_sub36 = Class18.method359(OutgoingPacket.aClass198_2035, class25.aClass449_330, (byte) 56);
					class298_sub36.buffer.writeByte(3 + Class58.method693(string, -175153344));
					class298_sub36.buffer.writeByte(bool ? 1 : 0);
					class298_sub36.buffer.writeShort(i, 16711935);
					class298_sub36.buffer.writeString(string, 2135659343);
					class25.writeOutboundPacket(class298_sub36, (byte) -99);
				}
			}
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("na.mw(").append(')').toString());
		}
	}

	static final void method3480(ClientScript2 class403, int i) {
		try {
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = GameClient.anInt8845 * -363202459;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("na.uf(").append(')').toString());
		}
	}
}
