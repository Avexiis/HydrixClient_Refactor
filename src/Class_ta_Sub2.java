...
public class Class_ta_Sub2 extends Class_ta {
	...
	static void method6000(ClientScript2 class403, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("wi.p(").append(')').toString());
		}
	}
	...
	public static void method6001(Class57[] class57s, int i) {
		try {
			...
			ContextMenu.aClass57Array5501 = new Class57[Skybox.anInt2964 * -232961423 + 10];
			FogPreference.anIntArray8372 = new int[-232961423 * Skybox.anInt2964 + 10];
			System.arraycopy(class57s, 0, ContextMenu.aClass57Array5501, 0, -232961423 * Skybox.anInt2964);
			for (int i_2_ = 0; i_2_ < -232961423 * Skybox.anInt2964; i_2_++)
				FogPreference.anIntArray8372[i_2_] = ContextMenu.aClass57Array5501[i_2_].method626();
			for (int i_3_ = Skybox.anInt2964 * -232961423; i_3_ < ContextMenu.aClass57Array5501.length; i_3_++)
				FogPreference.anIntArray8372[i_3_] = 12;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("wi.ao(").append(')').toString());
		}
	}
	...
	static final void method6002(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("wi.kv(").append(')').toString());
		}
	}

	static Packet method6003(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("wi.w(").append(')').toString());
		}
	}
	...
	static void method6004(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("wi.f(").append(')').toString());
		}
	}
	...
	static final void method6005(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("wi.wz(").append(')').toString());
		}
	}
	...
	public static void method6006(Js5 class243, Js5 class243_5_, int i, byte i_6_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("wi.a(").append(')').toString());
		}
	}
}
