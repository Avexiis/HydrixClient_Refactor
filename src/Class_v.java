...
public abstract class Class_v extends Node {
	...
	static final void method3669(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("v.aff(").append(')').toString());
		}
	}
	...
	public static void method3670(Player player, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("v.d(").append(')').toString());
		}
	}
	...
	static final void method3671(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("v.aoi(").append(')').toString());
		}
	}
	...
	static void method3672(int i, int i_1_, int i_2_, int i_3_, int i_4_, int i_5_, int i_6_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("v.t(").append(')').toString());
		}
	}
