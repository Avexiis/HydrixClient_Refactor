...
public class Class_xa_Sub1 extends Ground {
	float aFloat8447;
	...
	public void h() {
		if (((Class_xa_Sub1) this).anInt8473 > 0) {
			...
			Node[] nodes = new Node[((Class_xa_Sub1) this).aClass440_8479.method5855(1016688966)];
			((Class_xa_Sub1) this).aClass440_8479.method5854(nodes, 2103539357);
			for (int i = 0; i < nodes.length; i++)
				((Class298_Sub16) nodes[i]).method2910(((Class_xa_Sub1) this).anInt8473);
			int i = 20;
			...
			int i_3_ = ParticlePreference.method5639((((Class_xa_Sub1) this).anInt8473 / 4), 1661685249);
			if (i_3_ < 1)
				i_3_ = 1;
						...
						for (int i_33_ = 0; i_33_ < is_11_.length; i_33_++) {
							...
							if (i_38_ != -1) {
								...
								if (i_59_ < 2)
									...
									i_59_ = 126;
								i_44_ = (JAGLib.anIntArray3165[i_38_ & 0xff80 | i_59_]);
								if ((((Class_xa_Sub1) this).anInt8482 & 0x7) == 0) {
							...
							if (node == null) {
								...
								if (i_39_ != i_38_) {
									...
									if (i_62_ < 2)
										...
										i_62_ = 126;
									i_61_ = (JAGLib.anIntArray3165[i_39_ & 0xff80 | i_62_]);
									if ((((Class_xa_Sub1) this).anInt8482 & 0x7) == 0) {
								...
								is_32_[i_33_] = ((Class298_Sub20) node).aShort7314;
			...
			int i_80_ = 0;
			for (int i_81_ = 0; i_81_ < nodes.length; i_81_++) {
				Class298_Sub16 class298_sub16 = (Class298_Sub16) nodes[i_81_];
				if (((Class298_Sub16) class298_sub16).anInt7290 > 0)
					nodes[i_80_++] = class298_sub16;
			}
			((Class_xa_Sub1) this).aNodeArray8478 = new Node[i_80_];
			long[] ls = new long[i_80_];
			for (int i_82_ = 0; i_82_ < i_80_; i_82_++) {
				Class298_Sub16 class298_sub16 = (Class298_Sub16) nodes[i_82_];
	...
	public void method6339(int i, int i_123_, int i_124_, int i_125_, int i_126_, int i_127_, int i_128_, boolean[][] bools) {
		if (((Class_xa_Sub1) this).anInt8473 > 0) {
			...
			if (i_129_ > 0) {
				...
				((Class_xa_Sub1) this).aClass_ra_Sub3_8467.method5043(Matrix43f.aClass222_2504);
	...
	public void SA() {
		if (((Class_xa_Sub1) this).anInt8473 > 0) {
			...
			Node[] nodes = new Node[((Class_xa_Sub1) this).aClass440_8479.method5855(1332224628)];
			((Class_xa_Sub1) this).aClass440_8479.method5854(nodes, 2094257346);
			for (int i = 0; i < nodes.length; i++)
				((Class298_Sub16) nodes[i]).method2910(((Class_xa_Sub1) this).anInt8473);
			int i = 20;
			if (((Class_xa_Sub1) this).anIntArrayArrayArray8465 != null)
			...
			Class298_Sub16[] class298_sub16s = new Class298_Sub16[((Class_xa_Sub1) this).anInt8473];
			int i_288_ = ParticlePreference.method5639((((Class_xa_Sub1) this).anInt8473 / 4), 2098856769);
			if (i_288_ < 1)
				i_288_ = 1;
						...
						for (int i_318_ = 0; i_318_ < is_296_.length; i_318_++) {
							...
							if (i_323_ != -1) {
								...
								if (i_344_ < 2)
									...
									i_344_ = 126;
								i_329_ = (JAGLib.anIntArray3165[i_323_ & 0xff80 | i_344_]);
								if ((((Class_xa_Sub1) this).anInt8482 & 0x7) == 0) {
							...
							if (node == null) {
								...
								if (i_324_ != i_323_) {
									...
									if (i_347_ < 2)
										...
										i_347_ = 126;
									i_346_ = (JAGLib.anIntArray3165[i_324_ & 0xff80 | i_347_]);
									if ((((Class_xa_Sub1) this).anInt8482 & 0x7) == 0) {
								...
								is_317_[i_318_] = ((Class298_Sub20) node).aShort7314;
			...
			if ((((Class_xa_Sub1) this).anInt8482 & 0x7) != 0) {
				...
				((Class_xa_Sub1) this).aClass153_8472 = (((Class_xa_Sub1) this).aClass_ra_Sub3_8467.method5404(new Class181[] { new Class181(new Class155[] { Class155.aClass155_1610, Class155.aClass155_1599 }), new Class181(Class155.aClass155_1597) }));
			int i_365_ = 0;
			for (int i_366_ = 0; i_366_ < nodes.length; i_366_++) {
				Class298_Sub16 class298_sub16 = (Class298_Sub16) nodes[i_366_];
				if (((Class298_Sub16) class298_sub16).anInt7290 > 0)
					nodes[i_365_++] = class298_sub16;
			}
			((Class_xa_Sub1) this).aNodeArray8478 = new Node[i_365_];
			long[] ls = new long[i_365_];
			for (int i_367_ = 0; i_367_ < i_365_; i_367_++) {
				Class298_Sub16 class298_sub16 = (Class298_Sub16) nodes[i_367_];
	...
	public void method6338(int i, int i_368_, int i_369_, boolean[][] bools, boolean bool, int i_370_) {
		if (((Class_xa_Sub1) this).aNodeArray8478 != null) {
			...
			ByteBuffer bytebuffer = ((Class_xa_Sub1) this).aClass_ra_Sub3_8467.aByteBuffer8216;
			bytebuffer.clear();
			for (int i_381_ = 0; i_381_ < ((Class_xa_Sub1) this).aNodeArray8478.length; i_381_++) {
				Class298_Sub16 class298_sub16 = ((Class298_Sub16) ((Class_xa_Sub1) this).aNodeArray8478[i_381_]);
			...
			if (i_382_ != 0) {
				...
				if (((Class_xa_Sub1) this).aClass_ra_Sub3_8467.anInt8233 > 0) {
					...
					class137.aSceneObjectPosition_1522.method2007((float) ((((Class_xa_Sub1) this).aClass_ra_Sub3_8467.anInt8332) >> 16 & 0xff) / 255.0F, (float) ((((Class_xa_Sub1) this).aClass_ra_Sub3_8467.anInt8332) >> 8 & 0xff) / 255.0F, (float) ((((Class_xa_Sub1) this).aClass_ra_Sub3_8467.anInt8332) >> 0 & 0xff) / 255.0F);
				...
				if ((((Class_xa_Sub1) this).anInt8482 & 0x37) == 0) {
					int i_383_ = 0;
					for (int i_384_ = 0; (i_384_ < ((Class_xa_Sub1) this).aNodeArray8478.length); i_384_++) {
						...
						if (((Class298_Sub16) class298_sub16).anInt7282 != 0) {
							...
							if (((Class298_Sub16) class298_sub16).anInt7284 != -1) {
								...
								MaterialRaw materialRaw = (((Class_xa_Sub1) this).aClass_ra_Sub3_8467.anInterface_ma5299.method174((((Class298_Sub16) class298_sub16).anInt7284), 377396513));
								bool_385_ = !(Class298_Sub32_Sub31.method3339(materialRaw.aByte529, -596124611));
							} else
								class137.anInterface9_Impl2_1517 = (((Class_xa_Sub1) this).aClass_ra_Sub3_8467.anInterface9_Impl2_8310);
					...
					class137.aSceneObjectPosition_1527.method2007((((Class_xa_Sub1) this).aClass_ra_Sub3_8467.aFloatArray8283[0]), (((Class_xa_Sub1) this).aClass_ra_Sub3_8467.aFloatArray8283[1]), (((Class_xa_Sub1) this).aClass_ra_Sub3_8467.aFloatArray8283[2]));
					class137.aSceneObjectPosition_1528.method2007((((Class_xa_Sub1) this).aClass_ra_Sub3_8467.aFloat8364 * (((Class_xa_Sub1) this).aClass_ra_Sub3_8467.aFloat8362)), (((Class_xa_Sub1) this).aClass_ra_Sub3_8467.aFloat8364 * (((Class_xa_Sub1) this).aClass_ra_Sub3_8467.aFloat8289)), (((Class_xa_Sub1) this).aClass_ra_Sub3_8467.aFloat8364 * (((Class_xa_Sub1) this).aClass_ra_Sub3_8467.aFloat8290)));
					class137.aSceneObjectPosition_1529.method2007((-(((Class_xa_Sub1) this).aClass_ra_Sub3_8467.aFloat8293) * (((Class_xa_Sub1) this).aClass_ra_Sub3_8467.aFloat8362)), (-(((Class_xa_Sub1) this).aClass_ra_Sub3_8467.aFloat8293) * (((Class_xa_Sub1) this).aClass_ra_Sub3_8467.aFloat8289)), (-(((Class_xa_Sub1) this).aClass_ra_Sub3_8467.aFloat8293) * (((Class_xa_Sub1) this).aClass_ra_Sub3_8467.aFloat8290)));
					class137.aSceneObjectPosition_1515.method2007((((Class_xa_Sub1) this).aClass_ra_Sub3_8467.aFloat8291 * (((Class_xa_Sub1) this).aClass_ra_Sub3_8467.aFloat8362)), (((Class_xa_Sub1) this).aClass_ra_Sub3_8467.aFloat8291 * (((Class_xa_Sub1) this).aClass_ra_Sub3_8467.aFloat8289)), (((Class_xa_Sub1) this).aClass_ra_Sub3_8467.aFloat8291 * (((Class_xa_Sub1) this).aClass_ra_Sub3_8467.aFloat8290)));
					int i_386_ = 0;
					for (int i_387_ = 0; (i_387_ < ((Class_xa_Sub1) this).aNodeArray8478.length); i_387_++) {
						...
						if (((Class298_Sub16) class298_sub16).anInt7282 > 0) {
							...
							byte i_388_ = 11;
							if (((Class298_Sub16) class298_sub16).anInt7284 != -1) {
								MaterialRaw materialRaw = (((Class_xa_Sub1) this).aClass_ra_Sub3_8467.anInterface_ma5299.method174((((Class298_Sub16) class298_sub16).anInt7284), 515352996));
								i_388_ = materialRaw.aByte529;
								class137.anInterface9_Impl2_1517 = (((Class_ra_Sub3) (((Class_xa_Sub1) this).aClass_ra_Sub3_8467)).aClass157_8351.method1698(((Class298_Sub16) class298_sub16).anInt7284));
							...
							switch (i_388_) {
							case 7:
								class137.aSceneObjectPosition_1530.method2007((((Class_ra_Sub3) (((Class_xa_Sub1) this).aClass_ra_Sub3_8467)).aClass233_8231.aFloatArray2594[12]), (((Class_ra_Sub3) (((Class_xa_Sub1) this).aClass_ra_Sub3_8467)).aClass233_8231.aFloatArray2594[13]), (((Class_ra_Sub3) (((Class_xa_Sub1) this).aClass_ra_Sub3_8467)).aClass233_8231.aFloatArray2594[14]));
							...
							case 9:
								if (!(((Class_xa_Sub1) this).aClass_ra_Sub3_8467.aBoolean8214) && (((Class_xa_Sub1) this).anInt8482 & 0x8) != 0) {
									...
									class161_sub1_sub2.aSceneObjectPosition_9149.method2013(class137.aSceneObjectPosition_1524);
									class161_sub1_sub2.aClass232_9157.method2140(class137.aClass232_1525);
									class161_sub1_sub2.aSceneObjectPosition_9139.method2013(class137.aSceneObjectPosition_1522);
	...
	public void method6348(int i, int i_389_, int i_390_, boolean[][] bools, boolean bool, int i_391_) {
		if (((Class_xa_Sub1) this).aNodeArray8478 != null) {
			...
			ByteBuffer bytebuffer = ((Class_xa_Sub1) this).aClass_ra_Sub3_8467.aByteBuffer8216;
			bytebuffer.clear();
			for (int i_402_ = 0; i_402_ < ((Class_xa_Sub1) this).aNodeArray8478.length; i_402_++) {
				Class298_Sub16 class298_sub16 = ((Class298_Sub16) ((Class_xa_Sub1) this).aNodeArray8478[i_402_]);
				class298_sub16.method2915(anIntArray8471, anInt8453);
			}
			...
			if (i_403_ != 0) {
				...
				if ((((Class_xa_Sub1) this).anInt8482 & 0x37) == 0) {
					int i_404_ = 0;
					for (int i_405_ = 0; (i_405_ < ((Class_xa_Sub1) this).aNodeArray8478.length); i_405_++) {
						...
						if (((Class298_Sub16) class298_sub16).anInt7282 != 0) {
							...
							if (((Class298_Sub16) class298_sub16).anInt7284 != -1) {
								class137.anInterface9_Impl2_1517 = (((Class_ra_Sub3) (((Class_xa_Sub1) this).aClass_ra_Sub3_8467)).aClass157_8351.method1698(((Class298_Sub16) class298_sub16).anInt7284));
								MaterialRaw materialRaw = (((Class_xa_Sub1) this).aClass_ra_Sub3_8467.anInterface_ma5299.method174((((Class298_Sub16) class298_sub16).anInt7284), 593985487));
								bool_406_ = !(Class298_Sub32_Sub31.method3339(materialRaw.aByte529, -1511846848));
							} else
								class137.anInterface9_Impl2_1517 = (((Class_xa_Sub1) this).aClass_ra_Sub3_8467.anInterface9_Impl2_8310);
							((Class_xa_Sub1) this).aClass_ra_Sub3_8467.method5383(1, (((Class298_Sub16) class298_sub16).anInterface7_Impl1_7287));
							((Class_xa_Sub1) this).aClass_ra_Sub3_8467.method5455(((Class_xa_Sub1) this).aClass153_8472);
					...
					class137.aSceneObjectPosition_1515.method2007((((Class_xa_Sub1) this).aClass_ra_Sub3_8467.aFloat8291 * (((Class_xa_Sub1) this).aClass_ra_Sub3_8467.aFloat8362)), (((Class_xa_Sub1) this).aClass_ra_Sub3_8467.aFloat8291 * (((Class_xa_Sub1) this).aClass_ra_Sub3_8467.aFloat8289)), (((Class_xa_Sub1) this).aClass_ra_Sub3_8467.aFloat8291 * (((Class_xa_Sub1) this).aClass_ra_Sub3_8467.aFloat8290)));
					int i_407_ = 0;
					for (int i_408_ = 0; (i_408_ < ((Class_xa_Sub1) this).aNodeArray8478.length); i_408_++) {
						...
						if (((Class298_Sub16) class298_sub16).anInt7282 > 0) {
							...
							byte i_409_ = 11;
							if (((Class298_Sub16) class298_sub16).anInt7284 != -1) {
								MaterialRaw materialRaw = (((Class_xa_Sub1) this).aClass_ra_Sub3_8467.anInterface_ma5299.method174((((Class298_Sub16) class298_sub16).anInt7284), 1262090784));
								i_409_ = materialRaw.aByte529;
								class137.anInterface9_Impl2_1517 = (((Class_ra_Sub3) (((Class_xa_Sub1) this).aClass_ra_Sub3_8467)).aClass157_8351.method1698(((Class298_Sub16) class298_sub16).anInt7284));
								class137.method1509(materialRaw);
							} else
								class137.anInterface9_Impl2_1517 = (((Class_xa_Sub1) this).aClass_ra_Sub3_8467.anInterface9_Impl2_8310);
	...
	public void method6347(int i, int i_410_, int i_411_, int i_412_, int i_413_, int i_414_, int i_415_, boolean[][] bools) {
		if (((Class_xa_Sub1) this).anInt8473 > 0) {
			...
			if (i_416_ > 0) {
				...
				Matrix43f class222 = new Matrix43f();
				Matrix43f class222_425_ = new Matrix43f();
				class222.method2057(1.0F, 0.0F, 0.0F, 0.0F, 0.0F, 1.0F, 0.0F, 1.0F, 0.0F);
	...
	public void method6351(int i, int i_426_, int i_427_, int i_428_, int i_429_, int i_430_, int i_431_, boolean[][] bools) {
		if (((Class_xa_Sub1) this).anInt8473 > 0) {
			...
			if (i_432_ > 0) {
				...
				Matrix43f class222 = new Matrix43f();
				Matrix43f class222_441_ = new Matrix43f();
				class222.method2057(1.0F, 0.0F, 0.0F, 0.0F, 0.0F, 1.0F, 0.0F, 1.0F, 0.0F);
	...
	public void method6350(int i, int i_442_, int i_443_, int i_444_, int i_445_, int i_446_, int i_447_, boolean[][] bools) {
		if (((Class_xa_Sub1) this).anInt8473 > 0) {
			...
			if (i_448_ > 0) {
				...
				Matrix43f class222 = new Matrix43f();
				Matrix43f class222_457_ = new Matrix43f();
				class222.method2057(1.0F, 0.0F, 0.0F, 0.0F, 0.0F, 1.0F, 0.0F, 1.0F, 0.0F);
	...
	public void method6357(int i, int i_458_, int i_459_, boolean[][] bools, boolean bool, int i_460_) {
		if (((Class_xa_Sub1) this).aNodeArray8478 != null) {
			...
			ByteBuffer bytebuffer = ((Class_xa_Sub1) this).aClass_ra_Sub3_8467.aByteBuffer8216;
			bytebuffer.clear();
			for (int i_471_ = 0; i_471_ < ((Class_xa_Sub1) this).aNodeArray8478.length; i_471_++) {
				Class298_Sub16 class298_sub16 = ((Class298_Sub16) ((Class_xa_Sub1) this).aNodeArray8478[i_471_]);
				class298_sub16.method2915(anIntArray8471, anInt8453);
			}
			...
			if (i_472_ != 0) {
				...
				if ((((Class_xa_Sub1) this).anInt8482 & 0x37) == 0) {
					int i_473_ = 0;
					for (int i_474_ = 0; (i_474_ < ((Class_xa_Sub1) this).aNodeArray8478.length); i_474_++) {
						...
						if (((Class298_Sub16) class298_sub16).anInt7282 != 0) {
							...
							if (((Class298_Sub16) class298_sub16).anInt7284 != -1) {
								class137.anInterface9_Impl2_1517 = (((Class_ra_Sub3) (((Class_xa_Sub1) this).aClass_ra_Sub3_8467)).aClass157_8351.method1698(((Class298_Sub16) class298_sub16).anInt7284));
								MaterialRaw materialRaw = (((Class_xa_Sub1) this).aClass_ra_Sub3_8467.anInterface_ma5299.method174((((Class298_Sub16) class298_sub16).anInt7284), 444879772));
								bool_475_ = !(Class298_Sub32_Sub31.method3339(materialRaw.aByte529, -1276184366));
							} else
								class137.anInterface9_Impl2_1517 = (((Class_xa_Sub1) this).aClass_ra_Sub3_8467.anInterface9_Impl2_8310);
							((Class_xa_Sub1) this).aClass_ra_Sub3_8467.method5383(1, (((Class298_Sub16) class298_sub16).anInterface7_Impl1_7287));
							((Class_xa_Sub1) this).aClass_ra_Sub3_8467.method5455(((Class_xa_Sub1) this).aClass153_8472);
					...
					class137.aSceneObjectPosition_1515.method2007((((Class_xa_Sub1) this).aClass_ra_Sub3_8467.aFloat8291 * (((Class_xa_Sub1) this).aClass_ra_Sub3_8467.aFloat8362)), (((Class_xa_Sub1) this).aClass_ra_Sub3_8467.aFloat8291 * (((Class_xa_Sub1) this).aClass_ra_Sub3_8467.aFloat8289)), (((Class_xa_Sub1) this).aClass_ra_Sub3_8467.aFloat8291 * (((Class_xa_Sub1) this).aClass_ra_Sub3_8467.aFloat8290)));
					int i_476_ = 0;
					for (int i_477_ = 0; (i_477_ < ((Class_xa_Sub1) this).aNodeArray8478.length); i_477_++) {
						...
						if (((Class298_Sub16) class298_sub16).anInt7282 > 0) {
							...
							byte i_478_ = 11;
							if (((Class298_Sub16) class298_sub16).anInt7284 != -1) {
								MaterialRaw materialRaw = (((Class_xa_Sub1) this).aClass_ra_Sub3_8467.anInterface_ma5299.method174((((Class298_Sub16) class298_sub16).anInt7284), 2135192368));
								i_478_ = materialRaw.aByte529;
								class137.anInterface9_Impl2_1517 = (((Class_ra_Sub3) (((Class_xa_Sub1) this).aClass_ra_Sub3_8467)).aClass157_8351.method1698(((Class298_Sub16) class298_sub16).anInt7284));
								class137.method1509(materialRaw);
							} else
								class137.anInterface9_Impl2_1517 = (((Class_xa_Sub1) this).aClass_ra_Sub3_8467.anInterface9_Impl2_8310);
	...
	public void method6352(int i, int i_479_, int i_480_, int i_481_, int i_482_, int i_483_, int i_484_, boolean[][] bools) {
		if (((Class_xa_Sub1) this).anInt8473 > 0) {
			...
			if (i_485_ > 0) {
				...
				Matrix43f class222 = new Matrix43f();
				Matrix43f class222_494_ = new Matrix43f();
				class222.method2057(1.0F, 0.0F, 0.0F, 0.0F, 0.0F, 1.0F, 0.0F, 1.0F, 0.0F);
	...
	public void method6349(int i, int i_495_, int i_496_, int i_497_, int i_498_, int i_499_, int i_500_, boolean[][] bools) {
		if (((Class_xa_Sub1) this).anInt8473 > 0) {
			...
			if (i_501_ > 0) {
				...
				Matrix43f class222 = new Matrix43f();
				Matrix43f class222_510_ = new Matrix43f();
				class222.method2057(1.0F, 0.0F, 0.0F, 0.0F, 0.0F, 1.0F, 0.0F, 1.0F, 0.0F);
