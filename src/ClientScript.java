...
public class ClientScript extends Class298_Sub37 {
	...
	int method3473(Packet class298_sub53, int i) {
		try {
			class298_sub53.pos = 116413311 * (class298_sub53.payload.length - 2);
			int i_0_ = class298_sub53.readUnsignedShort();
			int i_1_ = class298_sub53.payload.length - 2 - i_0_ - 16;
			class298_sub53.pos = i_1_ * 116413311;
			...
			if (i_3_ > 0) {
				...
				for (int i_4_ = 0; i_4_ < i_3_; i_4_++) {
					...
					while (i_5_-- > 0) {
						...
						int i_7_ = class298_sub53.readUnsignedInt();
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aiz.f(").append(')').toString());
		}
	}

	public ClientScript(Packet class298_sub53) {
		int i = method3473(class298_sub53, 1653647818);
		int i_8_ = 0;
		Class394[] class394s = ScriptContext.method3534((byte) -29);
		while (385051775 * class298_sub53.pos < i) {
	...
	Class394 method3474(Packet class298_sub53, Class394[] class394s, byte i) {
		try {
			...
			return null;
			// throw ErrorContext.info(runtimeexception, new
		...
		try {
			...
			if (class394 == Class394.aClass394_4925) {
				...
				if (class394.aBoolean5188)
					anIntArray9676[i] = class298_sub53.readUnsignedInt();
				else
