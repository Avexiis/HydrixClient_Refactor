...
public class ClientScriptsExecutor {
	...
	static void method4690(ClientScript class298_sub37_sub17, int i, ClientScript2 class403, int i_0_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("px.s(").append(')').toString());
		}
	}

	static final void method4691(ClientScript2 class403, byte i) {
		try {
			((ClientScript2) class403).anObjectArray5240[((((ClientScript2) class403).anInt5241 += 969361751) * -203050393 - 1)] = ((Player) ((ClientScript2) class403).aClass365_Sub1_Sub1_Sub2_5242).getFullName(true, -1660599936);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("px.aom(").append(')').toString());
		}
	}
	...
	static boolean method4692(CharSequence charsequence, int i, boolean bool, int i_2_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("px.p(").append(')').toString());
		}
	}
	...
	static void method4693(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("px.o(").append(')').toString());
		}
	}
	...
	static final void method4694(ClientScript2 class403, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("px.wp(").append(')').toString());
		}
	}
}
