...
public class FileFilter_Sub1 extends FileFilter {
	...
	public boolean accept(File file) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aeo.accept(").append(')').toString());
		}
	}
	...
	public String getDescription() {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aeo.getDescription(").append(')').toString());
		}
	}
