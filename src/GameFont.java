...
public class GameFont {
	...
	public int method6254(String string, Interface28[] interface28s, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("uw.d(").append(')').toString());
		}
	}
	...
	public String method6256(String string, int i, Interface28[] interface28s, byte i_9_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("uw.u(").append(')').toString());
		}
	}
	...
	public int method6257(String string, int[] is, String[] strings, Interface28[] interface28s, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("uw.x(").append(')').toString());
		}
	}
	...
	int method6258(String string, int[] is, String[] strings, Interface28[] interface28s, boolean bool, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("uw.r(").append(')').toString());
		}
	}
	...
	public int method6259(String string, int i, Interface28[] interface28s, int i_34_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("uw.q(").append(')').toString());
		}
	}
	...
	public int method6261(String string, int i, int i_57_, int i_58_, int i_59_, Interface28[] interface28s, byte i_60_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("uw.y(").append(')').toString());
		}
	}
	...
	public int method6262(String string, int i, Interface28[] interface28s, int i_67_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("uw.n(").append(')').toString());
		}
	}
	...
	public Point method6263(String string, int i, int i_68_, int i_69_, Interface28[] interface28s, int i_70_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("uw.z(").append(')').toString());
		}
	}
	...
	public int method6264(String string, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("uw.k(").append(')').toString());
		}
	}
	...
	public static int method6265(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("uw.b(").append(')').toString());
		}
	}
	...
	static final void method6266(ClientScript2 class403, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("uw.hm(").append(')').toString());
		}
	}

	public static void method6267(Node node, Node node_85_, byte i) {
		try {
			if (node.aNode_3189 != null)
				node.unlink(-1460969981);
			node.aNode_3189 = node_85_.aNode_3189;
			node.aNode_3187 = node_85_;
	...
	static final void method6268(ClientScript2 class403, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("uw.aft(").append(')').toString());
		}
	}
}
