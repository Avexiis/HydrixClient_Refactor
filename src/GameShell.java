...
public abstract class GameShell implements Interface14, Runnable, FocusListener, WindowListener {
	...
	final void method2751(Class311 class311, String string, String string_0_, int i, int i_1_, int i_2_, int i_3_,
	...
	final void method2752(String string, String string_5_, int i, int i_6_, int i_7_, int i_8_, byte i_9_)
		...
		try {
			...
			Js5ConfigGroup.aString1462 = "1.1";
			try {
				BASType.aString3759 = System.getProperty("java.vendor");
				Js5ConfigGroup.aString1462 = "";
				/* JRE 10 Support */
				if(System.getProperty("java.version").equalsIgnoreCase("10"))
				{
					Js5ConfigGroup.aString1462 = "1.8.0_91";
				}
				else
				{
					Js5ConfigGroup.aString1462 = System.getProperty("java.version");
				}
			...
			try {
				...
				if (Class83.aString765 != null)
					Class83.aString765 = Class83.aString765 + "/";
			} catch (Exception exception) {
				/* empty */
			}
			try {
	...
	boolean method2753(File file, boolean bool, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, "mc.k(" + ')');
		}
	}
	...
	public boolean method2754(File file, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, "mc.p(" + ')');
		}
	}
	...
	void method2755(File file, File file_18_, int i) {
		try {
			try {
				DiskFile class476 = new DiskFile(Class180.aFile6528, "rw", 10000L);
				Packet class298_sub53 = new Packet(500);
			...
			throw ErrorContext.info(runtimeexception, "mc.i(" + ')');
		}
	}
	...
	synchronized void method2756(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, "mc.y(" + ')');
		}
	}
	...
	void method2757(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, "mc.v(" + ')');
		}
	}

	final boolean validHost(int i) {
		try {
			String string = EnumType.mainApplet.getDocumentBase().getHost().toLowerCase();
	...
	public void run() {
		try {
			...
			throw ErrorContext.info(runtimeexception, "mc.run(" + ')');
		}
	}
	...
	void method2759(byte i) {
		try {
				...
				if (string.indexOf("sun") != -1 || string.indexOf("apple") != -1) {
					...
					if (string_19_.startsWith("1.6.0_")) {
						...
						for (i_20_ = 6; (i_20_ < string_19_.length()
								&& Class431.method5764(string_19_.charAt(i_20_), -1385964882)); i_20_++) {
							/* empty */
						}
			...
			throw ErrorContext.info(runtimeexception, "mc.e(" + ')');
		}
	}
	...
	void method2760(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, "mc.w(" + ')');
		}
	}
	...
	String method2761(byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, "mc.j(" + ')');
		}
	}
	...
	public void method192() {
		try {
			...
			throw ErrorContext.info(runtimeexception, "mc.stop(" + ')');
		}
	}
	...
	public final synchronized void method195(Graphics graphics) {
		try {
			...
			throw ErrorContext.info(runtimeexception, "mc.paint(" + ')');
		}
	}
	...
	public void start() {
		try {
			...
			throw ErrorContext.info(runtimeexception, "mc.start(" + ')');
		}
	}
	...
	void method2764(byte i) {
		try {
			...
			synchronized (this) {
				SceneryShadowPreference.aBoolean8385 = aBoolean6481;
			}
			method2773((byte) 17);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, "mc.m(" + ')');
		}
	}
	...
	public boolean method2766(int i) {
		try {
			((GameShell) this).aBoolean6501 = Class85.method955(-1461998657).method265("jaclib", 888400764);
			if (((GameShell) this).aBoolean6501) {
				try {
			...
			return ((GameShell) this).aBoolean6501;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, "mc.ai(" + ')');
		}
	}
	...
	public boolean method2767(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, "mc.al(" + ')');
		}
	}
	...
	final void method2776(boolean bool, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, "mc.o(" + ')');
		}
	}
	...
	void method2777(Container container, int i) {
		try {
			...
			Class52_Sub2_Sub1.aCanvas9079.setSize(-2110394505 * Class462.canvasWidth,
					-1111710645 * Class298_Sub40_Sub9.anInt9716);
			Class52_Sub2_Sub1.aCanvas9079.setVisible(true);
			if (container == Class298_Sub36.aFrame7403) {
				Insets insets = Class298_Sub36.aFrame7403.getInsets();
				Class52_Sub2_Sub1.aCanvas9079.setLocation(insets.left + 1898544019 * anInt6473,
			...
			aBoolean6471 = true;
			aBoolean6478 = false;
			aLong6491 = TimeUtils.getTime((byte) 1) * -4845717340640327541L;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, "mc.h(" + ')');
		}
	}
		...
		try {
			...
			if (Class180.aFile6528.exists()) {
				try {
					DiskFile class476 = new DiskFile(Class180.aFile6528, "rw", 10000L);
					int i_32_;
					Packet class298_sub53;
					for (class298_sub53 = (new Packet((int) class476.method6080(-840924897))); (class298_sub53.pos
							* 385051775 < class298_sub53.payload.length); class298_sub53.pos += i_32_ * 116413311) {
						i_32_ = (class476.method6081(class298_sub53.payload, class298_sub53.pos * 385051775,
								(class298_sub53.payload.length - class298_sub53.pos * 385051775), (short) -10746));
						if (i_32_ == -1)
	...
	static final void method2787(IComponentDefinition class105, RSInterface RSInterface, ClientScript2 class403, int i) {
		try {
			class105.anInt1178 = (((ClientScript2) class403).anIntArray5244[(((ClientScript2) class403).anInt5239 -= -391880689)
	...
	static final void method2790(ClientScript2 class403, int i) {
		try {
			((ClientScript2) class403).anIntArray5244[((ClientScript2) class403).anInt5239 * 681479919
					- 1] = (((ClientScript2) class403).aClass162_5252.method1756(
	...
	static void method2791(int i, String string, String string_44_, int i_45_) {
		try {
			if (null != GameClient.gameConnection) {
				Class298_Sub36 class298_sub36 = Class18.method359(OutgoingPacket.aClass198_2088,
						GameClient.gameConnection.aClass449_330, (byte) 94);
				class298_sub36.buffer.writeShort(
						(1 + Js5ConfigGroup.method1310(string, (byte) -1) + Js5ConfigGroup.method1310(string_44_, (byte) -1)),
						16711935);
				class298_sub36.buffer.putJagString(string_44_, (short) -29506);
				class298_sub36.buffer.write128Byte(i, (byte) 1);
				class298_sub36.buffer.putJagString(string, (short) 12393);
