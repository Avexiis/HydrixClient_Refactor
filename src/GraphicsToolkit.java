...
public abstract class GraphicsToolkit {
	...
	public abstract EnvironmentMap method4986(EnvironmentMap environmentMap, EnvironmentMap environmentMap_0_, float f, EnvironmentMap environmentMap_1_);
	...
	public final void method4988(byte i) throws Exception_Sub1 {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ra.u(").append(')').toString());
		}
	}
	...
	public final void method4990(int i, int i_3_, int i_4_, int i_5_, int i_6_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ra.bd(").append(')').toString());
		}
	}
	...
	public final Class52 method4992(short i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ra.at(").append(')').toString());
		}
	}

	public abstract void animate_texture(int i);
	...
	public void method5000(int[] is) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ra.av(").append(')').toString());
		}
	}
	...
	public final void method5002(Canvas canvas, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ra.az(").append(')').toString());
		}
	}
	...
	public final void method5003(Canvas canvas, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ra.as(").append(')').toString());
		}
	}
	...
	public final void method5005(Class52_Sub1 class52_sub1, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ra.aw(").append(')').toString());
		}
	}
	...
	public abstract Matrix43f method5008();
	...
	public abstract Matrix43f method5013();
	...
	public final void method5014(int i, int i_50_, int i_51_, int i_52_, int i_53_, int i_54_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ra.ar(").append(')').toString());
		}
	}

	public final void method5015(int i, int i_55_, int i_56_, int i_57_, int i_58_, byte i_59_) {
		try {
			drawFilledBox(i, i_55_, i_56_, i_57_, i_58_, 1);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ra.ac(").append(')').toString());
		}
	}
	...
	public final void method5016(int i, int i_60_, int i_61_, int i_62_, int i_63_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ra.am(").append(')').toString());
		}
	}
	...
	public final void method5018(int i, int i_65_, int i_66_, int i_67_, int i_68_, int i_69_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ra.be(").append(')').toString());
		}
	}
	...
	public abstract EnvironmentMap createEnvironmentMap(int i, int i_113_, int i_114_, int i_115_, int i_116_, int i_117_);
	...
	public Class57 method5031(int[] is, int i, int i_123_, int i_124_, int i_125_, int i_126_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ra.bp(").append(')').toString());
		}
	}
	...
	public final void method5035(int i, int i_132_, int i_133_, int i_134_, short i_135_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ra.bf(").append(')').toString());
		}
	}
	...
	public abstract ModelPart method5037(Model class64, int i, int i_136_, int i_137_, int i_138_);
	...
	public abstract Ground method5040(int i, int i_155_, int[][] is, int[][] is_156_, int i_157_, int i_158_, int i_159_);

	public boolean method5041(int i) {
		try {
			return true;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ra.cx(").append(')').toString());
		}
	}

	public abstract void method5042(Class69 class69);

	public abstract void method5043(Matrix43f class222);
	...
	public Class57 method5046(int i, int i_165_, boolean bool, int i_166_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ra.bq(").append(')').toString());
		}
	}
	...
	public Class298_Sub10 method5049(int i, int i_169_, int i_170_, int i_171_, int i_172_, float f) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ra.cg(").append(')').toString());
		}
	}
	...
	public abstract Ground method5087(int i, int i_196_, int[][] is, int[][] is_197_, int i_198_, int i_199_, int i_200_);
	...
	public abstract void method5095(EnvironmentMap environmentMap);
	...
	public abstract ModelPart method5116(Model class64, int i, int i_328_, int i_329_, int i_330_);
	...
	public abstract Ground method5121(int i, int i_334_, int[][] is, int[][] is_335_, int i_336_, int i_337_, int i_338_);

	public abstract Ground method5122(int i, int i_339_, int[][] is, int[][] is_340_, int i_341_, int i_342_, int i_343_);

	public abstract Ground method5123(int i, int i_344_, int[][] is, int[][] is_345_, int i_346_, int i_347_, int i_348_);
	...
	public abstract void drawFilledBox(int i, int i_350_, int i_351_, int i_352_, int i_353_, int i_354_);
	...
	public abstract void method5129(Matrix43f class222);

	public abstract void method5130(Matrix43f class222);

	public abstract void method5131(Matrix43f class222);

	public abstract void method5132(Matrix43f class222);
	...
	public void dispose(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ra.y(").append(')').toString());
		}
	}
	...
	public abstract EnvironmentMap method5142(EnvironmentMap environmentMap, EnvironmentMap environmentMap_389_, float f, EnvironmentMap environmentMap_390_);
	...
	public final void method5143(Class52_Sub1 class52_sub1, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ra.af(").append(')').toString());
		}
	}
	...
	final Class52_Sub2 method5147(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ra.ah(").append(')').toString());
		}
	}
	...
	final void method5151(Canvas canvas, Class52_Sub2 class52_sub2, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ra.al(").append(')').toString());
		}
	}
	...
	public void method5152(float f, float f_396_, float f_397_, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ra.ce(").append(')').toString());
		}
	}
	...
	public final void method5163(Canvas canvas, int i, int i_427_, int i_428_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ra.ai(").append(')').toString());
		}
	}
	...
	public abstract Matrix43f method5171();
	...
	public final void method5173(Canvas canvas, int i, int i_445_, byte i_446_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ra.ap(").append(')').toString());
		}
	}
	...
	public abstract Matrix43f method5178();

	public abstract EnvironmentMap method5179(EnvironmentMap environmentMap, EnvironmentMap environmentMap_447_, float f, EnvironmentMap environmentMap_448_);
	...
	public abstract Matrix43f method5183();
	...
	protected void finalize() {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ra.finalize(").append(')').toString());
		}
	}
	...
	public abstract void method5189(EnvironmentMap environmentMap);
	...
	static void method5191(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ra.f(").append(')').toString());
		}
	}
	...
	static final void method5193(ClientScript2 class403, byte i) {
		try {
			...
			RSInterface RSInterface = SpotAnimTypeList.aRSInterfaceArray4165[i_493_ >> 16];
			FluType.method5887(class105, RSInterface, class403, -2057554129);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ra.kw(").append(')').toString());
		}
	}
	...
	static long method5194(CharSequence charsequence, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ra.a(").append(')').toString());
		}
	}
	...
	static void method5195(GraphicsToolkit class_ra, IComponentDefinition class105, int i, int i_496_, byte i_497_) {
		try {
			...
			if (null != class117) {
				...
				class_ra.r(i, i_496_, -2093041337 * class105.width + i, 457937409 * class105.height + i_496_);
				if ((-2093041337 * class105.width != class117.anInt1393 * 1633695381) || (-60174999 * class117.anInt1394 != 457937409 * class105.height))
					throw new IllegalStateException("");
				if (2 != -64305285 * Class3.anInt56 && 5 != Class3.anInt56 * -64305285 && null != Class384.aClass57_4127) {
					...
					if (2 == ObjectDeque.anInt7164 * -863531439) {
						...
						i_498_ = (int) sceneObjectPosition.x;
						i_499_ = (int) sceneObjectPosition.z;
					...
					for (int i_509_ = 0; i_509_ < 1659101557 * Class3.anInt67; i_509_++) {
						...
						LocType class432 = (GameClient.map.method2641(2011176396).list(Class3.anIntArray60[i_509_]));
					...
					for (Class298_Sub2 class298_sub2 = ((Class298_Sub2) GameClient.groundTiles.method5816(1742338274)); class298_sub2 != null; class298_sub2 = ((Class298_Sub2) GameClient.groundTiles.method5815((byte) 24))) {
						int i_512_ = (int) ((class298_sub2.aLong3188 * 7051297995265073167L) >> 28 & 0x3L);
						if (i_512_ == Class3.anInt57 * -1694437021) {
							int i_513_ = ((int) ((class298_sub2.aLong3188 * 7051297995265073167L) & 0x3fffL) - -1760580017 * worldTile.x);
							int i_514_ = ((int) ((class298_sub2.aLong3188 * 7051297995265073167L) >> 14 & 0x3fffL) - worldTile.y * 283514611);
							int i_515_ = 2 + i_513_ * 4 - i_498_ / 128;
							int i_516_ = 2 + i_514_ * 4 - i_499_ / 128;
							FluType.method5883(class105, class_ta, i, i_496_, i_515_, i_516_, SubIncommingPacket.aClass57Array2349[0], (byte) 16);
						}
					}
					GroundDecorPreference.method5662(class_ra, i_498_, i_499_, class105, class_ta, i, i_496_, 826111295);
					ErrorContext.method4171(i_498_, i_499_, class105, class_ta, i, i_496_, 1913514572);
					...
					if (2 != ObjectDeque.anInt7164 * -863531439) {
						if (Class3.anInt62 * 2076926079 != 0) {
							...
							FluType.method5883(class105, class_ta, i, i_496_, i_517_, i_518_, (Class234.aClass57Array2598[Class3.aBoolean63 ? 1 : 0]), (byte) 23);
						}
						if (!Class287.myPlayer.hidden)
							class_ra.method5015(i + (-2093041337 * class105.width / 2) - 1, (457937409 * class105.height / 2) + i_496_ - 1, 3, 3, -1, (byte) 7);
					}
				} else
					class_ra.DA(-16777216, class_ta, i, i_496_);
			}
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ra.r(").append(')').toString());
		}
	}
}
