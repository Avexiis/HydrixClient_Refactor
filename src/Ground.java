...
public abstract class Ground {
	...
	public final int method6340(int i, int i_44_, int i_45_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("xa.i(").append(')').toString());
		}
	}
	...
	public final int method6341(int i, int i_52_, byte i_53_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("xa.k(").append(')').toString());
		}
	}
	...
	Ground(int i, int i_61_, int i_62_, int[][] is) {
	...
	static final void method6360(ClientScript2 class403, int i) {
		try {
			...
			RSInterface RSInterface = SpotAnimTypeList.aRSInterfaceArray4165[i_166_ >> 16];
			Class22.method373(class105, RSInterface, class403, 327823219);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("xa.ja(").append(')').toString());
		}
	}
	...
	static final void method6361(ClientScript2 class403, byte i) {
		try {
			...
			RSInterface RSInterface = SpotAnimTypeList.aRSInterfaceArray4165[i_167_ >> 16];
			Class125.method1397(class105, RSInterface, class403, 1549580200);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("xa.nu(").append(')').toString());
		}
	}
	...
	static final void method6362(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("xa.zr(").append(')').toString());
		}
	}
	...
	static final void method6364(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("xa.akr(").append(')').toString());
		}
	}
}
