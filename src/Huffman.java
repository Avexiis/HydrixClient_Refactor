...
public class Huffman {
	...
	public Huffman(byte[] is) {
		int i = is.length;
		((Huffman) this).anIntArray1370 = new int[i];
		((Huffman) this).aByteArray1371 = is;
		int[] is_0_ = new int[33];
		((Huffman) this).anIntArray1372 = new int[8];
		int i_1_ = 0;
		for (int i_2_ = 0; i_2_ < i; i_2_++) {
			...
			if (0 != i_3_) {
				int i_4_ = 1 << 32 - i_3_;
				int i_5_ = is_0_[i_3_];
				((Huffman) this).anIntArray1370[i_2_] = i_5_;
				int i_6_;
				if ((i_5_ & i_4_) != 0)
					i_6_ = is_0_[i_3_ - 1];
				else {
				...
				for (int i_12_ = 0; i_12_ < i_3_; i_12_++) {
					...
					if ((i_5_ & i_13_) != 0) {
						if (((Huffman) this).anIntArray1372[i_11_] == 0)
							((Huffman) this).anIntArray1372[i_11_] = i_1_;
						i_11_ = ((Huffman) this).anIntArray1372[i_11_];
					} else
						i_11_++;
					if (i_11_ >= ((Huffman) this).anIntArray1372.length) {
						int[] is_14_ = (new int[2 * ((Huffman) this).anIntArray1372.length]);
						for (int i_15_ = 0; i_15_ < ((Huffman) this).anIntArray1372.length; i_15_++)
							is_14_[i_15_] = ((Huffman) this).anIntArray1372[i_15_];
						((Huffman) this).anIntArray1372 = is_14_;
					}
					i_13_ >>>= 1;
				}
				((Huffman) this).anIntArray1372[i_11_] = i_2_ ^ 0xffffffff;
				if (i_11_ >= i_1_)
					i_1_ = 1 + i_11_;
			}
		}
	...
	int method1245(byte[] is, int i, byte[] is_16_, int i_17_, int i_18_, int i_19_) {
		try {
			...
			for (;;) {
				byte i_22_ = is[i_21_];
				if (i_22_ < 0)
					i_20_ = ((Huffman) this).anIntArray1372[i_20_];
				else
					i_20_++;
				int i_23_;
				if ((i_23_ = ((Huffman) this).anIntArray1372[i_20_]) < 0) {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ep.f(").append(')').toString());
		}
	}
	...
	int method1246(byte[] is, int i, int i_24_, byte[] is_25_, int i_26_, byte i_27_) {
		try {
			...
			for (i_24_ += i; i < i_24_; i++) {
				int i_30_ = is[i] & 0xff;
				int i_31_ = ((Huffman) this).anIntArray1370[i_30_];
				int i_32_ = ((Huffman) this).aByteArray1371[i_30_];
				if (0 == i_32_)
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ep.a(").append(')').toString());
		}
	}

	public static final void method1247(int i) {
		try {
			GameShell.aClass309_6492.method3788(841920910);
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ep.ax(").append(')').toString());
		}
	}
	...
	static final void method1248(ClientScript2 class403, byte i) {
		try {
			...
			Class298_Sub33.method3396(class105, RSInterface, class403, -1171777109);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ep.eo(").append(')').toString());
		}
	}
	...
	static final void method1249(ClientScript2 class403, int i) {
		try {
			...
			RSInterface RSInterface = SpotAnimTypeList.aRSInterfaceArray4165[i_39_ >> 16];
			Class356.method4270(class105, RSInterface, class403, 268393846);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ep.ll(").append(')').toString());
		}
	}
	...
	static final void method1250(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ep.re(").append(')').toString());
		}
	}
	...
	static final void method1251(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ep.wh(").append(')').toString());
		}
	}
	...
	static byte method1253(int i, int i_42_, int i_43_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ep.by(").append(')').toString());
		}
	}

	public static final Interface method1254(int parentHash, Interface class298_sub51, int[] is, boolean bool, int i_44_) {
		try {
			Interface class298_sub51_45_ = (Interface) GameClient.aClass437_8841.get((long) parentHash);
			...
			if (null != GameClient.aClass105_8652) {
				LocalizedString.markComponentForRedraw(GameClient.aClass105_8652, 961005010);
				GameClient.aClass105_8652 = null;
			}
			Class247.method2376(-662741241);
			if (null != class105)
				Class65.method761((SpotAnimTypeList.aRSInterfaceArray4165[class105.interfacehash * -440872681 >>> 16]), class105, !bool, 112223880);
			if (!bool)
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ep.ld(").append(')').toString());
		}
	}
