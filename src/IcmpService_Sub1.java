...
public class IcmpService_Sub1 extends IcmpService {
	...
	protected void notify(int i, int i_0_, int i_1_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("adv.notify(").append(')').toString());
		}
	}
	...
	public static byte[][][] method6381(int i, int i_6_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("adv.f(").append(')').toString());
		}
	}
