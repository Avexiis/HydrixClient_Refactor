...
public class InputStream_Sub1 extends InputStream {
	public int read() {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aey.read(").append(')').toString());
		}
	}
	...
	public static void method273(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("aey.b(").append(')').toString());
		}
	}
}
