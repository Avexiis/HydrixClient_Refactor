/* IntegerPreferenceField - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

public abstract class IntegerPreferenceField {
	protected GamePreferences aGamePreferences_5346;
	...
	void method5613(int i, int i_1_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("rm.b(").append(')').toString());
		}
	}
	...
	IntegerPreferenceField(GamePreferences gamePreferences) {
		aGamePreferences_5346 = gamePreferences;
		anInt5350 = method5611(-1613011239) * 1886334997;
	}

	IntegerPreferenceField(int i, GamePreferences gamePreferences) {
	...
	public static void method5617(byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("rm.w(").append(')').toString());
		}
	}
	...
	static final void method5618(ClientScript2 class403, int i) {
		try {
			...
			GameClient.map.method2667(382492199);
			Class3.writePreferences();
			GameClient.aBoolean8666 = false;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("rm.amc(").append(')').toString());
		}
	}
	...
	static int method5619(CharSequence charsequence, int i, boolean bool, int i_4_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("rm.d(").append(')').toString());
		}
	}
	...
	static void method5620(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("rm.v(").append(')').toString());
		}
	}
	...
	static final boolean method5621(char c, int i) {
		try {
			if (Character.isISOControl(c))
				return false;
			if (LocType.method5788(c, (short) 160))
				return true;
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("rm.f(").append(')').toString());
		}
	}
	...
	static final void method5622(ClientScript2 class403, short i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("rm.ags(").append(')').toString());
		}
	}
	...
	public static void method5623(int i, int i_16_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("rm.u(").append(')').toString());
		}
	}
}
