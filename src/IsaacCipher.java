...
public final class IsaacCipher {
	...
	public final int method5914(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("sn.a(").append(')').toString());
		}
	}
	...
	final void method5915(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("sn.p(").append(')').toString());
		}
	}
	...
	public final int method5916(byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("sn.f(").append(')').toString());
		}
	}
	...
	final void method5917(byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("sn.b(").append(')').toString());
		}
	}
	...
	static final void method5918(ClientScript2 class403, int i) {
		try {
			...
			Skybox.method2594(class105, RSInterface, class403, 304191670);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("sn.df(").append(')').toString());
		}
	}
	...
	static Class52_Sub2_Sub1 method5919(Class_ra_Sub1 class_ra_sub1, Canvas canvas, int i, int i_14_, int i_15_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("sn.n(").append(')').toString());
		}
	}
	...
	static void method5920(int i) {
		try {
			try {
				...
				if (file.exists())
					GameShell.aClass484_6499 = new Class484(new DiskFile(file, "rw", 25L), 24, 0);
				else {
					while_104_: for (int i_16_ = 0; i_16_ < MagnetConfig.aStringArray679.length; i_16_++) {
						for (int i_17_ = 0; i_17_ < Class216.aStringArray6657.length; i_17_++) {
							...
							if (file_18_.exists()) {
								GameShell.aClass484_6499 = new Class484(new DiskFile(file_18_, "rw", 25L), 24, 0);
								break while_104_;
							}
						}
					}
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("sn.x(").append(')').toString());
		}
	}
}
