...
public class ItemDefinitions {
	...
	void method6025(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("th.a(").append(')').toString());
		}
	}

	void decode(Packet class298_sub53, boolean oldItems) {
		try {
			for (;;) {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("th.f(").append(')').toString());
		}
	}
	...
	void method6027(ItemDefinitions class468_1_, ItemDefinitions class468_2_, int i) {
		try {
			...
			itemName = class468_2_.itemName;
			aBoolean5731 = class468_2_.aBoolean5731;
			anInt5721 = class468_2_.anInt5721 * 1;
			anInt5704 = 126481113;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("th.p(").append(')').toString());
		}
	}
	...
	public final Model method6028(boolean bool, Class464 class464, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("th.z(").append(')').toString());
		}
	}

	public final ModelPart method6029(GraphicsToolkit class_ra, int i, int i_10_, Class366 class366, Animator animator, int i_11_, int i_12_, int i_13_, int i_14_, int i_15_) {
		try {
			if (null != ((ItemDefinitions) this).anIntArray5752 && i_10_ > 1) {
				...
				if (i_16_ != -1)
					return (((ItemDefinitions) this).aClass477_5751.getItemDefinitions(i_16_).method6029(class_ra, i, 1, class366, animator, i_11_, i_12_, i_13_, i_14_, 2041211835));
			}
			int i_18_ = i;
			if (null != animator)
				i_18_ |= animator.method5829(-1790708337);
			ModelPart modelPart;
			synchronized (((Class477) ((ItemDefinitions) this).aClass477_5751).aClass348_5994) {
				modelPart = ((ModelPart) (((Class477) ((ItemDefinitions) this).aClass477_5751).aClass348_5994.get((long) (1027112447 * ((ItemDefinitions) this).anInt5740 | class_ra.anInt5298 * 580915349 << 29))));
			}
			if (null == modelPart || class_ra.method5017(modelPart.m(), i_18_) != 0) {
				if (null != modelPart)
					i_18_ = class_ra.method5004(i_18_, modelPart.m());
				int i_19_ = i_18_;
				...
				if (class64.version < 13)
					class64.method755(2);
				modelPart = (class_ra.method5037(class64, i_19_, (((Class477) ((ItemDefinitions) this).aClass477_5751).anInt5991) * -424819635, 64 + 856370373 * ((ItemDefinitions) this).anInt5761, ((ItemDefinitions) this).anInt5762 * 1055603853 + 850));
				if (-1773084507 * ((ItemDefinitions) this).anInt5758 != 128 || 128 != ((ItemDefinitions) this).anInt5702 * 902366341 || 128 != -230848851 * ((ItemDefinitions) this).anInt5739)
					modelPart.oa(-1773084507 * ((ItemDefinitions) this).anInt5758, 902366341 * ((ItemDefinitions) this).anInt5702, ((ItemDefinitions) this).anInt5739 * -230848851);
				if (((ItemDefinitions) this).aShortArray5754 != null) {
					for (int i_20_ = 0; i_20_ < ((ItemDefinitions) this).aShortArray5754.length; i_20_++) {
						if (((ItemDefinitions) this).aByteArray5708 != null && i_20_ < ((ItemDefinitions) this).aByteArray5708.length)
							modelPart.X((((ItemDefinitions) this).aShortArray5754[i_20_]), aShortArray5757[(((ItemDefinitions) this).aByteArray5708[i_20_]) & 0xff]);
						else
							modelPart.X((((ItemDefinitions) this).aShortArray5754[i_20_]), (((ItemDefinitions) this).aShortArray5706[i_20_]));
					}
				}
				if (null != ((ItemDefinitions) this).aShortArray5711) {
					for (int i_21_ = 0; i_21_ < ((ItemDefinitions) this).aShortArray5711.length; i_21_++)
						modelPart.W(((ItemDefinitions) this).aShortArray5711[i_21_], ((ItemDefinitions) this).aShortArray5712[i_21_]);
				}
				if (null != class366) {
					for (int i_22_ = 0; i_22_ < 10; i_22_++) {
						for (int i_23_ = 0; (i_23_ < Class366.aShortArrayArray3970[i_22_].length); i_23_++) {
							if (class366.anIntArray3973[i_22_] < (Class22.aShortArrayArrayArray278[i_22_][i_23_]).length)
								modelPart.X((Class366.aShortArrayArray3970[i_22_][i_23_]), (Class22.aShortArrayArrayArray278[i_22_][i_23_][class366.anIntArray3973[i_22_]]));
						}
					}
				}
				modelPart.KA(i_18_);
				synchronized (((Class477) ((ItemDefinitions) this).aClass477_5751).aClass348_5994) {
					((Class477) ((ItemDefinitions) this).aClass477_5751).aClass348_5994.put(modelPart, (long) (((ItemDefinitions) this).anInt5740 * 1027112447 | class_ra.anInt5298 * 580915349 << 29));
				}
			}
			if (null != animator || 0 != i_14_) {
				modelPart = modelPart.method4755((byte) 1, i_18_, true);
				if (null != animator)
					animator.method5839(modelPart, 0, -1330952412);
				if (0 != i_14_)
					modelPart.PA(i_11_, i_12_, i_13_, i_14_);
			}
			modelPart.KA(i);
			return modelPart;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("th.d(").append(')').toString());
		}
	}
	...
	public ItemDefinitions method6030(int i, int i_24_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("th.u(").append(')').toString());
		}
	}
	...
	int[] method6031(GraphicsToolkit class_ra, GraphicsToolkit class_ra_27_, int i, int i_28_, int i_29_, boolean bool, int i_30_, Class264 class264, Class366 class366, int i_31_) {
		...
		try {
			...
			ModelPart modelPart = class_ra.method5037(class64, i_36_, 64, (((ItemDefinitions) this).anInt5761 * 856370373 + 64), 768 + (((ItemDefinitions) this).anInt5762 * 1055603853));
			if (!modelPart.method4743())
				return null;
			if (bool_37_)
				modelPart.oa(-1773084507 * ((ItemDefinitions) this).anInt5758, 902366341 * ((ItemDefinitions) this).anInt5702, ((ItemDefinitions) this).anInt5739 * -230848851);
			...
			Matrix43f class222_40_ = class_ra.method5178(); // draws it seems
			...
			class222_40_.method2064((float) (252709809 * anInt5717 << 2), (float) ((((Class220.SINE[330519029 * anInt5714 << 3]) * i_38_) >> 14) - modelPart.YA() / 2 + (-1811316489 * anInt5718 << 2)), (float) ((((Class220.COSINE[330519029 * anInt5714 << 3]) * i_38_) >> 14) + (anInt5718 * -1811316489 << 2)));
			class222_40_.method2071(1.0F, 0.0F, 0.0F, Class220.method2049((anInt5714 * 330519029) << 3));
			class_ra.ba(2, 0);
			class_ra.L();
			class_ra.drawFilledBox(0, 0, 36, 32, 0, 0);
			modelPart.method4739(class222_40_, null, 1);
			...
			if (1 == i_30_ || 2 == i_30_ && (anInt5704 * 789409129 == 1 || 1 != i) && i != -1)
				class264.method2488(Class108.method1149(i, (((Class477) (((ItemDefinitions) this).aClass477_5751)).aLanguage_5997), -2134002342), 0, 9, -256, -16777215, 1072909030);
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("th.x(").append(')').toString());
		}
	}
	...
	int[] method6032(int[] is, int i, int i_42_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("th.r(").append(')').toString());
		}
	}
	...
	void method6033(int[] is, int i, int i_48_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("th.q(").append(')').toString());
		}
	}
	...
	public final boolean method6034(boolean bool, Class464 class464, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("th.s(").append(')').toString());
		}
	}
	...
	public final boolean method6035(boolean bool, Class464 class464, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("th.y(").append(')').toString());
		}
	}
	...
	void method6036(ItemDefinitions class468_59_, ItemDefinitions class468_60_, int i) {
		try {
			...
			itemName = class468_60_.itemName;
			...
			if (itemName.toLowerCase().contains("team"))
				teamIds = 1 * class468_60_.teamIds;
			else
				teamIds = 0;
			...
			aStringArray5732[4] = LocalizedString.ACTION_DISCARD_ALT.getText((((Class477) (((ItemDefinitions) this).aClass477_5751)).aLanguage_5997), -875414210);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("th.k(").append(')').toString());
		}
	}
	...
	public int method6037(int i, int i_62_, int i_63_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("th.h(").append(')').toString());
		}
	}
	...
	void method6038(Packet stream, int opcode, boolean oldItems) {
		try {
			if (1 == opcode)
				...
				anInt5721 = stream.readUnsignedInt() * -1375390745;
			else if (opcode == 13)
				...
				for (int i_70_ = 0; i_70_ < i_69_; i_70_++)
					((ItemDefinitions) this).aByteArray5708[i_70_] = stream.readByte();
			} else if (43 == opcode) {
				anInt5763 = stream.readUnsignedInt() * 682064309;
				aBoolean5771 = true;
			} else if (44 == opcode) {
				...
				((ItemDefinitions) this).anInt5761 = stream.readByte() * 712208909;
			else if (opcode == 114)
				((ItemDefinitions) this).anInt5762 = stream.readByte() * -1050247335;
			else if (115 == opcode)
				teamIds = stream.readUnsignedByte() * 1325490629;
			else if (121 == opcode)
				((ItemDefinitions) this).anInt5756 = stream.readUnsignedShort() * -970653687;
			else if (122 == opcode)
				anInt5719 = stream.readUnsignedShort() * 2015131539;
			else if (opcode == 125) {
				((ItemDefinitions) this).anInt5742 = ((stream.readByte() << 2) * -1833538443);
				((ItemDefinitions) this).anInt5744 = (stream.readByte() << 2) * -25983505;
				((ItemDefinitions) this).anInt5748 = (stream.readByte() << 2) * 1243416501;
			} else if (opcode == 126) {
				((ItemDefinitions) this).anInt5743 = ((stream.readByte() << 2) * -1039520547);
				((ItemDefinitions) this).anInt5745 = (stream.readByte() << 2) * 1803423949;
				((ItemDefinitions) this).anInt5710 = (stream.readByte() << 2) * 519268429;
			} else if (opcode == 127) {
				...
				for (int i_75_ = 0; i_75_ < i_73_; i_75_++) {// GameClient script
																// map
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("th.b(").append(')').toString());
		}
	}
	...
	void method6039(ItemDefinitions class468_77_, ItemDefinitions class468_78_, int i) {
		try {
			...
			itemName = class468_78_.itemName;
			...
			teamIds = 1 * class468_78_.teamIds;
			...
			aStringArray5732[4] = LocalizedString.ACTION_DISCARD.getText((((Class477) (((ItemDefinitions) this).aClass477_5751)).aLanguage_5997), -875414210);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("th.i(").append(')').toString());
		}
	}
	...
	public final Model method6040(boolean bool, Class464 class464, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("th.t(").append(')').toString());
		}
	}
	...
	public String method6041(int i, String string, short i_85_) {
		try {
			if (((ItemDefinitions) this).aClass437_5766 == null)
				return string;
			LinkableObject linkableObject = ((LinkableObject) ((ItemDefinitions) this).aClass437_5766.get((long) i));
			if (linkableObject == null)
				return string;
			return (String) linkableObject.anObject7366;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("th.v(").append(')').toString());
		}
	}
	...
	static final void method6042(int i, int i_86_, int i_87_) {
		try {
			...
			if (Class301_Sub1.anInt7632 * -1198160439 != -1 && -1 != -19739017 * Class301_Sub1.anInt7627) {
				...
				if (i_88_ < 2 || i_88_ > 2)
					i_88_ /= 8;
				int i_89_ = (Class301_Sub1.anInt7627 * -19739017 - VarClanSettings.anInt4090 * 1882038855);
				if (i_89_ < 2 || i_89_ > 2)
					i_89_ /= 8;
				Class82_Sub14.anInt6875 = ((i_88_ + Class82_Sub14.anInt6875 * 1196508279) * -2076584633);
				VarClanSettings.anInt4090 = (i_89_ + 1882038855 * VarClanSettings.anInt4090) * -435591305;
				if (i_88_ == 0 && i_89_ == 0) {
			...
			if (Class301_Sub1.aBoolean7628 && DiskFile.aLinkedNodeList_5986 != null) {
				for (Class298_Sub6 class298_sub6 = ((Class298_Sub6) DiskFile.aLinkedNodeList_5986.method5939(1766612795)); null != class298_sub6; class298_sub6 = (Class298_Sub6) DiskFile.aLinkedNodeList_5986.method5944(49146)) {
					WorldMapLabel worldMapLabel = (Class301_Sub1.aWorldMapLabelList_3251.method4116(-530122905 * (((Class298_Sub6) class298_sub6).aWorldMapArea_7206.mapAreaId), -1186797555));
					if (class298_sub6.method2862(i, i_86_, (byte) 19)) {
						if (worldMapLabel.click_options != null) {
							if (null != worldMapLabel.click_options[4])
								Class234.method2174(worldMapLabel.click_options[4], worldMapLabel.aString3789, -1, 1012, -1, (long) ((((Class298_Sub6) class298_sub6).aWorldMapArea_7206.mapAreaId) * -530122905), worldMapLabel.anInt3817 * -804513353, 0, true, false, (long) ((((Class298_Sub6) class298_sub6).aWorldMapArea_7206.mapAreaId) * -530122905), false, -1324353170);
							if (worldMapLabel.click_options[3] != null)
								Class234.method2174(worldMapLabel.click_options[3], worldMapLabel.aString3789, -1, 1011, -1, (long) (-530122905 * (((Class298_Sub6) class298_sub6).aWorldMapArea_7206.mapAreaId)), worldMapLabel.anInt3817 * -804513353, 0, true, false, (long) ((((Class298_Sub6) class298_sub6).aWorldMapArea_7206.mapAreaId) * -530122905), false, -1509752920);
							if (worldMapLabel.click_options[2] != null)
								Class234.method2174(worldMapLabel.click_options[2], worldMapLabel.aString3789, -1, 1010, -1, (long) ((((Class298_Sub6) class298_sub6).aWorldMapArea_7206.mapAreaId) * -530122905), worldMapLabel.anInt3817 * -804513353, 0, true, false, (long) (-530122905 * (((Class298_Sub6) class298_sub6).aWorldMapArea_7206.mapAreaId)), false, -1074248386);
							if (worldMapLabel.click_options[1] != null)
								Class234.method2174(worldMapLabel.click_options[1], worldMapLabel.aString3789, -1, 1009, -1, (long) (-530122905 * (((Class298_Sub6) class298_sub6).aWorldMapArea_7206.mapAreaId)), worldMapLabel.anInt3817 * -804513353, 0, true, false, (long) ((((Class298_Sub6) class298_sub6).aWorldMapArea_7206.mapAreaId) * -530122905), false, -1424985903);
							if (null != worldMapLabel.click_options[0])
								Class234.method2174(worldMapLabel.click_options[0], worldMapLabel.aString3789, -1, 1008, -1, (long) ((((Class298_Sub6) class298_sub6).aWorldMapArea_7206.mapAreaId) * -530122905), worldMapLabel.anInt3817 * -804513353, 0, true, false, (long) ((((Class298_Sub6) class298_sub6).aWorldMapArea_7206.mapAreaId) * -530122905), false, -2019134484);
						}
						if (!((Class298_Sub6) class298_sub6).aWorldMapArea_7206.aBoolean7611) {
							((Class298_Sub6) class298_sub6).aWorldMapArea_7206.aBoolean7611 = true;
							Class126.method1405(Class502.aClass502_6727, -530122905 * (((Class298_Sub6) class298_sub6).aWorldMapArea_7206.mapAreaId), worldMapLabel.anInt3817 * -804513353, 20917601);
						}
						if (((Class298_Sub6) class298_sub6).aWorldMapArea_7206.aBoolean7611)
							Class126.method1405(Class502.aClass502_6721, -530122905 * (((Class298_Sub6) class298_sub6).aWorldMapArea_7206.mapAreaId), worldMapLabel.anInt3817 * -804513353, -1586023399);
					} else if (((Class298_Sub6) class298_sub6).aWorldMapArea_7206.aBoolean7611) {
						((Class298_Sub6) class298_sub6).aWorldMapArea_7206.aBoolean7611 = false;
						Class126.method1405(Class502.aClass502_6718, (-530122905 * (((Class298_Sub6) class298_sub6).aWorldMapArea_7206.mapAreaId)), -804513353 * worldMapLabel.anInt3817, -1187185253);
					}
				}
			}
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("th.bz(").append(')').toString());
		}
	}
	...
	public static int method6043(int i, int i_90_, int i_91_) {
		try {
			...
			try {
				...
				class233.method2152((float) (dimension.width / 2), (float) (dimension.height / 2), 512.0F, 512.0F, (float) GameClient.map.method2634((byte) -121), (float) GameClient.map.method2635(1789119116), (float) dimension.width, (float) dimension.height);
				...
				ModelPart modelPart = OverlayType.activeToolkit.method5037(class64, 2048, 64, 64, 768);
				int i_93_ = 0;
				while_107_: for (int i_94_ = 0; i_94_ < 500; i_94_++) {
					...
					for (int i_95_ = 15; i_95_ >= 0; i_95_--) {
						for (int i_96_ = 0; i_96_ <= i_95_; i_96_++) {
							GameClient.aClass222_8968.method2062((float) (int) (512.0F * ((float) i_96_ - (float) i_95_ / 2.0F)), 0.0F, (float) ((1 + i_95_) * 512));
							modelPart.method4739(GameClient.aClass222_8968, null, 0);
							i_93_++;
							if (TimeUtils.getTime((byte) 1) - l >= (long) i_90_) {
								if (i_91_ >= 1017103058)
				...
				long l_97_ = ((long) (i_93_ * 1000) / (TimeUtils.getTime((byte) 1) - l));
				OverlayType.activeToolkit.ba(3, 0);
				i_92_ = (int) l_97_;
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("th.gt(").append(')').toString());
		}
	}
}
