...
public class JAGLib {
	...
	public static Class323 method2825(Component component, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("mf.a(").append(')').toString());
		}
	}
	...
	static final void method2826(ClientScript2 class403, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("mf.ala(").append(')').toString());
		}
	}
}
