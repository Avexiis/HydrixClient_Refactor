...
public class MapKeys {
	...
	static final void method2829(ClientScript2 class403, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("mi.acn(").append(')').toString());
		}
	}
	...
	public static long method2830(int i, int i_1_, int i_2_, int i_3_, int i_4_, int i_5_, byte i_6_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("mi.x(").append(')').toString());
		}
	}

	static final void method2831(ClientScript2 class403, int i) {
		try {
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = GraphicsAutoSetup.clientPreferences.characterShadowPreference.method5693(-919235605) == 1 ? 1 : 0;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("mi.ajl(").append(')').toString());
		}
	}
	...
	static final void method2832(ClientScript2 class403, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("mi.aw(").append(')').toString());
		}
	}
	...
	static final void method2833(ClientScript2 class403, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("mi.age(").append(')').toString());
		}
	}
	...
	static void method2834(int i, int i_8_, int i_9_, int i_10_, int i_11_, int i_12_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("mi.ah(").append(')').toString());
		}
	}
}
