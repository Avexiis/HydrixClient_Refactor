/* MaterialRaw - Decompiled by JODE
...
public class MaterialRaw {
	...
	static void method599(RSInterface RSInterface, IComponentDefinition class105, byte i) {
		try {
			if (null != class105) {
				if (-1 != -1309843523 * class105.component) {
					IComponentDefinition class105_0_ = (RSInterface.aClass105Array1405[class105.parentId * 1573706803 & 0xffff]);
					if (class105_0_ != null) {
						if (class105_0_.aClass105Array1293 == class105_0_.aClass105Array1292) {
							...
							Class425.method5737(class105_0_.aClass105Array1292, 0, class105_0_.aClass105Array1293, 1, (class105.component * -1309843523));
							Class425.method5737(class105_0_.aClass105Array1292, 1 + class105.component * -1309843523, class105_0_.aClass105Array1293, 1 + -1309843523 * class105.component, (class105_0_.aClass105Array1292.length - class105.component * -1309843523 - 1));
						} else {
							int i_1_ = 0;
					...
					IComponentDefinition[] class105s = RSInterface.method1296((byte) -3);
					int i_2_;
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("cc.t(").append(')').toString());
		}
	}
	...
	static final void method600(ClientScript2 class403, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("cc.tp(").append(')').toString());
		}
	}

	static final void method601(ClientScript2 class403, int i) {
		try {
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = GameClient.anInt8834 * 1396956439;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("cc.uz(").append(')').toString());
		}
	}

	static final void method602(int i) {
		try {
			LocalizedString.markComponentForRedraw(GameClient.aClass105_8850, -1659993558);
			...
			if (!GameClient.aBoolean8938 || !GameClient.aBoolean8855) {
				...
				int i_3_ = Class165.recorder.getMouseX((byte) -21);
				int i_4_ = Class165.recorder.getMouseY((byte) -35);
				...
				if (i_3_ + -2093041337 * GameClient.aClass105_8850.width > (GameClient.anInt8858 * -1221279965 + -343518257 * GameClient.anInt8856))
					i_3_ = (-343518257 * GameClient.anInt8856 + GameClient.anInt8858 * -1221279965 - -2093041337 * GameClient.aClass105_8850.width);
				if (i_4_ < 1325631359 * GameClient.anInt8800)
					i_4_ = 1325631359 * GameClient.anInt8800;
				if (457937409 * GameClient.aClass105_8850.height + i_4_ > (1325631359 * GameClient.anInt8800 + -609231901 * GameClient.anInt8966))
					i_4_ = (-609231901 * GameClient.anInt8966 + GameClient.anInt8800 * 1325631359 - 457937409 * GameClient.aClass105_8850.height);
				int i_5_;
				int i_6_;
				...
				if (!Class165.recorder.method3881((byte) 88)) {
					if (GameClient.aBoolean8863) {
						...
						if (GameClient.aClass105_8850.anObjectArray1137 != null) {
							...
							scriptContext.source = GameClient.aClass105_8850;
							scriptContext.mouseX = 622624491 * i_5_;
							scriptContext.mouseY = i_6_ * 335112545;
							scriptContext.aClass105_7529 = GameClient.aClass105_8854;
							scriptContext.arguments = GameClient.aClass105_8850.anObjectArray1137;
							ClientBuild.execute(scriptContext, (byte) 83);
						}
					...
					} else if ((2089115297 * GameClient.anInt8830 == 1 || Class58.method694(-1591809416)) && ContextMenu.actionCount * -278777595 > 2)
					...
					if (null != GameClient.aClass105_8850.anObjectArray1291 && GameClient.aBoolean8863) {
						...
						scriptContext.mouseX = 622624491 * i_5_;
						scriptContext.mouseY = i_6_ * 335112545;
						scriptContext.arguments = GameClient.aClass105_8850.anObjectArray1291;
						ClientBuild.execute(scriptContext, (byte) 72);
					}
				}
			}
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("cc.lm(").append(')').toString());
		}
	}
}
