...
public abstract class ModelPart {
	...
	void method4732(Ground ground, int i, int i_41_, int i_42_, int i_43_, int i_44_, int i_45_, int i_46_) {
		boolean bool = false;
		boolean bool_47_ = false;
		boolean bool_48_ = false;
		int i_49_ = -i_43_ / 2;
		int i_50_ = -i_44_ / 2;
		int i_51_ = ground.method6340(i + i_49_, i_42_ + i_50_, -1693901736);
		int i_52_ = i_43_ / 2;
		int i_53_ = -i_44_ / 2;
		int i_54_ = ground.method6340(i + i_52_, i_42_ + i_53_, -1350603421);
		int i_55_ = -i_43_ / 2;
		int i_56_ = i_44_ / 2;
		int i_57_ = ground.method6340(i + i_55_, i_42_ + i_56_, -2095633165);
		int i_58_ = i_43_ / 2;
		int i_59_ = i_44_ / 2;
		int i_60_ = ground.method6340(i + i_58_, i_42_ + i_59_, -2087321793);
	...
	public final void method4735(AnimFrameset class298_sub37_sub4, int i, AnimFrameset class298_sub37_sub4_70_, int i_71_, int i_72_, int i_73_, int i_74_, boolean bool) {
		if (i != -1) {
			method4733();
			if (!ea()) {
				method4734();
			} else {
				AnimFrame class96 = class298_sub37_sub4.frames[i];
				AnimBase class298_sub15 = class96.aClass298_Sub15_931;
				AnimFrame class96_75_ = null;
	...
	public abstract void pa(int i, int i_76_, Ground ground, Ground ground_77_, int i_78_, int i_79_, int i_80_);

	public final void method4736(AnimFrameset class298_sub37_sub4, int i, AnimFrameset class298_sub37_sub4_81_, int i_82_, int i_83_, int i_84_, AnimFrameset class298_sub37_sub4_85_, int i_86_, AnimFrameset class298_sub37_sub4_87_, int i_88_, int i_89_, int i_90_, boolean[] bools, boolean bool) {
		if (i != -1) {
			if (bools == null || i_86_ == -1) {
				...
				if (!ea()) {
					...
					AnimFrame class96_92_ = class298_sub37_sub4_85_.frames[i_86_];
					AnimFrame class96_93_ = null;
	...
	public final void method4737(AnimFrameset class298_sub37_sub4, int i) {
		if (i != -1) {
			method4733();
			if (!ea()) {
				method4734();
				...
				for (int i_94_ = 0; i_94_ < class96.anInt925; i_94_++) {
					...
					if (class298_sub15.shadowed[i_95_]) {
						if (class96.aShortArray937[i_94_] != -1) {
							w(0, 0, 0, 0);
						}
						w(class298_sub15.transforms[i_95_], class96.aShortArray934[i_94_], class96.aShortArray930[i_94_], class96.aShortArray936[i_94_]);
					}
				}
				ka();
				method4734();
	...
	public abstract void method4739(Matrix43f class222, Class302_Sub1 class302_sub1, int i);
	...
	public abstract void method4740(Matrix43f class222, Class302_Sub1 class302_sub1, int i);
	...
	public abstract void method4745(ModelPart modelPart_140_, int i, int i_141_, int i_142_, boolean bool);

	public abstract boolean method4746(int i, int i_143_, Matrix43f class222, boolean bool, int i_144_);

	public abstract void method4747(ModelPart modelPart_145_, int i, int i_146_, int i_147_, boolean bool);

	public abstract ModelPart method4748(byte i, int i_148_, boolean bool);

	public abstract boolean eg();

	public abstract ModelPart method4749(byte i, int i_149_, boolean bool);

	public abstract ModelPart method4750(byte i, int i_150_, boolean bool);
	...
	public abstract void method4751(Matrix43f class222);
	...
	public abstract ModelPart method4755(byte i, int i_153_, boolean bool);

	abstract void method4756();

	public abstract void bq(int i, int i_154_, int i_155_);

	public abstract void bg(int i, int i_156_, Ground ground, Ground ground_157_, int i_158_, int i_159_, int i_160_);

	public abstract void bs(int i, int i_161_, Ground ground, Ground ground_162_, int i_163_, int i_164_, int i_165_);

	public abstract void bp(int i, int i_166_, Ground ground, Ground ground_167_, int i_168_, int i_169_, int i_170_);
	...
	public abstract void method4759(Matrix43f class222, Class302_Sub1 class302_sub1, int i);
	...
	public abstract void method4762(Matrix43f class222, int i, boolean bool);

	public abstract void dx(int i);

	public abstract boolean method4763(int i, int i_187_, Matrix43f class222, boolean bool, int i_188_);
	...
	public final void method4765(AnimFrameset class298_sub37_sub4, int i, AnimFrameset class298_sub37_sub4_191_, int i_192_, int i_193_, int i_194_, int i_195_, int i_196_, boolean bool, int[] is) {
		if (i != -1) {
			method4733();
			if (!ea()) {
				method4734();
	...
	void animate(boolean osrs, int transform, int[] labels, int x, int y, int z, int i_201_, boolean bool,
			int i_202_, int[] is_203_) {
		final int mask = osrs ? 0xff : 0x3fff;
		if (i_201_ == 1) {
		...
		if (osrs) {
			animate_transform_osrs(transform, labels, x, y, z);
		} else if (i_202_ != 65535) {
			e(transform, labels, x, y, z, bool, i_202_, is_203_);
		} else {
			method4738(transform, labels, x, y, z, i_201_, bool);
		}
	}

	public abstract void animate_transform_osrs(int type, int[] labels, int x, int y, int z);

	void method4767(AnimBase currentBase, AnimFrame currentFrame, AnimFrame nextFrame, int i, int i_211_, int i_212_,
			boolean[] bools, boolean bool, boolean bool_213_, int submeshes, int[] is) {
		final boolean osrs = currentBase.osrs;
		if (nextFrame == null || i == 0) {
			for (int i_215_ = 0; i_215_ < currentFrame.anInt925; i_215_++) {
				short i_216_ = currentFrame.aShortArray933[i_215_];
				if (bools == null || bools[i_216_] == bool || currentBase.transforms[i_216_] == 0) {
					short i_217_ = currentFrame.aShortArray937[i_215_];
					if (i_217_ != -1) {
						animate(osrs, 0, currentBase.labels[i_217_], 0, 0, 0, i_212_, bool_213_,
								submeshes & currentBase.settings[i_217_], is);
					}
					animate(osrs, currentBase.transforms[i_216_], currentBase.labels[i_216_],
							currentFrame.aShortArray934[i_215_], currentFrame.aShortArray930[i_215_],
							currentFrame.aShortArray936[i_215_], i_212_, bool_213_,
							submeshes & currentBase.settings[i_216_], is);
				}
			}
		} else {
			int i_218_ = 0;
			int i_219_ = 0;
			for (int i_220_ = 0; i_220_ < currentBase.numTransforms * 92429039; i_220_++) {
				boolean bool_221_ = false;
				if (i_218_ < currentFrame.anInt925 && currentFrame.aShortArray933[i_218_] == i_220_) {
					bool_221_ = true;
				}
				boolean bool_222_ = false;
				if (i_219_ < nextFrame.anInt925 && nextFrame.aShortArray933[i_219_] == i_220_) {
					bool_222_ = true;
				}
				if (bool_221_ || bool_222_) {
					if (bools != null && bools[i_220_] != bool && currentBase.transforms[i_220_] != 0) {
						if (bool_221_) {
							i_218_++;
						}
						if (bool_222_) {
						...
						int i_223_ = 0;
						int i_224_ = currentBase.transforms[i_220_];
						...
						byte i_229_;
						if (bool_221_) {
							i_225_ = currentFrame.aShortArray934[i_218_];
							i_226_ = currentFrame.aShortArray930[i_218_];
							i_227_ = currentFrame.aShortArray936[i_218_];
							i_228_ = currentFrame.aShortArray937[i_218_];
							i_229_ = currentFrame.aByteArray938[i_218_];
							i_218_++;
						} else {
							i_225_ = i_223_;
							i_226_ = i_223_;
						...
						byte i_234_;
						if (bool_222_) {
							i_230_ = nextFrame.aShortArray934[i_219_];
							i_231_ = nextFrame.aShortArray930[i_219_];
							i_232_ = nextFrame.aShortArray936[i_219_];
							i_233_ = nextFrame.aShortArray937[i_219_];
							i_234_ = nextFrame.aByteArray938[i_219_];
							i_219_++;
						} else {
							i_230_ = i_223_;
							i_231_ = i_223_;
						...
						if (i_228_ != -1) {
							animate(osrs, 0, currentBase.labels[i_228_], 0, 0, 0, i_212_, bool_213_,
									submeshes & currentBase.settings[i_228_], is);
						} else if (i_233_ != -1) {
							animate(osrs, 0, currentBase.labels[i_233_], 0, 0, 0, i_212_, bool_213_,
									submeshes & currentBase.settings[i_233_], is);
						}
						animate(osrs, i_224_, currentBase.labels[i_220_], i_235_, i_236_, i_237_, i_212_, bool_213_,
								submeshes & currentBase.settings[i_220_], is);
					}
				}
			}
		}
	...
	public abstract ModelPart method4770(byte i, int i_244_, boolean bool);
	...
	public abstract void method4776(Matrix43f class222, int i, boolean bool);

	public abstract boolean method4777();

	public abstract boolean method4778();

	public abstract void method4779(ModelPart modelPart_256_, int i, int i_257_, int i_258_, boolean bool);
	...
	public abstract void method4782(Matrix43f class222);

	public abstract void method4783(Matrix43f class222);
	...
	Class76 method4785(Model class64, int[] is, int i) {
		...
		if (class64.facesTexture != null) {
			int i_279_ = class64.numTextures;
			...
			for (int i_287_ = 0; i_287_ < i; i_287_++) {
				...
				if (class64.facesTexture[i_288_] != -1) {
					int i_289_ = class64.facesTexture[i_288_] & 0xff;
					for (int i_290_ = 0; i_290_ < 3; i_290_++) {
						short i_291_;
						if (i_290_ == 0) {
							i_291_ = class64.facesA[i_288_];
						} else if (i_290_ == 1) {
							i_291_ = class64.facesB[i_288_];
						} else {
							i_291_ = class64.facesC[i_288_];
						}
						int i_292_ = class64.verticesX[i_291_];
						int i_293_ = class64.verticesY[i_291_];
						int i_294_ = class64.verticesZ[i_291_];
			...
			for (int i_295_ = 0; i_295_ < i_279_; i_295_++) {
				byte i_296_ = class64.texturesMappingType[i_295_];
				if (i_296_ > 0) {
					...
					float f_298_;
					if (i_296_ == 1) {
						int i_299_ = class64.textureScaleX[i_295_];
						if (i_299_ == 0) {
							f = 1.0F;
							f_298_ = 1.0F;
						} else if (i_299_ > 0) {
						...
						f_297_ = 64.0F / class64.textureScaleY[i_295_];
					} else if (i_296_ == 2) {
						f = 64.0F / class64.textureScaleX[i_295_];
						f_297_ = 64.0F / class64.textureScaleY[i_295_];
						f_298_ = 64.0F / class64.textureScaleZ[i_295_];
					} else {
						f = class64.textureScaleX[i_295_] / 1024.0F;
						f_297_ = class64.textureScaleY[i_295_] / 1024.0F;
						f_298_ = class64.textureScaleZ[i_295_] / 1024.0F;
					}
					fs[i_295_] = method4731(class64.texturesMappingP[i_295_], class64.texturesMappingM[i_295_], class64.texturesMappingN[i_295_], class64.textureRotation[i_295_] & 0xff, f, f_297_, f_298_);
				}
			}
		}
	...
	public abstract void method4786(Matrix43f class222);
