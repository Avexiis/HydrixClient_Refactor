		...
		try {
			...
			if (null == class25.INCOMMING_PACKET) {
				if (class25.aBoolean337) {
					...
					class318.readBytes(class25.aClass298_Sub53_Sub2_333.payload, 0, 1, (byte) 1);
				...
				if (stream.method3661((byte) -78)) {
					...
					class318.readBytes(class25.aClass298_Sub53_Sub2_333.payload, 1, 1, (byte) 4);
					class25.anInt341 += 655103753;
					class25.anInt338 = 0;
				}
				class25.aBoolean337 = true;
				IncomingPacket[] class202s = Class510.method6290(-1456212765);
				int i_78_ = stream.readUnsignedSmart();
				if (i_78_ < 0 || i_78_ >= class202s.length) {
					throw new IOException(new StringBuilder().append(i_78_).append(" ").append(385051775 * stream.pos).toString());
				}
				class25.INCOMMING_PACKET = class202s[i_78_];
				class25.anInt336 = class25.INCOMMING_PACKET.value * -80186869;
			}
			if (-1 == -866602563 * class25.anInt336) {
				if (!class318.isAvailable(1, (byte) -5)) {
					return false;
				}
				class318.readBytes(stream.payload, 0, 1, (byte) 48);
				class25.anInt336 = (stream.payload[0] & 0xff) * -1265692267;
				class25.anInt341 += 655103753;
				class25.anInt338 = 0;
			}
			if (-2 == -866602563 * class25.anInt336) {
				...
				class318.readBytes(stream.payload, 0, 2, (byte) -84);
				stream.pos = 0;
			...
			if (-866602563 * class25.anInt336 > 0) {
				...
				stream.pos = 0;
				class318.readBytes(stream.payload, 0, -866602563 * class25.anInt336, (byte) 117);
			...
			if (class25.INCOMMING_PACKET == IncomingPacket.aClass202_2162) {
			...
			//i believe this will fix your other packet that you trieed to add
			/*if (class25.INCOMMING_PACKET == IncomingPacket.NPC_ON_ICOMPONENT_PACKET) {//is this used ingame?
		        int modelId = stream.readUnsignedInt((byte) 40);
		        int interfaceHash = stream.readUnsignedInt((byte) -19);
		    ...
		    if (IncomingPacket.SET_ZOOM_DIS == ((Class25) class25).INCOMMING_PACKET) {
				...
				final int hash = (cId + (interfaceId << 16));
				final IComponentDefinition def = Class140.method1558(hash, -1, -156511736);
				def.zoomDistance = zoom;
		    ...
		    if (IncomingPacket.RICH_PRESENCE == ((Class25) class25).INCOMMING_PACKET) {
				...
				String smallImgtext = stream.readString();
				String largeImgkey = stream.readString();
		    ...
		    if (IncomingPacket.SPIN_MYSTERY_BOX == ((Class25) class25).INCOMMING_PACKET) {
				...
				final int interfaceId = 1945;
				int parentHash = stream.readUnsignedInt((byte) 0);
				//		Huffman.openInterface(parentHash, new Interface(interfaceId, 0), new int[4], false, -37609880);
			...
			if (class25.INCOMMING_PACKET == IncomingPacket.aClass202_2261) {
				...
				if (bool) {
					...
					class162 = VarClientString.aClass162_6216;
				}
			...
			if (IncomingPacket.MESSAGE_PACKET == class25.INCOMMING_PACKET) {
				int i_80_ = stream.readUnsignedSmart();
				int i_81_ = stream.readUnsignedInt();
				...
				if ((i_82_ & 0x1) != 0) {
					string = stream.gstr();
					if (0 != (i_82_ & 0x2)) {
						string_83_ = stream.gstr();
					} else {
						string_83_ = string;
					}
				}
				String string_84_ = stream.gstr();
				if (i_80_ == 99) {
			...
			if (class25.INCOMMING_PACKET == IncomingPacket.aClass202_2309) {
				GameClient.anInt8845 = stream.readShort(2135181158) * 2043410797;
				GameClient.anInt8888 = GameClient.anInt8933 * 1991119277;
				class25.INCOMMING_PACKET = null;
				return true;
			}
			if (class25.INCOMMING_PACKET == IncomingPacket.KEEP_ALIVE_PACKET) {
				class25.INCOMMING_PACKET = null;
				return false;
			}
			if (class25.INCOMMING_PACKET == IncomingPacket.MODEL_ON_ICOMPONENT_PACKET) {
			...
			if (IncomingPacket.aClass202_2277 == class25.INCOMMING_PACKET) {
				int interfaceHash = stream.readUnsignedInt();
				int i_88_ = stream.readUnsignedShort();
				int i_89_ = stream.readUnsignedInt();
				Class343.method4162(1819553678);
				SubIncommingPacket.method1924(interfaceHash, 3, i_88_, i_89_, 262144);
				class25.INCOMMING_PACKET = null;
				return true;
			}
			if (class25.INCOMMING_PACKET == IncomingPacket.aClass202_2209) {
				int i_90_ = stream.readUnsignedInt();
			...
			if (IncomingPacket.aClass202_2270 == class25.INCOMMING_PACKET) {
			...
			if (class25.INCOMMING_PACKET == IncomingPacket.aClass202_2204) {
				Class313.anObjectArray3298 = null;
				class25.INCOMMING_PACKET = null;
				return true;
			}
			if (class25.INCOMMING_PACKET == IncomingPacket.GRAPHICS_PACKET) {
				...
				if (targetHash >> 30 != 0) {
					...
					int i_102_ = (targetHash >> 14 & 0x3fff) - -1760580017 * worldTile.x;
					int i_103_ = (targetHash & 0x3fff) - 283514611 * worldTile.y;
					if (i_102_ >= 0 && i_103_ >= 0 && i_102_ < GameClient.map.upperX(-1990296889) && i_103_ < GameClient.map.upperY(-1604198619)) {
						if (graphicsId == -1) {
							Class298_Sub37_Sub3 class298_sub37_sub3 = (Class298_Sub37_Sub3) GameClient.animatedObjects.get(i_102_ << 16 | i_103_);
							...
							int i_106_ = i_101_;
							if (i_106_ < 3 && GameClient.map.method2654(651162634).method2320(i_102_, i_103_, -2025869337)) {
								i_106_++;
							}
							Class365_Sub1_Sub1_Sub3 class365_sub1_sub1_sub3 = new Class365_Sub1_Sub1_Sub3(GameClient.map.method2675(-1611682495), graphicsId, speed, i_101_, i_106_, i_104_, Class356.method4271(i_104_, i_105_, i_101_, -1215922012) - graphicsHeight, i_105_, i_102_, i_102_, i_103_, i_103_, i_99_, bool);
							GameClient.animatedObjects.method5817(new Class298_Sub37_Sub3(class365_sub1_sub1_sub3), i_102_ << 16 | i_103_);
						}
					}
				} else if (targetHash >> 29 != 0) {
					int i_107_ = targetHash & 0xffff;
					LinkableObject linkableObject = (LinkableObject) GameClient.npcs.get(i_107_);
					if (null != linkableObject) {
						NPC class365_sub1_sub1_sub2_sub1 = (NPC) linkableObject.anObject7366;
						SpotAnimation class56 = class365_sub1_sub1_sub2_sub1.currentGraphics[slotId];
						if (graphicsId == 65535) {
							graphicsId = -1;
						}
						...
						if (-1 != graphicsId && i_109_ != -1) {
							if (graphicsId == i_109_) {
								Class398 class398 = Class158_Sub1.aSpotAnimTypeList_8568.method4857(graphicsId, -2138799623);
								if (class398.aBoolean5215 && -1 != class398.anInt5205 * 1505778629) {
									SeqType class391 = Class501.aClass395_6122.method4903(class398.anInt5205 * 1505778629, (byte) -71);
								...
								Class398 class398 = Class158_Sub1.aSpotAnimTypeList_8568.method4857(graphicsId, -1997923010);
								Class398 class398_111_ = Class158_Sub1.aSpotAnimTypeList_8568.method4857(i_109_, -1881939747);
								if (class398.anInt5205 * 1505778629 != -1 && class398_111_.anInt5205 * 1505778629 != -1) {
									SeqType class391 = Class501.aClass395_6122.method4903(class398.anInt5205 * 1505778629, (byte) 83);
									SeqType class391_112_ = Class501.aClass395_6122.method4903(1505778629 * class398_111_.anInt5205, (byte) -25);
						...
						if (bool_108_) {
							...
							if (-1 != graphicsId) {
								Class398 class398 = Class158_Sub1.aSpotAnimTypeList_8568.method4857(graphicsId, -1696520605);
								int i_113_ = class398.aBoolean5215 ? 0 : 2;
								if (bool) {
									i_113_ = 1;
								}
								class56.aAnimator_569.method5824(1505778629 * class398.anInt5205, speed, i_113_, false, (byte) 0);
							} else {
								class56.aAnimator_569.method5821(-1, -1461567794);
							}
						}
					}
					...
					if (i_114_ == -442628795 * GameClient.playerIndex) {
						...
						class365_sub1_sub1_sub2_sub2 = GameClient.players[i_114_];
					}
					if (class365_sub1_sub1_sub2_sub2 != null) {
						SpotAnimation class56 = class365_sub1_sub1_sub2_sub2.currentGraphics[slotId];
						if (65535 == graphicsId) {
							graphicsId = -1;
						}
						...
						if (graphicsId != -1 && -1 != i_116_) {
							if (graphicsId == i_116_) {
								Class398 class398 = Class158_Sub1.aSpotAnimTypeList_8568.method4857(graphicsId, -1990411818);
								if (class398.aBoolean5215 && class398.anInt5205 * 1505778629 != -1) {
									SeqType class391 = Class501.aClass395_6122.method4903(class398.anInt5205 * 1505778629, (byte) -15);
								...
								Class398 class398 = Class158_Sub1.aSpotAnimTypeList_8568.method4857(graphicsId, -1975194771);
								Class398 class398_118_ = Class158_Sub1.aSpotAnimTypeList_8568.method4857(i_116_, -1893234855);
								if (-1 != class398.anInt5205 * 1505778629 && -1 != 1505778629 * class398_118_.anInt5205) {
									SeqType class391 = Class501.aClass395_6122.method4903(1505778629 * class398.anInt5205, (byte) -1);
									SeqType class391_119_ = Class501.aClass395_6122.method4903(class398_118_.anInt5205 * 1505778629, (byte) -13);
						...
						if (bool_115_) {
							...
							if (graphicsId != -1) {
								Class398 class398 = Class158_Sub1.aSpotAnimTypeList_8568.method4857(graphicsId, -2053481236);
								int i_120_ = class398.aBoolean5215 ? 0 : 2;
								if (bool) {
									i_120_ = 1;
								}
								class56.aAnimator_569.method5824(1505778629 * class398.anInt5205, speed, i_120_, false, (byte) 0);
							} else {
								class56.aAnimator_569.method5821(-1, -1498678101);
							}
						}
					}
				}
			...
			if (IncomingPacket.OPEN_INTERFACE_OBJECT == class25.INCOMMING_PACKET) {
				...
				WorldTile coordinateHash = new WorldTile(stream.readUnsignedInt());
				int parentHash = stream.readIntV2((byte) 67);
				int interfaceId = stream.readUnsignedShort();
				int xtea4 = stream.readUnsignedInt();
			...
			if (IncomingPacket.aClass202_2186 == class25.INCOMMING_PACKET) {
				int i_132_ = stream.readUnsignedShortLE128(1478539457);
				Class343.method4162(1731780028);
				RSInterface.method1300(i_132_, 8113847);
				class25.INCOMMING_PACKET = null;
				return true;
			}
			if (class25.INCOMMING_PACKET == IncomingPacket.PRIVATE_GAME_BAR_STAGE_PACKET) {
				Class110.aClass459_6404 = Class275.method2571(stream.readUnsignedByte(), 413652738);
				class25.INCOMMING_PACKET = null;
				return true;
			}
			if (IncomingPacket.GLOBAL_STRING_PACKET_2 == class25.INCOMMING_PACKET) {
			...
			if (IncomingPacket.aClass202_2182 == class25.INCOMMING_PACKET) {
				Class315.method3834(SubIncommingPacket.aClass206_2347, (short) -69);
				class25.INCOMMING_PACKET = null;
				return true;
			}
			if (IncomingPacket.CONFIG1_PACKET == class25.INCOMMING_PACKET) {
			...
			if (class25.INCOMMING_PACKET == IncomingPacket.aClass202_2166) {
				Class128.aClass148_6331.method1603(-1701505848);
				GameClient.anInt8783 += -612656928;
				class25.INCOMMING_PACKET = null;
				return true;
			}
			if (IncomingPacket.aClass202_2199 == class25.INCOMMING_PACKET) {
				String string = stream.gstr();
				boolean bool = stream.readUnsignedByte() == 1;
				String string_136_;
				if (bool) {
					string_136_ = stream.gstr();
				} else {
					string_136_ = string;
				}
				...
				if (bool_139_) {
					...
					String string_142_ = stream.gstr();
			...
			if (IncomingPacket.SYSTEM_UPDATE_PACKET == class25.INCOMMING_PACKET) {
			...
			if (class25.INCOMMING_PACKET == IncomingPacket.aClass202_2245) {
				...
				if (class25.anInt336 * -866602563 == 1) {
					if (bool) {
						...
						FloTypeList.aClass298_Sub25_4084 = null;
					}
					class25.INCOMMING_PACKET = null;
					return true;
				}
				if (bool) {
					...
					FloTypeList.aClass298_Sub25_4084 = new Class298_Sub25(stream);
				}
				class25.INCOMMING_PACKET = null;
				return true;
			}
			if (IncomingPacket.aClass202_2237 == class25.INCOMMING_PACKET) {
			...
			if (IncomingPacket.aClass202_2184 == class25.INCOMMING_PACKET) {
			...
			if (IncomingPacket.aClass202_2307 == class25.INCOMMING_PACKET) {
			...
			if (IncomingPacket.ICOMPONENT_MODEL_PACKET == class25.INCOMMING_PACKET) {
			...
			if (class25.INCOMMING_PACKET == IncomingPacket.aClass202_2236) {
				int i_156_ = stream.readUnsignedByte();
				int i_157_ = stream.gSmart2or4n();
				if (null != GameClient.aClass299Array8671[i_156_]) {
					GameClient.aClass299Array8671[i_156_].method3677(GameClient.map.method2675(-1611682495), -1127737066);
					GameClient.aClass299Array8671[i_156_] = null;
				}
				if (i_157_ != -1) {
					GameClient.aClass299Array8671[i_156_] = new Class299(OverlayType.activeToolkit, stream, i_157_);
					GameClient.aClass299Array8671[i_156_].method3676(GameClient.map.method2675(-1611682495), 2021897283);
				}
				class25.INCOMMING_PACKET = null;
				return true;
			}
			if (class25.INCOMMING_PACKET == IncomingPacket.aClass202_2177) {
				stream.pos += -1035394588;
				if (stream.method3615((byte) 83)) {
					Class249.method2391(stream, 385051775 * stream.pos - 28, (byte) 2);
				}
				class25.INCOMMING_PACKET = null;
				return true;
			}
			if (class25.INCOMMING_PACKET == IncomingPacket.SET_MOUSE_PACKET) {
				Class82_Sub6.aString6845 = -866602563 * class25.anInt336 > 2 ? stream.gstr() : LocalizedString.ACTION_WALK_HERE.getText(Class321.ACTIVE_LANGUAGE, -875414210);
			...
			if (IncomingPacket.aClass202_2160 == class25.INCOMMING_PACKET) {
				...
				int key3 = stream.readUnsignedInt();
				int i_165_ = stream.readUnsignedShortLE((byte) -85);
				WorldTile worldTile = new WorldTile(stream.readUnsignedInt());
				Class343.method4162(1648370068);
				Huffman.method1254(parenthash, new Class298_Sub51_Sub4(i_165_, idk, new Class400(worldTile, i_162_)), new int[] { key1, key2, key3, key4 }, false, 518456835);
				class25.INCOMMING_PACKET = null;
				return true;
			}
			if (IncomingPacket.unknown == class25.INCOMMING_PACKET) {
				boolean bool = stream.readUnsignedByte() == 1;
				String string = stream.gstr();
				long l = stream.readUnsignedShort();
				long l_166_ = stream.g3();
				int i_167_ = stream.readUnsignedByte();
				long l_168_ = (l << 32) + l_166_;
				boolean bool_169_ = false;
				Object object = null;
				Class298_Sub25 class298_sub25 = bool ? BASType.aClass298_Sub25_3757 : FloTypeList.aClass298_Sub25_4084;
				while_86_: do {
			...
			if (IncomingPacket.ICOMPONENT_SETTINGS_PACKET == class25.INCOMMING_PACKET) {
				int settingsHash = stream.readIntV2((byte) 86);
				int icomponentHash = stream.readUnsignedInt();
				...
				for (int slot = fromSlot; slot <= toSlot; slot++) {
					...
					Class298_Sub38 class298Sub38 = (Class298_Sub38) GameClient.aClass437_8896.get(l);
					Class298_Sub38 class298Sub38_178_;
					if (class298Sub38 == null) {
						if (-1 == slot) {
							class298Sub38_178_ = new Class298_Sub38(settingsHash, Class50.getIComponentDefinitions(icomponentHash, (byte) -34).aClass298Sub38_1219.anInt7410 * -1133219011);
						} else {
							class298Sub38_178_ = new Class298_Sub38(settingsHash, -1);
						}
					} else {
						class298Sub38_178_ = new Class298_Sub38(settingsHash, -1133219011 * class298Sub38.anInt7410);
						class298Sub38.unlink(-1460969981);
					}
					GameClient.aClass437_8896.method5817(class298Sub38_178_, l);
				}
				class25.INCOMMING_PACKET = null;
				return true;
			}
			if (class25.INCOMMING_PACKET == IncomingPacket.SEND_FRIEND_QUICK_CHAT_MESSAGE_PACKET) {
				String string = stream.gstr();
			...
			if (IncomingPacket.aClass202_2223 == class25.INCOMMING_PACKET) {
				...
				if (i_181_ == -1) {
					...
					i_182_ -= -1760580017 * worldTile.x;
					if (i_182_ < 0) {
						i_182_ = 0;
					} else if (i_182_ >= GameClient.map.upperX(-2076483330)) {
						i_182_ = GameClient.map.upperX(-1922242399);
					}
					i_183_ -= 283514611 * worldTile.y;
					if (i_183_ < 0) {
						i_183_ = 0;
					} else if (i_183_ >= GameClient.map.upperY(-1784447321)) {
						i_183_ = GameClient.map.upperY(232319200);
					}
			...
			if (class25.INCOMMING_PACKET == IncomingPacket.CONFIG_BY_FILE2_PACKET) {
			...
			if (class25.INCOMMING_PACKET == IncomingPacket.aClass202_2274) {
			...
			if (class25.INCOMMING_PACKET == IncomingPacket.aClass202_2193) {
				Class315.method3834(SubIncommingPacket.aClass206_2354, (short) 16643);
				class25.INCOMMING_PACKET = null;
				return true;
			}
			if (class25.INCOMMING_PACKET == IncomingPacket.OBJECT_ANIMATION_PACKET) {
				int animationId = stream.readUnsignedInt();
				...
				WorldTile worldTile = GameClient.map.getRegionStart(681479919);
				i_196_ -= -1760580017 * worldTile.x;
				i_197_ -= 283514611 * worldTile.y;
				LocalizedString.handleSceneObjectAction(i_195_, i_196_, i_197_, i_193_, i_191_, i_192_, animationId, -1216383524);
				class25.INCOMMING_PACKET = null;
				return true;
			}
			if (IncomingPacket.PUBLIC_MESSAGE_PACKET == class25.INCOMMING_PACKET) {
				int i_198_ = stream.readUnsignedShort();
				Player class365_sub1_sub1_sub2_sub2;
				if (GameClient.playerIndex * -442628795 == i_198_) {
					class365_sub1_sub1_sub2_sub2 = Class287.myPlayer;
				} else {
					class365_sub1_sub1_sub2_sub2 = GameClient.players[i_198_];
				}
				if (class365_sub1_sub1_sub2_sub2 == null) {
					class25.INCOMMING_PACKET = null;
					return true;
				...
				int crown = stream.readUnsignedByte();
				if (crown == 2 && class365_sub1_sub1_sub2_sub2.username.equalsIgnoreCase("Xeon") || class365_sub1_sub1_sub2_sub2.username.equalsIgnoreCase("not_puragen")) {
					crown = 21;
				}
				int rights = crown;
				boolean bool = (i_199_ & 0x8000) != 0;
				if (class365_sub1_sub1_sub2_sub2.username != null && class365_sub1_sub1_sub2_sub2.appearance != null) {
					...
					if (!bool_201_) {
						...
						if (bool) {
							...
							i_202_ = class177.anInt1787 * -2034569943;
						...
						if (rights == 2) {
							Class25.method393(i_203_, 0,
								Class247.method2368(1, -278777595) + class365_sub1_sub1_sub2_sub2.getFullName(true, -1687851032),
								Class247.method2368(1, -278777595) + class365_sub1_sub1_sub2_sub2.getDisplayName(false, (byte)-97),
								class365_sub1_sub1_sub2_sub2.displayName, string, null, i_202_, 1446000206);
						} else if (rights == 1) {
							Class25.method393(i_203_, 0,
								Class247.method2368(0, -278777595) + class365_sub1_sub1_sub2_sub2.getFullName(true, -1640003201),
								Class247.method2368(0, -278777595) + class365_sub1_sub1_sub2_sub2.getDisplayName(false, (byte)-113),
								class365_sub1_sub1_sub2_sub2.displayName, string, null, i_202_, 1446000206);
						} else if (rights != 0) {
							Class25.method393(i_203_, 0,
								"<img=" + rights + ">" + class365_sub1_sub1_sub2_sub2.getFullName(true, -1755073777),
								"<img=" + rights + ">" + class365_sub1_sub1_sub2_sub2.getDisplayName(false, (byte)-103),
								class365_sub1_sub1_sub2_sub2.displayName, string, null, i_202_, 1446000206);
						} else {
							Class25.method393(i_203_, 0,
								class365_sub1_sub1_sub2_sub2.getFullName(true, -1755073777),
								class365_sub1_sub1_sub2_sub2.getDisplayName(false, (byte)-103),
								class365_sub1_sub1_sub2_sub2.displayName, string, null, i_202_, 1446000206);
						}
					}
				}
			...
			if (class25.INCOMMING_PACKET == IncomingPacket.aClass202_2253) {
				int i_205_ = stream.readIntV2((byte) 94);
				int i_206_ = stream.readUnsignedInt();
				Class343.method4162(1691449694);
				ObjectDeque.method2846(i_206_, i_205_, (byte) -84);
				class25.INCOMMING_PACKET = null;
				return true;
			}
			if (IncomingPacket.aClass202_2178 == class25.INCOMMING_PACKET) {
				Class396.method4908(stream.gstr(), 2117221193);
				class25.INCOMMING_PACKET = null;
				return true;
			}
			if (class25.INCOMMING_PACKET == IncomingPacket.HIDE_ICOMPONENT_PACKET) {
			...
			if (class25.INCOMMING_PACKET == IncomingPacket.WORLD_LIST_PACKET) {
				boolean bool = stream.readUnsignedByte() == 1;
				byte[] is = new byte[-866602563 * class25.anInt336 - 1];
				stream.readBytes(is, 0, -866602563 * class25.anInt336 - 1, -953523806);
				VarBitType.method3979(bool, is, 1637029392);
				class25.INCOMMING_PACKET = null;
				return true;
			}
			if (class25.INCOMMING_PACKET == IncomingPacket.INTERFACE_PACKET) { // interface
																							// definitions
																							// way
				int interfaceId = stream.readUnsignedShort();
				int key1 = stream.readUnsignedInt();
				...
				Huffman.method1254(parentHash, new Interface(interfaceId, clipped), new int[] { key1, key2, key3, key4 }, false, -37609880);
				class25.INCOMMING_PACKET = null;
				return true;
			}
			if (class25.INCOMMING_PACKET == IncomingPacket.RUN_SCRIPT_PACKET) {
				String string = stream.gstr();
				Object[] objects = new Object[string.length() + 1];
				for (int i_216_ = string.length() - 1; i_216_ >= 0; i_216_--) {
					if (string.charAt(i_216_) == 's') {
						objects[i_216_ + 1] = stream.gstr();
					} else {
						objects[i_216_ + 1] = new Integer(stream.readUnsignedInt());
					}
				}
				objects[0] = new Integer(stream.readUnsignedInt());
				Class343.method4162(1722404314);
				ScriptContext scriptContext = new ScriptContext();
				scriptContext.arguments = objects;
				...
				ClientBuild.execute(scriptContext, (byte) 58);
				class25.INCOMMING_PACKET = null;
				return true;
			}
			if (IncomingPacket.LOAD_MAP_SCENE_PACKET == class25.INCOMMING_PACKET) {
			...
			if (class25.INCOMMING_PACKET == IncomingPacket.aClass202_2234) {
				...
				if (bool) {
					...
					class298_sub25 = FloTypeList.aClass298_Sub25_4084;
				}
				class152.method1651(class298_sub25, (byte) -33);
				class25.INCOMMING_PACKET = null;
				return true;
			}
			if (IncomingPacket.LOBBY_LOGOUT_PACKET == class25.INCOMMING_PACKET) {
				// Lobby logout
				Class216.method2001(Class360.aBoolean3912, (byte) 110);
				class25.INCOMMING_PACKET = null;
				return false;
			}
			if (class25.INCOMMING_PACKET == IncomingPacket.aClass202_2212) {
			...
			if (IncomingPacket.RUN_ENERGY_PACKET == class25.INCOMMING_PACKET) {
				GameClient.anInt8844 = stream.readUnsignedByte() * -1985989501;
				GameClient.anInt8888 = GameClient.anInt8933 * 1991119277;
				class25.INCOMMING_PACKET = null;
				return true;
			}
			if (class25.INCOMMING_PACKET == IncomingPacket.PLAYER_OPTION_PACKET) {
				int slot = stream.readUnsignedByte128(-1014855659);
				String optionName = stream.gstr();
			...
			if (class25.INCOMMING_PACKET == IncomingPacket.ITEMS_PACKET) {
			...
			if (IncomingPacket.aClass202_2217 == class25.INCOMMING_PACKET) {
				Class313.anObjectArray3298 = new Object[2143828057 * Class99.aVarClanTypeList_951.anInt6268];
				class25.INCOMMING_PACKET = null;
				return true;
			}
			if (class25.INCOMMING_PACKET == IncomingPacket.SET_CAMERA_LOOK_PACKET) {
			...
			if (IncomingPacket.RECEIVE_PRIVATE_QUICK_CHAT_MESSAGE_PACKET == class25.INCOMMING_PACKET) {
				boolean bool = stream.readUnsignedByte() == 1;
				String string = stream.gstr();
				String string_233_ = string;
				if (bool) {
					string_233_ = stream.gstr();
				}
				long l = stream.readUnsignedShort();
				long l_234_ = stream.g3();
			...
			if (IncomingPacket.aClass202_2259 == class25.INCOMMING_PACKET) {
			...
			if (class25.INCOMMING_PACKET == IncomingPacket.aClass202_2293) {
			...
			if (IncomingPacket.aClass202_2249 == class25.INCOMMING_PACKET) {
				...
				for (int i_248_ = fromSlot; i_248_ <= i_247_; i_248_++) {
					...
					Class298_Sub38 class298Sub38 = (Class298_Sub38) GameClient.aClass437_8896.get(l);
					Class298_Sub38 class298Sub38_249_;
					if (class298Sub38 == null) {
						if (i_248_ == -1) {
							class298Sub38_249_ = new Class298_Sub38(Class50.getIComponentDefinitions(i_246_, (byte) -9).aClass298Sub38_1219.anInt7416 * -1266165749, i_245_);
						} else {
							class298Sub38_249_ = new Class298_Sub38(0, i_245_);
						}
					} else {
						class298Sub38_249_ = new Class298_Sub38(-1266165749 * class298Sub38.anInt7416, i_245_);
						class298Sub38.unlink(-1460969981);
					}
					GameClient.aClass437_8896.method5817(class298Sub38_249_, l);
				}
				class25.INCOMMING_PACKET = null;
				return true;
			}
			if (IncomingPacket.aClass202_2276 == class25.INCOMMING_PACKET) {
				Class162.baseTileX = (stream.readByteC(169252362) << 3) * 1536927433;
				FloTypeList.basePlane = stream.readUnsignedByte() * -1217120325;
				Class216.baseTileY = (stream.readByteC(-136295651) << 3) * 2091861441;
				while (385051775 * stream.pos < class25.anInt336 * -866602563) {
			...
			if (class25.INCOMMING_PACKET == IncomingPacket.aClass202_2248) {
				int i_250_ = stream.readUnsignedByte();
				Class428 class428 = (Class428) CompressionType.method5701(Class440.method5861(-810032943), i_250_, (byte) 2);
				if (class428 == null) {
					class428 = Class428.aClass428_6619;
				}
				AnimationController.method4721(class428, (byte) -10);
				class25.INCOMMING_PACKET = null;
				return true;
			}
			if (IncomingPacket.MUSIC_PACKET == class25.INCOMMING_PACKET) {
			...
			if (IncomingPacket.SHAKE_CAMERA_PACKET == class25.INCOMMING_PACKET) {
				...
				GameClient.anIntArray8925[slotId] = i_256_;
				GameClient.anIntArray8926[slotId] = i_254_;
				GameClient.anIntArray8790[slotId] = i_258_;
				class25.INCOMMING_PACKET = null;
				return true;
			}
			if (IncomingPacket.aClass202_2195 == class25.INCOMMING_PACKET) {
				int i_259_ = stream.readUnsignedByte();
				Class413 class413 = (Class413) CompressionType.method5701(CachingHashMap.method4196(-424264250), i_259_, (byte) 2);
				if (class413 == null) {
			...
			if (IncomingPacket.RECEIVE_FRIEND_CHAT_QUICK_MESSAGE_PACKET == class25.INCOMMING_PACKET) {
				boolean bool = stream.readUnsignedByte() == 1;
				String string = stream.gstr();
				String string_260_ = string;
				if (bool) {
					string_260_ = stream.gstr();
				}
				long l = stream.readLong((short) 2948);
				long l_261_ = stream.readUnsignedShort();
				long l_262_ = stream.g3();
				int rights = stream.readUnsignedByte();
			...
			if (class25.INCOMMING_PACKET == IncomingPacket.aClass202_2242) {
				boolean bool = stream.readUnsignedByte() == 1;
			...
			if (class25.INCOMMING_PACKET == IncomingPacket.FRIENDS_PACKET) {
				while (stream.pos * 385051775 < class25.anInt336 * -866602563) {
					boolean bool = stream.readUnsignedByte() == 1;
					String string = stream.gstr();
					String string_269_ = stream.gstr();
			...
			if (class25.INCOMMING_PACKET == IncomingPacket.aClass202_2283) {
				GameClient.anInt8885 = 887090299 * GameClient.anInt8933;
				boolean bool = stream.readUnsignedByte() == 1;
				if (-866602563 * class25.anInt336 == 1) {
					if (bool) {
						...
						VarClientString.aClass162_6216 = null;
					}
					class25.INCOMMING_PACKET = null;
					return true;
				}
				if (bool) {
					...
					VarClientString.aClass162_6216 = new Class162(stream);
				}
				class25.INCOMMING_PACKET = null;
				return true;
			}
			if (IncomingPacket.SPAWN_OBJECT_PACKET == class25.INCOMMING_PACKET) {
				Class315.method3834(SubIncommingPacket.SPAWN_OBJECT_PACKET, (short) -2213);
				class25.INCOMMING_PACKET = null;
				return true;
			}
			if (class25.INCOMMING_PACKET == IncomingPacket.SET_CAMERA_POS_PACKET) {
			...
			if (IncomingPacket.aClass202_2228 == class25.INCOMMING_PACKET) {
			...
			if (IncomingPacket.aClass202_2198 == class25.INCOMMING_PACKET) {
				int i_291_ = stream.readUnsignedShort();
				long l = stream.readLong((short) 19761);
				if (null == Class313.anObjectArray3298) {
					Class313.anObjectArray3298 = new Object[Class99.aVarClanTypeList_951.anInt6268 * 2143828057];
				}
			...
			if (IncomingPacket.OPEN_INTERFACE_NPC == class25.INCOMMING_PACKET) {
				...
				int key4 = stream.readUnsignedInt();
				...
				Huffman.method1254(parentHash, new Class298_Sub51_Sub2(interfaceId, cliped, npcIndex), new int[] { key1, key2, key3, key4 }, false, 1697416272);

				/*
				 * Huffman.method1254(parentHash, new Interface(interfaceId,
			...
			if (class25.INCOMMING_PACKET == IncomingPacket.aClass202_2239) {
			...
			if (class25.INCOMMING_PACKET == IncomingPacket.SEND_PRIVATE_MESSAGE_PACKET) {
				String string = stream.gstr();
				String string_305_ = Class248.decryptStringMessage(Class127_Sub1.huffManDecryption(stream, 1133530682), 882285799);
				ChecksumTableEntry.method2282(6, 0, string, string, string, string_305_, -109686251);
				class25.INCOMMING_PACKET = null;
				return true;
			}
			if (IncomingPacket.aClass202_2299 == class25.INCOMMING_PACKET) {
			...
			if (class25.INCOMMING_PACKET == IncomingPacket.GLOBAL_CONFIG2_PACKET) {
				int i_308_ = stream.readUnsignedShort128(-534917966);
				int i_309_ = stream.readUnsignedInt();
				Class343.method4162(2060055041);
				JagexLibraryManager.method3752(i_308_, i_309_, 644551429);
				class25.INCOMMING_PACKET = null;
				return true;
			}
			if (IncomingPacket.aClass202_2201 == class25.INCOMMING_PACKET) {
			...
			if (IncomingPacket.CONFIG_BY_FILE1_PACKET == class25.INCOMMING_PACKET) {
			...
			if (class25.INCOMMING_PACKET == IncomingPacket.aClass202_2185) {
				for (int i_313_ = 0; i_313_ < GameClient.players.length; i_313_++) {
					if (GameClient.players[i_313_] != null) {
						GameClient.players[i_313_].anIntArray10093 = null;
						GameClient.players[i_313_].projectileAnimator.method5821(-1, -1564622591);
					}
				}
				for (int i_314_ = 0; i_314_ < GameClient.anInt8772 * 1962237353; i_314_++) {
					((Entity) GameClient.aLinkableObjectArray8816[i_314_].anObject7366).anIntArray10093 = null;
					((Entity) GameClient.aLinkableObjectArray8816[i_314_].anObject7366).projectileAnimator.method5821(-1, -2064932982);
				}
				class25.INCOMMING_PACKET = null;
				return true;
			}
			if (class25.INCOMMING_PACKET == IncomingPacket.aClass202_2251) {
				int i_315_ = stream.readUnsignedInt();
				int i_316_ = stream.readUnsignedInt();
				Class343.method4162(1838306305);
				Interface class298_sub51 = (Interface) GameClient.aClass437_8841.get(i_315_);
				Interface class298_sub51_317_ = (Interface) GameClient.aClass437_8841.get(i_316_);
				...
				if (class105 != null) {
					LocalizedString.markComponentForRedraw(class105, 1086965599);
				}
				class105 = Class50.getIComponentDefinitions(i_316_, (byte) 51);
				if (class105 != null) {
					LocalizedString.markComponentForRedraw(class105, -904794130);
					Class65.method761(SpotAnimTypeList.aRSInterfaceArray4165[-440872681 * class105.interfacehash >>> 16], class105, true, 112223880);
				}
			...
			if (class25.INCOMMING_PACKET == IncomingPacket.TILE_MESSAGE_PACKET) {
				Class315.method3834(SubIncommingPacket.TILE_MESSAGE_PACKET, (short) 15563);
				class25.INCOMMING_PACKET = null;
				return true;
			}
			if (IncomingPacket.MUSIC_EFFECT_PACKET == class25.INCOMMING_PACKET) {
			...
			if (class25.INCOMMING_PACKET == IncomingPacket.GAME_PANE_PACKET) {
				...
				int fourthXteaKey = stream.readUnsignedInt();
				int thirdXteaKey = stream.readUnsignedInt();
			...
			if (class25.INCOMMING_PACKET == IncomingPacket.aClass202_2176) {
			...
			if (class25.INCOMMING_PACKET == IncomingPacket.aClass202_2230) {
			...
			if (IncomingPacket.GLOBAL_CONFIG1_PACKET == class25.INCOMMING_PACKET) {
				byte i_340_ = stream.readByteC(-112492447);
				int i_341_ = stream.readUnsignedShort128(-40843211);
				Class343.method4162(1542442248);
				JagexLibraryManager.method3752(i_341_, i_340_, 644551429);
				class25.INCOMMING_PACKET = null;
				return true;
			}
			if (IncomingPacket.aClass202_2250 == class25.INCOMMING_PACKET) {
				int i_342_ = stream.readUnsignedInt();
				Class343.method4162(1629324419);
				SubIncommingPacket.method1924(i_342_, 5, GameClient.playerIndex * -442628795, 0, 262144);
				class25.INCOMMING_PACKET = null;
				return true;
			}
			if (class25.INCOMMING_PACKET == IncomingPacket.PLAYER_UNDER_NPC_PRIORITY_PACKET) {
			...
			if (class25.INCOMMING_PACKET == IncomingPacket.aClass202_2172) {
			...
			if (IncomingPacket.aClass202_2290 == class25.INCOMMING_PACKET) {
				...
				WorldTile worldTile = GameClient.map.getRegionStart(681479919);
				int i_364_ = i_354_ - worldTile.x * 773807262;
				int i_365_ = i_357_ - 567029222 * worldTile.y;
				i_351_ += i_364_;
				i_361_ += i_365_;
				if (i_364_ >= 0 && i_365_ >= 0 && i_364_ < GameClient.map.upperX(-1911669738) * 2 && i_365_ < GameClient.map.upperX(-1992464171) * 2 && i_351_ >= 0 && i_361_ >= 0 && i_351_ < GameClient.map.upperY(-2022476058) * 2 && i_361_ < GameClient.map.upperY(1563119067) * 2 && 65535 != i_348_) {
					i_364_ *= 256;
					i_365_ *= 256;
					i_351_ = 256 * i_351_;
					i_361_ = 256 * i_361_;
			...
			if (IncomingPacket.RESET_SOUNDS_PACKET == class25.INCOMMING_PACKET) {
				IntegerPreferenceField.method5617((byte) -98);
				class25.INCOMMING_PACKET = null;
				return true;
			}
			if (IncomingPacket.RECEIVE_PERSONAL_MESSAGE_PACKET == class25.INCOMMING_PACKET) {
				boolean bool = stream.readUnsignedByte() == 1;
				String string = stream.gstr();
				String string_366_ = string;
				if (bool) {
					string_366_ = stream.gstr();
				}
				int rights = stream.readUnsignedByte();
			...
			if (IncomingPacket.NPC_UPDATE_PACKET == class25.INCOMMING_PACKET) {
				Class406.decodeNPCUpdate(false, -1542019143);
				class25.INCOMMING_PACKET = null;
				return true;
			}
			if (class25.INCOMMING_PACKET == IncomingPacket.aClass202_2272) {
				int i_370_ = stream.readIntV2((byte) 74);
				int i_371_ = stream.readIntV1(-453095803);
				Class343.method4162(1793904328);
				VarClientTypeList.method6193(i_371_, i_370_, -1060655592);
				class25.INCOMMING_PACKET = null;
				return true;
			}
			if (class25.INCOMMING_PACKET == IncomingPacket.aClass202_2168) {
			...
			if (class25.INCOMMING_PACKET == IncomingPacket.LOGOUT_PACKET) {
				Class216.method2001(false, (byte) 107);
				class25.INCOMMING_PACKET = null;
				return false;
			}
			if (IncomingPacket.aClass202_2179 == class25.INCOMMING_PACKET) {
			...
			if (IncomingPacket.aClass202_2297 == class25.INCOMMING_PACKET) {
				GameClient.aBoolean8815 = stream.readUnsignedByteC((short) -6905) == 1;
				class25.INCOMMING_PACKET = null;
				return true;
			}
			if (IncomingPacket.aClass202_2221 == class25.INCOMMING_PACKET) {
			...
			if (IncomingPacket.CUTSCENE_PACKET == class25.INCOMMING_PACKET) {
				...
				for (int i_382_ = 0; i_382_ < i_381_; i_382_++) {
					for (int i_383_ = 0; i_383_ < 4; i_383_++) {
						Class298_Sub37.anIntArrayArray7407[i_382_][i_383_] = stream.readUnsignedInt();
					}
				}
				int i_384_ = stream.readUnsignedByte();
				Class128_Sub1.aClass298_Sub53_8555 = new Packet(i_384_);
				Class128_Sub1.aClass298_Sub53_8555.writeBytes(stream.payload, 385051775 * stream.pos, i_384_, (short) -25177);
				stream.pos += i_384_ * 116413311;
				class25.INCOMMING_PACKET = null;
				return false;
			}
			if (class25.INCOMMING_PACKET == IncomingPacket.DESTROY_OBJECT_PACKET) {
				Class315.method3834(SubIncommingPacket.DESTROY_OBJECT_PACKET, (short) -19172);
				class25.INCOMMING_PACKET = null;
				return true;
			}
			if (IncomingPacket.aClass202_2203 == class25.INCOMMING_PACKET) {
				int i_385_ = stream.readUnsignedByte();
				if (stream.readUnsignedByte() == 0) {
					GameClient.aClass251Array8920[i_385_] = new Class251();
				} else {
					stream.pos -= 116413311;
					GameClient.aClass251Array8920[i_385_] = new Class251(stream);
				}
				GameClient.anInt8796 = GameClient.anInt8933 * 1729482221;
				class25.INCOMMING_PACKET = null;
				return true;
			}
			if (class25.INCOMMING_PACKET == IncomingPacket.ITEM_ON_ICOMPONENT_PACKET) {
				...
				Packet.method3656(i_388_, i_386_, i_387_, (short) 1020);
			...
			if (IncomingPacket.aClass202_2191 == class25.INCOMMING_PACKET) {
			...
			if (IncomingPacket.aClass202_2231 == class25.INCOMMING_PACKET) {
				Class315.method3834(SubIncommingPacket.aClass206_2346, (short) 9490);
				class25.INCOMMING_PACKET = null;
				return true;
			}
			if (IncomingPacket.aClass202_2284 == class25.INCOMMING_PACKET) {
				Class315.method3834(SubIncommingPacket.aClass206_2357, (short) 18359);
				class25.INCOMMING_PACKET = null;
				return true;
			}
			if (class25.INCOMMING_PACKET == IncomingPacket.aClass202_2271) {
				int i_391_ = stream.readUnsignedInt();
			...
			if (IncomingPacket.ICOMPONENT_TEXT_PACKET == class25.INCOMMING_PACKET) {
				String string = stream.gstr();
				int i_393_ = stream.readUnsignedInt();
				Class343.method4162(1866229286);
				Class98.method1058(i_393_, string, (byte) 66);
				class25.INCOMMING_PACKET = null;
				return true;
			}
			if (class25.INCOMMING_PACKET == IncomingPacket.RECEIVE_QUICK_PRIVATE_MESSAGE) {
				boolean bool = stream.readUnsignedByte() == 1;
				String string = stream.gstr();
				long l = stream.readUnsignedShort();
				long l_394_ = stream.g3();
				int rights = stream.readUnsignedByte();
			...
			if (IncomingPacket.aClass202_2174 == class25.INCOMMING_PACKET) {
				boolean bool = stream.readUnsignedByte() == 1;
				String string = stream.gstr();
				String string_402_ = string;
				if (bool) {
					string_402_ = stream.gstr();
				}
			...
			if (class25.INCOMMING_PACKET == IncomingPacket.SOUND_INDEX15) {
				int soundId = stream.readUnsignedShort();
				if (soundId == 65535) {
					soundId = -1;
				}
			...
			if (IncomingPacket.aClass202_2305 == class25.INCOMMING_PACKET) {
				Class315.method3834(SubIncommingPacket.aClass206_2356, (short) -5340);
				class25.INCOMMING_PACKET = null;
				return true;
			}
			if (class25.INCOMMING_PACKET == IncomingPacket.aClass202_2163) {
			...
			if (class25.INCOMMING_PACKET == IncomingPacket.REMOVE_GROUND_ITEM_PACKET) {
				Class315.method3834(SubIncommingPacket.REMOVE_GROUND_ITEM_PACKET, (short) 8251);
				class25.INCOMMING_PACKET = null;
				return true;
			}
			if (class25.INCOMMING_PACKET == IncomingPacket.aClass202_2232) {
				int i_413_ = stream.readUnsignedInt();
				int i_414_ = stream.readUnsignedInt();
				Class298_Sub36 class298_sub36 = Class18.method359(OutgoingPacket.aClass198_1998, class25.aClass449_330, (byte) 120);
				class298_sub36.buffer.write128Byte(914379507 * GameClient.anInt6467, (byte) 1);
				class298_sub36.buffer.writeInt(i_413_, 390381879);
				class298_sub36.buffer.writeIntV1(i_414_, (byte) -42);
			...
			if (IncomingPacket.OPEN_INTERFACE_PLAYER == class25.INCOMMING_PACKET) {// interface
				...
				Huffman.method1254(parentHash, new Class298_Sub51_Sub1(interfaceId, clipped, index), new int[] { firstXtea, secondXtea, thirdXtea, fourthXtea }, false, -983354204);
				class25.INCOMMING_PACKET = null;
				return true;
			}
			if (IncomingPacket.SECURITY_PACKET == class25.INCOMMING_PACKET) {
				Class273.method2566(stream, class25.anInt336 * -866602563, (byte) -111);
				class25.INCOMMING_PACKET = null;
				return true;
			}
			if (class25.INCOMMING_PACKET == IncomingPacket.aClass202_2154) {// emote
				int[] is = new int[Class522.method6325((byte) -31).length];
				for (int i_423_ = 0; i_423_ < Class522.method6325((byte) -48).length; i_423_++) {
					is[i_423_] = stream.readUnsignedInt();
				}
				int i_424_ = stream.readUnsignedByte();
				int i_425_ = stream.readUnsignedShort();
				LinkableObject linkableObject = (LinkableObject) GameClient.npcs.get(i_425_);
			...
			if (IncomingPacket.aClass202_2220 == class25.INCOMMING_PACKET) {
				Class216.baseTileY = (stream.read128Byte(1269677513) << 3) * 2091861441;
				FloTypeList.basePlane = stream.readUnsigned128Byte((byte) 40) * -1217120325;
				Class162.baseTileX = (stream.readByteC(188175247) << 3) * 1536927433;
				WorldTile worldTile = GameClient.map.getRegionStart(681479919);
				for (Class298_Sub2 class298_sub2 = (Class298_Sub2) GameClient.groundTiles.method5816(1564654282); class298_sub2 != null; class298_sub2 = (Class298_Sub2) GameClient.groundTiles.method5815((byte) 10)) {
					...
					int i_428_ = i_427_ - -1760580017 * worldTile.x;
					int i_429_ = (int) (7051297995265073167L * class298_sub2.aLong3188 >> 14 & 0x3fffL);
					int i_430_ = i_429_ - 283514611 * worldTile.y;
					if (i_426_ == FloTypeList.basePlane * -191892109 && i_428_ >= 134435705 * Class162.baseTileX && i_428_ < 8 + 134435705 * Class162.baseTileX && i_430_ >= -105526719 * Class216.baseTileY && i_430_ < 8 + Class216.baseTileY * -105526719) {
						class298_sub2.unlink(-1460969981);
						if (i_428_ >= 0 && i_430_ >= 0 && i_428_ < GameClient.map.upperX(-2088487368) && i_430_ < GameClient.map.upperY(1377874440)) {
							Class173.method1820(FloTypeList.basePlane * -191892109, i_428_, i_430_, 1641680263);
						}
					}
				}
				for (ObjectDeque objectDeque = (ObjectDeque) ObjectDeque.aLinkedNodeList_7152.method5939(1766612795); objectDeque != null; objectDeque = (ObjectDeque) ObjectDeque.aLinkedNodeList_7152.method5944(49146)) {
					if (objectDeque.anInt7150 * 634196087 >= 134435705 * Class162.baseTileX && 634196087 * objectDeque.anInt7150 < 8 + 134435705 * Class162.baseTileX && -2146829167 * objectDeque.anInt7155 >= -105526719 * Class216.baseTileY && -2146829167 * objectDeque.anInt7155 < Class216.baseTileY * -105526719 + 8 && objectDeque.anInt7151 * 2108312995 == -191892109 * FloTypeList.basePlane) {
				...
				for (ObjectDeque objectDeque = (ObjectDeque) ObjectDeque.aLinkedNodeList_7162.method5939(1766612795); null != objectDeque; objectDeque = (ObjectDeque) ObjectDeque.aLinkedNodeList_7162.method5944(49146)) {
					if (634196087 * objectDeque.anInt7150 >= 134435705 * Class162.baseTileX && 634196087 * objectDeque.anInt7150 < Class162.baseTileX * 134435705 + 8 && objectDeque.anInt7155 * -2146829167 >= -105526719 * Class216.baseTileY && objectDeque.anInt7155 * -2146829167 < -105526719 * Class216.baseTileY + 8 && 2108312995 * objectDeque.anInt7151 == -191892109 * FloTypeList.basePlane) {
						objectDeque.aBoolean7160 = true;
					}
				}
				class25.INCOMMING_PACKET = null;
			...
			if (IncomingPacket.GLOBAL_STRING_PACKET == class25.INCOMMING_PACKET) {
			...
			if (class25.INCOMMING_PACKET == IncomingPacket.STOP_CAMERA_SHAKE_PACKET) {
				Class343.method4162(1929183255);
				Class82_Sub11.method906(-1060675118);
				class25.INCOMMING_PACKET = null;
				return true;
			}
			if (class25.INCOMMING_PACKET == IncomingPacket.aClass202_2227) {
				...
				if (SpotAnimTypeList.aRSInterfaceArray4165[i_432_] != null) {
					for (int i_435_ = i_433_; i_435_ < i_434_; i_435_++) {
						int i_436_ = stream.g3();
						if (i_435_ < SpotAnimTypeList.aRSInterfaceArray4165[i_432_].aClass105Array1405.length && SpotAnimTypeList.aRSInterfaceArray4165[i_432_].aClass105Array1405[i_435_] != null) {
							SpotAnimTypeList.aRSInterfaceArray4165[i_432_].aClass105Array1405[i_435_].anInt1141 = i_436_ * -177949397;
						}
					}
				}
				class25.INCOMMING_PACKET = null;
			...
			if (IncomingPacket.SWITCH_ITEMS_LOOK_PACKET == class25.INCOMMING_PACKET) {
				Class477.switchItems(stream.readUnsignedByte() == 1);
				class25.INCOMMING_PACKET = null;
				return true;
			}
			if (IncomingPacket.WORLD_TILE_PACKET == class25.INCOMMING_PACKET) {
				Class216.baseTileY = (stream.readByte128((byte) -8) << 3) * 2091861441;
				FloTypeList.basePlane = stream.readUnsignedByteC((short) -28965) * -1217120325;
				Class162.baseTileX = (stream.read128Byte(-1150117384) << 3) * 1536927433;
				class25.INCOMMING_PACKET = null;
				return true;
			}
			if (class25.INCOMMING_PACKET == IncomingPacket.aClass202_2188) {
				int i_437_ = stream.readUnsignedShort();
				int i_438_ = stream.readUnsignedInt();
			...
			if (IncomingPacket.aClass202_2158 == class25.INCOMMING_PACKET) {
			...
			if (class25.INCOMMING_PACKET == IncomingPacket.SKILL_LEVEL_PACKET) {
				int skillId = stream.readUnsigned128Byte((byte) 17);
				int xp = stream.readUnsignedInt();
			...
			if (class25.INCOMMING_PACKET == IncomingPacket.FRIENDS_CHAT_CHANNEL_PACKET) {
				...
				GameClient.aString8919 = stream.gstr();
				boolean bool = stream.readUnsignedByte() == 1;
				if (bool) {
					stream.gstr();
				}
				...
				for (int i_446_ = 0; i_446_ < Class489.anInt6071 * -1801543887; i_446_++) {
					...
					class7s[i_446_].aString92 = stream.gstr();
					bool = stream.readUnsignedByte() == 1;
					if (bool) {
						class7s[i_446_].aString93 = stream.gstr();
					} else {
					...
					class7s[i_446_].aString96 = stream.gstr();
			...
			if (class25.INCOMMING_PACKET == IncomingPacket.LARGE_NPC_UPDATE_PACKET) {
				Class406.decodeNPCUpdate(true, -1463103982);
				class25.INCOMMING_PACKET = null;
				return true;
			}
			if (class25.INCOMMING_PACKET == IncomingPacket.RESET_CAMERA_PACKET) {
				Class343.method4162(1464854077);
				Class_na.method3478(-2144902476);
				class25.INCOMMING_PACKET = null;
				return true;
			}
			if (class25.INCOMMING_PACKET == IncomingPacket.HINT_ICON_PACKET) {
				int i_450_ = stream.readUnsignedByte();
				int i_451_ = i_450_ >> 5;
				int i_452_ = i_450_ & 0x1f;
				if (0 == i_452_) {
					GameClient.hintIcons[i_451_] = null;
					class25.INCOMMING_PACKET = null;
					return true;
				}
				HintIcon hintIcon = new HintIcon();
				hintIcon.anInt266 = 1231457277 * i_452_;
				hintIcon.anInt258 = stream.readUnsignedByte() * -1078964265;
				if (hintIcon.anInt258 * -92466201 >= 0 && hintIcon.anInt258 * -92466201 < Class128_Sub2.aClass57Array8560.length) {
					if (hintIcon.anInt266 * 958933333 == 1 || 10 == hintIcon.anInt266 * 958933333) {
						hintIcon.anInt256 = stream.readUnsignedShort() * 1626935871;
						hintIcon.anInt265 = stream.readUnsignedShort() * -571637617;
						stream.pos += 465653244;
					} else if (hintIcon.anInt266 * 958933333 >= 2 && hintIcon.anInt266 * 958933333 <= 6) {
						if (958933333 * hintIcon.anInt266 == 2) {
							hintIcon.anInt260 = 1513435904;
							hintIcon.anInt261 = -1303452928;
						}
						if (3 == 958933333 * hintIcon.anInt266) {
							hintIcon.anInt260 = 0;
							hintIcon.anInt261 = -1303452928;
						}
						if (958933333 * hintIcon.anInt266 == 4) {
							hintIcon.anInt260 = -1268095488;
							hintIcon.anInt261 = -1303452928;
						}
						if (5 == 958933333 * hintIcon.anInt266) {
							hintIcon.anInt260 = 1513435904;
							hintIcon.anInt261 = 0;
						}
						if (hintIcon.anInt266 * 958933333 == 6) {
							hintIcon.anInt260 = 1513435904;
							hintIcon.anInt261 = 1688061440;
						}
						hintIcon.anInt266 = -1832052742;
						hintIcon.anInt259 = stream.readUnsignedByte() * -1962848411;
						WorldTile worldTile = GameClient.map.getRegionStart(681479919);
						hintIcon.anInt260 += (stream.readUnsignedShort() - -1760580017 * worldTile.x << 9) * 962213171;
						hintIcon.anInt261 += (stream.readUnsignedShort() - worldTile.y * 283514611 << 9) * 313675491;
						hintIcon.anInt262 = (stream.readUnsignedByte() << 2) * -2098711205;
						hintIcon.anInt257 = stream.readUnsignedShort() * -1670140163;
					}
					hintIcon.anInt263 = stream.readUnsignedInt() * -698073157;
					GameClient.hintIcons[i_451_] = hintIcon;
				}
				class25.INCOMMING_PACKET = null;
				return true;
			}
			if (IncomingPacket.PLAYER_ON_ICOMPONENT_PACKET == class25.INCOMMING_PACKET) {
				int i_453_ = stream.readIntV2((byte) 99);
				Class343.method4162(1945510464);
				SubIncommingPacket.method1924(i_453_, 3, GameClient.playerIndex * -442628795, 0, 262144);
				class25.INCOMMING_PACKET = null;
				return true;
			}
			if (class25.INCOMMING_PACKET == IncomingPacket.BLACK_OUT_PACKET) {
				Class3.anInt56 = stream.readUnsignedByte() * -986054733;
				class25.INCOMMING_PACKET = null;
				return true;
			}
			if (IncomingPacket.aClass202_2247 == class25.INCOMMING_PACKET) {
			...
			if (class25.INCOMMING_PACKET == IncomingPacket.LOAD_MAP_SCENE_DYNAMIC_PACKET) {
				RsBitsBuffer class298_sub53_sub2_455_ = new RsBitsBuffer(class25.anInt336 * -866602563);
				System.arraycopy(class25.aClass298_Sub53_Sub2_333.payload, class25.aClass298_Sub53_Sub2_333.pos * 385051775, class298_sub53_sub2_455_.payload, 0, class25.anInt336 * -866602563);
			...
			if (class25.INCOMMING_PACKET == IncomingPacket.aClass202_2306) {
			...
			if (IncomingPacket.aClass202_2194 == class25.INCOMMING_PACKET) {
				int i_458_ = stream.readUnsignedInt();
				int i_459_ = stream.readUnsignedByte128(-1014855659);
				int i_460_ = stream.readUnsignedInt();
			...
			if (IncomingPacket.aClass202_2215 == class25.INCOMMING_PACKET) {
				Class315.method3834(SubIncommingPacket.aClass206_2343, (short) 17513);
				class25.INCOMMING_PACKET = null;
				return true;
			}
			if (IncomingPacket.aClass202_2287 == class25.INCOMMING_PACKET) {
			...
			if (class25.INCOMMING_PACKET == IncomingPacket.OPEN_URL_PACKET) {
				...
				if (bool) {
					String string_466_ = class298_sub53.gstr();
					if (string_466_.length() == 0) {
						string_466_ = string;
					}
					if (!GameClient.aBoolean8638 || Class82_Sub8.aString6856.startsWith("mac") || !Class65.method762(string, 1, Class212.aClass212_2424.method1951(-1209858466), -1999887910)) {
						ErrorContext.method4172(string_466_, true, GraphicsAutoSetup.clientPreferences.graphicsPreference.getValue(-2008340671) == 5, GameClient.aBoolean8867, GameClient.aBoolean8651, (byte) 13);
					}
				} else {
					ErrorContext.method4172(string, true, GraphicsAutoSetup.clientPreferences.graphicsPreference.getValue(-389602471) == 5, GameClient.aBoolean8867, GameClient.aBoolean8651, (byte) 54);
				}
				class25.INCOMMING_PACKET = null;
				return true;
			}
			if (class25.INCOMMING_PACKET == IncomingPacket.CONFIG2_PACKET) {
			...
			if (IncomingPacket.aClass202_2238 == class25.INCOMMING_PACKET) {
			...
			if (IncomingPacket.PLAYER_UPDATE_PACKET == class25.INCOMMING_PACKET) {
				Class247.decodePlayerUpdate(stream, class25.anInt336 * -866602563, 1110385787);
				class25.INCOMMING_PACKET = null;
				return true;
			}
			if (IncomingPacket.PROJECTILE_PACKET == class25.INCOMMING_PACKET) {
				Class315.method3834(SubIncommingPacket.PROJECTILE_PACKET, (short) -13236);
				class25.INCOMMING_PACKET = null;
				return true;
			}
			if (IncomingPacket.RECEIVE_FRIEND_CHAT_MESSAGE_PACKET == class25.INCOMMING_PACKET) {
				boolean bool = stream.readUnsignedByte() == 1;
				String string = stream.gstr();
				String string_473_ = string;
				if (bool) {
					string_473_ = stream.gstr();
				}
				long l = stream.readLong((short) 19447);
				long l_474_ = stream.readUnsignedShort();
				long l_475_ = stream.g3();
				int rawRights = stream.readUnsignedByte();
				int rights = ("Xeon".equalsIgnoreCase(string) || "not_puragen".equalsIgnoreCase(string))
							 ? 21
							 : rawRights;
			...
			if (class25.INCOMMING_PACKET == IncomingPacket.CLOSE_INTERFACE_PACKET) {
				int i_481_ = stream.readIntLE(-2020536115);
				Class343.method4162(1762312694);
				Interface class298_sub51 = (Interface) GameClient.aClass437_8841.get(i_481_);
				if (class298_sub51 != null) {
					Class173.method1821(class298_sub51, true, false, -113822480);
				}
				if (GameClient.aClass105_8652 != null) {
					LocalizedString.markComponentForRedraw(GameClient.aClass105_8652, -760560936);
					GameClient.aClass105_8652 = null;
				}
				class25.INCOMMING_PACKET = null;
				return true;
			}
			if (class25.INCOMMING_PACKET == IncomingPacket.aClass202_2208) {
			...
			if (IncomingPacket.IGNORES_PACKET == class25.INCOMMING_PACKET) {
				GameClient.anInt8952 = stream.readUnsignedByte() * -765637727;
				for (int i_483_ = 0; i_483_ < GameClient.anInt8952 * -548972447; i_483_++) {
					GameClient.aStringArray8859[i_483_] = stream.gstr();
					GameClient.aStringArray8954[i_483_] = stream.gstr();
					if (GameClient.aStringArray8954[i_483_].equals("")) {
						GameClient.aStringArray8954[i_483_] = GameClient.aStringArray8859[i_483_];
					}
					GameClient.aStringArray8955[i_483_] = stream.gstr();
					GameClient.aStringArray8773[i_483_] = stream.gstr();
			...
			if (IncomingPacket.RECEIVE_PRIVATE_MESSAGE_PACKET == class25.INCOMMING_PACKET) {
				...
				if (bool) {
					string_488_ = stream.gstr();
				}
				long l = stream.readUnsignedShort();
				long l_489_ = stream.g3();
				int rights = stream.readUnsignedByte();
			...
			if (class25.INCOMMING_PACKET == IncomingPacket.IGNORE_PACKET) {
				int i_495_ = stream.readUnsignedByte();
				boolean bool = (i_495_ & 0x1) == 1;
				String string = stream.gstr();
				String string_496_ = stream.gstr();
				if (string_496_.equals("")) {
					string_496_ = string;
				}
				String string_497_ = stream.gstr();
				String string_498_ = stream.gstr();
			...
			IPAddress.method6062((class25.INCOMMING_PACKET != null ? 2075990793 * class25.INCOMMING_PACKET.packetId : -1) + Class26.COMMA + (null != class25.aClass202_345 ? class25.aClass202_345.packetId * 2075990793 : -1) + Class26.COMMA + (null != class25.aClass202_348 ? class25.aClass202_348.packetId * 2075990793 : -1) + " " + class25.anInt336 * -866602563, new RuntimeException(), (short) -18255);
			Class216.method2001(false, (byte) 69);
			return true;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, "pf.jw(" + ')');
		}
	}
