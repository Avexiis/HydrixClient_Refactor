...
public class SceneObject extends Class365_Sub1_Sub3 implements Interface3 {
	...
	boolean method4350(GraphicsToolkit class_ra, int i, int i_2_, byte i_3_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("wl.bu(").append(')').toString());
		}
	}
	...
	public void method31(byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("wl.p(").append(')').toString());
		}
	}
	...
	boolean method4399(byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("wl.bf(").append(')').toString());
		}
	}
	...
	public static void method4507(long[] ls, Object[] objects, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("wl.r(").append(')').toString());
		}
	}
	...
	static final void method4509(IComponentDefinition class105, RSInterface RSInterface, ClientScript2 class403, byte i) {
		try {
			class105.method1122(333321190);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("wl.kx(").append(')').toString());
		}
	}
}
