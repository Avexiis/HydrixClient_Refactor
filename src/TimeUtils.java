...
public class TimeUtils {
	...
	void method1317(Class101 class101, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ey.a(").append(')').toString());
		}
	}
	...
	public static final synchronized long getTime(byte i) {
		try {
	...
	static final void method1320(Entity class365_sub1_sub1_sub2, Entity class365_sub1_sub1_sub2_10_, int i, int i_11_, int i_12_, int i_13_, int i_14_, int i_15_, int i_16_, int i_17_) {
		try {
			int i_18_ = class365_sub1_sub1_sub2_10_.getAnimId((byte) 1);
			if (i_18_ != -1) {
				Object object = null;
				Class57 class57 = (Class57) GameClient.aClass348_8697.get((long) i_18_);
				if (null == class57) {
					Class89[] class89s = Class89.method993(Class158.aClass243_6364, i_18_, 0);
					if (null == class89s)
						return;
					class57 = OverlayType.activeToolkit.method5125(class89s[0], true);
				...
				Class125.method1400(class365_sub1_sub1_sub2.plane, (int) sceneObjectPosition.x, (int) sceneObjectPosition.z, class365_sub1_sub1_sub2.getSize() * 256, 0, false, 2131920659);
				int i_19_ = (int) ((float) i_11_ + GameClient.aFloatArray8891[0] - 18.0F);
				int i_20_ = (int) ((float) i_12_ + GameClient.aFloatArray8891[1] - 16.0F - 54.0F);
				i_19_ += i / 4 * 18;
				i_20_ += 18 * (i % 4);
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ey.jp(").append(')').toString());
		}
	}

	static final void method1321(ClientScript2 class403, int i) {
		try {
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = GraphicsAutoSetup.clientPreferences.aGroundDecorPreference_7548.method5661((byte) 92);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ey.akg(").append(')').toString());
		}
	}
	...
	static final void method1322(ClientScript2 class403, short i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("ey.or(").append(')').toString());
		}
	}
}
