/* VarPlayerType - Decompiled by JODE
...
public class VarPlayerType {
	...
	void method1927(Packet class298_sub53, int i) {
		try {
			for (;;) {
			...
			throw ErrorContext.info(runtimeexception, "is.a(" + ')');
		}
	}

	void method1928(Packet class298_sub53, int i, int i_1_) {
		try {
			if (1 == i)
			...
			throw ErrorContext.info(runtimeexception, "is.f(" + ')');
		}
	}
	...
	static final void method1929(ClientScript2 class403, int i) {
		try {
			...
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = class105.component * -1309843523;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, "is.pr(" + ')');
		}
	}
	...
	public static boolean method1930(int i, byte i_2_) {
		try {
			...
			throw ErrorContext.info(runtimeexception, "is.u(" + ')');
		}
	}
	...
	static int method1931(Class343_Sub1 class343_sub1, Class343_Sub1 class343_sub1_3_, int i, boolean bool, int i_4_) {
		try {
			...
			if (i == 2)
				return Symbol.method397((class343_sub1.method4163(1486003850).aString3819), (class343_sub1_3_.method4163(1779443598).aString3819), DynamicLight.ACTIVE_LANGUAGE, -1018238154);
			if (3 == i) {
				...
				if (class343_sub1_3_.aString7719.equals("-"))
					return bool ? 1 : -1;
				return Symbol.method397(class343_sub1.aString7719, class343_sub1_3_.aString7719, DynamicLight.ACTIVE_LANGUAGE, -1275230374);
			}
			if (i == 4)
			...
			throw ErrorContext.info(runtimeexception, "is.q(" + ')');
		}
	}
	...
	static final void method1932(ClientScript2 class403, byte i) {
		try {
			...
			Class148.method1616(class105, RSInterface, class403, -1691554468);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, "is.fk(" + ')');
		}
	}
	...
	public static String method1933(Class298_Sub37_Sub15 class298_sub37_sub15, int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, "is.af(" + ')');
		}
	}
	...
	static final void method1934(ClientScript2 class403, short i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, "is.aer(" + ')');
		}
	}
	...
	static final void method1935(ClientScript2 class403, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, "is.afd(" + ')');
		}
	}
}
