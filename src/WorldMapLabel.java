/* WorldMapLabel - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

public class WorldMapLabel {
	WorldMapLabelList aWorldMapLabelList_3776;
	public byte[] aByteArray3777;
	public String[] click_options;
	...
	void method4234(Packet class298_sub53, int i) {
		try {
			for (;;) {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("or.a(").append(')').toString());
		}
	}
	...
	void method4235(Packet class298_sub53, int i, short i_1_) {
		try {
			if (1 == i)
				...
				anInt3782 = class298_sub53.g3() * 1266787663;
			else if (i == 6)
				...
				((WorldMapLabel) this).anInt3797 = class298_sub53.readUnsignedShort() * 1896723045;
				if (65535 == -539447443 * ((WorldMapLabel) this).anInt3797)
					((WorldMapLabel) this).anInt3797 = -1896723045;
				((WorldMapLabel) this).anInt3798 = class298_sub53.readUnsignedShort() * -1225014007;
				if (-869705415 * ((WorldMapLabel) this).anInt3798 == 65535)
					((WorldMapLabel) this).anInt3798 = 1225014007;
				...
				((WorldMapLabel) this).anInt3801 = class298_sub53.readUnsignedShort() * -1125434795;
				if (((WorldMapLabel) this).anInt3801 * 769127165 == 65535)
					((WorldMapLabel) this).anInt3801 = 1125434795;
				((WorldMapLabel) this).anInt3790 = class298_sub53.readUnsignedShort() * -1435131889;
				if (-1461367057 * ((WorldMapLabel) this).anInt3790 == 65535)
					((WorldMapLabel) this).anInt3790 = 1435131889;
				((WorldMapLabel) this).anInt3815 = class298_sub53.readUnsignedInt() * 1428832641;
				((WorldMapLabel) this).anInt3800 = class298_sub53.readUnsignedInt() * 1701861307;
			} else if (i == 21)
				anInt3802 = class298_sub53.readUnsignedInt() * -264999113;
			else if (22 == i)
				anInt3787 = class298_sub53.readUnsignedInt() * 1977581169;
			else if (i == 23) {
				...
				if (((WorldMapLabel) this).aClass437_3811 == null) {
					int i_9_ = Class416.method5590(i_8_, (byte) 16);
					((WorldMapLabel) this).aClass437_3811 = new HashTable(i_9_);
				}
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("or.f(").append(')').toString());
		}
	}
	...
	void method4236(int i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("or.b(").append(')').toString());
		}
	}
	...
	public boolean method4237(Interface23 interface23, int i) {
		try {
			int i_13_;
			if (-1 != -869705415 * ((WorldMapLabel) this).anInt3798)
				i_13_ = interface23.method252((-869705415 * ((WorldMapLabel) this).anInt3798), (byte) 44);
			else if (-1 != -539447443 * ((WorldMapLabel) this).anInt3797)
				i_13_ = interface23.method250((-539447443 * ((WorldMapLabel) this).anInt3797), (byte) 24);
			else
				return true;
			if (i_13_ < 338289559 * ((WorldMapLabel) this).anInt3795 || i_13_ > -959385363 * ((WorldMapLabel) this).anInt3796)
				return false;
			boolean bool = false;
			int i_14_;
			if (-1461367057 * ((WorldMapLabel) this).anInt3790 != -1)
				i_14_ = interface23.method252((((WorldMapLabel) this).anInt3790 * -1461367057), (byte) 17);
			else if (-1 != ((WorldMapLabel) this).anInt3801 * 769127165)
				i_14_ = interface23.method250((((WorldMapLabel) this).anInt3801 * 769127165), (byte) 72);
			else
				return true;
			if (i_14_ < ((WorldMapLabel) this).anInt3815 * 372768385 || i_14_ > 520017267 * ((WorldMapLabel) this).anInt3800)
				return false;
			return true;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("or.p(").append(')').toString());
		}
	}
	...
	public Class57 method4238(GraphicsToolkit class_ra, boolean bool, int i) {
		try {
			...
			Class57 class57 = (Class57) ((WorldMapLabelList) ((WorldMapLabel) this).aWorldMapLabelList_3776).aClass348_3635.get((long) i_16_);
			if (class57 != null)
				return class57;
			if (!((WorldMapLabelList) ((WorldMapLabel) this).aWorldMapLabelList_3776).aClass243_3638.method2310(i_15_, -457216440))
				return null;
			Class89 class89 = Class89.method987((((WorldMapLabelList) (((WorldMapLabel) this).aWorldMapLabelList_3776)).aClass243_3638), i_15_, 0);
			if (class89 != null) {
				class57 = class_ra.method5125(class89, true);
				((WorldMapLabelList) ((WorldMapLabel) this).aWorldMapLabelList_3776).aClass348_3635.put(class57, (long) i_16_);
			}
			return class57;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("or.i(").append(')').toString());
		}
	}
	...
	WorldMapLabel() {
		...
		aBoolean3780 = false;
		aBoolean3791 = true;
		click_options = new String[5];
		((WorldMapLabel) this).anInt3794 = 1998808761;
		((WorldMapLabel) this).anInt3797 = -1896723045;
		((WorldMapLabel) this).anInt3798 = 1225014007;
		((WorldMapLabel) this).anInt3801 = 1125434795;
		((WorldMapLabel) this).anInt3790 = 1435131889;
	...
	public String method4239(int i, String string, byte i_17_) {
		try {
			if (null == ((WorldMapLabel) this).aClass437_3811)
				return string;
			LinkableObject linkableObject = ((LinkableObject) ((WorldMapLabel) this).aClass437_3811.get((long) i));
			if (null == linkableObject)
				return string;
			return (String) linkableObject.anObject7366;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("or.u(").append(')').toString());
		}
	}

	public Class57 method4240(GraphicsToolkit class_ra, int i) {
		try {
			Class57 class57 = ((Class57) (((WorldMapLabelList) ((WorldMapLabel) this).aWorldMapLabelList_3776).aClass348_3635.get((long) (((WorldMapLabel) this).anInt3794 * 1027948663 | 0x20000 | class_ra.anInt5298 * 580915349 << 29))));
			if (null != class57)
				return class57;
			((WorldMapLabelList) ((WorldMapLabel) this).aWorldMapLabelList_3776).aClass243_3638.method2310(1027948663 * ((WorldMapLabel) this).anInt3794, -457216440);
			Class89 class89 = Class89.method987((((WorldMapLabelList) ((WorldMapLabel) this).aWorldMapLabelList_3776).aClass243_3638), ((WorldMapLabel) this).anInt3794 * 1027948663, 0);
			if (class89 != null) {
				class57 = class_ra.method5125(class89, true);
				((WorldMapLabelList) ((WorldMapLabel) this).aWorldMapLabelList_3776).aClass348_3635.put(class57, (long) (((WorldMapLabel) this).anInt3794 * 1027948663 | 0x20000 | class_ra.anInt5298 * 580915349 << 29));
			}
			return class57;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("or.k(").append(')').toString());
		}
	}
	...
	public int method4241(int i, int i_18_, int i_19_) {
		try {
			if (((WorldMapLabel) this).aClass437_3811 == null)
				return i_18_;
			Class298_Sub35 class298_sub35 = ((Class298_Sub35) ((WorldMapLabel) this).aClass437_3811.get((long) i));
			if (class298_sub35 == null)
				return i_18_;
			return class298_sub35.anInt7394 * -774922497;
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("or.d(").append(')').toString());
		}
	}
	...
	static final void method4242(ClientScript2 class403, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("or.to(").append(')').toString());
		}
	}
	...
	static final void method4243(ClientScript2 class403, byte i) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("or.ta(").append(')').toString());
		}
	}

	public static GameContext method4244(int i, byte i_21_) {
		try {
			GameContext[] gameContexts = Class499.method6216((byte) 75);
			for (int i_22_ = 0; i_22_ < gameContexts.length; i_22_++) {
				GameContext gameContext = gameContexts[i_22_];
				if (gameContext.gameType * -937307905 == i)
					return gameContext;
			}
			return null;
		} catch (RuntimeException runtimeexception) {
	...
	public static int method4245(long l) {
		try {
			...
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("or.q(").append(')').toString());
		}
	}

	static void method4246(int i, byte i_23_) {
		try {
			VarClanSettings.anInt4090 = i * -435591305;
			Class301_Sub1.anInt7627 = 789877945;
			Class301_Sub1.anInt7627 = 789877945;
			Class225.method2103(65536);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("or.co(").append(')').toString());
		}
	}
	...
	static final void method4248(ClientScript2 class403, byte i) {
		try {
			...
			((ClientScript2) class403).anObjectArray5240[((((ClientScript2) class403).anInt5241 += 969361751) * -203050393 - 1)] = (Class298_Sub32_Sub14.aClass477_9400.getItemDefinitions(i_24_).itemName);
		} catch (RuntimeException runtimeexception) {
			throw ErrorContext.info(runtimeexception, new StringBuilder().append("or.aaj(").append(')').toString());
		}
	}
}
