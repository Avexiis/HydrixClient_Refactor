...
public class a implements Interface25 {
	...
	ModelPart method276(h var_h, byte i, int i_15_, boolean bool) {
		...
		((h) var_h_17_).aMagnetConfigArray6676 = ((h) var_h).aMagnetConfigArray6676;
		return var_h_17_;
	}
	...
	void method279(ModelPart modelPart, Matrix43f class222, int[] is, int i) {
		((a) this).aClass233_6673.method2145(class222);
		wa(((a) this).nativeid, ((h) (h) modelPart).nativeid, ((a) this).aClass233_6673.aFloatArray2594, is, i);
	}

	native boolean ya(long l, long l_29_, int i, int i_30_, float[] fs, boolean bool);

	void method280(ModelPart modelPart, int[] is, Matrix43f class222) {
		((a) this).aClass233_6673.method2145(class222);
		J(((a) this).nativeid, ((h) (h) modelPart).nativeid, is, ((a) this).aClass233_6673.aFloatArray2594);
	}

	native void JA(long l);

	void method281(Ground ground, int i, int i_31_) {
		v(((a) this).nativeid, ((i) (i) ground).nativeid, i, i_31_);
	}

	native void v(long l, long l_32_, int i, int i_33_);

	void method282(Ground ground, int i, int i_34_, int i_35_, int i_36_, int i_37_, int i_38_, int i_39_, boolean[][] bools) {
		i(((a) this).nativeid, ((i) (i) ground).nativeid, i, i_34_, i_35_, i_36_, i_37_, i_38_, i_39_, bools);
	}
	...
	boolean method284(ModelPart modelPart, int i, int i_88_, Matrix43f class222, boolean bool) {
		((a) this).aClass233_6673.method2145(class222);
		return ya(((a) this).nativeid, ((h) (h) modelPart).nativeid, i, i_88_, ((a) this).aClass233_6673.aFloatArray2594, bool);
	}
	...
	void method285(ModelPart modelPart, ModelPart modelPart_93_, int i, int i_94_, int i_95_, boolean bool) {
		P(((a) this).nativeid, ((h) (h) modelPart).nativeid, ((h) (h) modelPart_93_).nativeid, i, i_94_, i_95_, bool);
	}
