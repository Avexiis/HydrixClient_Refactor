...
public class h extends ModelPart implements Interface25 {
	long nativeid;
	ja aJa6674;
	ba aBa6675;
	MagnetConfig[] aMagnetConfigArray6676;
	...
	public void method4786(Matrix43f class222) {
		...
		if (((h) this).aMagnetConfigArray6676 != null) {
			for (int i_1_ = 0; i_1_ < ((h) this).aMagnetConfigArray6676.length; i_1_++) {
				MagnetConfig magnetConfig = ((h) this).aMagnetConfigArray6676[i_1_];
				MagnetConfig magnetConfig_2_ = magnetConfig;
				if (magnetConfig.aMagnetConfig_672 != null)
					magnetConfig_2_ = magnetConfig.aMagnetConfig_672;
				if (magnetConfig.aClass233_677 == null)
					magnetConfig.aClass233_677 = new Class233();
				magnetConfig.aClass233_677.method2145(class222);
				magnetConfig_2_.anInt671 = ja.anIntArray6681[i++] * -1436341053;
				magnetConfig_2_.anInt675 = ja.anIntArray6681[i++] * 449866009;
				magnetConfig_2_.anInt676 = ja.anIntArray6681[i++] * 1336328763;
			}
		}
	}
	...
	public ModelPart method4755(byte i, int i_3_, boolean bool) {
	...
	public void method4745(ModelPart modelPart, int i, int i_7_, int i_8_, boolean bool) {
		((h) this).aJa6674.method5571().method285(this, modelPart, i, i_7_, i_8_, bool);
	}
	...
	public native void pa(int i, int i_11_, Ground ground, Ground ground_12_, int i_13_, int i_14_, int i_15_);
	...
	public native void bs(int i, int i_25_, Ground ground, Ground ground_26_, int i_27_, int i_28_, int i_29_);
	...
	public void method4779(ModelPart modelPart, int i, int i_38_, int i_39_, boolean bool) {
		((h) this).aJa6674.method5571().method285(this, modelPart, i, i_38_, i_39_, bool);
	}
	...
	public MagnetConfig[] method4774() {
		return ((h) this).aMagnetConfigArray6676;
	}
	...
	native void U(ja var_ja, ba var_ba, int i, int i_52_, int[] is, int[] is_53_, int[] is_54_, int[] is_55_,
			short[] is_56_, int i_57_, short[] is_58_, short[] is_59_, short[] is_60_, byte[] is_61_, byte[] is_62_,
			byte[] is_63_, byte[] is_64_, short[] is_65_, short[] is_66_, int[] is_67_, byte i_68_, short[] is_69_,
			int i_70_, byte[] is_71_, short[] is_72_, short[] is_73_, short[] is_74_, int[] is_75_, int[] is_76_,
			int[] is_77_, byte[] is_78_, byte[] is_79_, int[] is_80_, int[] is_81_, int[] is_82_, int[] is_83_,
			int i_84_, int i_85_, int i_86_, int i_87_, int i_88_, int i_89_, int[] is_90_);

	public ModelPart method4748(byte i, int i_91_, boolean bool) {
		return ((h) this).aJa6674.method5571().method276(this, i, i_91_, bool);
	}

	public ModelPart method4770(byte i, int i_92_, boolean bool) {
		return ((h) this).aJa6674.method5571().method276(this, i, i_92_, bool);
	}

	public ModelPart method4749(byte i, int i_93_, boolean bool) {
	...
	public native void bg(int i, int i_107_, Ground ground, Ground ground_108_, int i_109_, int i_110_,
                          int i_111_);

	public native int RA();

	public native void bp(int i, int i_112_, Ground ground, Ground ground_113_, int i_114_, int i_115_,
                          int i_116_);
	...
	public void method4747(ModelPart modelPart, int i, int i_117_, int i_118_, boolean bool) {
		((h) this).aJa6674.method5571().method285(this, modelPart, i, i_117_, i_118_, bool);
	}
	...
	h(ja var_ja, ba var_ba, Model class64, int i, int i_135_, int i_136_, int i_137_) {
		...
		((h) this).aMagnetConfigArray6676 = class64.aMagnetConfigArray613;
		int i_138_ = (class64.aClass85Array647 == null ? 0 : class64.aClass85Array647.length);
		int i_139_ = (class64.aMagnetConfigArray613 == null ? 0 : class64.aMagnetConfigArray613.length);
		int i_140_ = 0;
		...
		for (int i_142_ = 0; i_142_ < i_139_; i_142_++)
			is[i_140_++] = ((h) this).aMagnetConfigArray6676[i_142_].anInt674 * -180596249;
		int i_143_ = (class64.aVertexNormalArray649 == null ? 0 : class64.aVertexNormalArray649.length);
		int[] is_144_ = new int[i_143_ * 8];
		int i_145_ = 0;
		for (int i_146_ = 0; i_146_ < i_143_; i_146_++) {
			VertexNormal vertexNormal = class64.aVertexNormalArray649[i_146_];
			Class173 class173 = Node.method2844(vertexNormal.type * 1834782277, -67897652);
			is_144_[i_145_++] = vertexNormal.face * 1512514121;
		...
		for (int i_147_ = 0; i_147_ < i_143_; i_147_++) {
			VertexNormal vertexNormal = class64.aVertexNormalArray649[i_147_];
			is_144_[i_145_++] = vertexNormal.priority * -1606786303;
		}
		U(((h) this).aJa6674, ((h) this).aBa6675, class64.numVertices, class64.highestFaceIndex, class64.verticesX,
				class64.verticesY, class64.verticesZ, class64.verticesSkin, class64.vertexDuplicates,
				class64.numFaces, class64.facesA, class64.facesB, class64.facesC,
				class64.facesType, class64.facesPriority, class64.facesAlpha, class64.facesTexture,
				class64.facesColour, class64.facesMaterial, class64.facesSkin, class64.priority,
				class64.submeshes_lookup, class64.numTextures, class64.texturesMappingType, class64.texturesMappingP,
				class64.texturesMappingM, class64.texturesMappingN, class64.textureScaleX, class64.textureScaleY,
				class64.textureScaleZ, class64.textureRotation, class64.textureDirection, class64.textureSpeed,
				class64.textureTransU, class64.textureTransV, is, i_138_, i_139_, i, i_135_, i_136_, i_137_, is_144_);
	}

	public boolean method4746(int i, int i_148_, Matrix43f class222, boolean bool, int i_149_) {
	...
	public void method4751(Matrix43f class222) {
		...
		if (((h) this).aMagnetConfigArray6676 != null) {
			for (int i_176_ = 0; i_176_ < ((h) this).aMagnetConfigArray6676.length; i_176_++) {
				MagnetConfig magnetConfig = ((h) this).aMagnetConfigArray6676[i_176_];
				MagnetConfig magnetConfig_177_ = magnetConfig;
				if (magnetConfig.aMagnetConfig_672 != null)
					magnetConfig_177_ = magnetConfig.aMagnetConfig_672;
				if (magnetConfig.aClass233_677 == null)
					magnetConfig.aClass233_677 = new Class233();
				magnetConfig.aClass233_677.method2145(class222);
				magnetConfig_177_.anInt671 = ja.anIntArray6681[i++] * -1436341053;
				magnetConfig_177_.anInt675 = ja.anIntArray6681[i++] * 449866009;
				magnetConfig_177_.anInt676 = ja.anIntArray6681[i++] * 1336328763;
			}
		}
	}
	...
	public void method4782(Matrix43f class222) {
		...
		if (((h) this).aMagnetConfigArray6676 != null) {
			for (int i_179_ = 0; i_179_ < ((h) this).aMagnetConfigArray6676.length; i_179_++) {
				MagnetConfig magnetConfig = ((h) this).aMagnetConfigArray6676[i_179_];
				MagnetConfig magnetConfig_180_ = magnetConfig;
				if (magnetConfig.aMagnetConfig_672 != null)
					magnetConfig_180_ = magnetConfig.aMagnetConfig_672;
				if (magnetConfig.aClass233_677 == null)
					magnetConfig.aClass233_677 = new Class233();
				magnetConfig.aClass233_677.method2145(class222);
				magnetConfig_180_.anInt671 = ja.anIntArray6681[i++] * -1436341053;
				magnetConfig_180_.anInt675 = ja.anIntArray6681[i++] * 449866009;
				magnetConfig_180_.anInt676 = ja.anIntArray6681[i++] * 1336328763;
			}
		}
	}
	...
	public void method4783(Matrix43f class222) {
		...
		if (((h) this).aMagnetConfigArray6676 != null) {
			for (int i_182_ = 0; i_182_ < ((h) this).aMagnetConfigArray6676.length; i_182_++) {
				MagnetConfig magnetConfig = ((h) this).aMagnetConfigArray6676[i_182_];
				MagnetConfig magnetConfig_183_ = magnetConfig;
				if (magnetConfig.aMagnetConfig_672 != null)
					magnetConfig_183_ = magnetConfig.aMagnetConfig_672;
				if (magnetConfig.aClass233_677 == null)
					magnetConfig.aClass233_677 = new Class233();
				magnetConfig.aClass233_677.method2145(class222);
				magnetConfig_183_.anInt671 = ja.anIntArray6681[i++] * -1436341053;
				magnetConfig_183_.anInt675 = ja.anIntArray6681[i++] * 449866009;
				magnetConfig_183_.anInt676 = ja.anIntArray6681[i++] * 1336328763;
			}
		}
	}
	...
	native void fc(ja var_ja, ba var_ba, int i, int i_189_, int[] is, int[] is_190_, int[] is_191_, int[] is_192_,
			short[] is_193_, int i_194_, short[] is_195_, short[] is_196_, short[] is_197_, byte[] is_198_,
			byte[] is_199_, byte[] is_200_, byte[] is_201_, short[] is_202_, short[] is_203_, int[] is_204_,
			byte i_205_, short[] is_206_, int i_207_, byte[] is_208_, short[] is_209_, short[] is_210_, short[] is_211_,
			int[] is_212_, int[] is_213_, int[] is_214_, byte[] is_215_, byte[] is_216_, int[] is_217_, int[] is_218_,
			int[] is_219_, int[] is_220_, int i_221_, int i_222_, int i_223_, int i_224_, int i_225_, int i_226_,
			int[] is_227_);
	...
	public boolean method4763(int i, int i_231_, Matrix43f class222, boolean bool, int i_232_) {
	...
	public ModelPart method4750(byte i, int i_233_, boolean bool) {
