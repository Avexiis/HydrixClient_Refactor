...
public class ja extends GraphicsToolkit implements Interface25 {
	LinkedNodeList aLinkedNodeList_6680;
	...
	void method5068() {
		if (!((ja) this).aBoolean6684) {
			...
			for (ba var_ba = (ba) ((ja) this).aLinkedNodeList_6680.method5939(1766612795); var_ba != null; var_ba = (ba) ((ja) this).aLinkedNodeList_6680.method5944(49146))
				var_ba.ha();
			((ja) this).aLinkedNodeList_6680.method5943((byte) 1);
			da();
	...
	public EnvironmentMap method5142(EnvironmentMap environmentMap, EnvironmentMap environmentMap_65_, float f, EnvironmentMap environmentMap_) {
		return null;
	}
	...
	public void method5189(EnvironmentMap environmentMap) {
		/* empty */
	}

	public native void drawFilledBox(int i, int i_81_, int i_82_, int i_83_, int i_84_, int i_85_);
	...
	public Class_v method5026(int i) {
		...
		((ja) this).aLinkedNodeList_6680.addlast(var_ba, 1259364637);
		return var_ba;
	}
	...
	public ModelPart method5037(Model class64, int i, int i_194_, int i_195_, int i_196_) {
	...
	public void method5043(Matrix43f class222) {
	...
	public EnvironmentMap method5179(EnvironmentMap environmentMap, EnvironmentMap environmentMap_218_, float f, EnvironmentMap environmentMap_219_) {
		return null;
	}

	public void method5095(EnvironmentMap environmentMap) {
		/* empty */
	}
	...
	public ja(Canvas canvas, Interface_ma interface_ma, int i, int i_238_) {
		super(interface_ma);
		((ja) this).aLinkedNodeList_6680 = new LinkedNodeList();
		((ja) this).anInt6709 = 4096;
		((ja) this).anInt6685 = 4096;
		((ja) this).aBoolean6713 = false;
		try {
			if (!Class85.method955(2126469897).method265("sw3d", 1499520275) || Settings.DISABLE_SOFTWARE_MODE)
			...
			for (short i_240_ = 0; i_240_ < i_239_; i_240_++) {
				MaterialRaw materialRaw = anInterface_ma5299.method174(i_240_, 1423908475);
				if (materialRaw != null)
					V(i_240_, materialRaw.aShort532, materialRaw.anInt528 * -2138060883, materialRaw.aByte529, materialRaw.aByte536, materialRaw.anInt531 * 1616831825, materialRaw.aBoolean518, materialRaw.aByte533, materialRaw.aByte534, materialRaw.aByte535, materialRaw.aByte509, materialRaw.aBoolean524, materialRaw.aBoolean538, materialRaw.aBoolean527, materialRaw.aBoolean540, materialRaw.aBoolean541, materialRaw.aByte537, materialRaw.aBoolean543, materialRaw.aBoolean544, materialRaw.anInt519 * -490972023);
			}
	...
	public void method5131(Matrix43f class222) {
		((ja) this).aClass222_6688 = class222;
		((ja) this).aClass233_6689.method2145(class222);
		AA(((ja) this).aClass233_6689.aFloatArray2594);
		((ja) this).aClass233_6683.method2143(((ja) this).aClass233_6689, ((ja) this).aClass233_6690);
	...
	public Class_v method5102(int i) {
		ba var_ba = new ba(this, i);
		((ja) this).aLinkedNodeList_6680.addlast(var_ba, 472280132);
		return var_ba;
	}
	...
	public Ground method5121(int i, int i_408_, int[][] is, int[][] is_409_, int i_410_, int i_411_, int i_412_) {
		return new i(this, ((ja) this).aBa6682, i, i_408_, is, is_409_, i_410_, i_411_, i_412_);
	}

	public Ground method5122(int i, int i_413_, int[][] is, int[][] is_414_, int i_415_, int i_416_, int i_417_) {
		return new i(this, ((ja) this).aBa6682, i, i_413_, is, is_414_, i_415_, i_416_, i_417_);
	}

	public Ground method5123(int i, int i_418_, int[][] is, int[][] is_419_, int i_420_, int i_421_, int i_422_) {
		return new i(this, ((ja) this).aBa6682, i, i_418_, is, is_419_, i_420_, i_421_, i_422_);
	}

	public Ground method5087(int i, int i_423_, int[][] is, int[][] is_424_, int i_425_, int i_426_, int i_427_) {
	...
	public void method5132(Matrix43f class222) {
		((ja) this).aClass222_6688 = class222;
		((ja) this).aClass233_6689.method2145(class222);
		AA(((ja) this).aClass233_6689.aFloatArray2594);
		((ja) this).aClass233_6683.method2143(((ja) this).aClass233_6689, ((ja) this).aClass233_6690);
	...
	public void method5129(Matrix43f class222) {
		((ja) this).aClass222_6688 = class222;
		((ja) this).aClass233_6689.method2145(class222);
		AA(((ja) this).aClass233_6689.aFloatArray2594);
		((ja) this).aClass233_6683.method2143(((ja) this).aClass233_6689, ((ja) this).aClass233_6690);
	...
	public void method5130(Matrix43f class222) {
		((ja) this).aClass222_6688 = class222;
		((ja) this).aClass233_6689.method2145(class222);
		AA(((ja) this).aClass233_6689.aFloatArray2594);
		((ja) this).aClass233_6683.method2143(((ja) this).aClass233_6689, ((ja) this).aClass233_6690);
	...
	public EnvironmentMap method4986(EnvironmentMap environmentMap, EnvironmentMap environmentMap_479_, float f, EnvironmentMap environmentMap_480_) {
		return null;
	}
	...
	boolean SA(short i) {
		synchronized (anInterface_ma5299) {
			MaterialRaw class_cc = anInterface_ma5299.method174(i, 1155250631);
			if (class_cc == null) {
				boolean bool = false;
				return bool;
			}
	...
	public ModelPart method5116(Model class64, int i, int i_608_, int i_609_, int i_610_) {
	...
	public Ground method5040(int i, int i_664_, int[][] is, int[][] is_665_, int i_666_, int i_667_, int i_668_) {
